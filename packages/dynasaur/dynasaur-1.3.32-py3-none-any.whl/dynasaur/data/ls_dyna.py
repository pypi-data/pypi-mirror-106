...
class JointType(BinoutData):
    """ """
    #TODO: Check data channel types with binout extert
    DATA_CHANNEL_TYPES = ['alpha_moment_stiffness', 'd(gamma)_dt', 'joint_energy', 'joint_extra2',
                          'alpha_degrees', 'alpha_moment_total', 'gamma_degrees', 'd(alpha)_dt', 'beta_degrees',
                          'alpha_moment_damping', 'beta_moment_total', 'gamma_scale_factor', 'joint_extra1',
