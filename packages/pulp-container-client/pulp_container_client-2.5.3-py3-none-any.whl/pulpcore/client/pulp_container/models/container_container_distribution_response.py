...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, pulp_href=None, pulp_labels=None, repository_version=None, repository=None, name=None, pulp_created=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
