...
def perform_mle_background (freq, psd, n_harvey=2, r=1., m=1., teff=5770., dnu=None, numax=None, 
                            ...
                            quickfit=False, num=5000, reboxing_strategy='median', apodisation=False, high_cut_plaw=20.) :
  '''
  ...
  if dnu is None :
    dnu = dnu_scale (r, m)
    print ('Dnu computed with scale law: {:.1f} muHz'.format (dnu)) 
  if numax is None :
    numax = numax_scale (r, m, teff)
    print ('numax computed with scale law: {:.1f} muHz'.format (numax)) 
  ...
  if quickfit :
    aux_freq, aux_psd = degrade_psd (aux_freq, aux_psd, num=num, strategy=reboxing_strategy, numax=numax)
...
def explore_distribution_background (freq, psd, n_harvey=2, r=1., m=1., teff=5770., dnu=None, numax=None, 
                                     ...
                                     coeff_discard=50, thin=1, quickfit=False, num=5000, reboxing_strategy='median',  
