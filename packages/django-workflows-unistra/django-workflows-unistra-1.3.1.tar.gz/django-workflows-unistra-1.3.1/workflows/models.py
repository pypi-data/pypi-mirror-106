...
class Workflow(models.Model):
    ...
    **Attributes:**
    ...
    initial_state = models.ForeignKey("State", verbose_name=_(u"Initial state"), related_name="workflow_state", blank=True, null=True, on_delete=models.CASCADE)
...
class State(models.Model):
    ...
    **Attributes:**
    ...
    workflow = models.ForeignKey(Workflow, verbose_name=_(u"Workflow"), related_name="states", on_delete=models.CASCADE)
...
class Transition(models.Model):
    ...
    **Attributes:**
    ...
    """
    name = models.CharField(_(u"Name"), max_length=100)
    workflow = models.ForeignKey(Workflow, verbose_name=_(u"Workflow"), related_name="transitions", on_delete=models.CASCADE)
    destination = models.ForeignKey(State, verbose_name=_(u"Destination"), null=True, blank=True, related_name="destination_state", on_delete=models.CASCADE)
    condition = models.CharField(_(u"Condition"), blank=True, max_length=100)
    permission = models.ForeignKey(Permission, verbose_name=_(u"Permission"), blank=True, null=True, on_delete=models.CASCADE)

    class Meta:
        app_label = "workflows"

    def __unicode__(self):
        return "%s (%s)" % (self.name, self.worflow.name)
...
class StateObjectRelation(models.Model):
    ...
    **Attributes:**
    ...
    """
    content_type = models.ForeignKey(ContentType, verbose_name=_(u"Content type"), related_name="state_object", blank=True, null=True, on_delete=models.CASCADE)
    content_id = models.PositiveIntegerField(_(u"Content id"), blank=True, null=True)
    content = GenericForeignKey(ct_field="content_type", fk_field="content_id")
    state = models.ForeignKey(State, verbose_name=_(u"State"), on_delete=models.CASCADE)
...
class WorkflowObjectRelation(models.Model):
    ...
    **Attributes:**
    ...
    workflow
        ...
        instance.
    """
    content_type = models.ForeignKey(ContentType, verbose_name=_(u"Content type"), related_name="workflow_object", blank=True, null=True, on_delete=models.CASCADE)
    content_id = models.PositiveIntegerField(_(u"Content id"), blank=True, null=True)
    content = GenericForeignKey(ct_field="content_type", fk_field="content_id")
    workflow = models.ForeignKey(Workflow, verbose_name=_(u"Workflow"), related_name="wors", on_delete=models.CASCADE)
...
class WorkflowModelRelation(models.Model):
    ...
    **Attributes:**
    ...
    workflow = models.ForeignKey(Workflow, verbose_name=_(u"Workflow"), related_name="wmrs", on_delete=models.CASCADE)
...
class WorkflowPermissionRelation(models.Model):
    ...
    **Attributes:**
    ...
    permission = models.ForeignKey(Permission, related_name="permissions", on_delete=models.CASCADE)
