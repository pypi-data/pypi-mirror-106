...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '3.1.0-alpha.1621591564+59468584'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 3.1.0-alpha.1621591564+59468584`
                """)
            else:
                raise
