...
class OscarProtocol():
    ...
    def set_vehicle_forward_move(self):
        self.vehicle_move_cmd.forward_move()
        return True
...
class OscarSteeringWheelTorqueCmdDataV2(OscarCmdData):
    ...
    # THIS IS ONLY BECAUSE THE OSCAR_CAN_V2 HAS PUBLISHING AND CONFIRMABLE COMMAND
...
class OscarVehicleMoveCmdDataV2(OscarCmdData):
    ...
    def reverse_move(self):
        self._set_direction(self.REVERSE)
