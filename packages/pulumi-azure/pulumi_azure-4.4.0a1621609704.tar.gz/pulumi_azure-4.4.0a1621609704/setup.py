...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.4.0-alpha.1621609704+b06f2e8b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.4.0-alpha.1621609704+b06f2e8b`
                """)
            else:
                raise
