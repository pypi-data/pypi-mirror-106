...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.3.0-alpha.1621275299+cd6956bf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.3.0-alpha.1621275299+cd6956bf`
                """)
            else:
                raise
