...
class Minimum:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.listPy.cdPower.minimum.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WCDMa:MEASurement<Instance>:MEValuation:LIST:CDPower:MINimum?', self.__class__.FetchStruct())
