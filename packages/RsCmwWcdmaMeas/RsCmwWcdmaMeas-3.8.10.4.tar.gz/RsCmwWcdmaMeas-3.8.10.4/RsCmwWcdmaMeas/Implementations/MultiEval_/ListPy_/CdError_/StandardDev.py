...
class StandardDev:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.listPy.cdError.standardDev.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WCDMa:MEASurement<Instance>:MEValuation:LIST:CDERror:SDEViation?', self.__class__.FetchStruct())
