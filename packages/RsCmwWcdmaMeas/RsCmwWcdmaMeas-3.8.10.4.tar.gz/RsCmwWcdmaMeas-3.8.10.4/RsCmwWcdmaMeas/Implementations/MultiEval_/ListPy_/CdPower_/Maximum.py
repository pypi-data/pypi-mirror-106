...
class Maximum:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.multiEval.listPy.cdPower.maximum.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WCDMa:MEASurement<Instance>:MEValuation:LIST:CDPower:MAXimum?', self.__class__.FetchStruct())
