...
class Hsdpcch:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Hsdpcch_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Hsdpcch_.Average import Average
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Hsdpcch_.Minimum import Minimum
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Hsdpcch_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Hsdpcch_.StandardDev import StandardDev
