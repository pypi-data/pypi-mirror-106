...
[boto3.KinesisAnalyticsV2 1.17.74](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/kinesisanalyticsv2.html#KinesisAnalyticsV2)
...
def check_value(value: ApplicationRestoreTypeType) -> bool:
    ...
```
