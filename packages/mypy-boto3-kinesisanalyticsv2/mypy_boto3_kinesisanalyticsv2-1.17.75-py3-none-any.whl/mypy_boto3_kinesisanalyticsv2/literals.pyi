...
Usage::
    ...
    data: ApplicationRestoreTypeType = "RESTORE_FROM_CUSTOM_SNAPSHOT"
    ```
"""
import sys
...
RuntimeEnvironmentType = Literal["FLINK-1_11", "FLINK-1_6", "FLINK-1_8", "SQL-1_0"]
SnapshotStatusType = Literal["CREATING", "DELETING", "FAILED", "READY"]
UrlTypeType = Literal["FLINK_DASHBOARD_URL"]
