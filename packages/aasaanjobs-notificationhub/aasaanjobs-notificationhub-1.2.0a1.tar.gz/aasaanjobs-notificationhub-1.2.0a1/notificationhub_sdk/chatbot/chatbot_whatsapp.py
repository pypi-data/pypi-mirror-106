...
class ChatbotWhatsapp:
    def __init__(
        ...
        Parameters:
            ...
            message_format (MessageFormat, optional): format of the message; (defaults to MessageFormat.TEXT; other options are JSON and XML)
        ...
        self._chatbot_whatsapp.messageFormat = message_format
