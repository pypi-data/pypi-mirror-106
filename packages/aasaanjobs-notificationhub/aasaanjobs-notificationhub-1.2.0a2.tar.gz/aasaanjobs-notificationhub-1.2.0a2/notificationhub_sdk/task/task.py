...
from ..common import (AccountType, DataEnconding, MessageFormat, MessageContentType,
                      MessageType, Platform, WaterfallMode)
...
class Task:
    ...
    def __init__(self, name: str,
        ...
        Parameters:
            ...
            chatbot (chatbot, optional): Type of the chatbot (defaults to None)
        """
