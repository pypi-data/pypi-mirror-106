...
`;!function(e,t,r,i){var n=c();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var s=t((function(e){n.initializeInstanceElements(e,a.elements)}),r),a=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(p(o.descriptor)||p(n.descriptor)){if(u(o)||u(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(u(o)){if(u(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}d(o,n)}else t.push(o)}return t}(s.d.map(l)),e);n.initializeClassElements(s.F,a.elements),n.runClassFinishers(s.F,a.finishers)}([(0,s.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"method",key:"scrollToPos",value:function(e,t){this.contentElement.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading"> ${v(y(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"get",static:!0,key:"styles",value:function(){return[i.V.styles,o.iv`
    ...
    `:n.dy``}},{kind:"method",key:"_secureInclusionToggleChanged",value:async function(e){const t=e.target;this._use_secure_inclusion=t.checked}},{kind:"method",key:"_startInclusion",value:function(){this.hass&&(this._subscribed=this.hass.connection.subscribeMessage((e=>this._handleMessage(e)),{type:"zwave_js/add_node",entry_id:this.entry_id,secure:this._use_secure_inclusion}),this._addNodeTimeoutHandle=window.setTimeout((()=>this._unsubscribe()),9e4))}},{kind:"method",key:"_handleMessage",value:function(e){"inclusion started"===e.event&&(this._status="started"),"inclusion failed"===e.event&&(this._unsubscribe(),this._status="failed"),"inclusion stopped"===e.event&&(this._stoppedTimeout=setTimeout((()=>{this._nodeAdded||(this._status="",this._unsubscribe(),this._stoppedTimeout=void 0)}),3e3)),"device registered"===e.event&&(this._device=e.device),"node added"===e.event&&(this._nodeAdded=!0,this._stoppedTimeout&&clearTimeout(this._stoppedTimeout),this._status="interviewing"),"interview completed"===e.event&&(this._status="finished",this._unsubscribe()),"interview stage completed"===e.event&&(void 0===this._stages?this._stages=[e.stage]:this._stages=[...this._stages,e.stage])}},{kind:"method",key:"_unsubscribe",value:function(){this._subscribed&&(this._subscribed.then((e=>e())),this._subscribed=void 0),"started"===this._status&&this.hass.callWS({type:"zwave_js/stop_inclusion",entry_id:this.entry_id}),"finished"!==this._status&&(this._status=""),this._addNodeTimeoutHandle&&clearTimeout(this._addNodeTimeoutHandle)}},{kind:"method",key:"closeDialog",value:function(){this._unsubscribe(),this.entry_id=void 0,this._status="",this._nodeAdded=!1,this._device=void 0,this._stages=void 0,this._stoppedTimeout&&(clearTimeout(this._stoppedTimeout),this._stoppedTimeout=void 0),this._use_secure_inclusion=!1,(0,a.B)(this,"dialog-closed",{dialog:this.localName})}},{kind:"get",static:!0,key:"styles",value:function(){return[s.yu,n.iv`
      ...
      `]}}]}}),n.oi)}}]);
//# sourceMappingURL=chunk.6cf4b8f468123a654d5d.js.map