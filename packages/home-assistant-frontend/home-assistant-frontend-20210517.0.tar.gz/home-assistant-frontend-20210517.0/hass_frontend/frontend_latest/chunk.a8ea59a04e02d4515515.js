...
`,E=(e,t,r)=>{const i=getComputedStyle(t).getPropertyValue(`--weather-icon-${e}`);return i?n.dy`
  ...
  ${p.has(e)?n.YP`
    ...
    `}}]}}),i.oi)},89173:(e,t,r)=>{"use strict";var i=r(99722),n=r(50467),o=r(99476);class s extends o.p{async getCardSize(){if(!this._cards)return 0;const e=[];for(const t of this._cards)e.push((0,n.N)(t));const t=await Promise.all(e);return Math.max(...t)}static get styles(){return[super.sharedStyles,i.iv`
        #root {
          display: flex;
          height: 100%;
        }
    ...
    `}}]}}),n.oi)},26136:(e,t,r)=>{"use strict";var i=r(99722),n=r(50467),o=r(99476);class s extends o.p{async getCardSize(){if(!this._cards)return 0;const e=[];for(const t of this._cards)e.push((0,n.N)(t));return(await Promise.all(e)).reduce(((e,t)=>e+t),0)}static get styles(){return[super.sharedStyles,i.iv`
        #root {
          display: flex;
          flex-direction: column;
          height: 100%;
