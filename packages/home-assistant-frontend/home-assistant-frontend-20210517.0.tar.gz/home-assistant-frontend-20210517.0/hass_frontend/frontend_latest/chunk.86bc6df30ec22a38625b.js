...
`,is:"paper-icon-item",behaviors:[s.U]})},89194:(t,e,r)=>{"use strict";r(65233),r(65660),r(70019);var o=r(9672),l=r(50856);(0,o.k)({_template:l.d`
    ...
    <slot></slot>
`,is:"paper-item-body"})},1275:(t,e,r)=>{"use strict";r.d(e,{l:()=>s});var o=r(94707);const l=new WeakMap,s=(0,o.XM)(((t,e)=>r=>{const o=l.get(r);if(Array.isArray(t)){if(Array.isArray(o)&&o.length===t.length&&t.every(((t,e)=>t===o[e])))return}else if(o===t&&(void 0!==t||l.has(r)))return;r.setValue(e()),l.set(r,Array.isArray(t)?Array.from(t):t)}))}}]);
//# sourceMappingURL=chunk.86bc6df30ec22a38625b.js.map