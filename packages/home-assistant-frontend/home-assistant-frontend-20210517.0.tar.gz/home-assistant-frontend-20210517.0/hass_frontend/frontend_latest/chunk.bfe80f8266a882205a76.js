      ...
      <ha-app-layout>
        <app-header slot="header">
          <app-toolbar>
            ...
            <div
              class="save-button
              ${(0,a.$)({saved:!1===this._saving||!0===this._changed})}"
            >
