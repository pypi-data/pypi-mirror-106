...
class StandardDev:
	...
	def read(self) -> ResultData:
		...
		return self._core.io.query_struct(f'READ:CDMA:MEASurement<Instance>:MEValuation:MODulation:SDEViation?', self.__class__.ResultData())
	...
	def fetch(self) -> ResultData:
		...
		the parameter position within the result array. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:CDMA:MEASurement<Instance>:MEValuation:MODulation:SDEViation?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		...
		return self._core.io.query_struct(f'CALCulate:CDMA:MEASurement<Instance>:MEValuation:MODulation:SDEViation?', self.__class__.CalculateStruct())
