...
class Maximum:
	...
	def fetch(self) -> FetchStruct:
		...
		return self._core.io.query_struct(f'FETCh:CDMA:MEASurement<Instance>:MEValuation:LIST:MODulation:MAXimum?', self.__class__.FetchStruct())
	...
	def calculate(self) -> CalculateStruct:
		...
		return self._core.io.query_struct(f'CALCulate:CDMA:MEASurement<Instance>:MEValuation:LIST:MODulation:MAXimum?', self.__class__.CalculateStruct())
