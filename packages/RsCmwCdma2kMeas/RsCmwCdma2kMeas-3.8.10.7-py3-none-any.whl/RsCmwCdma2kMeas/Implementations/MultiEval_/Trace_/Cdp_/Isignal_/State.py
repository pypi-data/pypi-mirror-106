...
class State:
	...
	def fetch(self) -> List[enums.SigChStateB]:
		...
		Use RsCmwCdma2kMeas.reliability.last_value to read the updated reliability indicator. \n
			:return: cdp_isig_ch_state: INVisible | ACTive | IACTive The number of results depends on the selected spreading factor: SF=16, 32, 64. INV: No channel available ACTive: Active code channel IACtive: Inactive code channel"""
