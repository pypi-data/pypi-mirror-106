...
class vectoruc(object):
    ...
    def __len__(self) -> "std::vector< uchar >::size_type":
        return _fast.vectoruc___len__(self)

    def __getslice__(self, i: "std::vector< uchar >::difference_type", j: "std::vector< uchar >::difference_type") -> "std::vector< uchar,std::allocator< uchar > > *":
        return _fast.vectoruc___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _fast.vectoruc___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< uchar >::difference_type", j: "std::vector< uchar >::difference_type") -> "void":
        return _fast.vectoruc___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _fast.vectoruc___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< uchar >::value_type const &":
        return _fast.vectoruc___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _fast.vectoruc___setitem__(self, *args)

    def pop(self) -> "std::vector< uchar >::value_type":
        return _fast.vectoruc_pop(self)

    def append(self, x: "std::vector< uchar >::value_type const &") -> "void":
        return _fast.vectoruc_append(self, x)

    def empty(self) -> "bool":
        return _fast.vectoruc_empty(self)

    def size(self) -> "std::vector< uchar >::size_type":
        return _fast.vectoruc_size(self)

    def swap(self, v: "vectoruc") -> "void":
        return _fast.vectoruc_swap(self, v)

    def begin(self) -> "std::vector< uchar >::iterator":
        return _fast.vectoruc_begin(self)

    def end(self) -> "std::vector< uchar >::iterator":
        return _fast.vectoruc_end(self)

    def rbegin(self) -> "std::vector< uchar >::reverse_iterator":
        return _fast.vectoruc_rbegin(self)

    def rend(self) -> "std::vector< uchar >::reverse_iterator":
        return _fast.vectoruc_rend(self)

    def clear(self) -> "void":
        return _fast.vectoruc_clear(self)

    def get_allocator(self) -> "std::vector< uchar >::allocator_type":
        return _fast.vectoruc_get_allocator(self)

    def pop_back(self) -> "void":
        return _fast.vectoruc_pop_back(self)

    def erase(self, *args) -> "std::vector< uchar >::iterator":
        return _fast.vectoruc_erase(self, *args)

    def __init__(self, *args):
        _fast.vectoruc_swiginit(self, _fast.new_vectoruc(*args))

    def push_back(self, x: "std::vector< uchar >::value_type const &") -> "void":
        return _fast.vectoruc_push_back(self, x)

    def front(self) -> "std::vector< uchar >::value_type const &":
        return _fast.vectoruc_front(self)

    def back(self) -> "std::vector< uchar >::value_type const &":
        return _fast.vectoruc_back(self)

    def assign(self, n: "std::vector< uchar >::size_type", x: "std::vector< uchar >::value_type const &") -> "void":
    ...
    def reserve(self, n: "std::vector< uchar >::size_type") -> "void":
        return _fast.vectoruc_reserve(self, n)

    def capacity(self) -> "std::vector< uchar >::size_type":
...
class ImageSharpening(GaussianSmoothingFilter):
...
class Segmentation(Image):
    ...
    A segmentation data object is an 'Image' with a single channel and 8 bit unsigned integer data type.
...
class ImageImporter(object):
    ...
    def setFilename(self, filename: "std::string") -> "void":
        return _fast.ImageImporter_setFilename(self, filename)
...
class ImagePyramidPatchExporter(ProcessObject):
    r"""
