...
class EchoStateNetwork(nn.Module):
    ...
    def fit(self, y = None, X=None, burn_in=300, input_weight=None, verbose = False , 
        ...
        """
        #self.alpha = None
        self.multiple_ICs = multiple_ICs
                        ...
                        with torch.set_grad_enabled(False):
                            ...
                            if self.ODE_order:
                                ...
                                if eq_system:
                                    ...
                                    y0_vec = torch.ones_like(X).T * y0
                                    p0_vec = torch.ones_like(X).T * p0
                                    ...
                                    try:
                                        ...
                                        #self.Wy = Wy =  (Cx @ pinverse(Delta) + Cp @ pinverse(Sigma) ) @ Lam
                                        #self.Wp = Wp =  (Cp @ pinverse(Delta) - Cx @ pinverse(Sigma) ) @ Lam
                                    ...
                                    if multiple_ICs:
                                        force_t = force(t)
                                        D_As = [A*ode_coefs[0]- force_t for i, A in enumerate(As)]
                                    ...
                                    self.DH1 = DH1 = DH.T @ DH

                                    if nl:
                                        self.DH1 = self.DH1 -2 * self.q* D_A.T * gH.T @ gH
