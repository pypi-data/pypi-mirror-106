...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.2.0-alpha.1621595268+62a9f02f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.2.0-alpha.1621595268+62a9f02f`
                """)
            else:
                raise
