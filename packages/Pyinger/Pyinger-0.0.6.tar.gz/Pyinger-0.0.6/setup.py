...
LONG_DESCRIPTION = 'A package that allows you to check on a servers status. Can get GMAIL notifications if server is down. Less secure apps must be enabled with no 2 step authentication.'
