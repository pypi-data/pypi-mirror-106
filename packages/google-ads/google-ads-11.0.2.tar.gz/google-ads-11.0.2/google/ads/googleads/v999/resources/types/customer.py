...
from google.ads.googleads.v999.enums.types import account_status
from google.ads.googleads.v999.enums.types import (
    account_type as gage_account_type,
)
from google.ads.googleads.v999.enums.types import (
...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        test_account (bool):
            ...
            account.
        call_reporting_setting (google.ads.googleads.v999.resources.types.CallReportingSetting):
            Call reporting setting for a customer.
        conversion_tracking_setting (google.ads.googleads.v999.resources.types.ConversionTrackingSetting):
            Output only. Conversion tracking setting for
            a customer.
        remarketing_setting (google.ads.googleads.v999.resources.types.RemarketingSetting):
            Output only. Remarketing setting for a
            customer.
        pay_per_conversion_eligibility_failure_reasons (Sequence[google.ads.googleads.v999.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
        ...
        optimization_score_weight (float):
            ...
            This field is read-only.
        account_type (google.ads.googleads.v999.enums.types.AccountTypeEnum.AccountType):
            Output only. Engine account type, e.g. Google
            Ads, Microsoft Advertising, Yahoo Japan, Baidu,
            Facebook, Engine Track, etc.
        double_click_campaign_manager_setting (google.ads.googleads.v999.resources.types.DoubleClickCampaignManagerSetting):
            Output only. DoubleClick Campaign Manager
            (DCM) setting for a manager customer.
        status (google.ads.googleads.v999.enums.types.AccountStatusEnum.AccountStatus):
            Output only. Account status, e.g. Enabled,
            Paused, Removed, etc.
    ...
    account_type = proto.Field(
        proto.ENUM,
        number=31,
        enum=gage_account_type.AccountTypeEnum.AccountType,
    )
    double_click_campaign_manager_setting = proto.Field(
        proto.MESSAGE, number=32, message="DoubleClickCampaignManagerSetting",
    )
    status = proto.Field(
        proto.ENUM,
        number=33,
        enum=account_status.AccountStatusEnum.AccountStatus,
    )
    last_modified_time = proto.Field(proto.STRING, number=34,)
    engine_id = proto.Field(proto.STRING, number=35,)
...
class DoubleClickCampaignManagerSetting(proto.Message):
    ...
    advertiser_id = proto.Field(proto.INT64, number=1,)
    network_id = proto.Field(proto.INT64, number=2,)
    time_zone = proto.Field(proto.STRING, number=3,)
