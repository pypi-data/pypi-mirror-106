...
class ConversionAdjustmentUploadServiceClient(
    ...
    def upload_conversion_adjustments(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.UploadConversionAdjustmentsRequest`):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversion_adjustments (:class:`Sequence[google.ads.googleads.v999.services.types.ConversionAdjustment]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.UploadConversionAdjustmentsResponse:
