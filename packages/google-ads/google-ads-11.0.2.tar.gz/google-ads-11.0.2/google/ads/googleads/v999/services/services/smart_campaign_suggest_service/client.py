...
class SmartCampaignSuggestServiceClient(
    ...
    def suggest_smart_campaign_budget_options(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.SuggestSmartCampaignBudgetOptionsRequest`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.SuggestSmartCampaignBudgetOptionsResponse:
