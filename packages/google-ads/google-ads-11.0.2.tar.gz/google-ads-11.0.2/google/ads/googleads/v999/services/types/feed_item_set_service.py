...
class MutateFeedItemSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.FeedItemSetOperation]):
...
class FeedItemSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.FeedItemSet):
            Create operation: No resource name is
            expected for the new feed item set
        update (google.ads.googleads.v999.resources.types.FeedItemSet):
...
class MutateFeedItemSetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.MutateFeedItemSetResult]):
