...
from google.ads.googleads.v999.enums.types import frequency_cap_time_unit
from google.ads.googleads.v999.enums.types import reach_plan_ad_length
from google.ads.googleads.v999.enums.types import reach_plan_age_range
from google.ads.googleads.v999.enums.types import reach_plan_network
...
class ListPlannableLocationsRequest(proto.Message):
    ...
    [ReachPlanService.ListPlannableLocations][google.ads.googleads.v999.services.ReachPlanService.ListPlannableLocations].
        """
...
class ListPlannableLocationsResponse(proto.Message):
    ...
    Attributes:
        plannable_locations (Sequence[google.ads.googleads.v999.services.types.PlannableLocation]):
...
class ListPlannableProductsResponse(proto.Message):
    ...
    Attributes:
        product_metadata (Sequence[google.ads.googleads.v999.services.types.ProductMetadata]):
...
class ProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        plannable_targeting (google.ads.googleads.v999.services.types.PlannableTargeting):
...
class PlannableTargeting(proto.Message):
    ...
    Attributes:
        age_ranges (Sequence[google.ads.googleads.v999.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange]):
        ...
        genders (Sequence[google.ads.googleads.v999.common.types.GenderInfo]):
            Targetable genders for the ad product.
        devices (Sequence[google.ads.googleads.v999.common.types.DeviceInfo]):
            Targetable devices for the ad product.
        networks (Sequence[google.ads.googleads.v999.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork]):
...
class GenerateProductMixIdeasRequest(proto.Message):
    r"""Request message for
    [ReachPlanService.GenerateProductMixIdeas][google.ads.googleads.v999.services.ReachPlanService.GenerateProductMixIdeas].
    ...
    Attributes:
        ...
        budget_micros (int):
            ...
            one unit.
        preferences (google.ads.googleads.v999.services.types.Preferences):
...
class Preferences(proto.Message):
    ...
    Attributes:
        ...
        starts_with_sound (bool):
            ...
            If not set, default is any value.
        ad_length (google.ads.googleads.v999.enums.types.ReachPlanAdLengthEnum.ReachPlanAdLength):
...
class GenerateProductMixIdeasResponse(proto.Message):
    ...
    Attributes:
        product_allocation (Sequence[google.ads.googleads.v999.services.types.ProductAllocation]):
...
class GenerateReachForecastRequest(proto.Message):
    r"""Request message for
    [ReachPlanService.GenerateReachForecast][google.ads.googleads.v999.services.ReachPlanService.GenerateReachForecast].
    ...
    Attributes:
        ...
        currency_code (str):
            The currency code.
            Three-character ISO 4217 currency code.
        campaign_duration (google.ads.googleads.v999.services.types.CampaignDuration):
        ...
        cookie_frequency_cap_setting (google.ads.googleads.v999.services.types.FrequencyCap):
            Desired cookie frequency cap that will be applied to each
            planned product. This is equivalent to the frequency cap
            exposed in Google Ads when creating a campaign, it
            represents the maximum number of times an ad can be shown to
        ...
        targeting (google.ads.googleads.v999.services.types.Targeting):
        ...
        planned_products (Sequence[google.ads.googleads.v999.services.types.PlannedProduct]):
...
class FrequencyCap(proto.Message):
    ...
    Attributes:
        impressions (int):
            ...
            inclusive.
        time_unit (google.ads.googleads.v999.enums.types.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit):
...
class Targeting(proto.Message):
    ...
    Attributes:
        ...
        age_range (google.ads.googleads.v999.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange):
            Targeted age range.
        ...
        network (google.ads.googleads.v999.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork):
...
class GenerateReachForecastResponse(proto.Message):
    ...
    Attributes:
        on_target_audience_metrics (google.ads.googleads.v999.services.types.OnTargetAudienceMetrics):
            Reference on target audiences for this curve.
        reach_curve (google.ads.googleads.v999.services.types.ReachCurve):
...
class ReachCurve(proto.Message):
    ...
    Attributes:
        reach_forecasts (Sequence[google.ads.googleads.v999.services.types.ReachForecast]):
...
class ReachForecast(proto.Message):
    ...
    Attributes:
        cost_micros (int):
            The cost in micros.
        forecast (google.ads.googleads.v999.services.types.Forecast):
            Forecasted traffic metrics for this point.
        planned_product_reach_forecasts (Sequence[google.ads.googleads.v999.services.types.PlannedProductReachForecast]):
...
class PlannedProductReachForecast(proto.Message):
    ...
    Attributes:
        ...
        planned_product_forecast (google.ads.googleads.v999.services.types.PlannedProductForecast):
