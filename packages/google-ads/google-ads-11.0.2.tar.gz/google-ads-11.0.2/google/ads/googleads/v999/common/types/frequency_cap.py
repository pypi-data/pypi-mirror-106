...
from google.ads.googleads.v999.enums.types import frequency_cap_event_type
from google.ads.googleads.v999.enums.types import frequency_cap_level
...
class FrequencyCapEntry(proto.Message):
    ...
    Attributes:
        key (google.ads.googleads.v999.common.types.FrequencyCapKey):
...
class FrequencyCapKey(proto.Message):
    ...
    Attributes:
        level (google.ads.googleads.v999.enums.types.FrequencyCapLevelEnum.FrequencyCapLevel):
            The level on which the cap is to be applied
            (e.g. ad group ad, ad group). The cap is applied
            to all the entities of this level.
        event_type (google.ads.googleads.v999.enums.types.FrequencyCapEventTypeEnum.FrequencyCapEventType):
