...
class SmartCampaignSetting(proto.Message):
    ...
    Attributes:
        ...
        campaign (str):
            ...
            settings apply.
        phone_number (google.ads.googleads.v999.resources.types.SmartCampaignSetting.PhoneNumber):
            Phone number and region code.
        final_url (str):
    ...
    class PhoneNumber(proto.Message):
        r"""Phone number and region code in smart campaign settings.
        Attributes:
            phone_number (str):
        ...
        region_code = proto.Field(proto.STRING, number=2, optional=True,)
