    ...
    def get_campaign_experiment(
        ...
        if "get_campaign_experiment" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/GetCampaignExperiment",
    ...
    def create_campaign_experiment(
        ...
        if "create_campaign_experiment" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/CreateCampaignExperiment",
    ...
    def mutate_campaign_experiments(
        ...
        if "mutate_campaign_experiments" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/MutateCampaignExperiments",
    ...
    def graduate_campaign_experiment(
        ...
        if "graduate_campaign_experiment" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/GraduateCampaignExperiment",
    ...
    def promote_campaign_experiment(
        ...
        if "promote_campaign_experiment" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/PromoteCampaignExperiment",
    ...
    def end_campaign_experiment(
        ...
        if "end_campaign_experiment" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/EndCampaignExperiment",
    ...
    def list_campaign_experiment_async_errors(
        ...
        if "list_campaign_experiment_async_errors" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExperimentService/ListCampaignExperimentAsyncErrors",
