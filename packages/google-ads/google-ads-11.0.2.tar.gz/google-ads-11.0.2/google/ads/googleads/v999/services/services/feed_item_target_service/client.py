...
from google.ads.googleads.v999.resources.types import feed_item_target
...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def get_feed_item_target(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetFeedItemTargetRequest`):
                The request object. Request message for
                [FeedItemTargetService.GetFeedItemTarget][google.ads.googleads.v999.services.FeedItemTargetService.GetFeedItemTarget].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.FeedItemTarget:
                A feed item target.
        """
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateFeedItemTargetsRequest`):
                The request object. Request message for
                [FeedItemTargetService.MutateFeedItemTargets][google.ads.googleads.v999.services.FeedItemTargetService.MutateFeedItemTargets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.FeedItemTargetOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateFeedItemTargetsResponse:
