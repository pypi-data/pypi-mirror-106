...
from google.ads.googleads.v999.enums.types import invoice_type
...
class Invoice(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v999.enums.types.InvoiceTypeEnum.InvoiceType):
        ...
        due_date (str):
            ...
            format.
        service_date_range (google.ads.googleads.v999.common.types.DateRange):
        ...
        account_budget_summaries (Sequence[google.ads.googleads.v999.resources.types.Invoice.AccountBudgetSummary]):
    ...
    class AccountBudgetSummary(proto.Message):
        ...
        Attributes:
            ...
            total_amount_micros (int):
                ...
                tax amount.
            billable_activity_date_range (google.ads.googleads.v999.common.types.DateRange):
