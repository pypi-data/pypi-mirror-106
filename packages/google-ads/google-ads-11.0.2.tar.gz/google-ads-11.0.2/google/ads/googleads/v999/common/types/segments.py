...
from google.ads.googleads.v999.enums.types import click_type as gage_click_type
from google.ads.googleads.v999.enums.types import (
...
from google.ads.googleads.v999.enums.types import device as gage_device
from google.ads.googleads.v999.enums.types import (
...
from google.ads.googleads.v999.enums.types import slot as gage_slot
...
class Segments(proto.Message):
    ...
    Attributes:
        ad_destination_type (google.ads.googleads.v999.enums.types.AdDestinationTypeEnum.AdDestinationType):
            Ad Destination type.
        ad_network_type (google.ads.googleads.v999.enums.types.AdNetworkTypeEnum.AdNetworkType):
            Ad network type.
        budget_campaign_association_status (google.ads.googleads.v999.common.types.BudgetCampaignAssociationStatus):
            Budget campaign association status.
        click_type (google.ads.googleads.v999.enums.types.ClickTypeEnum.ClickType):
            Click type.
        conversion_action (str):
            Resource name of the conversion action.
        conversion_action_category (google.ads.googleads.v999.enums.types.ConversionActionCategoryEnum.ConversionActionCategory):
        ...
        conversion_attribution_event_type (google.ads.googleads.v999.enums.types.ConversionAttributionEventTypeEnum.ConversionAttributionEventType):
            Conversion attribution event type.
        conversion_lag_bucket (google.ads.googleads.v999.enums.types.ConversionLagBucketEnum.ConversionLagBucket):
            An enum value representing the number of days
            between the impression and the conversion.
        conversion_or_adjustment_lag_bucket (google.ads.googleads.v999.enums.types.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket):
            An enum value representing the number of days
        ...
        device (google.ads.googleads.v999.enums.types.DeviceEnum.Device):
            Device to which metrics apply.
        external_conversion_source (google.ads.googleads.v999.enums.types.ExternalConversionSourceEnum.ExternalConversionSource):
        ...
        hotel_check_in_day_of_week (google.ads.googleads.v999.enums.types.DayOfWeekEnum.DayOfWeek):
        ...
        hotel_country (str):
            Hotel country.
        hotel_date_selection_type (google.ads.googleads.v999.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
            Hotel date selection type.
        hotel_length_of_stay (int):
            Hotel length of stay.
        hotel_rate_rule_id (str):
            Hotel rate rule ID.
        hotel_rate_type (google.ads.googleads.v999.enums.types.HotelRateTypeEnum.HotelRateType):
            Hotel rate type.
        hotel_price_bucket (google.ads.googleads.v999.enums.types.HotelPriceBucketEnum.HotelPriceBucket):
            Hotel price bucket.
        hotel_state (str):
            Hotel state.
        hour (int):
        ...
        keyword (google.ads.googleads.v999.common.types.Keyword):
            Keyword criterion.
        month (str):
            Month as represented by the date of the first
            day of a month. Formatted as yyyy-MM-dd.
        month_of_year (google.ads.googleads.v999.enums.types.MonthOfYearEnum.MonthOfYear):
        ...
        product_channel (google.ads.googleads.v999.enums.types.ProductChannelEnum.ProductChannel):
            Channel of the product.
        product_channel_exclusivity (google.ads.googleads.v999.enums.types.ProductChannelExclusivityEnum.ProductChannelExclusivity):
            Channel exclusivity of the product.
        product_condition (google.ads.googleads.v999.enums.types.ProductConditionEnum.ProductCondition):
        ...
        search_engine_results_page_type (google.ads.googleads.v999.enums.types.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType):
            Type of the search engine results page.
        search_term_match_type (google.ads.googleads.v999.enums.types.SearchTermMatchTypeEnum.SearchTermMatchType):
            Match type of the keyword that triggered the
            ad, including variants.
        slot (google.ads.googleads.v999.enums.types.SlotEnum.Slot):
            Position of the ad.
        conversion_value_rule_primary_dimension (google.ads.googleads.v999.enums.types.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension):
            Primary dimension of applied conversion value rules.
            NO_RULE_APPLIED segment shows the total recorded value of
            conversions that does not have a value rule applied.
            ORIGINAL segment shows the original value of conversions
            which then has a value rule applied. GEO_LOCATION, DEVICE,
            AUDIENCE segments show the net adjustment when value rules
            are applied.
        webpage (str):
        ...
        asset_interaction_target (google.ads.googleads.v999.common.types.AssetInteractionTarget):
...
class Keyword(proto.Message):
    ...
    Attributes:
        ...
        info (google.ads.googleads.v999.common.types.KeywordInfo):
            Keyword info.
    """
...
class BudgetCampaignAssociationStatus(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus):
            Budget campaign association status.
    """
