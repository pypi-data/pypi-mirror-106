...
from google.ads.googleads.v999.resources.types import invoice
...
class ListInvoicesRequest(proto.Message):
    ...
    Attributes:
        ...
        issue_month (google.ads.googleads.v999.enums.types.MonthOfYearEnum.MonthOfYear):
...
class ListInvoicesResponse(proto.Message):
    ...
    Attributes:
        invoices (Sequence[google.ads.googleads.v999.resources.types.Invoice]):
