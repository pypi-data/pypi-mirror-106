...
class AccessibleBiddingStrategyServiceClient(
    ...
    def get_accessible_bidding_strategy(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAccessibleBiddingStrategyRequest`):
                The request object. Request message for
                [AccessibleBiddingStrategyService.GetAccessibleBiddingStrategy][google.ads.googleads.v999.services.AccessibleBiddingStrategyService.GetAccessibleBiddingStrategy].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AccessibleBiddingStrategy:
