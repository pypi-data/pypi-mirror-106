...
from google.ads.googleads.v999.resources.types import ad_group_ad_label
...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def get_ad_group_ad_label(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupAdLabelRequest`):
                The request object. Request message for
                [AdGroupAdLabelService.GetAdGroupAdLabel][google.ads.googleads.v999.services.AdGroupAdLabelService.GetAdGroupAdLabel].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupAdLabel:
    ...
    def mutate_ad_group_ad_labels(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupAdLabelsRequest`):
                The request object. Request message for
                [AdGroupAdLabelService.MutateAdGroupAdLabels][google.ads.googleads.v999.services.AdGroupAdLabelService.MutateAdGroupAdLabels].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupAdLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupAdLabelsResponse:
