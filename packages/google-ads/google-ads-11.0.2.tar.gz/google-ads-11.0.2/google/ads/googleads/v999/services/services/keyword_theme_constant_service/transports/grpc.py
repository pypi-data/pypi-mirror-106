    ...
    def get_keyword_theme_constant(
        ...
        if "get_keyword_theme_constant" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordThemeConstantService/GetKeywordThemeConstant",
    ...
    def suggest_keyword_theme_constants(
        ...
        if "suggest_keyword_theme_constants" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordThemeConstantService/SuggestKeywordThemeConstants",
