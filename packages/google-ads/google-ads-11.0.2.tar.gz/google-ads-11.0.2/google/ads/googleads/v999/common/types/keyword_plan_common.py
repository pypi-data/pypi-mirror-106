...
from google.ads.googleads.v999.common.types import dates
...
from google.ads.googleads.v999.enums.types import keyword_plan_competition_level
from google.ads.googleads.v999.enums.types import (
    keyword_plan_concept_group_type,
)
from google.ads.googleads.v999.enums.types import month_of_year
...
class KeywordPlanHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        monthly_search_volumes (Sequence[google.ads.googleads.v999.common.types.MonthlySearchVolume]):
            Approximate number of searches on this query
            for the past twelve months.
        competition (google.ads.googleads.v999.enums.types.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel):
...
class HistoricalMetricsOptions(proto.Message):
    ...
    Attributes:
        year_month_range (google.ads.googleads.v999.common.types.YearMonthRange):
...
class MonthlySearchVolume(proto.Message):
    ...
    Attributes:
        ...
        month (google.ads.googleads.v999.enums.types.MonthOfYearEnum.MonthOfYear):
...
class KeywordPlanAggregateMetrics(proto.Message):
    ...
    Attributes:
        aggregate_metric_types (Sequence[google.ads.googleads.v999.enums.types.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType]):
...
class KeywordPlanAggregateMetricResults(proto.Message):
    ...
    Attributes:
        device_searches (Sequence[google.ads.googleads.v999.common.types.KeywordPlanDeviceSearches]):
...
class KeywordAnnotations(proto.Message):
    ...
    Attributes:
        concepts (Sequence[google.ads.googleads.v999.common.types.KeywordConcept]):
...
class KeywordConcept(proto.Message):
    ...
    Attributes:
        ...
        concept_group (google.ads.googleads.v999.common.types.ConceptGroup):
...
class ConceptGroup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v999.enums.types.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType):
