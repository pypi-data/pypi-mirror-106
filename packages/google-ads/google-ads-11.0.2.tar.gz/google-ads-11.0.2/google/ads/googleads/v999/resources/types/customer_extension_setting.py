...
from google.ads.googleads.v999.enums.types import extension_setting_device
...
class CustomerExtensionSetting(proto.Message):
    ...
    Attributes:
        ...
        device (google.ads.googleads.v999.enums.types.ExtensionSettingDeviceEnum.ExtensionSettingDevice):
