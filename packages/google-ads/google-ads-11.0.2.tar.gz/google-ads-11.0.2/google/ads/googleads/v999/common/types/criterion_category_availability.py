...
class CriterionCategoryAvailability(proto.Message):
    ...
    Attributes:
        channel (google.ads.googleads.v999.common.types.CriterionCategoryChannelAvailability):
            Channel types and subtypes that are available
            to the category.
        locale (Sequence[google.ads.googleads.v999.common.types.CriterionCategoryLocaleAvailability]):
...
class CriterionCategoryChannelAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v999.enums.types.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode):
        ...
        advertising_channel_sub_type (Sequence[google.ads.googleads.v999.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType]):
...
class CriterionCategoryLocaleAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v999.enums.types.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode):
