...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, BiddingSeasonalityAdjustmentServiceTransport, None
        ] = None,
    ...
    def get_bidding_seasonality_adjustment(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetBiddingSeasonalityAdjustmentRequest`):
                The request object. Request message for
                [BiddingSeasonalityAdjustmentService.GetBiddingSeasonalityAdjustment][google.ads.googleads.v999.services.BiddingSeasonalityAdjustmentService.GetBiddingSeasonalityAdjustment].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.BiddingSeasonalityAdjustment:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_bidding_seasonality_adjustment
        ]
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateBiddingSeasonalityAdjustmentsRequest`):
                The request object. Request message for
                [BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments][google.ads.googleads.v999.services.BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.BiddingSeasonalityAdjustmentOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateBiddingSeasonalityAdjustmentsResponse:
