    ...
    def get_keyword_plan_ad_group_keyword(
        ...
        if "get_keyword_plan_ad_group_keyword" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordPlanAdGroupKeywordService/GetKeywordPlanAdGroupKeyword",
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        if "mutate_keyword_plan_ad_group_keywords" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordPlanAdGroupKeywordService/MutateKeywordPlanAdGroupKeywords",
