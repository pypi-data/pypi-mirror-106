...
class AdGroupBidModifier(proto.Message):
    ...
    Attributes:
        ...
        bid_modifier_source (google.ads.googleads.v999.enums.types.BidModifierSourceEnum.BidModifierSource):
            Output only. Bid modifier source.
        hotel_date_selection_type (google.ads.googleads.v999.common.types.HotelDateSelectionTypeInfo):
            Immutable. Criterion for hotel date selection
            (default dates vs. user selected).
        hotel_advance_booking_window (google.ads.googleads.v999.common.types.HotelAdvanceBookingWindowInfo):
            Immutable. Criterion for number of days prior
            to the stay the booking is being made.
        hotel_length_of_stay (google.ads.googleads.v999.common.types.HotelLengthOfStayInfo):
            Immutable. Criterion for length of hotel stay
            in nights.
        hotel_check_in_day (google.ads.googleads.v999.common.types.HotelCheckInDayInfo):
            Immutable. Criterion for day of the week the
            booking is for.
        device (google.ads.googleads.v999.common.types.DeviceInfo):
            Immutable. A device criterion.
        preferred_content (google.ads.googleads.v999.common.types.PreferredContentInfo):
            Immutable. A preferred content criterion.
        hotel_check_in_date_range (google.ads.googleads.v999.common.types.HotelCheckInDateRangeInfo):
