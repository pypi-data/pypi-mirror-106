...
from google.ads.googleads.v999.resources.types import campaign_feed
...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def get_campaign_feed(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCampaignFeedRequest`):
                The request object. Request message for
                [CampaignFeedService.GetCampaignFeed][google.ads.googleads.v999.services.CampaignFeedService.GetCampaignFeed].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CampaignFeed:
                A campaign feed.
        """
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_campaign_feed
        ]
    ...
    def mutate_campaign_feeds(
        ...
        *,
        ...
        operations: Sequence[
            campaign_feed_service.CampaignFeedOperation
        ] = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCampaignFeedsRequest`):
                The request object. Request message for
                [CampaignFeedService.MutateCampaignFeeds][google.ads.googleads.v999.services.CampaignFeedService.MutateCampaignFeeds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CampaignFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCampaignFeedsResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_feeds
        ]
