...
class MutateCampaignAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.CampaignAssetOperation]):
...
class CampaignAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.CampaignAsset):
            Create operation: No resource name is
            expected for the new campaign asset.
        update (google.ads.googleads.v999.resources.types.CampaignAsset):
...
class MutateCampaignAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateCampaignAssetResult]):
