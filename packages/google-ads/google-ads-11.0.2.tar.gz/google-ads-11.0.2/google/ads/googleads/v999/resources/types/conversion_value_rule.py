...
from google.ads.googleads.v999.enums.types import conversion_value_rule_status
from google.ads.googleads.v999.enums.types import value_rule_device_type
from google.ads.googleads.v999.enums.types import (
    value_rule_geo_location_match_type,
)
from google.ads.googleads.v999.enums.types import value_rule_operation
...
class ConversionValueRule(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            rule.
        action (google.ads.googleads.v999.resources.types.ConversionValueRule.ValueRuleAction):
            Action applied when the rule is triggered.
        geo_location_condition (google.ads.googleads.v999.resources.types.ConversionValueRule.ValueRuleGeoLocationCondition):
            Condition for Geo location that must be
            satisfied for the value rule to apply.
        device_condition (google.ads.googleads.v999.resources.types.ConversionValueRule.ValueRuleDeviceCondition):
            Condition for device type that must be
            satisfied for the value rule to apply.
        audience_condition (google.ads.googleads.v999.resources.types.ConversionValueRule.ValueRuleAudienceCondition):
        ...
        owner_customer (str):
            ...
            \*\*
        status (google.ads.googleads.v999.enums.types.ConversionValueRuleStatusEnum.ConversionValueRuleStatus):
    ...
    class ValueRuleAction(proto.Message):
        ...
        Attributes:
            operation (google.ads.googleads.v999.enums.types.ValueRuleOperationEnum.ValueRuleOperation):
    ...
    class ValueRuleGeoLocationCondition(proto.Message):
        ...
        Attributes:
            excluded_geo_target_constants (Sequence[str]):
                ...
                exclude.
            excluded_geo_match_type (google.ads.googleads.v999.enums.types.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType):
                Excluded Geo location match type.
            geo_target_constants (Sequence[str]):
                Geo locations that advertisers want to
                include.
            geo_match_type (google.ads.googleads.v999.enums.types.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType):
    ...
    class ValueRuleDeviceCondition(proto.Message):
        ...
        Attributes:
            device_types (Sequence[google.ads.googleads.v999.enums.types.ValueRuleDeviceTypeEnum.ValueRuleDeviceType]):
