...
class SuggestSmartCampaignBudgetOptionsRequest(proto.Message):
    ...
    Attributes:
        ...
        suggestion_info (google.ads.googleads.v999.services.types.SmartCampaignSuggestionInfo):
...
class SmartCampaignSuggestionInfo(proto.Message):
    ...
    Attributes:
        ...
        keyword_themes (Sequence[google.ads.googleads.v999.common.types.KeywordThemeInfo]):
        ...
        location_list (google.ads.googleads.v999.services.types.SmartCampaignSuggestionInfo.LocationList):
    ...
    class LocationList(proto.Message):
        ...
        Attributes:
            locations (Sequence[google.ads.googleads.v999.common.types.LocationInfo]):
                Required. Locations.
        """
...
class SuggestSmartCampaignBudgetOptionsResponse(proto.Message):
    ...
    Attributes:
        low (google.ads.googleads.v999.services.types.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption):
            Optional. The lowest budget option.
        recommended (google.ads.googleads.v999.services.types.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption):
            Optional. The recommended budget option.
        high (google.ads.googleads.v999.services.types.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption):
    ...
    class BudgetOption(proto.Message):
        ...
        Attributes:
            daily_amount_micros (int):
                ...
                currency unit.
            metrics (google.ads.googleads.v999.services.types.SuggestSmartCampaignBudgetOptionsResponse.Metrics):
