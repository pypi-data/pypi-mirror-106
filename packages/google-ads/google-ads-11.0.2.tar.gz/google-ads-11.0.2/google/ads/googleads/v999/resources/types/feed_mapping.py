...
from google.ads.googleads.v999.enums.types import app_placeholder_field
from google.ads.googleads.v999.enums.types import call_placeholder_field
from google.ads.googleads.v999.enums.types import callout_placeholder_field
from google.ads.googleads.v999.enums.types import custom_placeholder_field
from google.ads.googleads.v999.enums.types import dsa_page_feed_criterion_field
from google.ads.googleads.v999.enums.types import education_placeholder_field
from google.ads.googleads.v999.enums.types import feed_mapping_criterion_type
from google.ads.googleads.v999.enums.types import feed_mapping_status
from google.ads.googleads.v999.enums.types import flight_placeholder_field
from google.ads.googleads.v999.enums.types import hotel_placeholder_field
from google.ads.googleads.v999.enums.types import image_placeholder_field
from google.ads.googleads.v999.enums.types import job_placeholder_field
from google.ads.googleads.v999.enums.types import local_placeholder_field
from google.ads.googleads.v999.enums.types import (
    location_extension_targeting_criterion_field,
)
from google.ads.googleads.v999.enums.types import location_placeholder_field
from google.ads.googleads.v999.enums.types import message_placeholder_field
from google.ads.googleads.v999.enums.types import (
    placeholder_type as gage_placeholder_type,
)
from google.ads.googleads.v999.enums.types import price_placeholder_field
from google.ads.googleads.v999.enums.types import promotion_placeholder_field
from google.ads.googleads.v999.enums.types import real_estate_placeholder_field
from google.ads.googleads.v999.enums.types import sitelink_placeholder_field
from google.ads.googleads.v999.enums.types import (
    structured_snippet_placeholder_field,
)
from google.ads.googleads.v999.enums.types import travel_placeholder_field
...
class FeedMapping(proto.Message):
    ...
    Attributes:
        ...
        attribute_field_mappings (Sequence[google.ads.googleads.v999.resources.types.AttributeFieldMapping]):
            ...
            attributes. Required.
        status (google.ads.googleads.v999.enums.types.FeedMappingStatusEnum.FeedMappingStatus):
            Output only. Status of the feed mapping.
            This field is read-only.
        placeholder_type (google.ads.googleads.v999.enums.types.PlaceholderTypeEnum.PlaceholderType):
            Immutable. The placeholder type of this
            mapping (i.e., if the mapping maps feed
            attributes to placeholder fields).
        criterion_type (google.ads.googleads.v999.enums.types.FeedMappingCriterionTypeEnum.FeedMappingCriterionType):
...
class AttributeFieldMapping(proto.Message):
    ...
    Attributes:
        ...
        field_id (int):
            ...
            This field is read-only.
        sitelink_field (google.ads.googleads.v999.enums.types.SitelinkPlaceholderFieldEnum.SitelinkPlaceholderField):
            Immutable. Sitelink Placeholder Fields.
        call_field (google.ads.googleads.v999.enums.types.CallPlaceholderFieldEnum.CallPlaceholderField):
            Immutable. Call Placeholder Fields.
        app_field (google.ads.googleads.v999.enums.types.AppPlaceholderFieldEnum.AppPlaceholderField):
            Immutable. App Placeholder Fields.
        location_field (google.ads.googleads.v999.enums.types.LocationPlaceholderFieldEnum.LocationPlaceholderField):
            Output only. Location Placeholder Fields.
            This field is read-only.
        affiliate_location_field (google.ads.googleads.v999.enums.types.AffiliateLocationPlaceholderFieldEnum.AffiliateLocationPlaceholderField):
            Output only. Affiliate Location Placeholder
            Fields. This field is read-only.
        callout_field (google.ads.googleads.v999.enums.types.CalloutPlaceholderFieldEnum.CalloutPlaceholderField):
            Immutable. Callout Placeholder Fields.
        structured_snippet_field (google.ads.googleads.v999.enums.types.StructuredSnippetPlaceholderFieldEnum.StructuredSnippetPlaceholderField):
            Immutable. Structured Snippet Placeholder
            Fields.
        message_field (google.ads.googleads.v999.enums.types.MessagePlaceholderFieldEnum.MessagePlaceholderField):
            Immutable. Message Placeholder Fields.
        price_field (google.ads.googleads.v999.enums.types.PricePlaceholderFieldEnum.PricePlaceholderField):
            Immutable. Price Placeholder Fields.
        promotion_field (google.ads.googleads.v999.enums.types.PromotionPlaceholderFieldEnum.PromotionPlaceholderField):
            Immutable. Promotion Placeholder Fields.
        ad_customizer_field (google.ads.googleads.v999.enums.types.AdCustomizerPlaceholderFieldEnum.AdCustomizerPlaceholderField):
            Immutable. Ad Customizer Placeholder Fields
        dsa_page_feed_field (google.ads.googleads.v999.enums.types.DsaPageFeedCriterionFieldEnum.DsaPageFeedCriterionField):
            Immutable. Dynamic Search Ad Page Feed
            Fields.
        location_extension_targeting_field (google.ads.googleads.v999.enums.types.LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField):
            Immutable. Location Target Fields.
        education_field (google.ads.googleads.v999.enums.types.EducationPlaceholderFieldEnum.EducationPlaceholderField):
            Immutable. Education Placeholder Fields
        flight_field (google.ads.googleads.v999.enums.types.FlightPlaceholderFieldEnum.FlightPlaceholderField):
            Immutable. Flight Placeholder Fields
        custom_field (google.ads.googleads.v999.enums.types.CustomPlaceholderFieldEnum.CustomPlaceholderField):
            Immutable. Custom Placeholder Fields
        hotel_field (google.ads.googleads.v999.enums.types.HotelPlaceholderFieldEnum.HotelPlaceholderField):
            Immutable. Hotel Placeholder Fields
        real_estate_field (google.ads.googleads.v999.enums.types.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField):
            Immutable. Real Estate Placeholder Fields
        travel_field (google.ads.googleads.v999.enums.types.TravelPlaceholderFieldEnum.TravelPlaceholderField):
            Immutable. Travel Placeholder Fields
        local_field (google.ads.googleads.v999.enums.types.LocalPlaceholderFieldEnum.LocalPlaceholderField):
            Immutable. Local Placeholder Fields
        job_field (google.ads.googleads.v999.enums.types.JobPlaceholderFieldEnum.JobPlaceholderField):
            Immutable. Job Placeholder Fields
        image_field (google.ads.googleads.v999.enums.types.ImagePlaceholderFieldEnum.ImagePlaceholderField):
