...
from google.ads.googleads.v999.resources.types import ad_group_feed
...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def get_ad_group_feed(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupFeedRequest`):
                The request object. Request message for
                [AdGroupFeedService.GetAdGroupFeed][google.ads.googleads.v999.services.AdGroupFeedService.GetAdGroupFeed].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupFeed:
                An ad group feed.
        """
    ...
    def mutate_ad_group_feeds(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupFeedsRequest`):
                The request object. Request message for
                [AdGroupFeedService.MutateAdGroupFeeds][google.ads.googleads.v999.services.AdGroupFeedService.MutateAdGroupFeeds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupFeedsResponse:
