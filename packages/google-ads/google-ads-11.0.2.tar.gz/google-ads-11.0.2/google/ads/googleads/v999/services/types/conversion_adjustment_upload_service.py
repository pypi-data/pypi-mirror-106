...
from google.ads.googleads.v999.enums.types import conversion_adjustment_type
...
class UploadConversionAdjustmentsRequest(proto.Message):
    ...
    [ConversionAdjustmentUploadService.UploadConversionAdjustments][google.ads.googleads.v999.services.ConversionAdjustmentUploadService.UploadConversionAdjustments].

    Attributes:
        customer_id (str):
            Required. The ID of the customer performing
            the upload.
        conversion_adjustments (Sequence[google.ads.googleads.v999.services.types.ConversionAdjustment]):
...
class UploadConversionAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v999.services.types.ConversionAdjustmentResult]):
...
class ConversionAdjustment(proto.Message):
    ...
    Attributes:
        ...
        adjustment_type (google.ads.googleads.v999.enums.types.ConversionAdjustmentTypeEnum.ConversionAdjustmentType):
            The adjustment type.
        restatement_value (google.ads.googleads.v999.services.types.RestatementValue):
        ...
        gclid_date_time_pair (google.ads.googleads.v999.services.types.GclidDateTimePair):
