...
class MutateMediaFilesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.MediaFileOperation]):
...
class MediaFileOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v999.resources.types.MediaFile):
...
class MutateMediaFilesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateMediaFileResult]):
