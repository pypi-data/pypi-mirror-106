...
class AdGroupCriterionSimulationServiceClient(
    ...
    def get_ad_group_criterion_simulation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupCriterionSimulationRequest`):
                The request object. Request message for
                [AdGroupCriterionSimulationService.GetAdGroupCriterionSimulation][google.ads.googleads.v999.services.AdGroupCriterionSimulationService.GetAdGroupCriterionSimulation].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupCriterionSimulation:
