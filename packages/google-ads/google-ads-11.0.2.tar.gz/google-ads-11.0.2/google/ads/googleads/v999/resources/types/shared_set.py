...
from google.ads.googleads.v999.enums.types import shared_set_status
from google.ads.googleads.v999.enums.types import shared_set_type
...
class SharedSet(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            only.
        type_ (google.ads.googleads.v999.enums.types.SharedSetTypeEnum.SharedSetType):
        ...
        status (google.ads.googleads.v999.enums.types.SharedSetStatusEnum.SharedSetStatus):
