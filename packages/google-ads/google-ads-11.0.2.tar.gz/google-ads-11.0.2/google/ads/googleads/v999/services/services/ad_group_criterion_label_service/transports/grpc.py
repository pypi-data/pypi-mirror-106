    ...
    def get_ad_group_criterion_label(
        ...
        if "get_ad_group_criterion_label" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AdGroupCriterionLabelService/GetAdGroupCriterionLabel",
    ...
    def mutate_ad_group_criterion_labels(
        ...
        if "mutate_ad_group_criterion_labels" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels",
