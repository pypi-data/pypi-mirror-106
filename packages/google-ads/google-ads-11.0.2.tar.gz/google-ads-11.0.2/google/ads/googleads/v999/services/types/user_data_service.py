...
class UploadUserDataRequest(proto.Message):
    ...
    [UserDataService.UploadUserData][google.ads.googleads.v999.services.UserDataService.UploadUserData]

    Attributes:
        customer_id (str):
            Required. The ID of the customer for which to
            update the user data.
        operations (Sequence[google.ads.googleads.v999.services.types.UserDataOperation]):
