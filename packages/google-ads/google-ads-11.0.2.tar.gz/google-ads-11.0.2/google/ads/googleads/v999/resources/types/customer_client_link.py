...
from google.ads.googleads.v999.enums.types import manager_link_status
...
class CustomerClientLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.ManagerLinkStatusEnum.ManagerLinkStatus):
