    ...
    def get_campaign_extension_setting(
        ...
        if "get_campaign_extension_setting" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExtensionSettingService/GetCampaignExtensionSetting",
    ...
    def mutate_campaign_extension_settings(
        ...
        if "mutate_campaign_extension_settings" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings",
