...
from google.ads.googleads.v999.resources.types import campaign
...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def get_campaign(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCampaignRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.Campaign:
                A campaign.
        """
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCampaignsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCampaignsResponse:
