...
from google.ads.googleads.v999.enums.types import feed_item_validation_status
from google.ads.googleads.v999.enums.types import (
    geo_targeting_restriction as gage_geo_targeting_restriction,
)
from google.ads.googleads.v999.enums.types import placeholder_type
...
from google.ads.googleads.v999.errors.types import feed_item_validation_error
...
class FeedItem(proto.Message):
    ...
    Attributes:
        ...
        end_date_time (str):
            ...
            Examples: "2018-03-05 09:15:00" or "2018-02-01
            14:34:30".
        attribute_values (Sequence[google.ads.googleads.v999.resources.types.FeedItemAttributeValue]):
            The feed item's attribute values.
        geo_targeting_restriction (google.ads.googleads.v999.enums.types.GeoTargetingRestrictionEnum.GeoTargetingRestriction):
        ...
        policy_infos (Sequence[google.ads.googleads.v999.resources.types.FeedItemPlaceholderPolicyInfo]):
    ...
    last_modified_time = proto.Field(proto.STRING, number=15,)
...
class FeedItemAttributeValue(proto.Message):
    ...
    Attributes:
        ...
        price_value (google.ads.googleads.v999.common.types.Money):
...
class FeedItemPlaceholderPolicyInfo(proto.Message):
    ...
    Attributes:
        placeholder_type_enum (google.ads.googleads.v999.enums.types.PlaceholderTypeEnum.PlaceholderType):
        ...
        policy_topic_entries (Sequence[google.ads.googleads.v999.common.types.PolicyTopicEntry]):
            ...
            the placeholder type.
        validation_status (google.ads.googleads.v999.enums.types.FeedItemValidationStatusEnum.FeedItemValidationStatus):
            Output only. The validation status of the
            palceholder type.
        validation_errors (Sequence[google.ads.googleads.v999.resources.types.FeedItemValidationError]):
            Output only. List of placeholder type
            validation errors.
        quality_approval_status (google.ads.googleads.v999.enums.types.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus):
            Output only. Placeholder type quality
            evaluation approval status.
        quality_disapproval_reasons (Sequence[google.ads.googleads.v999.enums.types.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason]):
...
class FeedItemValidationError(proto.Message):
    ...
    Attributes:
        validation_error (google.ads.googleads.v999.errors.types.FeedItemValidationErrorEnum.FeedItemValidationError):
