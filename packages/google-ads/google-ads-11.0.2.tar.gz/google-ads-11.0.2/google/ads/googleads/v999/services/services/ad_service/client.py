...
from google.ads.googleads.v999.resources.types import ad
...
class AdServiceClient(metaclass=AdServiceClientMeta):
    ...
    def get_ad(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdRequest`):
                The request object. Request message for
                [AdService.GetAd][google.ads.googleads.v999.services.AdService.GetAd].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.Ad:
                An ad.
        """
    ...
    def mutate_ads(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdsRequest`):
                The request object. Request message for
                [AdService.MutateAds][google.ads.googleads.v999.services.AdService.MutateAds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdsResponse:
