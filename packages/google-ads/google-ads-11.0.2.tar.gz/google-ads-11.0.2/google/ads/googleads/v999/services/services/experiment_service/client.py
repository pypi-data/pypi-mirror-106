...
from google.ads.googleads.v999.resources.types import experiment
from google.ads.googleads.v999.services.types import experiment_service
...
class ExperimentServiceClient(metaclass=ExperimentServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the experiment service client.
        ...
        if isinstance(transport, ExperimentServiceTransport):
            ...
            self._transport = ExperimentServiceGrpcTransport(
    ...
    def get_experiment(
        self,
        request: experiment_service.GetExperimentRequest = None,
        *,
        ...
        r"""Returns the requested experiment in full detail.
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetExperimentRequest`):
                The request object. Request message for
                [ExperimentService.GetExperiment][google.ads.googleads.v999.services.ExperimentService.GetExperiment].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.Experiment:
                A Google ads experiment for users to
                experiment changes on multiple
                campaigns, compare the performance, and
        ...
        # in a experiment_service.GetExperimentRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, experiment_service.GetExperimentRequest):
            request = experiment_service.GetExperimentRequest(request)
