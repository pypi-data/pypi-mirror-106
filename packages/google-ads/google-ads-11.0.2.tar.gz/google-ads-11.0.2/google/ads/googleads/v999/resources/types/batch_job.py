...
from google.ads.googleads.v999.enums.types import batch_job_status
...
class BatchJob(proto.Message):
    ...
    Attributes:
        ...
        metadata (google.ads.googleads.v999.resources.types.BatchJob.BatchJobMetadata):
            Output only. Contains additional information
            about this batch job.
        status (google.ads.googleads.v999.enums.types.BatchJobStatusEnum.BatchJobStatus):
