...
class MutateCustomAudiencesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.CustomAudienceOperation]):
...
class CustomAudienceOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.CustomAudience):
            Create operation: No resource name is
            expected for the new custom audience.
        update (google.ads.googleads.v999.resources.types.CustomAudience):
...
class MutateCustomAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.MutateCustomAudienceResult]):
