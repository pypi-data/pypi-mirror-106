...
from google.ads.googleads.v999.resources.types import ad_group_bid_modifier
...
class AdGroupBidModifierServiceClient(
    ...
    def get_ad_group_bid_modifier(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupBidModifierRequest`):
                The request object. Request message for
                [AdGroupBidModifierService.GetAdGroupBidModifier][google.ads.googleads.v999.services.AdGroupBidModifierService.GetAdGroupBidModifier].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupBidModifier:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_ad_group_bid_modifier
        ]
    ...
    def mutate_ad_group_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupBidModifiersRequest`):
                The request object. Request message for
                [AdGroupBidModifierService.MutateAdGroupBidModifiers][google.ads.googleads.v999.services.AdGroupBidModifierService.MutateAdGroupBidModifiers].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupBidModifiersResponse:
