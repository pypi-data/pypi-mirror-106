...
class CampaignCriterionSimulationServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CampaignCriterionSimulationServiceTransport]]
    _transport_registry[
        "grpc"
...
class CampaignCriterionSimulationServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, CampaignCriterionSimulationServiceTransport, None
        ] = None,
    ...
    def get_campaign_criterion_simulation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCampaignCriterionSimulationRequest`):
                The request object. Request message for
                [CampaignCriterionSimulationService.GetCampaignCriterionSimulation][google.ads.googleads.v999.services.CampaignCriterionSimulationService.GetCampaignCriterionSimulation].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CampaignCriterionSimulation:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_campaign_criterion_simulation
        ]
