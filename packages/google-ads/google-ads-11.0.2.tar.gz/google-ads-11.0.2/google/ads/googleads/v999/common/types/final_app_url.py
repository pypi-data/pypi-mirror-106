...
from google.ads.googleads.v999.enums.types import app_url_operating_system_type
...
class FinalAppUrl(proto.Message):
    ...
    Attributes:
        os_type (google.ads.googleads.v999.enums.types.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType):
