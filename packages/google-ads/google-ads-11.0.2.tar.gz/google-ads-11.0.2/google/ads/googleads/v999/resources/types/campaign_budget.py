...
from google.ads.googleads.v999.enums.types import budget_delivery_method
from google.ads.googleads.v999.enums.types import budget_period
from google.ads.googleads.v999.enums.types import budget_status
from google.ads.googleads.v999.enums.types import budget_type
...
class CampaignBudget(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.BudgetStatusEnum.BudgetStatus):
            Output only. The status of this campaign
            budget. This field is read-only.
        delivery_method (google.ads.googleads.v999.enums.types.BudgetDeliveryMethodEnum.BudgetDeliveryMethod):
        ...
        recommended_budget_amount_micros (int):
            ...
            This field is read-only.
        period (google.ads.googleads.v999.enums.types.BudgetPeriodEnum.BudgetPeriod):
        ...
        recommended_budget_estimated_change_weekly_views (int):
            ...
            This field is read-only.
        type_ (google.ads.googleads.v999.enums.types.BudgetTypeEnum.BudgetType):
