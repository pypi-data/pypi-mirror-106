...
from google.ads.googleads.v999.resources.types import feed_item
...
class FeedItemServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[FeedItemServiceTransport]]
...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def get_feed_item(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetFeedItemRequest`):
                The request object. Request message for
                [FeedItemService.GetFeedItem][google.ads.googleads.v999.services.FeedItemService.GetFeedItem].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.FeedItem:
                A feed item.
        """
    ...
    def mutate_feed_items(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateFeedItemsRequest`):
                The request object. Request message for
                [FeedItemService.MutateFeedItems][google.ads.googleads.v999.services.FeedItemService.MutateFeedItems].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.FeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateFeedItemsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_feed_items
        ]
