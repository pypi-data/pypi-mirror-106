...
from google.ads.googleads.v999.resources.types import mobile_device_constant
...
class MobileDeviceConstantServiceClient(
    metaclass=MobileDeviceConstantServiceClientMeta
):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, MobileDeviceConstantServiceTransport, None
        ] = None,
    ...
    def get_mobile_device_constant(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetMobileDeviceConstantRequest`):
                The request object. Request message for
                [MobileDeviceConstantService.GetMobileDeviceConstant][google.ads.googleads.v999.services.MobileDeviceConstantService.GetMobileDeviceConstant].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.MobileDeviceConstant:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_mobile_device_constant
        ]
...
__all__ = ("MobileDeviceConstantServiceClient",)
