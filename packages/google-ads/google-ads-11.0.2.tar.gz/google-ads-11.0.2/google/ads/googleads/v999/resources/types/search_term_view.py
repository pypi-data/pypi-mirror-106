...
from google.ads.googleads.v999.enums.types import search_term_targeting_status
...
class SearchTermView(proto.Message):
    ...
    Attributes:
        ...
        ad_group (str):
            ...
            served in.
        status (google.ads.googleads.v999.enums.types.SearchTermTargetingStatusEnum.SearchTermTargetingStatus):
