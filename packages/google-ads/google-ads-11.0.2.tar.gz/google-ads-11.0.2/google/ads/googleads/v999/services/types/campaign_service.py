...
class GetCampaignRequest(proto.Message):
    ...
    [CampaignService.GetCampaign][google.ads.googleads.v999.services.CampaignService.GetCampaign].
...
class MutateCampaignsRequest(proto.Message):
    r"""Request message for
    [CampaignService.MutateCampaigns][google.ads.googleads.v999.services.CampaignService.MutateCampaigns].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaigns are being modified.
        operations (Sequence[google.ads.googleads.v999.services.types.CampaignOperation]):
...
class CampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.Campaign):
            Create operation: No resource name is
            expected for the new campaign.
        update (google.ads.googleads.v999.resources.types.Campaign):
...
class MutateCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateCampaignResult]):
