...
from google.ads.googleads.v999.resources.types import ad_group_ad_asset_view
from google.ads.googleads.v999.services.types import (
    ad_group_ad_asset_view_service,
)
...
class AdGroupAdAssetViewServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AdGroupAdAssetViewServiceTransport]]
...
class AdGroupAdAssetViewServiceClient(
    ...
    def get_ad_group_ad_asset_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupAdAssetViewRequest`):
                The request object. Request message for
                [AdGroupAdAssetViewService.GetAdGroupAdAssetView][google.ads.googleads.v999.services.AdGroupAdAssetViewService.GetAdGroupAdAssetView].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupAdAssetView:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_ad_group_ad_asset_view
        ]
...
__all__ = ("AdGroupAdAssetViewServiceClient",)
