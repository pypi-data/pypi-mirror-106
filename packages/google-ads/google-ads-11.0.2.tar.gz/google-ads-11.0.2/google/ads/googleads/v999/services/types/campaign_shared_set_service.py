...
class MutateCampaignSharedSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.CampaignSharedSetOperation]):
...
class CampaignSharedSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v999.resources.types.CampaignSharedSet):
...
class MutateCampaignSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateCampaignSharedSetResult]):
