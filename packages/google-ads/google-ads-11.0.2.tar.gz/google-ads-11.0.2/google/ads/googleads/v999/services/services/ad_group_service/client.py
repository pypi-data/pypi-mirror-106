...
from google.ads.googleads.v999.resources.types import ad_group
...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def get_ad_group(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroup:
                An ad group.
        """
    ...
    def mutate_ad_groups(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupsResponse:
