...
class MutateSmartCampaignSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.SmartCampaignSettingOperation]):
...
class SmartCampaignSettingOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v999.resources.types.SmartCampaignSetting):
...
class MutateSmartCampaignSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateSmartCampaignSettingResult]):
