...
class MutateCustomerClientLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v999.services.types.CustomerClientLinkOperation):
...
class CustomerClientLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.CustomerClientLink):
            Create operation: No resource name is
            expected for the new link.
        update (google.ads.googleads.v999.resources.types.CustomerClientLink):
...
class MutateCustomerClientLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v999.services.types.MutateCustomerClientLinkResult):
