...
from google.ads.googleads.v999.resources.types import conversion_action
...
class ConversionActionServiceClient(
    ...
    def get_conversion_action(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetConversionActionRequest`):
                The request object. Request message for
                [ConversionActionService.GetConversionAction][google.ads.googleads.v999.services.ConversionActionService.GetConversionAction].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.ConversionAction:
                A conversion action.
        """
    ...
    def mutate_conversion_actions(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateConversionActionsRequest`):
                The request object. Request message for
                [ConversionActionService.MutateConversionActions][google.ads.googleads.v999.services.ConversionActionService.MutateConversionActions].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.ConversionActionOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateConversionActionsResponse:
