...
from google.ads.googleads.v999.common.types import extensions
from google.ads.googleads.v999.enums.types import keyword_match_type
from google.ads.googleads.v999.enums.types import recommendation_type
...
class Recommendation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v999.enums.types.RecommendationTypeEnum.RecommendationType):
            Output only. The type of recommendation.
        impact (google.ads.googleads.v999.resources.types.Recommendation.RecommendationImpact):
        ...
        dismissed (bool):
            ...
            dismissed or not.
        campaign_budget_recommendation (google.ads.googleads.v999.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The campaign budget
            recommendation.
        forecasting_campaign_budget_recommendation (google.ads.googleads.v999.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The forecasting campaign budget
            recommendation.
        keyword_recommendation (google.ads.googleads.v999.resources.types.Recommendation.KeywordRecommendation):
            Output only. The keyword recommendation.
        text_ad_recommendation (google.ads.googleads.v999.resources.types.Recommendation.TextAdRecommendation):
            Output only. Add expanded text ad
            recommendation.
        target_cpa_opt_in_recommendation (google.ads.googleads.v999.resources.types.Recommendation.TargetCpaOptInRecommendation):
            Output only. The TargetCPA opt-in
            recommendation.
        maximize_conversions_opt_in_recommendation (google.ads.googleads.v999.resources.types.Recommendation.MaximizeConversionsOptInRecommendation):
            Output only. The MaximizeConversions Opt-In
            recommendation.
        enhanced_cpc_opt_in_recommendation (google.ads.googleads.v999.resources.types.Recommendation.EnhancedCpcOptInRecommendation):
            Output only. The Enhanced Cost-Per-Click Opt-
            n recommendation.
        search_partners_opt_in_recommendation (google.ads.googleads.v999.resources.types.Recommendation.SearchPartnersOptInRecommendation):
            Output only. The Search Partners Opt-In
            recommendation.
        maximize_clicks_opt_in_recommendation (google.ads.googleads.v999.resources.types.Recommendation.MaximizeClicksOptInRecommendation):
            Output only. The MaximizeClicks Opt-In
            recommendation.
        optimize_ad_rotation_recommendation (google.ads.googleads.v999.resources.types.Recommendation.OptimizeAdRotationRecommendation):
            Output only. The Optimize Ad Rotation
            recommendation.
        callout_extension_recommendation (google.ads.googleads.v999.resources.types.Recommendation.CalloutExtensionRecommendation):
            Output only. The Callout extension
            recommendation.
        sitelink_extension_recommendation (google.ads.googleads.v999.resources.types.Recommendation.SitelinkExtensionRecommendation):
            Output only. The Sitelink extension
            recommendation.
        call_extension_recommendation (google.ads.googleads.v999.resources.types.Recommendation.CallExtensionRecommendation):
            Output only. The Call extension
            recommendation.
        keyword_match_type_recommendation (google.ads.googleads.v999.resources.types.Recommendation.KeywordMatchTypeRecommendation):
            Output only. The keyword match type
            recommendation.
        move_unused_budget_recommendation (google.ads.googleads.v999.resources.types.Recommendation.MoveUnusedBudgetRecommendation):
            Output only. The move unused budget
            recommendation.
        target_roas_opt_in_recommendation (google.ads.googleads.v999.resources.types.Recommendation.TargetRoasOptInRecommendation):
            Output only. The Target ROAS opt-in
            recommendation.
        responsive_search_ad_recommendation (google.ads.googleads.v999.resources.types.Recommendation.ResponsiveSearchAdRecommendation):
            Output only. The add responsive search ad
            recommendation.
        marginal_roi_campaign_budget_recommendation (google.ads.googleads.v999.resources.types.Recommendation.CampaignBudgetRecommendation):
    ...
    class RecommendationImpact(proto.Message):
        ...
        Attributes:
            base_metrics (google.ads.googleads.v999.resources.types.Recommendation.RecommendationMetrics):
                Output only. Base metrics at the time the
                recommendation was generated.
            potential_metrics (google.ads.googleads.v999.resources.types.Recommendation.RecommendationMetrics):
    ...
    class CampaignBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_budget_amount_micros (int):
                ...
                micros.
            budget_options (Sequence[google.ads.googleads.v999.resources.types.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption]):
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        ...
        Attributes:
            options (Sequence[google.ads.googleads.v999.resources.types.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption]):
        ...
        class TargetCpaOptInRecommendationOption(proto.Message):
            ...
            Attributes:
                goal (google.ads.googleads.v999.enums.types.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal):
    ...
    class CalloutExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v999.common.types.CalloutFeedItem]):
    ...
    class KeywordMatchTypeRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_match_type (google.ads.googleads.v999.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
    ...
    class MoveUnusedBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            budget_recommendation (google.ads.googleads.v999.resources.types.Recommendation.CampaignBudgetRecommendation):
    ...
    class SitelinkExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v999.common.types.SitelinkFeedItem]):
    ...
    class CallExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v999.common.types.CallFeedItem]):
