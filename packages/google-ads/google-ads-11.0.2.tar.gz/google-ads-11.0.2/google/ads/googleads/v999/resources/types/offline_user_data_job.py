...
from google.ads.googleads.v999.enums.types import offline_user_data_job_status
from google.ads.googleads.v999.enums.types import offline_user_data_job_type
...
class OfflineUserDataJob(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v999.enums.types.OfflineUserDataJobTypeEnum.OfflineUserDataJobType):
            Immutable. Type of the job.
        status (google.ads.googleads.v999.enums.types.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus):
            Output only. Status of the job.
        failure_reason (google.ads.googleads.v999.enums.types.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason):
            Output only. Reason for the processing
            failure, if status is FAILED.
        customer_match_user_list_metadata (google.ads.googleads.v999.common.types.CustomerMatchUserListMetadata):
            Immutable. Metadata for data updates to a
            CRM-based user list.
        store_sales_metadata (google.ads.googleads.v999.common.types.StoreSalesMetadata):
