...
class SearchGoogleAdsFieldsPager:
    ...
    :class:`google.ads.googleads.v999.services.types.SearchGoogleAdsFieldsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v999.services.types.SearchGoogleAdsFieldsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v999.services.types.SearchGoogleAdsFieldsResponse`):
