...
from google.ads.googleads.v999.resources.types import merchant_center_link
...
class MerchantCenterLinkServiceClient(
    ...
    def list_merchant_center_links(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.ListMerchantCenterLinksRequest`):
                The request object. Request message for
                [MerchantCenterLinkService.ListMerchantCenterLinks][google.ads.googleads.v999.services.MerchantCenterLinkService.ListMerchantCenterLinks].
        ...
        Returns:
            google.ads.googleads.v999.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetMerchantCenterLinkRequest`):
                The request object. Request message for
                [MerchantCenterLinkService.GetMerchantCenterLink][google.ads.googleads.v999.services.MerchantCenterLinkService.GetMerchantCenterLink].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateMerchantCenterLinkRequest`):
                The request object. Request message for
                [MerchantCenterLinkService.MutateMerchantCenterLink][google.ads.googleads.v999.services.MerchantCenterLinkService.MutateMerchantCenterLink].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v999.services.types.MerchantCenterLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateMerchantCenterLinkResponse:
