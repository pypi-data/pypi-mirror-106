...
class MutateAdGroupAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.AdGroupAssetOperation]):
...
class AdGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.AdGroupAsset):
            Create operation: No resource name is
            expected for the new ad group asset.
        update (google.ads.googleads.v999.resources.types.AdGroupAsset):
...
class MutateAdGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateAdGroupAssetResult]):
