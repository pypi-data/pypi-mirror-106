...
class UploadClickConversionsRequest(proto.Message):
    ...
    [ConversionUploadService.UploadClickConversions][google.ads.googleads.v999.services.ConversionUploadService.UploadClickConversions].

    Attributes:
        customer_id (str):
            Required. The ID of the customer performing
            the upload.
        conversions (Sequence[google.ads.googleads.v999.services.types.ClickConversion]):
...
class UploadClickConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v999.services.types.ClickConversionResult]):
...
class UploadCallConversionsRequest(proto.Message):
    r"""Request message for
    [ConversionUploadService.UploadCallConversions][google.ads.googleads.v999.services.ConversionUploadService.UploadCallConversions].

    Attributes:
        customer_id (str):
            Required. The ID of the customer performing
            the upload.
        conversions (Sequence[google.ads.googleads.v999.services.types.CallConversion]):
            Required. The conversions that are being
            uploaded.
        partial_failure (bool):
            Required. If true, successful operations will
...
class UploadCallConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v999.services.types.CallConversionResult]):
            Returned for successfully processed conversions. Proto will
            be empty for rows that received an error. Results are not
            returned when validate_only is true.
    """
...
class ClickConversion(proto.Message):
    ...
    Attributes:
        ...
        external_attribution_data (google.ads.googleads.v999.services.types.ExternalAttributionData):
            ...
            otherwise.
        custom_variables (Sequence[google.ads.googleads.v999.services.types.CustomVariable]):
            The custom variables associated with this
            conversion.
        cart_data (google.ads.googleads.v999.services.types.CartData):
...
class CartData(proto.Message):
    ...
    Attributes:
        merchant_id (str):
            ...
            uploaded.
        feed_region_code (str):
            The region code associated with the feed
        ...
        items (Sequence[google.ads.googleads.v999.services.types.CartData.Item]):
    ...
    merchant_id = proto.Field(proto.STRING, number=1,)
    feed_region_code = proto.Field(proto.STRING, number=2,)
