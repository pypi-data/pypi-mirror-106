    ...
    def get_customer_extension_setting(
        ...
        if "get_customer_extension_setting" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CustomerExtensionSettingService/GetCustomerExtensionSetting",
    ...
    def mutate_customer_extension_settings(
        ...
        if "mutate_customer_extension_settings" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.CustomerExtensionSettingService/MutateCustomerExtensionSettings",
