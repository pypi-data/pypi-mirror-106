    ...
    def get_ad_group_criterion(
        ...
        if "get_ad_group_criterion" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AdGroupCriterionService/GetAdGroupCriterion",
    ...
    def mutate_ad_group_criteria(
        ...
        if "mutate_ad_group_criteria" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AdGroupCriterionService/MutateAdGroupCriteria",
