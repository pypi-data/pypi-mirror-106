...
from google.ads.googleads.v999.enums.types import combined_audience_status
...
class CombinedAudience(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.CombinedAudienceStatusEnum.CombinedAudienceStatus):
