...
from google.ads.googleads.v999.resources.types import ad_group_ad
...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def get_ad_group_ad(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupAdRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupAd:
                An ad group ad.
        """
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupAdsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupAdOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupAdsResponse:
