...
class MutateCustomerUserAccessInvitationRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v999.services.types.CustomerUserAccessInvitationOperation):
...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v999.resources.types.CustomerUserAccessInvitation):
...
class MutateCustomerUserAccessInvitationResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v999.services.types.MutateCustomerUserAccessInvitationResult):
