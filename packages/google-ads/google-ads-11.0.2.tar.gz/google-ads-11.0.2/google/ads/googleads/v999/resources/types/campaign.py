...
from google.ads.googleads.v999.common.types import bidding
from google.ads.googleads.v999.common.types import custom_parameter
from google.ads.googleads.v999.common.types import frequency_cap
from google.ads.googleads.v999.common.types import (
...
from google.ads.googleads.v999.enums.types import app_campaign_app_store
from google.ads.googleads.v999.enums.types import (
    app_campaign_bidding_strategy_goal_type,
)
from google.ads.googleads.v999.enums.types import asset_field_type
from google.ads.googleads.v999.enums.types import (
    bidding_strategy_type as gage_bidding_strategy_type,
)
from google.ads.googleads.v999.enums.types import brand_safety_suitability
from google.ads.googleads.v999.enums.types import campaign_experiment_type
from google.ads.googleads.v999.enums.types import campaign_serving_status
from google.ads.googleads.v999.enums.types import campaign_status
from google.ads.googleads.v999.enums.types import (
...
from google.ads.googleads.v999.enums.types import optimization_goal_type
from google.ads.googleads.v999.enums.types import (
...
class Campaign(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.CampaignStatusEnum.CampaignStatus):
            The status of the campaign.
            When a new campaign is added, the status
            defaults to ENABLED.
        serving_status (google.ads.googleads.v999.enums.types.CampaignServingStatusEnum.CampaignServingStatus):
            Output only. The ad serving status of the
            campaign.
        ad_serving_optimization_status (google.ads.googleads.v999.enums.types.AdServingOptimizationStatusEnum.AdServingOptimizationStatus):
            The ad serving optimization status of the
            campaign.
        advertising_channel_type (google.ads.googleads.v999.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType):
        ...
        advertising_channel_sub_type (google.ads.googleads.v999.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType):
        ...
        tracking_url_template (str):
            ...
            URL.
        url_custom_parameters (Sequence[google.ads.googleads.v999.common.types.CustomParameter]):
            The list of mappings used to substitute custom parameter
            tags in a ``tracking_url_template``, ``final_urls``, or
            ``mobile_final_urls``.
        url_custom_parameter_operations (Sequence[google.ads.googleads.v999.common.types.CustomParameterOperation]):
            The list of operations changing URL custom
            parameters.
            Adding a custom parameter with a key that
            already exists in this list causes the existing
            custom parameter to be replaced with the new
            value.
            When removing a custom parameter, only the key
            of the custom parameter is used. The value of
            the custom parameter is ignored.
        real_time_bidding_setting (google.ads.googleads.v999.common.types.RealTimeBiddingSetting):
            Settings for Real-Time Bidding, a feature
            only available for campaigns targeting the Ad
            Exchange network.
        network_settings (google.ads.googleads.v999.resources.types.Campaign.NetworkSettings):
            The network settings for the campaign.
        hotel_setting (google.ads.googleads.v999.resources.types.Campaign.HotelSettingInfo):
            Immutable. The hotel setting for the
            campaign.
        dynamic_search_ads_setting (google.ads.googleads.v999.resources.types.Campaign.DynamicSearchAdsSetting):
            The setting for controlling Dynamic Search
            Ads (DSA).
        shopping_setting (google.ads.googleads.v999.resources.types.Campaign.ShoppingSetting):
            The setting for controlling Shopping
            campaigns.
        targeting_setting (google.ads.googleads.v999.common.types.TargetingSetting):
            Setting for targeting related features.
        geo_target_type_setting (google.ads.googleads.v999.resources.types.Campaign.GeoTargetTypeSetting):
            The setting for ads geotargeting.
        local_campaign_setting (google.ads.googleads.v999.resources.types.Campaign.LocalCampaignSetting):
            The setting for local campaign.
        app_campaign_setting (google.ads.googleads.v999.resources.types.Campaign.AppCampaignSetting):
            The setting related to App Campaign.
        smart_campaign_setting (google.ads.googleads.v999.resources.types.Campaign.SmartCampaignSetting):
            Output only. The setting for controlling
            Smart Campaigns.
        labels (Sequence[str]):
            Output only. The resource names of labels
            attached to this campaign.
        experiment_type (google.ads.googleads.v999.enums.types.CampaignExperimentTypeEnum.CampaignExperimentType):
        ...
        bidding_strategy_type (google.ads.googleads.v999.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        final_url_suffix (str):
            ...
            tracking.
        frequency_caps (Sequence[google.ads.googleads.v999.common.types.FrequencyCapEntry]):
            A list that limits how often each user will
            see this campaign's ads.
        video_brand_safety_suitability (google.ads.googleads.v999.enums.types.BrandSafetySuitabilityEnum.BrandSafetySuitability):
            Output only. 3-Tier Brand Safety setting for
            the campaign.
        vanity_pharma (google.ads.googleads.v999.resources.types.Campaign.VanityPharma):
            Describes how unbranded pharma ads will be
            displayed.
        selective_optimization (google.ads.googleads.v999.resources.types.Campaign.SelectiveOptimization):
        ...
        optimization_goal_setting (google.ads.googleads.v999.resources.types.Campaign.OptimizationGoalSetting):
            Optimization goal setting for this campaign,
            which includes a set of optimization goal types.
        tracking_setting (google.ads.googleads.v999.resources.types.Campaign.TrackingSetting):
            Output only. Campaign-level settings for
            tracking information.
        payment_mode (google.ads.googleads.v999.enums.types.PaymentModeEnum.PaymentMode):
        ...
        engine_id (str):
            ...
            external engine account. This field is for non-
            Google Ads account only, i.e. Yahoo Japan,
            Microsoft, Baidu etc. For Google Ads entity,
            please use "campaign.id" instead.
        excluded_parent_asset_field_types (Sequence[google.ads.googleads.v999.enums.types.AssetFieldTypeEnum.AssetFieldType]):
        ...
        commission (google.ads.googleads.v999.common.types.Commission):
            Commission is an automatic bidding strategy
            in which the advertiser pays a certain portion
            of the conversion value.
        manual_cpc (google.ads.googleads.v999.common.types.ManualCpc):
            Standard Manual CPC bidding strategy.
            Manual click-based bidding where user pays per
            click.
        manual_cpm (google.ads.googleads.v999.common.types.ManualCpm):
            Standard Manual CPM bidding strategy.
            Manual impression-based bidding where user pays
            per thousand impressions.
        manual_cpv (google.ads.googleads.v999.common.types.ManualCpv):
            Output only. A bidding strategy that pays a
            configurable amount per video view.
        maximize_conversions (google.ads.googleads.v999.common.types.MaximizeConversions):
        ...
        maximize_conversion_value (google.ads.googleads.v999.common.types.MaximizeConversionValue):
        ...
        target_cpa (google.ads.googleads.v999.common.types.TargetCpa):
        ...
        target_impression_share (google.ads.googleads.v999.common.types.TargetImpressionShare):
        ...
        target_roas (google.ads.googleads.v999.common.types.TargetRoas):
        ...
        target_spend (google.ads.googleads.v999.common.types.TargetSpend):
        ...
        percent_cpc (google.ads.googleads.v999.common.types.PercentCpc):
            Standard Percent Cpc bidding strategy where
            bids are a fraction of the advertised price for
            some good or service.
        target_cpm (google.ads.googleads.v999.common.types.TargetCpm):
    ...
    class LocalCampaignSetting(proto.Message):
        ...
        Attributes:
            location_source_type (google.ads.googleads.v999.enums.types.LocationSourceTypeEnum.LocationSourceType):
    ...
    class PhoneNumber(proto.Message):
        ...
        Attributes:
            phone_number (str):
                Output only. Phone number of the smart
                campaign.
            country_code (str):
                Output only. Upper-case, two-letter country
                code as defined by ISO-3166.
        """

        phone_number = proto.Field(proto.STRING, number=3, optional=True,)
    ...
    class OptimizationGoalSetting(proto.Message):
        ...
        Attributes:
            optimization_goal_types (Sequence[google.ads.googleads.v999.enums.types.OptimizationGoalTypeEnum.OptimizationGoalType]):
    ...
    class GeoTargetTypeSetting(proto.Message):
        ...
        Attributes:
            positive_geo_target_type (google.ads.googleads.v999.enums.types.PositiveGeoTargetTypeEnum.PositiveGeoTargetType):
                The setting used for positive geotargeting in
                this particular campaign.
            negative_geo_target_type (google.ads.googleads.v999.enums.types.NegativeGeoTargetTypeEnum.NegativeGeoTargetType):
    ...
    class AppCampaignSetting(proto.Message):
        ...
        Attributes:
            bidding_strategy_goal_type (google.ads.googleads.v999.enums.types.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType):
            ...
            app_store (google.ads.googleads.v999.enums.types.AppCampaignAppStoreEnum.AppCampaignAppStore):
    ...
    class VanityPharma(proto.Message):
        ...
        Attributes:
            vanity_pharma_display_url_mode (google.ads.googleads.v999.enums.types.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode):
                The display mode for vanity pharma URLs.
            vanity_pharma_text (google.ads.googleads.v999.enums.types.VanityPharmaTextEnum.VanityPharmaText):
    ...
    class SmartCampaignSetting(proto.Message):
        r"""The setting for controlling smart campaigns.
        Attributes:
            phone_number (google.ads.googleads.v999.resources.types.Campaign.PhoneNumber):
                Output only. Phone number and country code.
            final_url (str):
                Output only. Landing page url given by user
                for this Campaign.
            business_name (str):
                Output only. The name of the business.
            business_location_id (int):
                Output only. The ID of the Google My Business (GMB)
                Location. The location ID can be fetched by GMB API with its
        ...
        phone_number = proto.Field(
            proto.MESSAGE, number=1, message="Campaign.PhoneNumber",
        )
        final_url = proto.Field(proto.STRING, number=5, oneof="destination",)
        business_name = proto.Field(
            proto.STRING, number=7, oneof="business_setting",
        )
        business_location_id = proto.Field(
            proto.INT64, number=8, oneof="business_setting",
        )
    ...
    url_custom_parameter_operations = proto.RepeatedField(
        proto.MESSAGE,
        number=13,
        message=custom_parameter.CustomParameterOperation,
    )
    ...
    smart_campaign_setting = proto.Field(
        proto.MESSAGE, number=57, message=SmartCampaignSetting,
    )
