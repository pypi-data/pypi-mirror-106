...
from google.ads.googleads.v999.enums.types import custom_interest_member_type
from google.ads.googleads.v999.enums.types import custom_interest_status
from google.ads.googleads.v999.enums.types import custom_interest_type
...
class CustomInterest(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.CustomInterestStatusEnum.CustomInterestStatus):
        ...
        type_ (google.ads.googleads.v999.enums.types.CustomInterestTypeEnum.CustomInterestType):
            Type of the custom interest, CUSTOM_AFFINITY or
            CUSTOM_INTENT. By default the type is set to
            CUSTOM_AFFINITY.
        description (str):
            Description of this custom interest audience.
        members (Sequence[google.ads.googleads.v999.resources.types.CustomInterestMember]):
...
class CustomInterestMember(proto.Message):
    ...
    Attributes:
        member_type (google.ads.googleads.v999.enums.types.CustomInterestMemberTypeEnum.CustomInterestMemberType):
