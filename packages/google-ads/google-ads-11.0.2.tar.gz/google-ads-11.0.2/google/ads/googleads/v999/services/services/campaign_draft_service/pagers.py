...
class ListCampaignDraftAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v999.services.types.ListCampaignDraftAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v999.services.types.ListCampaignDraftAsyncErrorsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v999.services.types.ListCampaignDraftAsyncErrorsResponse`):
