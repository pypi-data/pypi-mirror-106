...
class UserIdentifier(proto.Message):
    ...
    Attributes:
        user_identifier_source (google.ads.googleads.v999.enums.types.UserIdentifierSourceEnum.UserIdentifierSource):
        ...
        third_party_user_id (str):
            ...
            for SSD.
        address_info (google.ads.googleads.v999.common.types.OfflineUserAddressInfo):
            Address information.
    """
...
class TransactionAttribute(proto.Message):
    ...
    Attributes:
        ...
        store_attribute (google.ads.googleads.v999.common.types.StoreAttribute):
        ...
        custom_value (str):
            ...
            allow-list.
        item_attribute (google.ads.googleads.v999.common.types.ItemAttribute):
...
class ItemAttribute(proto.Message):
    ...
    Attributes:
        ...
        region_code (str):
            ...
            ads/api/reference/data/codes-formats#country-
    ...
    region_code = proto.Field(proto.STRING, number=3,)
...
class UserData(proto.Message):
    ...
    Attributes:
        user_identifiers (Sequence[google.ads.googleads.v999.common.types.UserIdentifier]):
            User identification info. Required.
        transaction_attribute (google.ads.googleads.v999.common.types.TransactionAttribute):
            Additional transactions/attributes associated
            with the user. Required when updating store
            sales data.
        user_attribute (google.ads.googleads.v999.common.types.UserAttribute):
...
class StoreSalesMetadata(proto.Message):
    ...
    Attributes:
        ...
        custom_key (str):
            ...
            Accessible only to customers on the allow-list.
        third_party_metadata (google.ads.googleads.v999.common.types.StoreSalesThirdPartyMetadata):
