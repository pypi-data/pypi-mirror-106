...
from google.ads.googleads.v999.resources.types import feed
...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def get_feed(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetFeedRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.Feed:
                A feed.
        """
    ...
    def mutate_feeds(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateFeedsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.FeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateFeedsResponse:
