...
class ListCampaignExperimentAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v999.services.types.ListCampaignExperimentAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v999.services.types.ListCampaignExperimentAsyncErrorsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v999.services.types.ListCampaignExperimentAsyncErrorsResponse`):
