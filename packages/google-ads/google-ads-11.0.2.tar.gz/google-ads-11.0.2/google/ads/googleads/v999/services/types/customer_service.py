...
class MutateCustomerRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operation (google.ads.googleads.v999.services.types.CustomerOperation):
...
class CreateCustomerClientRequest(proto.Message):
    ...
    Attributes:
        ...
        customer_client (google.ads.googleads.v999.resources.types.Customer):
        ...
        access_role (google.ads.googleads.v999.enums.types.AccessRoleEnum.AccessRole):
...
class CustomerOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v999.resources.types.Customer):
...
class MutateCustomerResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v999.services.types.MutateCustomerResult):
