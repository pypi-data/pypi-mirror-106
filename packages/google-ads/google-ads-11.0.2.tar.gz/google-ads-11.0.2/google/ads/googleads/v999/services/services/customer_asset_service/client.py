...
from google.ads.googleads.v999.resources.types import customer_asset
...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def get_customer_asset(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCustomerAssetRequest`):
                The request object. Request message for
                [CustomerAssetService.GetCustomerAsset][google.ads.googleads.v999.services.CustomerAssetService.GetCustomerAsset].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CustomerAsset:
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCustomerAssetsRequest`):
                The request object. Request message for
                [CustomerAssetService.MutateCustomerAssets][google.ads.googleads.v999.services.CustomerAssetService.MutateCustomerAssets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CustomerAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCustomerAssetsResponse:
