...
from google.ads.googleads.v999.resources.types import campaign_draft
from google.ads.googleads.v999.services.services.campaign_draft_service import (
    pagers,
)
...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def get_campaign_draft(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCampaignDraftRequest`):
                The request object. Request message for
                [CampaignDraftService.GetCampaignDraft][google.ads.googleads.v999.services.CampaignDraftService.GetCampaignDraft].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CampaignDraft:
                A campaign draft.
        """
    ...
    def mutate_campaign_drafts(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCampaignDraftsRequest`):
                The request object. Request message for
                [CampaignDraftService.MutateCampaignDrafts][google.ads.googleads.v999.services.CampaignDraftService.MutateCampaignDrafts].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CampaignDraftOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCampaignDraftsResponse:
    ...
    def promote_campaign_draft(
        ...
        *,
        ...
        use
        [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v999.services.CampaignDraftService.ListCampaignDraftAsyncErrors]
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.PromoteCampaignDraftRequest`):
                The request object. Request message for
                [CampaignDraftService.PromoteCampaignDraft][google.ads.googleads.v999.services.CampaignDraftService.PromoteCampaignDraft].
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.ListCampaignDraftAsyncErrorsRequest`):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v999.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v999.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
