    ...
    def get_conversion_value_rule(
        ...
        if "get_conversion_value_rule" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ConversionValueRuleService/GetConversionValueRule",
    ...
    def mutate_conversion_value_rules(
        ...
        if "mutate_conversion_value_rules" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ConversionValueRuleService/MutateConversionValueRules",
