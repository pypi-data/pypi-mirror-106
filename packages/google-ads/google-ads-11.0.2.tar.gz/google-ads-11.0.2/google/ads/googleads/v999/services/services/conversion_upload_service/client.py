...
from google.ads.googleads.v999.services.types import conversion_upload_service
...
class ConversionUploadServiceClient(
    ...
    def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.UploadClickConversionsRequest`):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v999.services.types.ClickConversion]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.UploadClickConversionsResponse:
    ...
    def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.UploadCallConversionsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v999.services.types.CallConversion]`):
                Required. The conversions that are
                being uploaded.
        ...
        Returns:
            google.ads.googleads.v999.services.types.UploadCallConversionsResponse:
                Response message for
                [ConversionUploadService.UploadCallConversions][google.ads.googleads.v999.services.ConversionUploadService.UploadCallConversions].
