...
class MutateCustomerUserAccessRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operation (google.ads.googleads.v999.services.types.CustomerUserAccessOperation):
...
class CustomerUserAccessOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v999.resources.types.CustomerUserAccess):
...
class MutateCustomerUserAccessResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v999.services.types.MutateCustomerUserAccessResult):
