...
from google.ads.googleads.v999.resources.types import payments_account
...
class ListPaymentsAccountsResponse(proto.Message):
    ...
    Attributes:
        payments_accounts (Sequence[google.ads.googleads.v999.resources.types.PaymentsAccount]):
