...
class ProductBiddingCategoryConstantServiceClient(
    ...
    def get_product_bidding_category_constant(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetProductBiddingCategoryConstantRequest`):
                The request object. Request message for
                [ProductBiddingCategoryConstantService.GetProductBiddingCategoryConstant][google.ads.googleads.v999.services.ProductBiddingCategoryConstantService.GetProductBiddingCategoryConstant].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.ProductBiddingCategoryConstant:
