...
class MutateAccountLinkRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operation (google.ads.googleads.v999.services.types.AccountLinkOperation):
...
class AccountLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v999.resources.types.AccountLink):
...
class MutateAccountLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v999.services.types.MutateAccountLinkResult):
