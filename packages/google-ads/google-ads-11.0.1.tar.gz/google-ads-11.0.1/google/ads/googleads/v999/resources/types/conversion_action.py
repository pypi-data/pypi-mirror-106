...
from google.ads.googleads.v999.common.types import tag_snippet
from google.ads.googleads.v999.enums.types import (
    attribution_model as gage_attribution_model,
)
from google.ads.googleads.v999.enums.types import conversion_action_category
from google.ads.googleads.v999.enums.types import (
    conversion_action_counting_type,
)
from google.ads.googleads.v999.enums.types import conversion_action_status
from google.ads.googleads.v999.enums.types import conversion_action_type
from google.ads.googleads.v999.enums.types import (
...
class ConversionAction(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.ConversionActionStatusEnum.ConversionActionStatus):
            The status of this conversion action for
            conversion event accrual.
        type_ (google.ads.googleads.v999.enums.types.ConversionActionTypeEnum.ConversionActionType):
            Immutable. The type of this conversion
            action.
        category (google.ads.googleads.v999.enums.types.ConversionActionCategoryEnum.ConversionActionCategory):
        ...
        view_through_lookback_window_days (int):
            ...
            an interaction.
        value_settings (google.ads.googleads.v999.resources.types.ConversionAction.ValueSettings):
            Settings related to the value for conversion
            events associated with this conversion action.
        counting_type (google.ads.googleads.v999.enums.types.ConversionActionCountingTypeEnum.ConversionActionCountingType):
            How to count conversion events for the
            conversion action.
        attribution_model_settings (google.ads.googleads.v999.resources.types.ConversionAction.AttributionModelSettings):
            Settings related to this conversion action's
            attribution model.
        tag_snippets (Sequence[google.ads.googleads.v999.common.types.TagSnippet]):
        ...
        mobile_app_vendor (google.ads.googleads.v999.enums.types.MobileAppVendorEnum.MobileAppVendor):
            Output only. Mobile app vendor for an app
            conversion action.
        firebase_settings (google.ads.googleads.v999.resources.types.ConversionAction.FirebaseSettings):
            Output only. Firebase settings for Firebase
            conversion types.
        third_party_app_analytics_settings (google.ads.googleads.v999.resources.types.ConversionAction.ThirdPartyAppAnalyticsSettings):
            Output only. Third Party App Analytics
            settings for third party conversion types.
        floodlight_settings (google.ads.googleads.v999.resources.types.ConversionAction.FloodlightSettings):
    ...
    class AttributionModelSettings(proto.Message):
        ...
        Attributes:
            attribution_model (google.ads.googleads.v999.enums.types.AttributionModelEnum.AttributionModel):
                The attribution model type of this conversion
                action.
            data_driven_model_status (google.ads.googleads.v999.enums.types.DataDrivenModelStatusEnum.DataDrivenModelStatus):
    ...
    class FloodlightSettings(proto.Message):
        ...
        activity_group_tag = proto.Field(proto.STRING, number=1,)
        activity_tag = proto.Field(proto.STRING, number=2,)
        activity_id = proto.Field(proto.INT64, number=3,)
    ...
    floodlight_settings = proto.Field(
        proto.MESSAGE, number=29, message=FloodlightSettings,
    )
