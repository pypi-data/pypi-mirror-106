...
from google.ads.googleads.v999.enums.types import ad_group_ad_rotation_mode
from google.ads.googleads.v999.enums.types import ad_group_status
from google.ads.googleads.v999.enums.types import ad_group_type
...
from google.ads.googleads.v999.enums.types import targeting_dimension
...
class AdGroup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.AdGroupStatusEnum.AdGroupStatus):
            The status of the ad group.
        type_ (google.ads.googleads.v999.enums.types.AdGroupTypeEnum.AdGroupType):
            Immutable. The type of the ad group.
        ad_rotation_mode (google.ads.googleads.v999.enums.types.AdGroupAdRotationModeEnum.AdGroupAdRotationMode):
        ...
        percent_cpc_bid_micros (int):
            ...
            1,000,000 \* [fraction].
        explorer_auto_optimizer_setting (google.ads.googleads.v999.common.types.ExplorerAutoOptimizerSetting):
            Settings for the Display Campaign Optimizer,
            initially termed "Explorer".
        display_custom_bid_dimension (google.ads.googleads.v999.enums.types.TargetingDimensionEnum.TargetingDimension):
        ...
        effective_target_cpa_source (google.ads.googleads.v999.enums.types.BiddingSourceEnum.BiddingSource):
        ...
        effective_target_roas_source (google.ads.googleads.v999.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective target
        ...
        engine_id (str):
            ...
            account. This field is for non-Google Ads account only, i.e.
            Yahoo Japan, Microsoft, Baidu etc. For Google Ads entity,
            please use "ad_group.id" instead.
        start_date (str):
        ...
        language_code (str):
            ...
            More details: https://docs.microsoft.com/en-
            us/advertising/guides/ad-
    ...
    engine_id = proto.Field(proto.STRING, number=50,)
    start_date = proto.Field(proto.STRING, number=51,)
    end_date = proto.Field(proto.STRING, number=52,)
    language_code = proto.Field(proto.STRING, number=53,)
    excluded_parent_asset_field_types = proto.RepeatedField(
        proto.ENUM,
        number=54,
        enum=asset_field_type.AssetFieldTypeEnum.AssetFieldType,
    )
    last_modified_time = proto.Field(proto.STRING, number=55,)
