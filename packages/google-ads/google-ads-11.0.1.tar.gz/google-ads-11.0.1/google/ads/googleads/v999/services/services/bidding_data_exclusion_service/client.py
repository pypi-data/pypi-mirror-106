...
from google.ads.googleads.v999.resources.types import bidding_data_exclusion
...
class BiddingDataExclusionServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, BiddingDataExclusionServiceTransport, None
        ] = None,
    ...
    def get_bidding_data_exclusion(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetBiddingDataExclusionRequest`):
                The request object. Request message for
                [BiddingDataExclusionService.GetBiddingDataExclusion][google.ads.googleads.v999.services.BiddingDataExclusionService.GetBiddingDataExclusion].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.BiddingDataExclusion:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_bidding_data_exclusion
        ]
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateBiddingDataExclusionsRequest`):
                The request object. Request message for
                [BiddingDataExclusionService.MutateBiddingDataExclusions][google.ads.googleads.v999.services.BiddingDataExclusionService.MutateBiddingDataExclusions].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.BiddingDataExclusionOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateBiddingDataExclusionsResponse:
