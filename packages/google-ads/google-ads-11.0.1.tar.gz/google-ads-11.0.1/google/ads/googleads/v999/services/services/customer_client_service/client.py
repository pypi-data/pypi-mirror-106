...
from google.ads.googleads.v999.resources.types import customer_client
from google.ads.googleads.v999.services.types import customer_client_service
...
class CustomerClientServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CustomerClientServiceTransport]]
...
class CustomerClientServiceClient(metaclass=CustomerClientServiceClientMeta):
    ...
    def get_customer_client(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCustomerClientRequest`):
                The request object. Request message for
                [CustomerClientService.GetCustomerClient][google.ads.googleads.v999.services.CustomerClientService.GetCustomerClient].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CustomerClient:
...
__all__ = ("CustomerClientServiceClient",)
