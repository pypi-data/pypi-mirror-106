    ...
    def get_geo_target_constant(
        ...
        if "get_geo_target_constant" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.GeoTargetConstantService/GetGeoTargetConstant",
    ...
    def suggest_geo_target_constants(
        ...
        if "suggest_geo_target_constants" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.GeoTargetConstantService/SuggestGeoTargetConstants",
