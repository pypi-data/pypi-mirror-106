...
from google.ads.googleads.v999.resources.types import ad_group_asset
...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def get_ad_group_asset(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupAssetRequest`):
                The request object. Request message for
                [AdGroupAssetService.GetAdGroupAsset][google.ads.googleads.v999.services.AdGroupAssetService.GetAdGroupAsset].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupAsset:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_ad_group_asset
        ]
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        operations: Sequence[
            ad_group_asset_service.AdGroupAssetOperation
        ] = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupAssetsRequest`):
                The request object. Request message for
                [AdGroupAssetService.MutateAdGroupAssets][google.ads.googleads.v999.services.AdGroupAssetService.MutateAdGroupAssets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupAssetsResponse:
