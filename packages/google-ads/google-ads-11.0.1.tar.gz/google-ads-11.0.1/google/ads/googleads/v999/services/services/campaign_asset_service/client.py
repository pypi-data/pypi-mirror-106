...
from google.ads.googleads.v999.resources.types import campaign_asset
...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def get_campaign_asset(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCampaignAssetRequest`):
                The request object. Request message for
                [CampaignAssetService.GetCampaignAsset][google.ads.googleads.v999.services.CampaignAssetService.GetCampaignAsset].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CampaignAsset:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_campaign_asset
        ]
    ...
    def mutate_campaign_assets(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCampaignAssetsRequest`):
                The request object. Request message for
                [CampaignAssetService.MutateCampaignAssets][google.ads.googleads.v999.services.CampaignAssetService.MutateCampaignAssets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CampaignAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCampaignAssetsResponse:
