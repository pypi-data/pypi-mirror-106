    ...
    def get_keyword_plan_campaign(
        ...
        if "get_keyword_plan_campaign" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordPlanCampaignService/GetKeywordPlanCampaign",
    ...
    def mutate_keyword_plan_campaigns(
        ...
        if "mutate_keyword_plan_campaigns" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns",
