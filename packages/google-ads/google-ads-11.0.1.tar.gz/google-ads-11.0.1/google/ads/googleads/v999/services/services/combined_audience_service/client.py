...
from google.ads.googleads.v999.resources.types import combined_audience
from google.ads.googleads.v999.services.types import combined_audience_service
...
class CombinedAudienceServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CombinedAudienceServiceTransport]]
...
class CombinedAudienceServiceClient(
    metaclass=CombinedAudienceServiceClientMeta
):
    ...
    def get_combined_audience(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCombinedAudienceRequest`):
                The request object. Request message for
                [CombinedAudienceService.GetCombinedAudience][google.ads.googleads.v999.services.CombinedAudienceService.GetCombinedAudience].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CombinedAudience:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_combined_audience
        ]
...
__all__ = ("CombinedAudienceServiceClient",)
