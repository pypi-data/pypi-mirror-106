...
class GetConversionCustomVariableRequest(proto.Message):
    ...
    [ConversionCustomVariableService.GetConversionCustomVariable][google.ads.googleads.v999.services.ConversionCustomVariableService.GetConversionCustomVariable].
...
class MutateConversionCustomVariablesRequest(proto.Message):
    r"""Request message for
    [ConversionCustomVariableService.MutateConversionCustomVariables][google.ads.googleads.v999.services.ConversionCustomVariableService.MutateConversionCustomVariables].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            conversion custom variables are being modified.
        operations (Sequence[google.ads.googleads.v999.services.types.ConversionCustomVariableOperation]):
...
class ConversionCustomVariableOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.ConversionCustomVariable):
            Create operation: No resource name is
            expected for the new conversion custom variable.
        update (google.ads.googleads.v999.resources.types.ConversionCustomVariable):
...
class MutateConversionCustomVariablesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateConversionCustomVariableResult]):
