...
from google.ads.googleads.v999.services.types import invoice_service
...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    ...
    def list_invoices(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.ListInvoicesRequest`):
            ...
            issue_year (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (:class:`google.ads.googleads.v999.enums.types.MonthOfYearEnum.MonthOfYear`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.ListInvoicesResponse:
                Response message for
                [InvoiceService.ListInvoices][google.ads.googleads.v999.services.InvoiceService.ListInvoices].
