...
class MutateCampaignBidModifiersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.CampaignBidModifierOperation]):
...
class CampaignBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.CampaignBidModifier):
            Create operation: No resource name is
            expected for the new campaign bid modifier.
        update (google.ads.googleads.v999.resources.types.CampaignBidModifier):
...
class MutateCampaignBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateCampaignBidModifierResult]):
