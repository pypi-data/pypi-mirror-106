...
class MutateUserListsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.UserListOperation]):
...
class UserListOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.UserList):
            Create operation: No resource name is
            expected for the new user list.
        update (google.ads.googleads.v999.resources.types.UserList):
...
class MutateUserListsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateUserListResult]):
