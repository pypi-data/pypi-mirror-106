...
from google.ads.googleads.v999.common.types import simulation
from google.ads.googleads.v999.enums.types import simulation_modification_method
from google.ads.googleads.v999.enums.types import simulation_type
...
class CampaignSimulation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v999.enums.types.SimulationTypeEnum.SimulationType):
            Output only. The field that the simulation
            modifies.
        modification_method (google.ads.googleads.v999.enums.types.SimulationModificationMethodEnum.SimulationModificationMethod):
        ...
        cpc_bid_point_list (google.ads.googleads.v999.common.types.CpcBidSimulationPointList):
            Output only. Simulation points if the simulation type is
            CPC_BID.
        target_cpa_point_list (google.ads.googleads.v999.common.types.TargetCpaSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_CPA.
        target_roas_point_list (google.ads.googleads.v999.common.types.TargetRoasSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_ROAS.
        target_impression_share_point_list (google.ads.googleads.v999.common.types.TargetImpressionShareSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_IMPRESSION_SHARE.
        budget_point_list (google.ads.googleads.v999.common.types.BudgetSimulationPointList):
