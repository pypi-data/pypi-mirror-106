    ...
    def get_bidding_seasonality_adjustment(
        ...
        if "get_bidding_seasonality_adjustment" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.BiddingSeasonalityAdjustmentService/GetBiddingSeasonalityAdjustment",
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        if "mutate_bidding_seasonality_adjustments" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments",
