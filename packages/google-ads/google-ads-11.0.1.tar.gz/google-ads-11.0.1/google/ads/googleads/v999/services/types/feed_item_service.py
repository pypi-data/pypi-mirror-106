...
class MutateFeedItemsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.FeedItemOperation]):
...
class FeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.FeedItem):
            Create operation: No resource name is
            expected for the new feed item.
        update (google.ads.googleads.v999.resources.types.FeedItem):
...
class MutateFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateFeedItemResult]):
