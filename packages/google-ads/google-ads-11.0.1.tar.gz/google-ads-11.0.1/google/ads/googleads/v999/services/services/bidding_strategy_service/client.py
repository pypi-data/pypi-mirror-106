...
from google.ads.googleads.v999.resources.types import bidding_strategy
...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def get_bidding_strategy(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetBiddingStrategyRequest`):
                The request object. Request message for
                [BiddingStrategyService.GetBiddingStrategy][google.ads.googleads.v999.services.BiddingStrategyService.GetBiddingStrategy].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.BiddingStrategy:
                A bidding strategy.
        """
    ...
    def mutate_bidding_strategies(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateBiddingStrategiesRequest`):
                The request object. Request message for
                [BiddingStrategyService.MutateBiddingStrategies][google.ads.googleads.v999.services.BiddingStrategyService.MutateBiddingStrategies].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.BiddingStrategyOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateBiddingStrategiesResponse:
