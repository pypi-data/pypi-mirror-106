...
class MutateFeedItemSetLinksRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.FeedItemSetLinkOperation]):
...
class FeedItemSetLinkOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v999.resources.types.FeedItemSetLink):
...
class MutateFeedItemSetLinksResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.MutateFeedItemSetLinkResult]):
