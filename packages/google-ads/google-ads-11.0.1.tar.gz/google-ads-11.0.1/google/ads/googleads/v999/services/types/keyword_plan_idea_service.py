...
from google.ads.googleads.v999.enums.types import (
    keyword_plan_keyword_annotation,
)
from google.ads.googleads.v999.enums.types import (
...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    [KeywordPlanIdeaService.GenerateKeywordIdeas][google.ads.googleads.v999.services.KeywordPlanIdeaService.GenerateKeywordIdeas].
    ...
    Attributes:
        ...
        page_size (int):
            ...
            results.
        keyword_plan_network (google.ads.googleads.v999.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
        keyword_annotation (Sequence[google.ads.googleads.v999.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
        ...
        keyword_and_url_seed (google.ads.googleads.v999.services.types.KeywordAndUrlSeed):
            A Keyword and a specific Url to generate
            ideas from e.g. cars, www.example.com/cars.
        keyword_seed (google.ads.googleads.v999.services.types.KeywordSeed):
            A Keyword or phrase to generate ideas from,
            e.g. cars.
        url_seed (google.ads.googleads.v999.services.types.UrlSeed):
            A specific url to generate ideas from, e.g.
            www.example.com/cars.
        site_seed (google.ads.googleads.v999.services.types.SiteSeed):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        text (str):
            ...
            KeywordPlanService.
        keyword_idea_metrics (google.ads.googleads.v999.common.types.KeywordPlanHistoricalMetrics):
            The historical metrics for the keyword.
        keyword_annotations (google.ads.googleads.v999.common.types.KeywordAnnotations):
