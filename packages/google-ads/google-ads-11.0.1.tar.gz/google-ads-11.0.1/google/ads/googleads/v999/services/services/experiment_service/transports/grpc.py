...
class ExperimentServiceGrpcTransport(ExperimentServiceTransport):
    ...
    def get_experiment(
        ...
        [experiment_service.GetExperimentRequest], experiment.Experiment
    ]:
        r"""Return a callable for the get experiment method over gRPC.

        Returns the requested experiment in full detail.
        ...
        if "get_experiment" not in self._stubs:
            self._stubs["get_experiment"] = self.grpc_channel.unary_unary(
                "/google.ads.googleads.v999.services.ExperimentService/GetExperiment",
                request_serializer=experiment_service.GetExperimentRequest.serialize,
