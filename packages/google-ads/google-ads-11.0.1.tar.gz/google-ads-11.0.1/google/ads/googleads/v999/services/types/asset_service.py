...
class GetAssetRequest(proto.Message):
    ...
    [AssetService.GetAsset][google.ads.googleads.v999.services.AssetService.GetAsset]
...
class MutateAssetsRequest(proto.Message):
    r"""Request message for
    [AssetService.MutateAssets][google.ads.googleads.v999.services.AssetService.MutateAssets]

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose assets
            are being modified.
        operations (Sequence[google.ads.googleads.v999.services.types.AssetOperation]):
...
class AssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.Asset):
            Create operation: No resource name is
            expected for the new asset.
        update (google.ads.googleads.v999.resources.types.Asset):
...
class MutateAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateAssetResult]):
