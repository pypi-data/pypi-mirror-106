...
class MutateConversionValueRuleSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.ConversionValueRuleSetOperation]):
...
class ConversionValueRuleSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.ConversionValueRuleSet):
            Create operation: No resource name is
            expected for the new conversion value rule set.
        update (google.ads.googleads.v999.resources.types.ConversionValueRuleSet):
...
class MutateConversionValueRuleSetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.MutateConversionValueRuleSetResult]):
