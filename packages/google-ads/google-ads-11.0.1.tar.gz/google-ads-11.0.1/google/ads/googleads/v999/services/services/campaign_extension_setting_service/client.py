...
from google.ads.googleads.v999.resources.types import campaign_extension_setting
...
class CampaignExtensionSettingServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, CampaignExtensionSettingServiceTransport, None
        ] = None,
    ...
    def get_campaign_extension_setting(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCampaignExtensionSettingRequest`):
                The request object. Request message for
                [CampaignExtensionSettingService.GetCampaignExtensionSetting][google.ads.googleads.v999.services.CampaignExtensionSettingService.GetCampaignExtensionSetting].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CampaignExtensionSetting:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_campaign_extension_setting
        ]
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCampaignExtensionSettingsRequest`):
                The request object. Request message for
                [CampaignExtensionSettingService.MutateCampaignExtensionSettings][google.ads.googleads.v999.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CampaignExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCampaignExtensionSettingsResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_extension_settings
        ]
