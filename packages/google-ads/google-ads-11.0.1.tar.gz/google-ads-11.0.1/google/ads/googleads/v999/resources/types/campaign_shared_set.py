...
from google.ads.googleads.v999.enums.types import campaign_shared_set_status
...
class CampaignSharedSet(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.CampaignSharedSetStatusEnum.CampaignSharedSetStatus):
