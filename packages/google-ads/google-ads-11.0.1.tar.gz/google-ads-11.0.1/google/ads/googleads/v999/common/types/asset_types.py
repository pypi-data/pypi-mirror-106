...
from google.ads.googleads.v999.common.types import feed_common
from google.ads.googleads.v999.enums.types import lead_form_call_to_action_type
from google.ads.googleads.v999.enums.types import lead_form_desired_intent
...
from google.ads.googleads.v999.enums.types import promotion_extension_occasion
...
class ImageAsset(proto.Message):
    ...
    Attributes:
        ...
        full_size (google.ads.googleads.v999.common.types.ImageDimension):
...
class LeadFormAsset(proto.Message):
    ...
    Attributes:
        business_name (str):
            ...
            advertised.
        call_to_action_type (google.ads.googleads.v999.enums.types.LeadFormCallToActionTypeEnum.LeadFormCallToActionType):
        ...
        fields (Sequence[google.ads.googleads.v999.common.types.LeadFormField]):
            Ordered list of input fields.
        delivery_methods (Sequence[google.ads.googleads.v999.common.types.LeadFormDeliveryMethod]):
        ...
        post_submit_call_to_action_type (google.ads.googleads.v999.enums.types.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType):
        ...
        background_image_asset (str):
            ...
            must be 1.91:1 (+-1%).
        desired_intent (google.ads.googleads.v999.enums.types.LeadFormDesiredIntentEnum.LeadFormDesiredIntent):
...
class LeadFormField(proto.Message):
    ...
    Attributes:
        input_type (google.ads.googleads.v999.enums.types.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType):
            Describes the input type, which may be a
            predefined type such as "full name" or a pre-
            vetted question like "Do you own a car?".
        single_choice_answers (google.ads.googleads.v999.common.types.LeadFormSingleChoiceAnswers):
...
class LeadFormDeliveryMethod(proto.Message):
    ...
    Attributes:
        webhook (google.ads.googleads.v999.common.types.WebhookDelivery):
...
class PromotionAsset(proto.Message):
    ...
    Attributes:
        ...
        discount_modifier (google.ads.googleads.v999.enums.types.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier):
        ...
        redemption_end_date (str):
            ...
            to be redeemed, in yyyy-MM-dd format.
        occasion (google.ads.googleads.v999.enums.types.PromotionExtensionOccasionEnum.PromotionExtensionOccasion):
        ...
        ad_schedule_targets (Sequence[google.ads.googleads.v999.common.types.AdScheduleInfo]):
        ...
        money_amount_off (google.ads.googleads.v999.common.types.Money):
        ...
        orders_over_amount (google.ads.googleads.v999.common.types.Money):
