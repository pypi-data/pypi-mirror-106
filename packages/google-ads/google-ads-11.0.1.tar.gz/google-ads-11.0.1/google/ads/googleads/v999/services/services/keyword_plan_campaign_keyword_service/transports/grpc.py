    ...
    def get_keyword_plan_campaign_keyword(
        ...
        if "get_keyword_plan_campaign_keyword" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordPlanCampaignKeywordService/GetKeywordPlanCampaignKeyword",
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        if "mutate_keyword_plan_campaign_keywords" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords",
