...
from google.ads.googleads.v999.resources.types import feed_item_set_link
...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def get_feed_item_set_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetFeedItemSetLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.FeedItemSetLink:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_feed_item_set_link
        ]
    ...
    def mutate_feed_item_set_links(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateFeedItemSetLinksRequest`):
                The request object. Request message for
                [FeedItemSetLinkService.MutateFeedItemSetLinks][google.ads.googleads.v999.services.FeedItemSetLinkService.MutateFeedItemSetLinks].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.FeedItemSetLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateFeedItemSetLinksResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_feed_item_set_links
        ]
