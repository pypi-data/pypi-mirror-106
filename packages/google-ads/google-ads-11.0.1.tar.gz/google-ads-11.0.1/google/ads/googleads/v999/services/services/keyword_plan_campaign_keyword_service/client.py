...
class KeywordPlanCampaignKeywordServiceClient(
    ...
    def get_keyword_plan_campaign_keyword(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetKeywordPlanCampaignKeywordRequest`):
                The request object. Request message for
                [KeywordPlanCampaignKeywordService.GetKeywordPlanCampaignKeyword][google.ads.googleads.v999.services.KeywordPlanCampaignKeywordService.GetKeywordPlanCampaignKeyword].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.KeywordPlanCampaignKeyword:
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateKeywordPlanCampaignKeywordsRequest`):
                The request object. Request message for
                [KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords][google.ads.googleads.v999.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.KeywordPlanCampaignKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateKeywordPlanCampaignKeywordsResponse:
