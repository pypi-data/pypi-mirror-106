...
class SuggestKeywordThemeConstantsRequest(proto.Message):
    ...
    Attributes:
        query_text (str):
            ...
            "plumber" or "roofer".
        region_code (str):
            Upper-case, two-letter region code as defined
            by ISO-3166. This for refining the scope of the
            query, default to 'US' if not set.
        language_code (str):
...
class SuggestKeywordThemeConstantsResponse(proto.Message):
    ...
    Attributes:
        keyword_theme_constants (Sequence[google.ads.googleads.v999.resources.types.KeywordThemeConstant]):
