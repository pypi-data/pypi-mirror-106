...
from google.ads.googleads.v999.enums.types import account_link_status
from google.ads.googleads.v999.enums.types import linked_account_type
from google.ads.googleads.v999.enums.types import mobile_app_vendor
...
class AccountLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v999.enums.types.AccountLinkStatusEnum.AccountLinkStatus):
            The status of the link.
        type_ (google.ads.googleads.v999.enums.types.LinkedAccountTypeEnum.LinkedAccountType):
            Output only. The type of the linked account.
        third_party_app_analytics (google.ads.googleads.v999.resources.types.ThirdPartyAppAnalyticsLinkIdentifier):
            Immutable. A third party app analytics link.
        data_partner (google.ads.googleads.v999.resources.types.DataPartnerLinkIdentifier):
            Output only. Data partner link.
        google_ads (google.ads.googleads.v999.resources.types.GoogleAdsLinkIdentifier):
...
class ThirdPartyAppAnalyticsLinkIdentifier(proto.Message):
    ...
    Attributes:
        ...
        app_vendor (google.ads.googleads.v999.enums.types.MobileAppVendorEnum.MobileAppVendor):
