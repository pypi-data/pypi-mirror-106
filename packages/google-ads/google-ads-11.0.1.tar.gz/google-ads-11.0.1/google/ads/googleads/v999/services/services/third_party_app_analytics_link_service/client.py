...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, ThirdPartyAppAnalyticsLinkServiceTransport, None
        ] = None,
    ...
    def get_third_party_app_analytics_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetThirdPartyAppAnalyticsLinkRequest`):
                The request object. Request message for
                [ThirdPartyAppAnalyticsLinkService.GetThirdPartyAppAnalyticsLink][google.ads.googleads.v999.services.ThirdPartyAppAnalyticsLinkService.GetThirdPartyAppAnalyticsLink].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.ThirdPartyAppAnalyticsLink:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_third_party_app_analytics_link
        ]
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.RegenerateShareableLinkIdRequest`):
                The request object. Request message for
                [ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId][google.ads.googleads.v999.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId].
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
        ...
        Returns:
            google.ads.googleads.v999.services.types.RegenerateShareableLinkIdResponse:
