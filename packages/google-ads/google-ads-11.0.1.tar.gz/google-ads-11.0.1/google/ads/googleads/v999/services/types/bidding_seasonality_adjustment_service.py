...
class MutateBiddingSeasonalityAdjustmentsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.BiddingSeasonalityAdjustmentOperation]):
...
class BiddingSeasonalityAdjustmentOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.BiddingSeasonalityAdjustment):
            Create operation: No resource name is
            expected for the new seasonality adjustment.
        update (google.ads.googleads.v999.resources.types.BiddingSeasonalityAdjustment):
...
class MutateBiddingSeasonalityAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateBiddingSeasonalityAdjustmentsResult]):
