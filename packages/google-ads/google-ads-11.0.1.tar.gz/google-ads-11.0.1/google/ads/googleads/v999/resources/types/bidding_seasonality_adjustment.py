...
from google.ads.googleads.v999.enums.types import advertising_channel_type
from google.ads.googleads.v999.enums.types import device
from google.ads.googleads.v999.enums.types import seasonality_event_scope
from google.ads.googleads.v999.enums.types import seasonality_event_status
...
class BiddingSeasonalityAdjustment(proto.Message):
    ...
    Attributes:
        ...
        seasonality_adjustment_id (int):
            ...
            adjustment.
        scope (google.ads.googleads.v999.enums.types.SeasonalityEventScopeEnum.SeasonalityEventScope):
            The scope of the seasonality adjustment.
        status (google.ads.googleads.v999.enums.types.SeasonalityEventStatusEnum.SeasonalityEventStatus):
        ...
        description (str):
            ...
            adjustment.
        devices (Sequence[google.ads.googleads.v999.enums.types.DeviceEnum.Device]):
        ...
        campaigns (Sequence[str]):
            ...
            listed when the scope of this adjustment is CAMPAIGN. Note:
            a seasonality adjustment with both advertising_channel_types
            and campaign_ids is not supported.
        advertising_channel_types (Sequence[google.ads.googleads.v999.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType]):
