    ...
    def get_conversion_custom_variable(
        ...
        if "get_conversion_custom_variable" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ConversionCustomVariableService/GetConversionCustomVariable",
    ...
    def mutate_conversion_custom_variables(
        ...
        if "mutate_conversion_custom_variables" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ConversionCustomVariableService/MutateConversionCustomVariables",
