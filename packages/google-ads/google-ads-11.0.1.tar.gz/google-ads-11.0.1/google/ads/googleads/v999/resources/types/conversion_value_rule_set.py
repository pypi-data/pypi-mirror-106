...
from google.ads.googleads.v999.enums.types import value_rule_set_attachment_type
from google.ads.googleads.v999.enums.types import value_rule_set_dimension
...
class ConversionValueRuleSet(proto.Message):
    ...
    Attributes:
        ...
        dimensions (Sequence[google.ads.googleads.v999.enums.types.ValueRuleSetDimensionEnum.ValueRuleSetDimension]):
        ...
        owner_customer (str):
            ...
            \*\* Read-only \*\*
        attachment_type (google.ads.googleads.v999.enums.types.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType):
        ...
        campaign (str):
            ...
            campaign.
        status (google.ads.googleads.v999.enums.types.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus):
