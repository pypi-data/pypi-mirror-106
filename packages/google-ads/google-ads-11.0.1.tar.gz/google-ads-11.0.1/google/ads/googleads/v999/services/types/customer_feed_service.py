...
class MutateCustomerFeedsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.CustomerFeedOperation]):
...
class CustomerFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.CustomerFeed):
            Create operation: No resource name is
            expected for the new customer feed.
        update (google.ads.googleads.v999.resources.types.CustomerFeed):
...
class MutateCustomerFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateCustomerFeedResult]):
