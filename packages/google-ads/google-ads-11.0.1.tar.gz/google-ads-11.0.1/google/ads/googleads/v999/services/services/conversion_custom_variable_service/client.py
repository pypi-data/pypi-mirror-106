...
from google.ads.googleads.v999.resources.types import conversion_custom_variable
...
class ConversionCustomVariableServiceClient(
    ...
    def get_conversion_custom_variable(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetConversionCustomVariableRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.ConversionCustomVariable:
    ...
    def mutate_conversion_custom_variables(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateConversionCustomVariablesRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.ConversionCustomVariableOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateConversionCustomVariablesResponse:
