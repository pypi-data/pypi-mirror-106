...
class MutateAdsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (Sequence[google.ads.googleads.v999.services.types.AdOperation]):
...
class AdOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v999.resources.types.Ad):
...
class MutateAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateAdResult]):
