...
from google.ads.googleads.v999.enums.types import geo_targeting_type
...
class GeographicView(proto.Message):
    ...
    Attributes:
        ...
        location_type (google.ads.googleads.v999.enums.types.GeoTargetingTypeEnum.GeoTargetingType):
