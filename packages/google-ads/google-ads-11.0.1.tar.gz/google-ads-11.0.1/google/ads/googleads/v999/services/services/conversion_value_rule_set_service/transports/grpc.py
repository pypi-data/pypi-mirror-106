...
class ConversionValueRuleSetServiceGrpcTransport(
    ...
    def get_conversion_value_rule_set(
        ...
        r"""Return a callable for the get conversion value rule set method over gRPC.

        Returns the requested conversion value rule set.

        Returns:
            Callable[[~.GetConversionValueRuleSetRequest],
        ...
        if "get_conversion_value_rule_set" not in self._stubs:
            self._stubs[
                "get_conversion_value_rule_set"
            ] = self.grpc_channel.unary_unary(
                "/google.ads.googleads.v999.services.ConversionValueRuleSetService/GetConversionValueRuleSet",
                request_serializer=conversion_value_rule_set_service.GetConversionValueRuleSetRequest.serialize,
                response_deserializer=conversion_value_rule_set.ConversionValueRuleSet.deserialize,
            )
        return self._stubs["get_conversion_value_rule_set"]
    ...
    def mutate_conversion_value_rule_sets(
        ...
        if "mutate_conversion_value_rule_sets" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ConversionValueRuleSetService/MutateConversionValueRuleSets",
