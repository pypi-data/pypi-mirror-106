...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v999.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v999.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v999.services.types.GenerateKeywordIdeaResponse`):
    ...
    def __iter__(
        self,
    ) -> Iterable[keyword_plan_idea_service.GenerateKeywordIdeaResult]:
