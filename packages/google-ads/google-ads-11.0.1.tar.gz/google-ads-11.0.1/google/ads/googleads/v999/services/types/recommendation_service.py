...
class GetRecommendationRequest(proto.Message):
    ...
    [RecommendationService.GetRecommendation][google.ads.googleads.v999.services.RecommendationService.GetRecommendation].
...
class ApplyRecommendationRequest(proto.Message):
    r"""Request message for
    [RecommendationService.ApplyRecommendation][google.ads.googleads.v999.services.RecommendationService.ApplyRecommendation].

    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v999.services.types.ApplyRecommendationOperation]):
...
class ApplyRecommendationOperation(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            apply.
        campaign_budget (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.CampaignBudgetParameters):
            Optional parameters to use when applying a
            campaign budget recommendation.
        text_ad (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.TextAdParameters):
            Optional parameters to use when applying a
            text ad recommendation.
        keyword (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.KeywordParameters):
            Optional parameters to use when applying
            keyword recommendation.
        target_cpa_opt_in (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.TargetCpaOptInParameters):
            Optional parameters to use when applying
            target CPA opt-in recommendation.
        target_roas_opt_in (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.TargetRoasOptInParameters):
            Optional parameters to use when applying
            target ROAS opt-in recommendation.
        callout_extension (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.CalloutExtensionParameters):
            Parameters to use when applying callout
            extension recommendation.
        call_extension (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.CallExtensionParameters):
            Parameters to use when applying call
            extension recommendation.
        sitelink_extension (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.SitelinkExtensionParameters):
            Parameters to use when applying sitelink
            extension recommendation.
        move_unused_budget (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.MoveUnusedBudgetParameters):
            Parameters to use when applying move unused
            budget recommendation.
        responsive_search_ad (google.ads.googleads.v999.services.types.ApplyRecommendationOperation.ResponsiveSearchAdParameters):
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        Attributes:
            callout_extensions (Sequence[google.ads.googleads.v999.common.types.CalloutFeedItem]):
    ...
    class CallExtensionParameters(proto.Message):
        ...
        Attributes:
            call_extensions (Sequence[google.ads.googleads.v999.common.types.CallFeedItem]):
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        Attributes:
            sitelink_extensions (Sequence[google.ads.googleads.v999.common.types.SitelinkFeedItem]):
...
class ApplyRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.ApplyRecommendationResult]):
...
class DismissRecommendationRequest(proto.Message):
    r"""Request message for
    [RecommendationService.DismissRecommendation][google.ads.googleads.v999.services.RecommendationService.DismissRecommendation].

    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v999.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
...
class DismissRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v999.services.types.DismissRecommendationResponse.DismissRecommendationResult]):
