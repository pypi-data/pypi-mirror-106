    ...
    def get_account_budget_proposal(
        ...
        if "get_account_budget_proposal" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AccountBudgetProposalService/GetAccountBudgetProposal",
    ...
    def mutate_account_budget_proposal(
        ...
        if "mutate_account_budget_proposal" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AccountBudgetProposalService/MutateAccountBudgetProposal",
