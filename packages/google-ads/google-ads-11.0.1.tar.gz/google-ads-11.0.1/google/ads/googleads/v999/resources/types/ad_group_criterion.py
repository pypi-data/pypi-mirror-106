...
from google.ads.googleads.v999.common.types import criteria
from google.ads.googleads.v999.common.types import custom_parameter
from google.ads.googleads.v999.common.types import final_url
from google.ads.googleads.v999.enums.types import (
    ad_group_criterion_approval_status,
)
from google.ads.googleads.v999.enums.types import ad_group_criterion_status
from google.ads.googleads.v999.enums.types import bidding_source
from google.ads.googleads.v999.enums.types import (
    criterion_system_serving_status,
)
from google.ads.googleads.v999.enums.types import criterion_type
from google.ads.googleads.v999.enums.types import quality_score_bucket
...
class AdGroupCriterion(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            criterion.
            This field is ignored for mutates.
        status (google.ads.googleads.v999.enums.types.AdGroupCriterionStatusEnum.AdGroupCriterionStatus):
            ...
            added.
        quality_info (google.ads.googleads.v999.resources.types.AdGroupCriterion.QualityInfo):
            Output only. Information regarding the
            quality of the criterion.
        ad_group (str):
            Immutable. The ad group to which the
            criterion belongs.
        type_ (google.ads.googleads.v999.enums.types.CriterionTypeEnum.CriterionType):
        ...
        system_serving_status (google.ads.googleads.v999.enums.types.CriterionSystemServingStatusEnum.CriterionSystemServingStatus):
            Output only. Serving status of the criterion.
        approval_status (google.ads.googleads.v999.enums.types.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus):
        ...
        effective_percent_cpc_bid_micros (int):
            ...
            amount.
        effective_cpc_bid_source (google.ads.googleads.v999.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPC bid.
        effective_cpm_bid_source (google.ads.googleads.v999.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPM bid.
        effective_cpv_bid_source (google.ads.googleads.v999.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPV bid.
        effective_percent_cpc_bid_source (google.ads.googleads.v999.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective Percent
            CPC bid.
        position_estimates (google.ads.googleads.v999.resources.types.AdGroupCriterion.PositionEstimates):
        ...
        final_url_operations (Sequence[google.ads.googleads.v999.common.types.FinalUrlOperation]):
            The list of operations changing final URLs.
        ...
        engine_id (str):
            ...
            only, i.e. Yahoo Japan, Microsoft, Baidu etc. For Google Ads
            entity, please use "ad_group_criterion.criterion_id"
            instead.
        ...
        keyword (google.ads.googleads.v999.common.types.KeywordInfo):
            Immutable. Keyword.
        placement (google.ads.googleads.v999.common.types.PlacementInfo):
            Immutable. Placement.
        mobile_app_category (google.ads.googleads.v999.common.types.MobileAppCategoryInfo):
            Immutable. Mobile app category.
        mobile_application (google.ads.googleads.v999.common.types.MobileApplicationInfo):
            Immutable. Mobile application.
        listing_group (google.ads.googleads.v999.common.types.ListingGroupInfo):
            Immutable. Listing group.
        age_range (google.ads.googleads.v999.common.types.AgeRangeInfo):
            Immutable. Age range.
        gender (google.ads.googleads.v999.common.types.GenderInfo):
            Immutable. Gender.
        income_range (google.ads.googleads.v999.common.types.IncomeRangeInfo):
            Immutable. Income range.
        parental_status (google.ads.googleads.v999.common.types.ParentalStatusInfo):
            Immutable. Parental status.
        user_list (google.ads.googleads.v999.common.types.UserListInfo):
            Immutable. User List.
        youtube_video (google.ads.googleads.v999.common.types.YouTubeVideoInfo):
            Immutable. YouTube Video.
        youtube_channel (google.ads.googleads.v999.common.types.YouTubeChannelInfo):
            Immutable. YouTube Channel.
        topic (google.ads.googleads.v999.common.types.TopicInfo):
            Immutable. Topic.
        user_interest (google.ads.googleads.v999.common.types.UserInterestInfo):
            Immutable. User Interest.
        webpage (google.ads.googleads.v999.common.types.WebpageInfo):
            Immutable. Webpage
        app_payment_model (google.ads.googleads.v999.common.types.AppPaymentModelInfo):
            Immutable. App Payment Model.
        custom_affinity (google.ads.googleads.v999.common.types.CustomAffinityInfo):
            Immutable. Custom Affinity.
        custom_intent (google.ads.googleads.v999.common.types.CustomIntentInfo):
            Immutable. Custom Intent.
        custom_audience (google.ads.googleads.v999.common.types.CustomAudienceInfo):
            Immutable. Custom Audience.
        combined_audience (google.ads.googleads.v999.common.types.CombinedAudienceInfo):
    ...
    class QualityInfo(proto.Message):
        ...
        Attributes:
            quality_score (int):
                ...
                value.
            creative_quality_score (google.ads.googleads.v999.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The performance of the ad
                compared to other advertisers.
            post_click_quality_score (google.ads.googleads.v999.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The quality score of the landing
                page.
            search_predicted_ctr (google.ads.googleads.v999.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
    ...
    final_url_operations = proto.RepeatedField(
        proto.MESSAGE, number=12, message=final_url.FinalUrlOperation,
    )
    ...
    engine_id = proto.Field(proto.STRING, number=76,)
    last_modified_time = proto.Field(proto.STRING, number=78,)
    keyword = proto.Field(
        proto.MESSAGE,
        number=27,
        oneof="criterion",
