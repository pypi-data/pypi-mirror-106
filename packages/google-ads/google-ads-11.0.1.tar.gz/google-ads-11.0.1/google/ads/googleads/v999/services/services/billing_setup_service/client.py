...
from google.ads.googleads.v999.resources.types import billing_setup
from google.ads.googleads.v999.services.types import billing_setup_service
...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def get_billing_setup(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetBillingSetupRequest`):
                The request object. Request message for
                [BillingSetupService.GetBillingSetup][google.ads.googleads.v999.services.BillingSetupService.GetBillingSetup].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.BillingSetup:
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateBillingSetupRequest`):
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v999.services.types.BillingSetupOperation`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateBillingSetupResponse:
