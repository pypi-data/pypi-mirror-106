    ...
    def list_plannable_locations(
        ...
        if "list_plannable_locations" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ReachPlanService/ListPlannableLocations",
    ...
    def list_plannable_products(
        ...
        if "list_plannable_products" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ReachPlanService/ListPlannableProducts",
    ...
    def generate_product_mix_ideas(
        ...
        if "generate_product_mix_ideas" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ReachPlanService/GenerateProductMixIdeas",
    ...
    def generate_reach_forecast(
        ...
        if "generate_reach_forecast" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.ReachPlanService/GenerateReachForecast",
