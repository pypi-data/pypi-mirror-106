...
__protobuf__ = proto.module(
    package="google.ads.googleads.v999.enums",
...
class LeadFormFieldUserInputTypeEnum(proto.Message):
    ...
    class LeadFormFieldUserInputType(proto.Enum):
        ...
        EDUCATION_DEGREE = 1061
        EDUCATION_START = 1062
        EDUCATION_BEGIN = 1063
        SALARY_RANGE = 1015
        PRODUCT = 1016
        SERVICE = 1017
        OFFER = 1018
        ...
        EXISTING_CUSTOMER = 1064
        CUSTOMER_TYPE = 1065
        INSURANCE_START = 1066
        INSURANCE_TYPE = 1067
        ...
        PRODUCT_SAMPLES_INTEREST = 1032
        EVENT_SIGNUP_INTEREST = 1033
        PREFERRED_SHOPPING_PLACES = 1034
        FAVORITE_BRAND = 1035
        SERVICE_PROVIDER_INTERNET = 1069
        SERVICE_PROVIDER_PHONE = 1070
        PLAN_WITH_PHONE = 1071
        TRANSPORTATION_COMMERCIAL_LICENSE_TYPE = 1036
        VALID_DRIVER_LICENSE = 1037
        FLEET_SIZE = 1072
