...
from google.ads.googleads.v999.enums.types import campaign_draft_status
...
class CampaignDraft(proto.Message):
    ...
    Attributes:
        ...
        draft_campaign (str):
            ...
            This field is read-only.
        status (google.ads.googleads.v999.enums.types.CampaignDraftStatusEnum.CampaignDraftStatus):
