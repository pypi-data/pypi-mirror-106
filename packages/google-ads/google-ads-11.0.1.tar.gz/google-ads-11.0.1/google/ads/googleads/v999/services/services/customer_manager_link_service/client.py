...
from google.ads.googleads.v999.resources.types import customer_manager_link
...
class CustomerManagerLinkServiceClient(
    ...
    def get_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetCustomerManagerLinkRequest`):
                The request object. Request message for
                [CustomerManagerLinkService.GetCustomerManagerLink][google.ads.googleads.v999.services.CustomerManagerLinkService.GetCustomerManagerLink].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.CustomerManagerLink:
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateCustomerManagerLinkRequest`):
                The request object. Request message for
                [CustomerManagerLinkService.MutateCustomerManagerLink][google.ads.googleads.v999.services.CustomerManagerLinkService.MutateCustomerManagerLink].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.CustomerManagerLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateCustomerManagerLinkResponse:
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MoveManagerLinkRequest`):
                The request object. Request message for
                [CustomerManagerLinkService.MoveManagerLink][google.ads.googleads.v999.services.CustomerManagerLinkService.MoveManagerLink].
            customer_id (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MoveManagerLinkResponse:
                Response message for a
