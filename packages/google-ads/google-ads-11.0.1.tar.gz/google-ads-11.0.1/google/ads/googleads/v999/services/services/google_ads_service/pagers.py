...
class SearchPager:
    ...
    :class:`google.ads.googleads.v999.services.types.SearchGoogleAdsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v999.services.types.SearchGoogleAdsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v999.services.types.SearchGoogleAdsResponse`):
