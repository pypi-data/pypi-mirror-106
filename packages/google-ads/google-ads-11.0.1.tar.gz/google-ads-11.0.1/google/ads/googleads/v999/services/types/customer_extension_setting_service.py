...
class GetCustomerExtensionSettingRequest(proto.Message):
    ...
    [CustomerExtensionSettingService.GetCustomerExtensionSetting][google.ads.googleads.v999.services.CustomerExtensionSettingService.GetCustomerExtensionSetting].
...
class MutateCustomerExtensionSettingsRequest(proto.Message):
    r"""Request message for
    [CustomerExtensionSettingService.MutateCustomerExtensionSettings][google.ads.googleads.v999.services.CustomerExtensionSettingService.MutateCustomerExtensionSettings].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customer extension settings are being modified.
        operations (Sequence[google.ads.googleads.v999.services.types.CustomerExtensionSettingOperation]):
    ...
    operations = proto.RepeatedField(
        proto.MESSAGE, number=2, message="CustomerExtensionSettingOperation",
    )
...
class CustomerExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.CustomerExtensionSetting):
            Create operation: No resource name is
            expected for the new customer extension setting.
        update (google.ads.googleads.v999.resources.types.CustomerExtensionSetting):
...
class MutateCustomerExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateCustomerExtensionSettingResult]):
    ...
    results = proto.RepeatedField(
        proto.MESSAGE, number=2, message="MutateCustomerExtensionSettingResult",
    )
