...
class MutateAdGroupFeedsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.AdGroupFeedOperation]):
...
class AdGroupFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.AdGroupFeed):
            Create operation: No resource name is
            expected for the new ad group feed.
        update (google.ads.googleads.v999.resources.types.AdGroupFeed):
...
class MutateAdGroupFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateAdGroupFeedResult]):
