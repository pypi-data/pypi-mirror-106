...
from google.ads.googleads.v999.enums.types import keyword_plan_forecast_interval
...
class KeywordPlan(proto.Message):
    ...
    Attributes:
        ...
        forecast_period (google.ads.googleads.v999.resources.types.KeywordPlanForecastPeriod):
...
class KeywordPlanForecastPeriod(proto.Message):
    ...
    Attributes:
        date_interval (google.ads.googleads.v999.enums.types.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval):
            A future date range relative to the current
            date used for forecasting.
        date_range (google.ads.googleads.v999.common.types.DateRange):
