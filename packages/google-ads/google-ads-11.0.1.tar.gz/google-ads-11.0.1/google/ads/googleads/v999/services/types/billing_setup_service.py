...
class MutateBillingSetupRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v999.services.types.BillingSetupOperation):
...
class BillingSetupOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v999.resources.types.BillingSetup):
...
class MutateBillingSetupResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v999.services.types.MutateBillingSetupResult):
