...
from google.ads.googleads.v999.services.services.google_ads_service import (
    pagers,
)
from google.ads.googleads.v999.services.types import google_ads_service
...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def search(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.SearchGoogleAdsRequest`):
        ...
        Returns:
            google.ads.googleads.v999.services.services.google_ads_service.pagers.SearchPager:
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.SearchGoogleAdsStreamRequest`):
                The request object. Request message for
        ...
        Returns:
            Iterable[google.ads.googleads.v999.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                [GoogleAdsService.SearchStream][google.ads.googleads.v999.services.GoogleAdsService.SearchStream].
    ...
    def mutate(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateGoogleAdsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`Sequence[google.ads.googleads.v999.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateGoogleAdsResponse:
                Response message for
                [GoogleAdsService.Mutate][google.ads.googleads.v999.services.GoogleAdsService.Mutate].
