    ...
    def get_ad_group_extension_setting(
        ...
        if "get_ad_group_extension_setting" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AdGroupExtensionSettingService/GetAdGroupExtensionSetting",
    ...
    def mutate_ad_group_extension_settings(
        ...
        if "mutate_ad_group_extension_settings" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v999.services.AdGroupExtensionSettingService/MutateAdGroupExtensionSettings",
