...
from google.ads.googleads.v999.common.types import asset_policy
from google.ads.googleads.v999.enums.types import (
    asset_performance_label as gage_asset_performance_label,
)
from google.ads.googleads.v999.enums.types import served_asset_field_type
...
class AdTextAsset(proto.Message):
    ...
    Attributes:
        text (str):
            Asset text.
        pinned_field (google.ads.googleads.v999.enums.types.ServedAssetFieldTypeEnum.ServedAssetFieldType):
        ...
        asset_performance_label (google.ads.googleads.v999.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            The performance label of this text asset.
        policy_summary_info (google.ads.googleads.v999.common.types.AdAssetPolicySummary):
