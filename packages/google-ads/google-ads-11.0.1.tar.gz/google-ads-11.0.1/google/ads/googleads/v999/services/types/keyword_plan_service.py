...
from google.ads.googleads.v999.common.types import keyword_plan_common
...
class GetKeywordPlanRequest(proto.Message):
    ...
    [KeywordPlanService.GetKeywordPlan][google.ads.googleads.v999.services.KeywordPlanService.GetKeywordPlan].
...
class MutateKeywordPlansRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.MutateKeywordPlans][google.ads.googleads.v999.services.KeywordPlanService.MutateKeywordPlans].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            keyword plans are being modified.
        operations (Sequence[google.ads.googleads.v999.services.types.KeywordPlanOperation]):
...
class KeywordPlanOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.KeywordPlan):
            Create operation: No resource name is
            expected for the new keyword plan.
        update (google.ads.googleads.v999.resources.types.KeywordPlan):
...
class MutateKeywordPlansResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateKeywordPlansResult]):
...
class GenerateForecastCurveRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateForecastCurve][google.ads.googleads.v999.services.KeywordPlanService.GenerateForecastCurve].
...
class GenerateForecastCurveResponse(proto.Message):
    ...
    Attributes:
        campaign_forecast_curves (Sequence[google.ads.googleads.v999.services.types.KeywordPlanCampaignForecastCurve]):
...
class GenerateForecastTimeSeriesRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v999.services.KeywordPlanService.GenerateForecastTimeSeries].
...
class GenerateForecastTimeSeriesResponse(proto.Message):
    ...
    Attributes:
        weekly_time_series_forecasts (Sequence[google.ads.googleads.v999.services.types.KeywordPlanWeeklyTimeSeriesForecast]):
...
class GenerateForecastMetricsRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v999.services.KeywordPlanService.GenerateForecastMetrics].
...
class GenerateForecastMetricsResponse(proto.Message):
    ...
    Attributes:
        campaign_forecasts (Sequence[google.ads.googleads.v999.services.types.KeywordPlanCampaignForecast]):
            List of campaign forecasts.
            One maximum.
        ad_group_forecasts (Sequence[google.ads.googleads.v999.services.types.KeywordPlanAdGroupForecast]):
            List of ad group forecasts.
        keyword_forecasts (Sequence[google.ads.googleads.v999.services.types.KeywordPlanKeywordForecast]):
...
class KeywordPlanCampaignForecast(proto.Message):
    ...
    Attributes:
        ...
        campaign_forecast (google.ads.googleads.v999.services.types.ForecastMetrics):
...
class KeywordPlanAdGroupForecast(proto.Message):
    ...
    Attributes:
        ...
        ad_group_forecast (google.ads.googleads.v999.services.types.ForecastMetrics):
...
class KeywordPlanKeywordForecast(proto.Message):
    ...
    Attributes:
        ...
        keyword_forecast (google.ads.googleads.v999.services.types.ForecastMetrics):
...
class KeywordPlanCampaignForecastCurve(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            ``customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}``
        max_cpc_bid_forecast_curve (google.ads.googleads.v999.services.types.KeywordPlanMaxCpcBidForecastCurve):
...
class KeywordPlanMaxCpcBidForecastCurve(proto.Message):
    ...
    Attributes:
        max_cpc_bid_forecasts (Sequence[google.ads.googleads.v999.services.types.KeywordPlanMaxCpcBidForecast]):
...
class KeywordPlanMaxCpcBidForecast(proto.Message):
    ...
    Attributes:
        ...
        max_cpc_bid_forecast (google.ads.googleads.v999.services.types.ForecastMetrics):
...
class KeywordPlanWeeklyTimeSeriesForecast(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            ``customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}``
        weekly_forecasts (Sequence[google.ads.googleads.v999.services.types.KeywordPlanWeeklyForecast]):
            The forecasts for the Keyword Plan campaign
            at different max CPC bids.
    """
...
class KeywordPlanWeeklyForecast(proto.Message):
    ...
    Attributes:
        start_date (str):
            ...
            date is inclusive.
        forecast (google.ads.googleads.v999.services.types.ForecastMetrics):
            The forecast for the Keyword Plan campaign
            for the week.
    """
...
class GenerateHistoricalMetricsRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v999.services.KeywordPlanService.GenerateHistoricalMetrics].

    Attributes:
        keyword_plan (str):
            Required. The resource name of the keyword
            plan of which historical metrics are requested.
        aggregate_metrics (google.ads.googleads.v999.common.types.KeywordPlanAggregateMetrics):
            The aggregate fields to include in response.
        historical_metrics_options (google.ads.googleads.v999.common.types.HistoricalMetricsOptions):
...
class GenerateHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        metrics (Sequence[google.ads.googleads.v999.services.types.KeywordPlanKeywordHistoricalMetrics]):
            List of keyword historical metrics.
        aggregate_metric_results (google.ads.googleads.v999.common.types.KeywordPlanAggregateMetricResults):
...
class KeywordPlanKeywordHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        keyword_metrics (google.ads.googleads.v999.common.types.KeywordPlanHistoricalMetrics):
