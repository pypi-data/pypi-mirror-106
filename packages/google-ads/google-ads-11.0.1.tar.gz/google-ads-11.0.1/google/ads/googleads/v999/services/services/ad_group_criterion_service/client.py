...
from google.ads.googleads.v999.resources.types import ad_group_criterion
...
class AdGroupCriterionServiceClient(
    ...
    def get_ad_group_criterion(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetAdGroupCriterionRequest`):
        ...
        Returns:
            google.ads.googleads.v999.resources.types.AdGroupCriterion:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_ad_group_criterion
        ]
    ...
    def mutate_ad_group_criteria(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.MutateAdGroupCriteriaRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v999.services.types.AdGroupCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v999.services.types.MutateAdGroupCriteriaResponse:
