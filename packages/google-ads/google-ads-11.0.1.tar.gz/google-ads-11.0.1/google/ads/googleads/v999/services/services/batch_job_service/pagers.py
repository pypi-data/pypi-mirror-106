...
class ListBatchJobResultsPager:
    ...
    :class:`google.ads.googleads.v999.services.types.ListBatchJobResultsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v999.services.types.ListBatchJobResultsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v999.services.types.ListBatchJobResultsResponse`):
