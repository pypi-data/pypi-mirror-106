...
class MutateRemarketingActionsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v999.services.types.RemarketingActionOperation]):
...
class RemarketingActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v999.resources.types.RemarketingAction):
            Create operation: No resource name is
            expected for the new remarketing action.
        update (google.ads.googleads.v999.resources.types.RemarketingAction):
...
class MutateRemarketingActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v999.services.types.MutateRemarketingActionResult]):
