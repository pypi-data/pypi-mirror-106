...
class DynamicSearchAdsSearchTermViewServiceClient(
    ...
    def get_dynamic_search_ads_search_term_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v999.services.types.GetDynamicSearchAdsSearchTermViewRequest`):
                The request object. Request message for
                [DynamicSearchAdsSearchTermViewService.GetDynamicSearchAdsSearchTermView][google.ads.googleads.v999.services.DynamicSearchAdsSearchTermViewService.GetDynamicSearchAdsSearchTermView].
        ...
        Returns:
            google.ads.googleads.v999.resources.types.DynamicSearchAdsSearchTermView:
