...
from hansken.util import b64decode, b64encode, format_byte_size, Namespace
...
def upload(connection_or_endpoint, image_id, image_file, key,
           destination=local_proxy, auth=None, project=False, extract=False, keystore_url=None, store_key=False,
    ...
    def do_upload(connection):
        ...
        if destination is local_proxy:
            ...
            with WebHDFSServer(connection.upload_image) as server:
