...
from certora_cli.certoraConfigIO import read_from_conf, current_conf_to_file
...
def run_local_type_check() -> None:
    ...
    if java is None:
        print(
            "`java` is not installed. It is highly recommended to install Java version 11 or later to check "
    ...
    try:
        ...
        if int(major_java_version) < MIN_JAVA_VERSION:
            print("Installed Java version is too old to check specification files locally. It is highly recommended to "
    ...
    try:
        ...
        if parsed_args.build_only:
            ...
            if parsed_args.local:
                ...
                print(f"Finished running verifier:\n {check_cmd}")
