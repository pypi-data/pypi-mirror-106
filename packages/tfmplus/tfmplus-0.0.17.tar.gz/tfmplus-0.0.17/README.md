...
`BAUD_9600`, `BAUD_14400`, `BAUD_19200`, `BAUD_56000`, `BAUD_115200`, `BAUD_460800` and `BAUD_921600`<br />

Device data-frame output rates are programmable up to 10KHz, but the internal measuring frame-rate is fixed at 4KHz.<br />
"Standard" output data-frame rates are: 
FRAME_1`, `FRAME_2`, `FRAME_5`, `FRAME_10`, `FRAME_20`, `FRAME_25`, `FRAME_50`, `FRAME_100`, `FRAME_125`, `FRAME_200`, `FRAME_250`, `FRAME_500` and `FRAME_1000`
<br />If the data-frame rate is set to `FRAME_0`, single data frames can be triggered by using the `TRIGGER_DETECTION` command.
