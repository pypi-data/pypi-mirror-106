...
class ArbitraryWaveformGenerator(Moku):
    ...
    def set_defaults(self):
        """
        Set Arbitrary Waveform Generator to a default state.
        """
    ...
    def enable_output(self, channel, enable=True, strict=True):
        """
        Enable/disable each output channel.
    ...
    def disable_modulation(self, channel, strict=True):
        """
        Disable the modulation of a channel.
    ...
    def pulse_modulate(
            ...
            strict=True):
        """
        Configures pulse modulation mode of a channel. The Arbitrary Waveform
        Generator has the ability to insert a deadtime between cycles of the
        look-up table. This time is specified in cycles of the waveform. During
        this time, the output will be held at the given dead_voltage. This
        allows the user to, for example, generate infrequent pulses without
        using space in the LUT to specify the time between, keeping the full
        LUT size to provide a high-resolution pulse shape.
    ...
    def burst_modulate(
        ...
        :type trigger_mode: `string`, {'Gated', 'Start', 'NCycle'}
