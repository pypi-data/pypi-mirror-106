...
class WaveformGenerator(Moku):
    ...
    def set_defaults(self):
        """
        Set the Waveform Generator to sane defaults.
        """
    ...
    def sync_phase(self):
        ...
        The phase of both channels is reset to their respective phase
        offset values
    ...
    def set_modulation(
        ...
        :type type: `string`, {'None', 'Amplitude', 'Frequency', 'Phase'}
