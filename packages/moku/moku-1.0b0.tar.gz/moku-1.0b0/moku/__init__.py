...
class Moku:
    ...
    def describe(self):
        ...
        Returns name, hardware model, firmware version
    ...
    def firmware_version(self):
        """
        Get current firmware version of the Moku.
        """
    ...
    def available_power_supplies(self):
        """
        Get all available power supplies on the Moku hardware.
        """
    ...
    def read_power_supply(self, id):
        """
        Read Power supply of a specific ID.
    ...
    def set_power_supply(self, id, enable=True, voltage=3, current=0.1):
        """
        Configure a specific power supply channel (Once a load is connected,
        the power supply operates either at the set current or set voltage,
        whichever reaches the set point first)
    ...
    def list(self, target):
        ...
        :type target: `string`, (bitstreams, persist)
        :param target: Target directory to listr files for
