...
class PatternFilter(ExpressionFilter):
    ...
    def match(self, value: t.Union[str, t.Any]) -> bool:
        ...
        path = value if isinstance(value, str) else getattr(value, self.key)
...
class SizeFilter(ExpressionFilter):
    ...
    def match(self, value: t.Union[int, t.Any]) -> bool:
        ...
        size = value if isinstance(value, int) else getattr(value, self.key)
...
def parse_expression(
    ...
    filter_re = fr"({'|'.join(sorted(factory))})({'|'.join(OPERATORS)})([^&]*)&?"
    ...
    for match in matches:
        ...
        filters.append(factory[key](key, op, value))
