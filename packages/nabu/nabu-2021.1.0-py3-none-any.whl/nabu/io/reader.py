...
from ..utils import subsample_dict, get_3D_subregion
...
class HDF5Loader:
    ...
    """
    def __init__(self, fname, data_path, sub_region=None):
        self.fname = fname
    ...
    def load_data(self, force_load=False):
        ...
        with HDF5File(self.fname, "r") as fdesc:
            data = fdesc[self.data_path][self.start_z:self.end_z, self.start_y:self.end_y, self.start_x:self.end_x]
        self.data = data
        self._loaded = True
        return data
