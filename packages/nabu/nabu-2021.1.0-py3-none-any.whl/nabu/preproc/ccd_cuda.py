...
from ..preproc.ccd import CCDProcessing, CCDCorrection, FlatFieldArrays
from ..cuda.kernel import CudaKernel
from ..cuda.medfilt import MedianFilter
from ..utils import get_cuda_srcfile, updiv, deprecated
from ..io.reader import load_images_from_dataurl_dict


@deprecated(
    "In future versions of nabu, the class CudaFlatField will be used directly with numpy arrays instead of DataUrls",
    do_print=True
)
def CudaFlatFieldDataUrls(
    radios_shape: tuple,
    flats: dict,
    darks: dict,
    radios_indices=None,
...
# The current behavior is to use FlatField with dataurl objects.
# This will change in future versions, where FlatField will be used directly with arrays.
CudaFlatField = CudaFlatFieldDataUrls
