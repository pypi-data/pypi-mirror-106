...
class Current:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.nrMmwMeas.prach.modulation.current.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:NRMMw:MEASurement<Instance>:PRACh:MODulation:CURRent?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:NRMMw:MEASurement<Instance>:PRACh:MODulation:CURRent \n
		Snippet: value: ResultData = driver.nrMmwMeas.prach.modulation.current.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:NRMMw:MEASurement<Instance>:PRACh:MODulation:CURRent?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:NRMMw:MEASurement<Instance>:PRACh:MODulation:CURRent \n
		Snippet: value: CalculateStruct = driver.nrMmwMeas.prach.modulation.current.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:NRMMw:MEASurement<Instance>:PRACh:MODulation:CURRent?', self.__class__.CalculateStruct())
