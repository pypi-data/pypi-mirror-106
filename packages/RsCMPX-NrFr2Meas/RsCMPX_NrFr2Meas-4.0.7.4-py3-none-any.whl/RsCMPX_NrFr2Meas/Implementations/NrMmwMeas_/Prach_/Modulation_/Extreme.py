...
class Extreme:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Tx_Power_Minimum: float: No parameter help available
			- Tx_Power_Maximum: float: No parameter help available
			- Peak_Power_Min: float: No parameter help available
			- Peak_Power_Max: float: No parameter help available"""
		__meta_args_list = [
	...
	def read(self) -> ResultData:
		"""SCPI: READ:NRMMw:MEASurement<Instance>:PRACh:MODulation:EXTReme \n
		Snippet: value: ResultData = driver.nrMmwMeas.prach.modulation.extreme.read() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:NRMMw:MEASurement<Instance>:PRACh:MODulation:EXTReme?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:NRMMw:MEASurement<Instance>:PRACh:MODulation:EXTReme \n
		Snippet: value: ResultData = driver.nrMmwMeas.prach.modulation.extreme.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:NRMMw:MEASurement<Instance>:PRACh:MODulation:EXTReme?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:NRMMw:MEASurement<Instance>:PRACh:MODulation:EXTReme \n
		Snippet: value: CalculateStruct = driver.nrMmwMeas.prach.modulation.extreme.calculate() \n
		No command help available \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:NRMMw:MEASurement<Instance>:PRACh:MODulation:EXTReme?', self.__class__.CalculateStruct())
