...
class ListEndpointsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/s3outposts.html#S3Outposts.Paginator.ListEndpoints.paginate)
