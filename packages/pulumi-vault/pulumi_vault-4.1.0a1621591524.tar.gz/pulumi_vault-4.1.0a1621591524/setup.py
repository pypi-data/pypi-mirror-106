...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.1.0-alpha.1621591524+bb8ec02c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.1.0-alpha.1621591524+bb8ec02c`
                """)
            else:
                raise
