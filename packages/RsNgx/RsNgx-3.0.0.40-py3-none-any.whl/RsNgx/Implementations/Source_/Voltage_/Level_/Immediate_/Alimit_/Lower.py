...
class Lower:
	...
	def set(self, voltage: float) -> None:
		...
		Sets or queries the lower safety limit for voltage. \n
			:param voltage: numeric value | MIN | MINimum | MAX | MAXimum | list numeric vaule Numeric value for safety limit. MIN | MINimum Min value for lower safety limit. MAX | MAXimum Max value for lower safety limit. Range: 0.000E+00 to 2.050E+01
		"""
