...
class Mode:
	...
	def set(self, arg_0: enums.LogMode) -> None:
		...
		Sets or queries the data logging mode. \n
			:param arg_0: UNLimited | COUNt | DURation | SPAN UNLimited Infinite data capture. COUNt Number of measurement values to be captured. DURation Duration of the measurement values capture. SPAN Interval of the measurement values capture.
		"""
