...
class LearningMachine(object):
  ...
  def __init__(self,initConfig='poscar.gen',
               ...
               accMax=0.96,accInc=1.0,mdInc=1.2,resetAcc=5,
               learnWay=5,FreePairs=None,
               FreeAtoms=None,FirstAtom=None,
               rodic=None,
               rmin=0.6,rmax=1.3,angmax=15.0,
               UseZmat=True,
               EngTole=0.05,dEtole=0.2,d2Etole=0.05,dEstop=2.0,
               nn=True,vdwnn=False,
...
if __name__ == '__main__':
   ...
   lm = LearningMachine(initConfig='noco6.gen',
                        ...
                        EngTole=0.085,dEtole=0.14,dEstop=1.0,d2Etole=0.06,
