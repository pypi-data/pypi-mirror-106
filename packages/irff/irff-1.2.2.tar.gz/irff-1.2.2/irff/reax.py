...
class ReaxFF(object):
  ...
  def set_neurons(self):
      ...
      self.ang_v = ['val1','val2','val3','val4','val5','val6','val7',
                    'pen1','pen2','pen3','pen4',
                    'coa1','coa2','coa3','coa4'] 
  ...
  def clip_parameters(self):
      ...
      for k in self.v:
          ...
          if key == 'n.u.':
             ...
             self.p[k] = tf.clip_by_value(self.v[k],0.0001,0.001)
          elif key=='hbtol':
             self.p[k] = tf.clip_by_value(self.v[k],0.0001,0.001)
          elif key=='cutoff':
             self.p[k] = tf.clip_by_value(self.v[k],0.01,0.012)
          elif key=='ovun5':
             self.p[k] = tf.clip_by_value(self.v[k],0.0,60.0*self.unit)
          elif key=='ovun1':
             self.p[k] = tf.clip_by_value(self.v[k],0.1,2.0)
             ...
             self.p[k] = tf.clip_by_value(self.v[k],0.01*self.unit,9.0*self.unit)
          elif key == 'Dehb':
