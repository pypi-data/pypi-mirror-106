...
setup(
    name="wai.annotations.bluechannel",
    description="Blue-channel image segmentation format plugins for wai.annotations.",
    long_description=f"{_read('DESCRIPTION.rst')}\n"
                     f"{_read('CHANGES.rst')}",
    url="https://github.com/waikato-datamining/wai-annotations-bluechannel",
    classifiers=[
