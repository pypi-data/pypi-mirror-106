...
class AnyInstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/elb.html#ElasticLoadBalancing.Waiter.AnyInstanceInServiceWaiter)
...
class InstanceDeregisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/elb.html#ElasticLoadBalancing.Waiter.InstanceDeregisteredWaiter)
...
class InstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/elb.html#ElasticLoadBalancing.Waiter.InstanceInServiceWaiter)
