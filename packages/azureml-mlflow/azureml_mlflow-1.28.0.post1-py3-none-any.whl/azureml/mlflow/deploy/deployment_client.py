...
from ._util import file_stream_to_object, handle_model_uri, create_inference_config, submit_update_call
...
class AzureMLDeploymentClient(BaseDeploymentClient):
    ...
    def create_deployment(self, name, model_uri, flavor=None, config=None):
        ...
        try:
            aml_model = Model(self.workspace, id='{}:{}'.format(model_name, model_version))
        except Exception as e:
