...
from mlflow import get_tracking_uri, get_registry_uri, pyfunc
...
"""
    ...
    SAMPLE_INPUT_STR = "sample_input = pd.read_json('{input_format_str}', orient='split')"
    SAMPLE_OUTPUT_STR = "sample_output = pd.read_json('{output_format_str}', orient='records')"
