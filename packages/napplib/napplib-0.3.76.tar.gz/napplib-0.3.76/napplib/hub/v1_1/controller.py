...
class HubController:
    ...
    @classmethod
    def post_products(self, server_url, token, products: List[Product]):
        return self.__post_integrate_products(server_url, token, products)

    @classmethod
    def post_store_products(self, server_url, token, store_id, products: List[Product]):
        return self.__post_integrate_products(server_url, token, products, store_id)

    @classmethod
    def post_store_products_marketplace(self, server_url, token, store_id, marketplace_id, products: List[Product]):
        return self.__post_integrate_products(server_url, token, products, store_id, marketplace_id)
