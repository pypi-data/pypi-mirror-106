...
[boto3.IoTEvents 1.17.74](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/iotevents.html#IoTEvents)
...
def check_value(value: AnalysisResultLevelType) -> bool:
    ...
```
