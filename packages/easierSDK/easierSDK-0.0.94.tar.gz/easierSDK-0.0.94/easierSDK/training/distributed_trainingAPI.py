...
class DistributedTrainingAPI():
    ...
    def create_training(self, x, y, easier_model:EasierModel, training_metadata:TrainingMetadata=None, x_test=None, y_test=None, public=False, num_workers=3, worker_batch_size=64):
