...
class ReadOnlyTableWrapper(object):
    ...
    def __init__(self, columnNameList, height=400, heightPolicy="fixed"):
        """@brief Constructor
           ...
           @heightPolicy The height policy (auto, fixed, fit, min, max). default=fixed."""
        ...
        self._dataTable = DataTable(source=self._source, columns=self._columns, height=height, height_policy=heightPolicy)
...
class ShutdownButtonWrapper(object):
    ...
    def __init__(self, shutDownMethod):
        ...
        self._alertButtonWrapper = AlertButtonWrapper("Quit",\
                                                      "The application has stopped. Please close the browser window",\
                                                      buttonType="danger",\
