...
VALID_RBAC_ENTITY_TYPES = ("User", "Role", "RoleAssignment")
# This is a superset of all valid entity types
VALID_ENTITY_TYPES = (*VALID_ENDPOINT_ENTITY_TYPES, *VALID_RBAC_ENTITY_TYPES)
