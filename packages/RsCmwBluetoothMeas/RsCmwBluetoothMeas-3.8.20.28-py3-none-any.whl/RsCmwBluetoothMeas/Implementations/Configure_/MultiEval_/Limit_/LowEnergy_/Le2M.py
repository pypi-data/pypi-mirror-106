...
class Le2M:
	"""Le2M commands group definition. 13 total commands, 3 Sub-groups, 7 group commands"""
	...
	def daverage(self):
		...
		if not hasattr(self, '_daverage'):
			from .Le2M_.Daverage import Daverage
	...
	def dminimum(self):
		...
		if not hasattr(self, '_dminimum'):
			from .Le2M_.Dminimum import Dminimum
	...
	def dmaximum(self):
		...
		if not hasattr(self, '_dmaximum'):
			from .Le2M_.Dmaximum import Dmaximum
	...
	def get_sacp(self) -> SacpStruct:
		...
		Snippet: value: SacpStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_sacp() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:SACP?', self.__class__.SacpStruct())

	def set_sacp(self, value: SacpStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:SACP \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_sacp(value = SacpStruct()) \n
		These commands define and enable the 'Spectrum ACP' limits for BR (...:LIMit:SACP) , LE 1M PHY ( ...:LE1M...) , LE 2M PHY
		(...:LE2M...) , and LE coded PHY (...:LRANge...) , respectively. \n
			:param value: see the help for SacpStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:SACP', value)
	...
	def get_power_vs_time(self) -> PowerVsTimeStruct:
		...
		Snippet: value: PowerVsTimeStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_power_vs_time() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:PVTime?', self.__class__.PowerVsTimeStruct())

	def set_power_vs_time(self, value: PowerVsTimeStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:PVTime \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_power_vs_time(value = PowerVsTimeStruct()) \n
		Defines the power limits: lower and upper average power limits, upper limit for 'peak minus average power', limit check
		enabling. Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..
		) are available. \n
			:param value: see the help for PowerVsTimeStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:PVTime', value)
	...
	def get_faccuracy(self) -> FaccuracyStruct:
		...
		Snippet: value: FaccuracyStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_faccuracy() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FACCuracy?', self.__class__.FaccuracyStruct())

	def set_faccuracy(self, value: FaccuracyStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FACCuracy \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_faccuracy(value = FaccuracyStruct()) \n
		Defines the limit for the frequency accuracy. Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE
		coded PHY (..:LRANge..) are available. \n
			:param value: see the help for FaccuracyStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FACCuracy', value)
	...
	def get_foffset(self) -> FoffsetStruct:
		...
		Snippet: value: FoffsetStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_foffset() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FOFFset?', self.__class__.FoffsetStruct())

	def set_foffset(self, value: FoffsetStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FOFFset \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_foffset(value = FoffsetStruct()) \n
		Sets/gets the frequency offset limit. Commands for uncoded LE 1M PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded
		PHY (..:LRANge..) are available. \n
			:param value: see the help for FoffsetStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FOFFset', value)
	...
	def get_mratio(self) -> MratioStruct:
		...
		Snippet: value: MratioStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_mratio() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:MRATio?', self.__class__.MratioStruct())

	def set_mratio(self, value: MratioStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:MRATio \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_mratio(value = MratioStruct()) \n
		Sets or queries the modulation ratio limit Δf2 avg / Δf1 avg for LE 1M PHY (...:LE1M...) and LE 2M PHY (...:LE2M...) . \n
			:param value: see the help for MratioStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:MRATio', value)
	...
	def get_delta(self) -> DeltaStruct:
		...
		Snippet: value: DeltaStruct = driver.configure.multiEval.limit.lowEnergy.le2M.get_delta() \n
		Sets/gets the limit for the frequency deviation Δf2 for LE 2M PHY that must be exceeded by 99.9% of the measured samples. \n
			:return: structure: for return value, see the help for DeltaStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:DELTa?', self.__class__.DeltaStruct())

	def set_delta(self, value: DeltaStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:DELTa \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_delta(value = DeltaStruct()) \n
		Sets/gets the limit for the frequency deviation Δf2 for LE 2M PHY that must be exceeded by 99.9% of the measured samples. \n
			:param value: see the help for DeltaStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:DELTa', value)
	...
	def set_fdrift(self, value: FdriftStruct) -> None:
		"""SCPI: CONFigure:BLUetooth:MEASurement<Instance>:MEValuation:LIMit:LENergy:LE2M:FDRift \n
		Snippet: driver.configure.multiEval.limit.lowEnergy.le2M.set_fdrift(value = FdriftStruct()) \n
		Sets and enables limits for frequency drift, maximum drift rate and initial frequency drift. Commands for uncoded LE 1M
		PHY (..:LE1M..) , LE 2M PHY (..:LE2M..) , and LE coded PHY (..:LRANge..) are available. \n
