...
def array_rad_pattern_plot(array_alignment, w=None, sing_elem_patterns=None, axes=None, log_scale_min=-50, scaling="voltage"):
    """
        Description:
        ------------
        ...
        -----------          
             ...
             :param scaling           : "voltage" / "snr" (default:"voltage"), displays voltage gain or antenna gain (SNR improvement)
    ...
    if scaling == "snr": AF_log -= 10*np.log10(np.sum(np.abs(w)))
    theta_index = 0
    for theta in incident_angles:
