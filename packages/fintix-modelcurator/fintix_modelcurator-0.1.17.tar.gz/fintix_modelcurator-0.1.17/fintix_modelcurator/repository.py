...
class ModelRepository:
    ...
    def upload_model(self, model_name):
        ...
        try:
            ...
            cur.execute("INSERT INTO io_fintix.custom_model (model_uid, model_name, model) VALUES(%s, %s, %s) ON CONFLICT (model_uid) DO UPDATE SET model = %s WHERE model_uid = '%s'",
                        (model_name, model_name, script_content, script_content, model_name))
            conn.commit()
