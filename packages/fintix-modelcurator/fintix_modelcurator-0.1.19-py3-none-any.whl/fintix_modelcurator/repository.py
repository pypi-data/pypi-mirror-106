...
class ModelRepository:
    ...
    def upload_model(self, model_name):
        ...
        try:
            ...
            cur.execute(f"INSERT INTO io_fintix.custom_model (model_uid, model_name, model) VALUES('{model_name}', '{model_name}', %s) ON CONFLICT (model_uid) DO UPDATE SET model = %s WHERE model_uid = '{model_name}'",
