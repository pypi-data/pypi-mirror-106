/*! For license information please see chunk.a02e6d898c4610dc50c6.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[5872],{18601:(e,t,a)=>{"use strict";a.d(t,{qN:()=>i.q,Wg:()=>r});var i=a(78220);class r extends i.H{createRenderRoot(){return this.attachShadow({mode:"open",delegatesFocus:!0})}click(){this.formElement&&(this.formElement.focus(),this.formElement.click())}setAriaLabel(e){this.formElement&&this.formElement.setAttribute("aria-label",e)}firstUpdated(){super.firstUpdated(),this.mdcRoot.addEventListener("change",(e=>{this.dispatchEvent(new Event("change",e))}))}}},63207:(e,t,a)=>{"use strict";a(65660),a(15112);var i=a(9672),r=a(87156),n=a(50856),o=a(65233);(0,i.k)({_template:n.d`
    <style>
      :host {
        @apply --layout-inline;
...
`,is:"paper-textarea",behaviors:[h.d0,l.V],properties:{_ariaLabelledBy:{observer:"_ariaLabelledByChanged",type:String},_ariaDescribedBy:{observer:"_ariaDescribedByChanged",type:String},value:{type:String},rows:{type:Number,value:1},maxRows:{type:Number,value:0}},get selectionStart(){return this.$.input.textarea.selectionStart},set selectionStart(e){this.$.input.textarea.selectionStart=e},get selectionEnd(){return this.$.input.textarea.selectionEnd},set selectionEnd(e){this.$.input.textarea.selectionEnd=e},_ariaLabelledByChanged:function(e){this._focusableElement.setAttribute("aria-labelledby",e)},_ariaDescribedByChanged:function(e){this._focusableElement.setAttribute("aria-describedby",e)},get _focusableElement(){return this.inputElement.textarea}})},58993:(e,t,a)=>{"use strict";a.d(t,{yh:()=>i,U2:()=>o,t8:()=>s,ZH:()=>l});class i{constructor(e="keyval-store",t="keyval"){this.storeName=t,this._dbp=new Promise(((a,i)=>{const r=indexedDB.open(e,1);r.onerror=()=>i(r.error),r.onsuccess=()=>a(r.result),r.onupgradeneeded=()=>{r.result.createObjectStore(t)}}))}_withIDBStore(e,t){return this._dbp.then((a=>new Promise(((i,r)=>{const n=a.transaction(this.storeName,e);n.oncomplete=()=>i(),n.onabort=n.onerror=()=>r(n.error),t(n.objectStore(this.storeName))}))))}}let r;function n(){return r||(r=new i),r}function o(e,t=n()){let a;return t._withIDBStore("readonly",(t=>{a=t.get(e)})).then((()=>a.result))}function s(e,t,a=n()){return a._withIDBStore("readwrite",(a=>{a.put(t,e)}))}function l(e=n()){return e._withIDBStore("readwrite",(e=>{e.clear()}))}}}]);
//# sourceMappingURL=chunk.a02e6d898c4610dc50c6.js.map