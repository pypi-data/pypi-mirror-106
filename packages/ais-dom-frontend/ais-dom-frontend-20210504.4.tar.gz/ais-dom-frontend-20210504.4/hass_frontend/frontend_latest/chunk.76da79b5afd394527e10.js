...
`;!function(r,e,o,t){var a=l();if(t)for(var i=0;i<t.length;i++)a=t[i](a);var n=e((function(r){a.initializeInstanceElements(r,f.elements)}),o),f=a.decorateClass(function(r){for(var e=[],o=function(r){return"method"===r.kind&&r.key===i.key&&r.placement===i.placement},t=0;t<r.length;t++){var a,i=r[t];if("method"===i.kind&&(a=e.find(o)))if(p(i.descriptor)||p(a.descriptor)){if(s(i)||s(a))throw new ReferenceError("Duplicated methods ("+i.key+") can't be decorated.");a.descriptor=i.descriptor}else{if(s(i)){if(s(a))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+i.key+").");a.decorators=i.decorators}d(i,a)}else e.push(i)}return e}(n.d.map(c)),r);a.initializeClassElements(n.F,f.elements),a.runClassFinishers(n.F,f.finishers)}([(0,i.Mo)("ha-dialog")],(function(r,e){class o extends e{constructor(...e){super(...e),r(this)}}return{F:o,d:[{kind:"method",key:"scrollToPos",value:function(r,e){this.contentElement.scrollTo(r,e)}},{kind:"method",key:"renderHeading",value:function(){return i.dy`<slot name="heading"> ${u(v(o.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"get",static:!0,key:"styles",value:function(){return[t.o,i.iv`
        .mdc-dialog {
...
`}}]);
//# sourceMappingURL=chunk.76da79b5afd394527e10.js.map