...
class Average:
	...
	class FetchStruct(StructBase):
		...
		__meta_args_list = [
			...
			ArgStruct('Am_Pm_Delay', DataType.FloatList, None, False, True, 1)]
		...
		def __init__(self):
			...
			self.Am_Pm_Delay: List[float] = None
	...
	def fetch(self) -> FetchStruct:
		...
		return self._core.io.query_struct(f'FETCh:GSM:MEASurement<Instance>:MEValuation:LIST:MODulation:AVERage?', self.__class__.FetchStruct())
	...
	def calculate(self) -> CalculateStruct:
		...
		return self._core.io.query_struct(f'CALCulate:GSM:MEASurement<Instance>:MEValuation:LIST:MODulation:AVERage?', self.__class__.CalculateStruct())
