...
class Maximum:
	...
	def calculate(self) -> CalculateStruct:
		...
		return self._core.io.query_struct(f'CALCulate:GSM:MEASurement<Instance>:MEValuation:MODulation:MAXimum?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		...
		return self._core.io.query_struct(f'FETCh:GSM:MEASurement<Instance>:MEValuation:MODulation:MAXimum?', self.__class__.ResultData())
	...
	def read(self) -> ResultData:
		...
		for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:GSM:MEASurement<Instance>:MEValuation:MODulation:MAXimum?', self.__class__.ResultData())
