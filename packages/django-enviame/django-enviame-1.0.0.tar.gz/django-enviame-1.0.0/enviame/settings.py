"""
Settings for Linets with enviame courier are all namespaced in the LINETS setting.
For example your project's `settings.py` file might look like this:

LINETS_ENVIAME = {
    'ENVIAME': {
        'BASE_URL': 'https://linets.api.enviame.io/api/s2/v2/',
        'COMPANY_ID': '999',
        'API_KEY': '7d06682sdgff666fb8802bf81113',
        'COD_BOD': 'linets_enviame',
    },
}
...
class APISettings:
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'LINETS_ENVIAME', {})
