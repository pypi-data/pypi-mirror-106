...
class AddonActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Waiter.AddonActiveWaiter)
...
class AddonDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Waiter.AddonDeletedWaiter)
...
class ClusterActiveWaiter(Boto3Waiter):
    ...
    def wait(self, name: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Waiter.ClusterActiveWaiter)
...
class ClusterDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, name: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Waiter.ClusterDeletedWaiter)
...
class NodegroupActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Waiter.NodegroupActiveWaiter)
...
class NodegroupDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Waiter.NodegroupDeletedWaiter)
