...
class DescribeAddonVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.DescribeAddonVersions.paginate)
...
class ListAddonsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.ListAddons.paginate)
...
class ListClustersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.ListClusters.paginate)
...
class ListFargateProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.ListFargateProfiles.paginate)
...
class ListIdentityProviderConfigsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.ListIdentityProviderConfigs.paginate)
...
class ListNodegroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.ListNodegroups.paginate)
...
class ListUpdatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.73/reference/services/eks.html#EKS.Paginator.ListUpdates.paginate)
