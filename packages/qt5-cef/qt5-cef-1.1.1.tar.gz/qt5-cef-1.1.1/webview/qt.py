...
def launch_main_window(uid, title, url, width, height, resizable, full_screen, min_size,
    ...
    if platform.system() == 'Darwin':
        ...
        # 研发模式下，venv目录下的路径
        framework_dir_path_venv = os.path.abspath("./venv/lib/python" + python_version + "/site-packages/cefpython3/Chromium Embedded Framework.framework")
        browser_subprocess_path_venv = os.path.abspath("./venv/lib/python" + python_version + "/site-packages/cefpython3/subprocess")
        exist_venv = os.path.exists(framework_dir_path_venv)

        # APP 生产编译模式下，Contents/Resources下的路径
        framework_dir_path_app = os.path.abspath("./lib/python" + python_version + "/cefpython3/Chromium Embedded Framework.framework")
        browser_subprocess_path_app = os.path.abspath("./lib/python" + python_version + "/cefpython3/subprocess")
        exist_app = os.path.exists(framework_dir_path_app)
        ...
        if exist_app:
            framework_dir_path = framework_dir_path_app
            browser_subprocess_path = browser_subprocess_path_app
        elif exist_system:
        ...
        print("framework_dir_path : ", framework_dir_path)
        print("browser_subprocess_path : ", browser_subprocess_path)
