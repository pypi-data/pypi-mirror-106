...
<tr class="form-group${required_class}">
    ...
    % elif data['type'] == 'Int':
        <input type="text" class="form-control input-sm touchspin" data-bts-min="${data.get('min') or -4294967295}" data-bts-max="${data.get('max') or 4294967295}" id="${id}" name="${data['name']}"${required_prop} />
    ...
    <div class="col-md-6">
        <form class="form-inline">
            <div class="input-group input-group-sm">
                <input class="form-control" type="search" id="input-filter" placeholder="${translate('Filter')}" aria-label="${translate('Filter')}">
                <div class="input-group-addon">
...
<div class="alert alert-warning alert-dismissible">
    ...
    <h4><i class="icon fa fa-ban"></i> ${translate('One or more optional libraries are not available!')}</h4>
    <ul>
...
<div class="alert alert-warning alert-dismissible">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    <h4><i class="icon fa fa-warning"></i> ${translate('Orphan routes detected!')}</h4>
    <ul>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="help-modal-label">${translate('Help')}</h4>
      </div>
...
<div class="modal fade" id="response-modal" tabindex="-1" role="dialog" aria-labelledby="response-modal-label">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="response-modal-label">${translate('Response')}</h4>
      </div>
      <div class="modal-body">
          ...
          <div id="response-request-data">
              <h4>${translate('Request Data')}</h4>
              <pre></pre>
          </div>

          <div id="response-request-curl-cmd">
              <h4>${translate('CURL Command')}</h4>
              <pre></pre>
          </div>

          <div id="response-code">
              <h4>${translate('Response Status Code')}</h4>
              <pre></pre>
          </div>

          <div id="response-body">
              <h4>${translate('Response Body')}</h4>
              <pre></pre>
          </div>
