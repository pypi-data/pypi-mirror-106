...
<tr class="form-group${required_class}">
    ...
    % elif data['type'] == 'Int':
        <input type="text" class="form-control form-control-sm touchspin" data-bts-min="${data.get('min') or -4294967295}" data-bts-max="${data.get('max') or 4294967295}" id="${id}" name="${data['name']}"${required_prop} />
  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="card" id="response-request-data">
