...
def get_header_language() -> str:
    ...
    if not lang and not current_app.i18n_is_consumer:
...
def init_app(
    app: Flask,
    lang_list: List[str],
    header_language_name: str = "language",
    header_language_function=None,
    i18n_language_default: str = None,
    i18n_language_mapping: dict = None,
    ...
    app.i18n_language_default = (
        i18n_language_default if i18n_language_default in lang_list else LANG_EN
    )
    app.i18n_language_mapping = i18n_language_mapping or dict()
    app.i18n_is_consumer = is_consumer
