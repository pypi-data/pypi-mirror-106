...
def generate_sign(
    app_key: str, app_secret: str, url: str, method: str, body_str: str = "", salt: str = "&"
) -> (str, str, str):
...
def valid_sign(
    ...
    valid_generate_sign = __generate_sign(
        app_key, app_secret, url, method, body_str, timestamp, nonce, salt
    )
...
class AppInfoService:
    @abstractmethod
    def get_app_info(self, app_key: str) -> AppInfo:
        pass
...
class AppSignValidService:
    ...
    def valid(self):
        ...
        if not valid_sign(
            ...
            raise ServiceException(code=400, msg="invalid sign")
