...
def progress_bar(item, iterable, **kwargs):
    """Function return either click progress bar or a custom iterable"""
...
class Record(Resource):
    ...
    def _upload(self, f_size, obj, file_name, replace=False):
        ...
        with progress_bar(self, range(chunk_count)) as iterable_bar:
