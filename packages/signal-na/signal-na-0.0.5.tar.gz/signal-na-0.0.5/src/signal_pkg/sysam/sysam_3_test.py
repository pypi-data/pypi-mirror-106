...
if __name__ == "__main__":
    ...
    # Te2 = 1e-7
    # liste_signaux[2] = SignalGBF(liste_tmin_tmax = liste_tmin_tmax, Te = Te2)
    # liste_signaux[4] = SignalGBF(liste_tmin_tmax = liste_tmin_tmax, Te = Te2)
    # liste_signaux[0].configurer_voie("SA1", repetition = True)
    # liste_signaux[1].configurer_voie("SA2", repetition = True)
    # liste_signaux[2].configurer_voie("EA1", repetition = True)
    # liste_signaux[3].configurer_voie("EA5", repetition = True)
    ...
    # # tester sorties echantillonnées trop vite
    # Te2 = 1e-7
    # liste_signaux[0] = SignalGBF(liste_tmin_tmax = liste_tmin_tmax, Te = Te2)
    # liste_signaux[1] = SignalGBF(liste_tmin_tmax = liste_tmin_tmax, Te = Te2)
    # liste_signaux[0].configurer_voie("SA1", repetition = True)
    # liste_signaux[1].configurer_voie("SA2", repetition = True)
    # liste_signaux[2].configurer_voie("EA1", repetition = True)
    # liste_signaux[3].configurer_voie("EA5", repetition = True)
    ...
    # liste_signaux[0] = SignalGBF(liste_tmin_tmax = liste_tmin_tmax2, Te = Te)
    # liste_signaux[0].configurer_voie("SA1", repetition = True)
    # liste_signaux[1].configurer_voie("SA2", repetition = True)
    # liste_signaux[2].configurer_voie("EA1", repetition = True)
    # liste_signaux[3].configurer_voie("EA5", repetition = True)
