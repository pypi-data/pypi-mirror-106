...
<p>The program is developed in Python3.7, and is available as open source under an MIT license (see the file LICENSE included in the distribution of this program, or in Help-&gt;About in the opneSpex menu). 
</p>
