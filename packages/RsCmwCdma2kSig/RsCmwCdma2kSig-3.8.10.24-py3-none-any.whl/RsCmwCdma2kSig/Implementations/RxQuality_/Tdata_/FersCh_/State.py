...
class State:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.rxQuality.tdata.fersCh.state.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:CDMA:SIGNaling<Instance>:RXQuality:TDATa:FERSch:STATe?')
