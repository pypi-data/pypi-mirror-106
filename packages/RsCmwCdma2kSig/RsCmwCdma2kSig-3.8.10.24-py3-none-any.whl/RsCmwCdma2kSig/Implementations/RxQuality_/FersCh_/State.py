...
class State:
	...
	def fetch(self) -> str:
		...
		Snippet: value: str = driver.rxQuality.fersCh.state.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:CDMA:SIGNaling<Instance>:RXQuality:FERSch:STATe?', suppressed)
