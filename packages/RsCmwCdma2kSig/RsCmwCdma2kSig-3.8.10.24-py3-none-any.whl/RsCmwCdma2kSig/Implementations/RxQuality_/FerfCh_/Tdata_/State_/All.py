...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.rxQuality.ferfCh.tdata.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:CDMA:SIGNaling<Instance>:RXQuality:FERFch:TDATa:STATe:ALL?', self.__class__.FetchStruct())
