...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.rxQuality.tdata.fersCh.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:CDMA:SIGNaling<Instance>:RXQuality:TDATa:FERSch:STATe:ALL?', self.__class__.FetchStruct())
