...
-   MERGED WITH YOUTUBE-DL COMMIT/DFBBE29: (v2021.05.16) You get all the
...
-   NEW EXTRACTORS: AnimeLab, Philo MSO, Rcs, Gedi, bitwave.tv, mildom,
    ...
    whowatch, MxplayerShow, parlview (au)
...
-   SUBTITLE EXTRACTION FROM MANIFESTS: Subtitles can be extracted from
    ...
    be6202f12b97858b9d716e608394b51065d0419f for details
...
-   Youtube channel URLs are automatically redirected to /video. Either
    append a /featured to the URL or use
    --compat-options no-youtube-channel-redirect to download only the
    videos in the home page
