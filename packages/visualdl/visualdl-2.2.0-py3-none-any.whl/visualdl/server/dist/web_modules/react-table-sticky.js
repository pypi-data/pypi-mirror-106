import{c as h}from"./common/_commonjsHelpers-4f955397.js";var m=h(function(S,r){Object.defineProperty(r,"__esModule",{value:!0}),r.checkErrors=t=>{const e=!!t.find(s=>s.parent),n=t.filter(s=>s.sticky&&!s.parent).map(({Header:s})=>`'${s}'`);if(e&&n.length)throw new Error(`WARNING react-table-sticky:
