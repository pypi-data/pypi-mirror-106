...
f31=Font(os.path.join(DIR,'Werner20-Regular.ttf'),True,False,True,list(' %,./()[]:;'),1.1)
f32=Font(os.path.join(DIR,'Werner21-Regular.ttf'),True,False,True,list(' %,./()[]:;'),1.1)
f=[f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f13,f14,f15,f16,f17,f18,f19,f20,f21,f22,f23,f25,f27,f28,f29,f30,f31,f32]