...
def interakce_findajob_dwp_gov_uk():
    ...
    # TODO CO DELAT V PRIPADE TIMEOUTU WEBSTRANKY?
    # CO DELAT PRI ZTRATE PRIPOJENI K WEBU?
    ...
    #adresa_pro_hledani = 'https://findajob.dwp.gov.uk/search?cti=full_time&cty=permanent&loc=86384&pp=50&sf=30000&page=1'

    #adresa_pro_hledani = 'https://findajob.dwp.gov.uk/search?cti=full_time&cty=permanent&loc=86384&pp=50&sf=30000&st=100000&page=2'
    
    #adresa_pro_hledani = 'https://findajob.dwp.gov.uk/search?cti=full_time&cty=permanent&loc=86384&pp=50&sf=30000&page=2'
    
    
    #adresa_pro_hledani = 'https://findajob.dwp.gov.uk/search?cat=15&cti=full_time&cty=permanent&loc=86384&pp=50&sf=20000'
    ...
    def posli_zadost_o_zamestnani(url):
        ...
        # TODO zde jsme meli timeout hlasku, na webu chybelo tlacitko
        ...
        prvek = prohlizec.find_element(By.CSS_SELECTOR,
        'tr.govuk-table__row:nth-child(6) > td:nth-child(2)')
        ...
        if len(vysledek_z_db) > 0:
            ...
            print(f'Zadost uz byla poslana {len(vysledek_z_db)}x:')
        ...
        if len(vysledek_z_db) == 0:
            ...
            # TODO sem dat try-except pro pripad ze se nepodari otevrit url
            # v tom pripade spustit dalsi vlakno
