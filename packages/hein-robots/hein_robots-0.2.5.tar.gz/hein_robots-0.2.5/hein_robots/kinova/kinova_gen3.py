...
class KinovaGen3Arm(robot_arms.RobotArm):
    ...
    def __init__(self, host: str = '192.168.1.10', port: int = 10000, username: str = 'admin', password: str = 'admin', connect: bool = True,
                 default_velocity: float = 250, max_velocity: float = 500, default_joint_velocity: float = 5.0, position_units: str = Units.MILLIMETERS):
    ...
    def move_joints(self, joint_positions: List[float],
        ...
        action.reach_joint_angles.constraint.value = self.default_joint_velocity if velocity is None else velocity
