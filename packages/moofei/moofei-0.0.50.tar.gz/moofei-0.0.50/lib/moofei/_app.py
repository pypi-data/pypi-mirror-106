...
def static_file(path="", is_static=True, as_attachment=True): 
    ...
    if is_static:
        ...
        if not as_attachment and os.path.isfile(path):
...
def finds(interval, name='.', words="", fcase=1, ftype=None, wcase=0, plugin_box=None, plugin_fix=None, show_only_file=0, basedir="", isdeep=None, fsize=None, istry=0, more_break=1, mass_words="", **awgs):   
    ...
    dawgs = dict(
                    ...
                    fcase = fcase, ftype=(name in ('.','') and 2) or ftype or None,
                    wcase = wcase,
