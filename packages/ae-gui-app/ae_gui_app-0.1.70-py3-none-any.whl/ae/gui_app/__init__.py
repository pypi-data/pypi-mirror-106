...
from ae.base import (                                                                                   # type: ignore
    ...
    duplicates, instantiate_config_parser, now_str, os_platform, snake_to_camel)
...
class MainAppBase(ConsoleApp, ABC):
    ...
    def popups_opened(self, classes: Tuple = ()) -> List:
        ...
        :param classes:         optional class filter - if not passed then only the widgets underneath win/root with an
                                `open` method will be added. Pass tuple for to restrict found popup widgets to certain
...
# bind imported but unused names, to be available in :meth:`MainAppBase.global_variables`
_d_ = (get_f_string, get_text, os_platform, path_name, placeholder_path)
