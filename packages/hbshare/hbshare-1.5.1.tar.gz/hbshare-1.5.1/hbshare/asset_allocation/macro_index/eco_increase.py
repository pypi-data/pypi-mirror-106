...
class EconomyIncrease:
    ...
    def get_eco_increase_data(self):
        """
        经济增长类数据：GDP、制造业PMI、发电量：当月同比、消费者信心指数、70个大中城市新建商品住宅价格指数:环比
        """
        index_list = ['M0039354', 'M0017126', 'S0027013', 'M0012303', 'S2707412']
        name_dict = {'M0039354': 'GDP', 'M0017126': 'PMI', 'S0027013': 'generating_cap_yoy',
...
if __name__ == '__main__':
    EconomyIncrease('2005-01-01', '2021-04-23', is_increment=0).get_construct_result()