...
class OsmOrderAssign:
    ...
    def get_searchid_from_id(self, id):
        ...
        if id == '1':
            searchid = sw.get_hfch_assign_searchid_type1()
        elif id == '11':
            searchid = sw.get_hfch_assign_searchid_type11()
        elif id == '12':
            searchid = sw.get_hfch_assign_searchid_type12()
        elif id == '2':
            searchid = sw.get_hfch_assign_searchid_type2()
        else:
