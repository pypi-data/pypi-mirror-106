...
class OsmSearchid:
    ...
    def get_hfch_assign_searchid_type1(self):
        advanced_search = {
    ...
    def get_hfch_assign_searchid_type11(self):
        advanced_search = {
                "0": {"search_field_name": "Task.status", "search_field_id": "584", "search_field_type": "19",
                   "search_field_rel_obj": "Enums", "search_opr": "TDD_OPER_EQUAL", "input1": "待录入需求", "input2": "null",
                   "offset": "null"},
    ...
    def get_hfch_assign_searchid_type12(self):
        advanced_search = {
                "0": {"search_field_name": "Task.status", "search_field_id": "584", "search_field_type": "19",
                   "search_field_rel_obj": "Enums", "search_opr": "TDD_OPER_EQUAL", "input1": "待录入需求", "input2": "null",
                   "offset": "null"},
    ...
    def get_hfch_assign_searchid_type2(self):
        advanced_search = {
            "0": {"search_field_name": "Task.status", "search_field_id": "584", "search_field_type": "19",
                 "search_field_rel_obj": "Enums", "search_opr": "TDD_OPER_EQUAL", "input1": "待录入需求", "input2": "null",
                 "offset": "null"},
