...
class Maximum:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.tsMask.acsiso.maximum.read() \n
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.tsMask.acsiso.maximum.fetch() \n
		No command help available \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.tsMask.acsiso.maximum.calculate() \n
		No command help available \n
