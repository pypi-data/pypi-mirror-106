...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '3.1.0-alpha.1621612404+966c7022'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 3.1.0-alpha.1621612404+966c7022`
                """)
            else:
                raise
