...
class ImageScanCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.77/reference/services/ecr.html#ECR.Waiter.ImageScanCompleteWaiter)
...
class LifecyclePolicyPreviewCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.77/reference/services/ecr.html#ECR.Waiter.LifecyclePolicyPreviewCompleteWaiter)
