...
class ClusterRunningWaiter(Boto3Waiter):
    ...
    def wait(self, ClusterId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/emr.html#EMR.Waiter.ClusterRunningWaiter)
...
class ClusterTerminatedWaiter(Boto3Waiter):
    ...
    def wait(self, ClusterId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/emr.html#EMR.Waiter.ClusterTerminatedWaiter)
...
class StepCompleteWaiter(Boto3Waiter):
    ...
    def wait(self, ClusterId: str, StepId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/emr.html#EMR.Waiter.StepCompleteWaiter)
