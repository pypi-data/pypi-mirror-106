...
class connect_Flow(connect_Base):
    ...
    def processSetup(self):
        ...
        try:
            ...
            exStr = connect_flow_FlowExecutor.getExceptionMessage(ex)
            self.logger.writeException(exStr)
    ...
    def getFormattedRequest(self,request,lastRequest,fmt):
        if (request != lastRequest):
            if (self.logger.getLevel() == connect_logger_Logger.LEVEL_DEBUG):
                ...
                requestStr = (connect_util_Util.beautifyObject(diff,self.logger.isCompact(),False,self.logger.isBeautified()) if ((diff is not None)) else request)
...
class connect_models_TierConfigRequest(connect_models_IdModel):
    ...
    _hx_methods = ["register", "update", "prepareUpdateBody", "approveByTemplate", "fail", "inquire", "pend", "assign", "unassign", "getParamById"]
