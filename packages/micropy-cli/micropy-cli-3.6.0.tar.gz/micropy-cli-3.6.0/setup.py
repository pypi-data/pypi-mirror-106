...
['micropy',
 ...
 'micropy.lib.stubber.data',
 'micropy.lib.stubber.minified',
 'micropy.lib.stubber.src',
 'micropy.lib.stubber.tests',
 'micropy.lib.stubber.tests.board',
 'micropy.lib.stubber.tests.checkout_repo',
 'micropy.lib.stubber.tests.common',
 'micropy.lib.stubber.tests.mocks.micropython-cpython_core',
 'micropy.lib.stubber.tests.mocks.pycopy-cpython_core',
 'micropy.lib.stubber.tests.stubber',
 'micropy.packages',
 'micropy.project',
...
{'': ['*'],
 ...
 'micropy.lib.stubber': ['.githooks/*',
                         ...
                         'scripts/*',
                         'tools/*'],
 'micropy.lib.stubber.data': ['ignore/*', 'pycom_ignore/*'],
...
{':sys_platform == "win32"': ['colorama>=0.4.3,<0.5.0'],
 'create_stubs': ['rshell>=0.0.30,<0.0.31', 'pyminifier>=2.1,<3.0'],
 'docs': ['sphinx>=2.2,<3.0',
