...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '3.1.0-alpha.1621595247+f73d8242'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 3.1.0-alpha.1621595247+f73d8242`
                """)
            else:
                raise
