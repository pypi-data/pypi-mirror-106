...
class DeltaStorage:
    ...
    def create_table(self, table_definition: TableDefinition, options: dict = None):
        ...
        self.__overwrite_tblproperties(table_definition)
    ...
    def __overwrite_tblproperties(self, table_definition: TableDefinition):
        properties = ','.join([f"'{k}'='{v}'" for k, v in table_definition.tbl_properties.items()])
