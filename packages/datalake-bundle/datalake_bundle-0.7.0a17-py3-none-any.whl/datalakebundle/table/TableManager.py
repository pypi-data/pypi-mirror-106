...
class TableManager:
    ...
    def get_definition(self, table_schema: TableSchema) -> TableDefinition:
        return self.__table_definition_factory.create_from_table_schema(table_schema)

    def create(self, table_schema: TableSchema):
        table_definition = self.__table_definition_factory.create_from_table_schema(table_schema)

        self.__table_creator.create(table_definition)

    def create_if_not_exists(self, table_schema: TableSchema):
        table_definition = self.__table_definition_factory.create_from_table_schema(table_schema)
