        ...
        if (3 == sys.version_info.major) and (6 == sys.version_info.minor):
            if not self.ICP and not self.WSD:
                print("DEPRECATED!! Python 3.6 framework is deprecated and will be removed on Apr 8th, 2021. "
                      ...
                      "Switch to using new client https://pypi.org/project/ibm-watson-machine-learning with python 3.7")
            elif self.ICP:
                print("DEPRECATED!! The Python 3.6 framework is deprecated and will be removed from a future release. "
                      ...
                      "For details, see [Supported frameworks[(https://www.ibm.com/docs/en/cloud-paks/cp-data/3.0.1?topic=models-supported-frameworks) for updating models, and [Changing environments[(https://www.ibm.com/docs/en/cloud-paks/cp-data/3.0.1?topic=environments-changing) for updating notebooks.")
