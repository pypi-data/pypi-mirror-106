...
class Experiments(WMLResource):
    ...
    def list(self, limit=None):
        ...
        experiment_values = [(m[u'metadata'][u'guid'], m[u'entity'][u'name'], m[u'metadata'][u'created_at']) for m in
    ...
    def get_revision_details(self, experiment_uid, rev_uid):
        ...
        **Parameters**
        ...
        .. important::
            #. **experiment_uid**: Stored experiment UID (optional).\n
               **type**: str\n

            #. **rev_id**: rev_id number of experiment.\n
               **type**: int\n
    ...
    def list_revisions(self, experiment_uid, limit=None):
        ...
        **Parameters**
        ...
        .. important::
            #. **experiment_uid**: Unique id of stored experiment.\n
               **type**: str\n
