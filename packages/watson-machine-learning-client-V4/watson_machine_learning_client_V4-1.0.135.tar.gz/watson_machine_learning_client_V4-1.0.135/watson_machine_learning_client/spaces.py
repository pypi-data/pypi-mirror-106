...
#####CREATE MEMBER
    ...
    def exports(self, space_uid, meta_props):
        ...
        if self._client.ICP and (self._client.wml_credentials.get('version', '') == '2.5'
                                 or self._client.wml_credentials.get('version', '').startswith('2.5.')):
            raise WMLClientError('Note: Space exports are unsupported on CPD 2.5.')
