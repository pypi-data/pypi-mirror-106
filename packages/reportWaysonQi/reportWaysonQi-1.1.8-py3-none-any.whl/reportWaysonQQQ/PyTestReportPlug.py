...
from reportWaysonQi.api import make_report
...
def pytest_addoption(parser):
    ...
    group.addoption('--pytest_desc', action='store', dest='pytest_desc', metavar='path', default="Tester:GLR Wayson Qi \nThe current test stage is Sprint2 \nThis is the GUI automation test for the GLR project",
