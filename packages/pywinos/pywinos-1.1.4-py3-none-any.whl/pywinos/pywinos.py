...
class WinOSClient:
    ...
    def clean_directory(self, path: str, ignore_errors: bool = False):
        ...
        for the_file in os.listdir(path):
            ...
            self.remove(file_path, ignore_errors=ignore_errors)
        return True

    @staticmethod
    def remove(path: str, ignore_errors: bool = False) -> bool:
        """Remove file or directory recursively

        :param path: Full file\\directory path
        :param ignore_errors: If ignore_errors is set, errors are ignored. Used for directory only
        """
