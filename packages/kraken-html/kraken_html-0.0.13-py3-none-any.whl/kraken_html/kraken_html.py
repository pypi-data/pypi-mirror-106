...
from kraken_html.html_bootstrap import Html_bootstrap as HTML
...
class Kraken_html:
    ...
    def __init__(self, organization = '', title = None, description = '', nav = '', footer_nav = '', logo = ''):
        ...
        self.html = HTML(self.title, self.description, self.nav, self.footer_nav, self.logo)
    ...
    def get_record_page(self, record_type, record_id, breadcrumbs = ''):
        ...
        record = self.get_db_record(record_type, record_id)
