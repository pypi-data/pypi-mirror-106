...
from mldock.api.local import \
    _copy_boilerplate_to_dst, docker_build, \
        _rename_file, search_mldock_containers
...
def stop():
    ...
    try:
        ...
        container_tag = click.prompt(
            text=style_dropdown(group_name="container name", options=tags.copy(), default='abort'),
            type=ChoiceWithNumbers(tags.copy(), case_sensitive=False),
            show_default=False,
            default='abort',
            show_choices=False
        )
