...
instrument_id = 'SR105'
begin_trading_date = datetime.datetime(2020, 5, 1)
end_trading_date = datetime.datetime(2020, 5, 10)
interval = 1
bar_type = EnumBarType.minute
qi_data_controller = QiDataController(qi_data_directory)
bar_series = qi_data_controller.load_bar_series_by_date(EnumMarket.期货, instrument_id, 1, bar_type, begin_trading_date, end_trading_date)
