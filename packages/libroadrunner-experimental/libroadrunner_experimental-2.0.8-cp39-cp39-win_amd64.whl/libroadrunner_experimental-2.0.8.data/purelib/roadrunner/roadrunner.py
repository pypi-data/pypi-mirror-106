...
class StringVector(object):
    ...
    def __init__(self, *args):
        _roadrunner.StringVector_swiginit(self, _roadrunner.new_StringVector(*args))
...
# Register StringVector in _roadrunner:
_roadrunner.StringVector_swigregister(StringVector)
...
class StringList(object):
    ...
    def __init__(self, *args):
        _roadrunner.StringList_swiginit(self, _roadrunner.new_StringList(*args))
...
# Register StringList in _roadrunner:
_roadrunner.StringList_swigregister(StringList)
...
class ExecutableModel(object):
    ...
    def getExecutableModelDesc(self) -> "std::string":
        ...
        Author: JKM
        07/31/2015
        Returns a human-readable description of the code generation backend,
...
def getVersionStr(*args) -> "std::string":
    r"""
...
class Logger(object):
    ...
    @staticmethod
    def enableConsoleLogging(*args) -> "void":
        r"""
    ...
    @staticmethod
    def enableFileLogging(*args) -> "void":
        r"""
...
def Logger_enableConsoleLogging(*args) -> "void":
    r"""
...
def Logger_enableFileLogging(*args) -> "void":
    r"""
...
class RoadRunner(object):
    ...
    def makeIntegrator(self, name: "std::string") -> "rr::Integrator *":
    ...
    def saveState(self, *args) -> "void":
        return _roadrunner.RoadRunner_saveState(self, *args)

    def loadState(self, filename: "std::string") -> "void":
    ...
    def _setSelections(self, selections: "StringVector") -> "void":
    ...
    def getFullEigenValues(self) -> "std::vector< ls::Complex,std::allocator< ls::Complex > >":
        r"""
    ...
    def getReducedEigenValues(self) -> "std::vector< ls::Complex,std::allocator< ls::Complex > >":
        r"""
    ...
    def addSpeciesConcentration(self, *args) -> "void":
        r"""
        ...
        """
        return _roadrunner.RoadRunner_addSpeciesConcentration(self, *args)

    def addSpeciesAmount(self, *args) -> "void":
        r"""
        ...
        :param forceRegenerate:: a boolean value to indicate if the model is regenerated
                                    ...
                                    of editing function
            					       ...
            					       set this flag to true only in the last call of editing
        """
        return _roadrunner.RoadRunner_addSpeciesAmount(self, *args)
    ...
    def _addReaction(self, rid: "std::string const &", reactants: "StringVector", products: "StringVector", kineticLaw: "std::string const &", forceRegenerate: "bool"=True) -> "void":
        return _roadrunner.RoadRunner__addReaction(self, rid, reactants, products, kineticLaw, forceRegenerate)

    def addReaction(self, rid: "std::string const &", reactants: "StringVector", products: "StringVector", kineticLaw: "std::string const &", forceRegenerate: "bool"=True) -> "void":
    ...
    def addParameter(self, pid: "std::string const &", value: "double", forceRegenerate: "bool"=True) -> "void":
        r"""
        Add a parameter to the current model
        :type pid: string
        :param pid:: the ID of the parameter to be added
    ...
    def addCompartment(self, cid: "std::string const &", initVolume: "double", forceRegenerate: "bool"=True) -> "void":
        r"""
        Add a compartment to the current model
        :type cid: string
        :param cid:: the ID of the compartment to be added
    ...
    def _setSteadyStateSelections(self, steadyStateSelections: "StringVector") -> "void":
        r"""
...
def RoadRunner_ensureSolversRegistered() -> "void":
    r"""Ensures all integrators and steady state solvers are registered"""
    return _roadrunner.RoadRunner_ensureSolversRegistered()
...
class SteadyStateSolverRegistrar(object):
    r"""
    Author: JKM, WBC
    ...
    def construct(self, model: "ExecutableModel") -> "rr::SteadyStateSolver *":
        r"""
        Author: JKM, WBC
...
# Register SteadyStateSolverRegistrar in _roadrunner:
_roadrunner.SteadyStateSolverRegistrar_swigregister(SteadyStateSolverRegistrar)

class SteadyStateSolverFactory(object):
    r"""
    Author: JKM, WBC
    ...
    and returns a base pointer to 'rr::SteadyStateSolver'.
    """
    ...
    def New(self, name: "std::string const &", m: "ExecutableModel") -> "rr::SteadyStateSolver *":
        r"""
        Author: JKM, WBC
        Constructs a new solver given the name
        (e.g. cvode, gillespie)
        """
        return _roadrunner.SteadyStateSolverFactory_New(self, name, m)

    def registerSteadyStateSolver(self, i: "SteadyStateSolverRegistrar") -> "void":
        r"""
        Author: JKM, WBC
        Registers a new solver with the factory
    ...
    @staticmethod
    def getInstance() -> "rr::SteadyStateSolverFactory &":
        r"""
        Author: JKM, WBC
    ...
    def getNumSteadyStateSolvers(self) -> "std::size_t":
        return _roadrunner.SteadyStateSolverFactory_getNumSteadyStateSolvers(self)

    def getListSteadyStateSolverNames(self) -> "std::vector< std::string,std::allocator< std::string > >":
        return _roadrunner.SteadyStateSolverFactory_getListSteadyStateSolverNames(self)

    def getSteadyStateSolverName(self, n: "std::size_t") -> "std::string":
        return _roadrunner.SteadyStateSolverFactory_getSteadyStateSolverName(self, n)

    def getSteadyStateSolverHint(self, n: "std::size_t") -> "std::string":
        return _roadrunner.SteadyStateSolverFactory_getSteadyStateSolverHint(self, n)

    def getSteadyStateSolverDescription(self, n: "std::size_t") -> "std::string":
        return _roadrunner.SteadyStateSolverFactory_getSteadyStateSolverDescription(self, n)

# Register SteadyStateSolverFactory in _roadrunner:
_roadrunner.SteadyStateSolverFactory_swigregister(SteadyStateSolverFactory)

def SteadyStateSolverFactory_getInstance() -> "rr::SteadyStateSolverFactory &":
    r"""
    Author: JKM, WBC
    Returns the singleton instance of the solver factory
    """
...
def fixMissingStoich(sbml: "std::string const") -> "std::string":
    r"""
    Author: JKM
    Adds missing stoichiometry information.
...
class NewtonIteration(KinsolSteadyStateSolver):
    ...
    @staticmethod
    def getNewtonIterationName() -> "std::string":
        r"""static version of getName"""
        return _roadrunner.NewtonIteration_getNewtonIterationName()

    @staticmethod
    def getNewtonIterationDescription() -> "std::string":
        r"""static version of getDescription"""
        return _roadrunner.NewtonIteration_getNewtonIterationDescription()

    @staticmethod
    def getNewtonIterationHint() -> "std::string":
        r"""static version of getHint"""
        return _roadrunner.NewtonIteration_getNewtonIterationHint()
...
def NewtonIteration_getNewtonIterationName() -> "std::string":
    r"""static version of getName"""
    return _roadrunner.NewtonIteration_getNewtonIterationName()

def NewtonIteration_getNewtonIterationDescription() -> "std::string":
    r"""static version of getDescription"""
    return _roadrunner.NewtonIteration_getNewtonIterationDescription()

def NewtonIteration_getNewtonIterationHint() -> "std::string":
    r"""static version of getHint"""
    return _roadrunner.NewtonIteration_getNewtonIterationHint()
...
class BasicNewtonIteration(NewtonIteration):
    ...
    @staticmethod
    def getBasicNewtonIterationName() -> "std::string":
        r"""static version of getName"""
        return _roadrunner.BasicNewtonIteration_getBasicNewtonIterationName()

    @staticmethod
    def getBasicNewtonIterationDescription() -> "std::string":
        r"""static version of getDescription"""
        return _roadrunner.BasicNewtonIteration_getBasicNewtonIterationDescription()

    @staticmethod
    def getBasicNewtonIterationHint() -> "std::string":
        r"""static version of getHint"""
        return _roadrunner.BasicNewtonIteration_getBasicNewtonIterationHint()
...
def BasicNewtonIteration_getBasicNewtonIterationName() -> "std::string":
    r"""static version of getName"""
    return _roadrunner.BasicNewtonIteration_getBasicNewtonIterationName()

def BasicNewtonIteration_getBasicNewtonIterationDescription() -> "std::string":
    r"""static version of getDescription"""
    return _roadrunner.BasicNewtonIteration_getBasicNewtonIterationDescription()

def BasicNewtonIteration_getBasicNewtonIterationHint() -> "std::string":
    r"""static version of getHint"""
    return _roadrunner.BasicNewtonIteration_getBasicNewtonIterationHint()

class BasicNewtonIterationRegistrar(SteadyStateSolverRegistrar):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def getName(self) -> "std::string":
        r"""Gets the name associated with this integrator type"""
        return _roadrunner.BasicNewtonIterationRegistrar_getName(self)

    def getDescription(self) -> "std::string":
        r"""Gets the description associated with this integrator type"""
        return _roadrunner.BasicNewtonIterationRegistrar_getDescription(self)

    def getHint(self) -> "std::string":
        r"""Gets the hint associated with this integrator type"""
        return _roadrunner.BasicNewtonIterationRegistrar_getHint(self)

    def construct(self, model: "ExecutableModel") -> "rr::SteadyStateSolver *":
        r"""Constructs a new integrator of a given type"""
        return _roadrunner.BasicNewtonIterationRegistrar_construct(self, model)

    def __init__(self):
        _roadrunner.BasicNewtonIterationRegistrar_swiginit(self, _roadrunner.new_BasicNewtonIterationRegistrar())
    __swig_destroy__ = _roadrunner.delete_BasicNewtonIterationRegistrar

# Register BasicNewtonIterationRegistrar in _roadrunner:
_roadrunner.BasicNewtonIterationRegistrar_swigregister(BasicNewtonIterationRegistrar)
...
class LinesearchNewtonIteration(NewtonIteration):
    ...
    @staticmethod
    def getLinesearchNewtonIterationName() -> "std::string":
        r"""static version of getName"""
        return _roadrunner.LinesearchNewtonIteration_getLinesearchNewtonIterationName()

    @staticmethod
    def getLinesearchNewtonIterationDescription() -> "std::string":
        r"""static version of getDescription"""
        return _roadrunner.LinesearchNewtonIteration_getLinesearchNewtonIterationDescription()

    @staticmethod
    def getLinesearchNewtonIterationHint() -> "std::string":
        r"""static version of getHint"""
        return _roadrunner.LinesearchNewtonIteration_getLinesearchNewtonIterationHint()
...
def LinesearchNewtonIteration_getLinesearchNewtonIterationName() -> "std::string":
    r"""static version of getName"""
    return _roadrunner.LinesearchNewtonIteration_getLinesearchNewtonIterationName()

def LinesearchNewtonIteration_getLinesearchNewtonIterationDescription() -> "std::string":
    r"""static version of getDescription"""
    return _roadrunner.LinesearchNewtonIteration_getLinesearchNewtonIterationDescription()

def LinesearchNewtonIteration_getLinesearchNewtonIterationHint() -> "std::string":
    r"""static version of getHint"""
    return _roadrunner.LinesearchNewtonIteration_getLinesearchNewtonIterationHint()

class LinesearchNewtonIterationRegistrar(SteadyStateSolverRegistrar):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def getName(self) -> "std::string":
        r"""Gets the name associated with this integrator type"""
        return _roadrunner.LinesearchNewtonIterationRegistrar_getName(self)

    def getDescription(self) -> "std::string":
        r"""Gets the description associated with this integrator type"""
        return _roadrunner.LinesearchNewtonIterationRegistrar_getDescription(self)

    def getHint(self) -> "std::string":
        r"""Gets the hint associated with this integrator type"""
        return _roadrunner.LinesearchNewtonIterationRegistrar_getHint(self)

    def construct(self, model: "ExecutableModel") -> "rr::SteadyStateSolver *":
        r"""Constructs a new integrator of a given type"""
        return _roadrunner.LinesearchNewtonIterationRegistrar_construct(self, model)

    def __init__(self):
        _roadrunner.LinesearchNewtonIterationRegistrar_swiginit(self, _roadrunner.new_LinesearchNewtonIterationRegistrar())
    __swig_destroy__ = _roadrunner.delete_LinesearchNewtonIterationRegistrar

# Register LinesearchNewtonIterationRegistrar in _roadrunner:
_roadrunner.LinesearchNewtonIterationRegistrar_swigregister(LinesearchNewtonIterationRegistrar)
