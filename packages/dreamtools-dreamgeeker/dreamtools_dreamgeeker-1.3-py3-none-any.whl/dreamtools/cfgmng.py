...
class CFGEngine(object):
    ...
    @classmethod
    def working_directory(cls, sub_dir):
        CFGEngine.initial()
...
class CFGBases(CFGEngine):
    ...
    @classmethod
    def loadingbyref(cls, filename, *args, **kwargs):
        """
