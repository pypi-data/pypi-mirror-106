...
class EADSerialiser:
    ...
    def __init__(self):
        xslt_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                 'management', 'commands', 'html-to-ead.xsl')
        self._transform_to_ead = etree.XSLT(etree.parse(xslt_path))

    def _append_xml(self, parent, xml, from_html=True):
        if xml:
            root = etree.fromstring('<wrapper>{}</wrapper>'.format(xml))
            if from_html:
                root = self._transform_to_ead(root).getroot()
    ...
    def _serialise_abstract(self, abstract_obj, did):
        ...
        self._append_xml(abstract, abstract_obj.abstract)
    ...
    def _serialise_accessrestrict(self, accessrestrict_obj, archdesc):
        ...
        self._append_xml(accessrestrict, accessrestrict_obj.accessrestrict)
    ...
    def _serialise_accruals(self, accruals_obj, archdesc):
        ...
        self._append_xml(accruals, accruals_obj.accruals)
    ...
    def _serialise_acqinfo(self, acqinfo_obj, archdesc):
        ...
        self._append_xml(acqinfo, acqinfo_obj.acqinfo)
    ...
    def _serialise_addressline(self, addressline_obj, address):
        ...
        self._append_xml(addressline, addressline_obj.addressline)
    ...
    def _serialise_altformavail(self, altformavail_obj, archdesc):
        ...
        self._append_xml(altformavail, altformavail_obj.altformavail)
    ...
    def _serialise_appraisal(self, appraisal_obj, archdesc):
        ...
        self._append_xml(appraisal, appraisal_obj.appraisal)
    ...
    def _serialise_arrangement(self, arrangement_obj, archdesc):
        ...
        self._append_xml(arrangement, arrangement_obj.arrangement)
    ...
    def _serialise_author(self, author_obj, titlestmt):
        ...
        self._append_xml(author, author_obj.author)
    ...
    def _serialise_bibliography(self, bibliography_obj, archdesc):
        ...
        self._append_xml(bibliography, bibliography_obj.bibliography)
    ...
    def _serialise_bioghist(self, bioghist_obj, archdesc):
        ...
        self._append_xml(bioghist, bioghist_obj.bioghist)
    ...
    def _serialise_citation(self, parent_obj, parent):
        ...
        self._append_xml(citation, parent_obj.citation)
    ...
    def _serialise_container(self, container_obj, did):
        ...
        self._append_xml(container, container_obj.container)
    ...
    def _serialise_controlaccess(self, controlaccess_obj, archdesc):
        ...
        self._append_xml(controlaccess, controlaccess_obj.controlaccess)
    ...
    def _serialise_controlnote(self, controlnote_obj, notestmt):
        ...
        self._append_xml(controlnote, controlnote_obj.controlnote)
    ...
    def _serialise_custodhist(self, custodhist_obj, archdesc):
        ...
        self._append_xml(custodhist, custodhist_obj.custodhist)
    ...
    def _serialise_datesingle(self, datesingle_obj, parent, prefix=''):
        ...
        self._append_xml(datesingle, datesingle_obj.datesingle)
    ...
    def _serialise_descriptivenote(self, obj, parent, prefix=''):
        ...
        self._append_xml(descriptivenote, content)
    ...
    def _serialise_didnote(self, didnote_obj, did):
        ...
        self._append_xml(didnote, didnote_obj.didnote)
    ...
    def _serialise_dimensions(self, dimensions_obj, pds):
        ...
        self._append_xml(dimensions, dimensions_obj.dimensions)
    ...
    def _serialise_editionstmt(self, ead_obj, filedesc):
        ...
        serialise_attrs(ead_obj, EDITIONSTMT_ATTRS, editionstmt,
                        'editionstmt_')
        self._append_xml(editionstmt, ead_obj.editionstmt)
    ...
    def _serialise_fileplan(self, fileplan_obj, archdesc):
        ...
        self._append_xml(fileplan, fileplan_obj.fileplan)
    ...
    def _serialise_fromtodate(self, daterange_obj, daterange, element_name):
        ...
        self._append_xml(date, getattr(daterange_obj, element_name))
    ...
    def _serialise_geogname(self, relation_obj, relation):
        ...
        self._append_xml(geogname, relation_obj.geogname)
    ...
    def _serialise_index(self, index_obj, archdesc):
        ...
        self._append_xml(index, index_obj.index)
    ...
    def _serialise_legalstatus(self, legalstatus_obj, archdesc):
        ...
        self._append_xml(legalstatus, legalstatus_obj.legalstatus)
    ...
    def _serialise_materialspec(self, materialspec_obj, did):
        ...
        self._append_xml(materialspec, materialspec_obj.materialspec)
    ...
    def _serialise_originalsloc(self, originalsloc_obj, archdesc):
        ...
        self._append_xml(originalsloc, originalsloc_obj.originalsloc)
    ...
    def _serialise_otherfindaid(self, otherfindaid_obj, archdesc):
        ...
        self._append_xml(otherfindaid, otherfindaid_obj.otherfindaid)
    ...
    def _serialise_part(self, part_obj, name):
        ...
        self._append_xml(part, part_obj.part)
    ...
    def _serialise_physdesc(self, physdesc_obj, did):
        ...
        self._append_xml(physdesc, physdesc_obj.physdesc)
    ...
    def _serialise_physfacet(self, physfacet_obj, physdescstructured):
        ...
        self._append_xml(physfacet, physfacet_obj.physfacet)
    ...
    def _serialise_physloc(self, physloc_obj, did):
        ...
        self._append_xml(physloc, physloc_obj.physloc)
    ...
    def _serialise_phystech(self, phystech_obj, archdesc):
        ...
        self._append_xml(phystech, phystech_obj.phystech)
    ...
    def _serialise_prefercite(self, prefercite_obj, archdesc):
        ...
        self._append_xml(prefercite, prefercite_obj.prefercite)
    ...
    def _serialise_processinfo(self, processinfo_obj, archdesc):
        ...
        self._append_xml(processinfo, processinfo_obj.processinfo)
    ...
    def _serialise_publicationstmt(self, ead_obj, filedesc):
        ...
        serialise_attrs(ead_obj, PUBLICATIONSTMT_ATTRS, publicationstmt,
                        'publicationstmt_')
        self._append_xml(publicationstmt, ead_obj.publicationstmt)
    ...
    def _serialise_relatedmaterial(self, relatedmaterial_obj, archdesc):
        ...
        self._append_xml(relatedmaterial, relatedmaterial_obj.relatedmaterial)
    ...
    def _serialise_scopecontent(self, scopecontent_obj, parent):
        ...
        self._append_xml(scopecontent, scopecontent_obj.scopecontent)
    ...
    def _serialise_separatedmaterial(self, sm_obj, archdesc):
        ...
        self._append_xml(sm, sm_obj.separatedmaterial)
    ...
    def _serialise_seriesstmt(self, ead_obj, filedesc):
        ...
        self._append_xml(seriesstmt, ead_obj.seriesstmt)
    ...
    def _serialise_sponsor(self, sponsor_obj, titlestmt):
        ...
        self._append_xml(sponsor, sponsor_obj.sponsor)
    ...
    def _serialise_subtitle(self, subtitle_obj, titlestmt):
        ...
        self._append_xml(subtitle, subtitle_obj.subtitle)
    ...
    def _serialise_titleproper(self, titleproper_obj, parent):
        ...
        self._append_xml(titleproper, titleproper_obj.titleproper)
    ...
    def _serialise_unitdate(self, unitdate_obj, did):
        ...
        self._append_xml(unitdate, unitdate_obj.unitdate)
    ...
    def _serialise_unitid(self, unitid_obj, did):
        ...
        self._append_xml(unitid, unitid_obj.unitid)
    ...
    def _serialise_unittitle(self, unittitle_obj, did):
        ...
        self._append_xml(unittitle, unittitle_obj.unittitle)
    ...
    def _serialise_userestrict(self, userestrict_obj, archdesc):
        ...
        self._append_xml(userestrict, userestrict_obj.userestrict)
