...
if __name__ == '__main__':
    ...
    stock_board_industry_cons_ths_df = stock_board_industry_cons_ths(symbol="半导体及元件")
    print(stock_board_industry_cons_ths_df)

    stock_board_industry_info_ths_df = stock_board_industry_info_ths(symbol="半导体及元件")
