...
class RsCmwBluetoothSig:
	...
	_driver_options = "SupportedInstrModels = CMW500/CMW100/CMW270/CMW280/CMP, SupportedIdnPatterns = CMW, SimulationIdnString = 'Rohde&Schwarz,CMW500,100001,3.8.20.0026'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '3.8.20.0026'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '3.8.20.0026'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCmwBluetoothSig version failed. Current version: '3.8.20.0026', minimum required version: '{min_version}'")
