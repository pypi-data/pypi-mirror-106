...
class ListSigningJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.77/reference/services/signer.html#Signer.Paginator.ListSigningJobs.paginate)
...
class ListSigningPlatformsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.77/reference/services/signer.html#Signer.Paginator.ListSigningPlatforms.paginate)
...
class ListSigningProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.77/reference/services/signer.html#Signer.Paginator.ListSigningProfiles.paginate)
