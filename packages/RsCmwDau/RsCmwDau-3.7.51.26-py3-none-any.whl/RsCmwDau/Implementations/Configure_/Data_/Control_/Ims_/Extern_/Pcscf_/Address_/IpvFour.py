...
class IpvFour:
	...
	def set(self, ip_v_4_address: str, ims=repcap.Ims.Default) -> None:
		"""SCPI: CONFigure:DATA:CONTrol:IMS<Suffix>:EXTern:PCSCf:ADDRess:IPVFour \n
		Snippet: driver.configure.data.control.ims.extern.pcscf.address.ipvFour.set(ip_v_4_address = '1', ims = repcap.Ims.Default) \n
