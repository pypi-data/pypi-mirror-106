...
- className (string; optional):
    ...
    class \"mpc-bib-card\" is always added to the top-level element by
    default.
...
- fetchOpenAccessUrl (boolean; optional):
    ...
    reference (using the doi prop) (default: False).
...
- year (optional):
    ...
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, title=Component.UNDEFINED, author=Component.UNDEFINED, year=Component.UNDEFINED, journal=Component.UNDEFINED, doi=Component.UNDEFINED, fetchOpenAccessUrl=Component.UNDEFINED, openAccessUrl=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'author', 'className', 'doi', 'fetchOpenAccessUrl', 'journal', 'openAccessUrl', 'title', 'year']
        self._type = 'BibCard'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'author', 'className', 'doi', 'fetchOpenAccessUrl', 'journal', 'openAccessUrl', 'title', 'year']
