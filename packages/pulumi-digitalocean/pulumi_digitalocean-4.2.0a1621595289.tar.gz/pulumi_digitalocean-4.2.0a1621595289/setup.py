...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.2.0-alpha.1621595289+2e8a9f2b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.2.0-alpha.1621595289+2e8a9f2b`
                """)
            else:
                raise
