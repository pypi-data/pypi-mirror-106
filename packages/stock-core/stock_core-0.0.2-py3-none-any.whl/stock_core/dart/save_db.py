...
class Pipeline:
    ...
    def to_sqlite(self):
        ...
        print(f"Save dart to {self.data['code']}.db on {os.path.basename(sqlite_path)} ...")
        with engine.connect() as conn:
            ...
            try:
                ...
                logger.info(f"stock_code : {self.data['stock_code']}, "
                ...
                logger.info(f"stock_code : {self.data['stock_code']}, rcept_no : {self.data['rcept_no']} - saved already.")
