...
A python package for easily converting between python and decimal. Mostly a test of packaging. This is an early project so there may be bugs.
 ...
 | 0.5.5 - Many bug fixes and minor changes
 | 0.6.0 - Many new features and conversions
 | 0.6.1 - Fixes to docs, new examples, bug fixes and small improvements.
 | 0.6.3 - Minor morse changes and bug fixes.
"""
setup(
  ...
  keywords = ['Decimal', 'Binary', 'ascii', 'morse', 'temperature', 'Convert', 'conversion', 'easy'],   # Keywords that define your package best
  install_requires=[],
  classifiers=[
