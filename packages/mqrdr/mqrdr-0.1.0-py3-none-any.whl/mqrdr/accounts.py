...
def list_accounts(token, page=1, page_size=10, impersonated_id=None):
    ''' List accounts
...
def search_accounts(token, data, page=1, page_size=10, impersonated_id=None):
    ''' Search accounts
...
def view_account_details(token, account_id):
