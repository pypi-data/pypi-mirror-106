...
class MassMemory:
	...
	def delete(self, filename: str) -> None:
		...
		Deletes the specified files. \n
			:param filename: String parameter specifying the file to be deleted. The wildcards * and ? are allowed. Specifying a directory instead of a file is not allowed.
		"""
