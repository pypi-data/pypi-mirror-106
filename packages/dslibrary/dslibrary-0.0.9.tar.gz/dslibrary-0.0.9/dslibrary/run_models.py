...
class ModelRunner(object):
    ...
    """
    def __init__(self, uri: str=None, user: str=None, run_id: str=None, project_root: str=None, entry_point: str = "main", mlflow: (bool, dict)=None):
        """
        ...
        if "dsl" in sig.parameters or "dslibrary" in sig.parameters:
            ...
            try:
                ...
                for k, v in orig_env.items():
                    os.environ[k] = v or ""
        # we return captured data, in case there is any
        if hasattr(dsl, "_spec"):
            return dsl._spec.get("capture")
    ...
    def run_local(self, path: str, entry_point: str=None, extra_env: dict=None):
        ...
        if not path or os.path.isdir(path):
            ...
            folder = self.project_root or os.path.split(path)[0]
