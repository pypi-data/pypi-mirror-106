...
# -- color names for stringcolor lib
COLOR_GREEN = 'green2'
COLOR_BLUE = 'blue2'
COLOR_RED = 'red2'
COLOR_YELLOW = 'yellow2'
COLOR_GRAY = "LightGrey8"
COLOR_LIGHT_BLUE = "LightSkyBlue"
...
def get_resource_path(resource_name):
    ...
    try:
        ...
        raise ResourceNotFoundException(f'resource name: [{resource_name}] not found') from ex
