...
def get_inference_client(*, model_name, project_name, version):
    ...
    return getattr(import_module(path), class_)(
        model_name=model_name, project_name=project_name, version=version
    )
...
class ModelInferenceClient:
    ...
    def __init__(self, *, model_name, project_name, version="latest"):
