...
setup(
    ...
    description='Práctica UF4',
    long_description='long description',
    author='Alba Navarro',
    author_email='41012054h@iespoblenou.org',
    url='https://github.com/albanv01/practicaUUF4',
    download_url='https://pypi.org/project/AlmacenBebidasAlba/'.format(
        VERSION),
