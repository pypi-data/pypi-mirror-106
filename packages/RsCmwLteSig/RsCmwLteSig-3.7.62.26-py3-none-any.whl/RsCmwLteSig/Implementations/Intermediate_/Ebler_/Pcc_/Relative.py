...
class Relative:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.intermediate.ebler.pcc.relative.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:INTermediate:LTE:SIGNaling<Instance>:EBLer:PCC:RELative?', self.__class__.FetchStruct())
