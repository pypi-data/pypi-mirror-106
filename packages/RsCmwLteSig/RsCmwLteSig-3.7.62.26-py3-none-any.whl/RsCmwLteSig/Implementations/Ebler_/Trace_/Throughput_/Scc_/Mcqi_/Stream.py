...
class Stream:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Yvalue: List[float]: Median CQI value calculated from the CQI indices reported within 200 processed subframes (the labeled subframe and the previous 199 subframes) Range: 0 to 15"""
		__meta_args_list = [
