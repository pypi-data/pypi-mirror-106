...
class Confidence:
	...
	def fetch(self) -> enums.Confidence:
		...
		Snippet: value: enums.Confidence = driver.ebler.pcc.confidence.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:LTE:SIGNaling<Instance>:EBLer:PCC:CONFidence?', suppressed)
