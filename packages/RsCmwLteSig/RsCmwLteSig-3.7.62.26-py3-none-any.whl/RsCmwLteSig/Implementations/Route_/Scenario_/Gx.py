...
class Gx:
	"""Gx commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("gx", core, parent)
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:GX[:FLEXible] \n
		Snippet: driver.route.scenario.gx.set_flexible(value = FlexibleStruct()) \n
		Activates the scenario '7CC - nx4 nx4 nx4 nx4 nx4 nx2 nx2' and selects the signal paths. For possible parameter values,
		see 'Values for Signal Path Selection'. \n
