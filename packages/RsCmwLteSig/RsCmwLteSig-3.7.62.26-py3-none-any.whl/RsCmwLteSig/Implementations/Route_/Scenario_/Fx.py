...
class Fx:
	"""Fx commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("fx", core, parent)
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:FX[:FLEXible] \n
		Snippet: driver.route.scenario.fx.set_flexible(value = FlexibleStruct()) \n
		Activates the scenario '6CC - nx4 nx4 nx4 nx4 nx4 nx4' and selects the signal paths. For possible parameter values, see
		'Values for Signal Path Selection'. \n
