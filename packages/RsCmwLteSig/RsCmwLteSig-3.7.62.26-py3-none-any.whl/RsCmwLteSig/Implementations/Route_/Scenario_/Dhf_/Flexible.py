...
class Flexible:
	...
	def set_external(self, value: ExternalStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:DHF[:FLEXible][:EXTernal] \n
		Snippet: driver.route.scenario.dhf.flexible.set_external(value = ExternalStruct()) \n
		No command help available \n
	...
	def set_internal(self, value: InternalStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:DHF[:FLEXible]:INTernal \n
		Snippet: driver.route.scenario.dhf.flexible.set_internal(value = InternalStruct()) \n
		Activates the scenario '4CC - Fading - nx2 nx2 nx2 nx2' with internal fading and selects the signal paths. For possible
		parameter values, see 'Values for Signal Path Selection'. \n
