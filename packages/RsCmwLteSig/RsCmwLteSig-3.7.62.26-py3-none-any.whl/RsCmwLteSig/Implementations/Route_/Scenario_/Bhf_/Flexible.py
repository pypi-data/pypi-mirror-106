...
class Flexible:
	...
	class InternalStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Scc_1_Tx_3_Connector: enums.TxConnector: RF connector for the third SCC output path
			- Scc_1_Tx_3_Converter: enums.TxConverter: TX module for the third SCC output path
			- Scc_1_Tx_4_Connector: enums.TxConnector: RF connector for the fourth SCC output path
			- Scc_1_Tx_4_Converter: enums.TxConverter: TX module for the fourth SCC output path
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.bhf.flexible.get_internal() \n
		Activates the scenario '2CC - Fading - nx4 nx4' with internal fading and selects the signal paths. For possible parameter
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:BHF:FLEXible:INTernal?', self.__class__.InternalStruct())

	def set_internal(self, value: InternalStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:BHF[:FLEXible]:INTernal \n
		Snippet: driver.route.scenario.bhf.flexible.set_internal(value = InternalStruct()) \n
		Activates the scenario '2CC - Fading - nx4 nx4' with internal fading and selects the signal paths. For possible parameter
		values, see 'Values for Signal Path Selection'. \n
			:param value: see the help for InternalStruct structure arguments.
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:BHF:FLEXible:INTernal', value)
