...
class Hya:
	"""Hya commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("hya", core, parent)
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:HYA[:FLEXible] \n
		Snippet: driver.route.scenario.hya.set_flexible(value = FlexibleStruct()) \n
		No command help available \n
