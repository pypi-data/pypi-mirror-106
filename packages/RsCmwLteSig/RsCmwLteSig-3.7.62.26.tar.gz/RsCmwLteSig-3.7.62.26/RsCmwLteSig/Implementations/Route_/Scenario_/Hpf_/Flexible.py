...
class Flexible:
	...
	class InternalStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Scc_7_Fading_Board: enums.FadingBoard: Internal fader for the SCC7
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Scc_7_Fading_Board', enums.FadingBoard),
		...
		def __init__(self):
			...
			self.Scc_7_Fading_Board: enums.FadingBoard = None
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.hpf.flexible.get_internal() \n
		Activates the scenario '8CC - Fading - nx2 nx2 nx2 nx2 nx2 nx2 nx2 nx2' with internal fading and selects the signal paths.
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HPF:FLEXible:INTernal?', self.__class__.InternalStruct())

	def set_internal(self, value: InternalStruct) -> None:
		"""SCPI: ROUTe:LTE:SIGNaling<instance>:SCENario:HPF[:FLEXible]:INTernal \n
		Snippet: driver.route.scenario.hpf.flexible.set_internal(value = InternalStruct()) \n
		Activates the scenario '8CC - Fading - nx2 nx2 nx2 nx2 nx2 nx2 nx2 nx2' with internal fading and selects the signal paths.
		For possible parameter values, see 'Values for Signal Path Selection'. \n
			:param value: see the help for InternalStruct structure arguments.
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:HPF:FLEXible:INTernal', value)
