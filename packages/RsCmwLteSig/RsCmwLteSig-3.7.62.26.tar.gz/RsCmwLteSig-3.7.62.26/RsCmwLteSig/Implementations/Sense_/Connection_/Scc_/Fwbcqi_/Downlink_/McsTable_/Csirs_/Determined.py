...
class Determined:
	...
	def get(self, table_name: enums.Table = None, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> List[int]:
		...
		Snippet: value: List[int] = driver.sense.connection.scc.fwbcqi.downlink.mcsTable.csirs.determined.get(table_name = enums.Table.ANY, secondaryCompCarrier = repcap.SecondaryCompCarrier.Default) \n
