...
class Foffset:
	"""Foffset commands group definition. 4 total commands, 2 Sub-groups, 0 group commands"""
	...
	def downlink(self):
		...
		if not hasattr(self, '_downlink'):
			from .Foffset_.Downlink import Downlink
	...
	def uplink(self):
		...
		if not hasattr(self, '_uplink'):
			from .Foffset_.Uplink import Uplink
