...
class Relative:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Thougput_Avg_Rel: float: Average DL throughput (as percentage of maximum reachable throughput) Range: 0 % to 100 %, Unit: %
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.ebler.all.relative.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:LTE:SIGNaling<Instance>:EBLer:ALL:RELative?', self.__class__.FetchStruct())
