...
class EditModelForm(object):
    ...
    def __init__(self, description=None, dl_task=None, primary_batch_size=None, primary_hardware=None, accuracy_metrics=None, name=None, input_dimensions=None, local_vars_configuration=None):  # noqa: E501
