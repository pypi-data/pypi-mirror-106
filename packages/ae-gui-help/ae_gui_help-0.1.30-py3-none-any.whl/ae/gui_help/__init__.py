...
The following classes are providing a solid fundament to implement tours for your app:
...
class OnboardingTour(TourBase):
    ...
    page_ids = ['', 'page_switching', 'tip_help_intro', 'tip_help_tooltip', 'responsible_layout', 'layout_font_size',
