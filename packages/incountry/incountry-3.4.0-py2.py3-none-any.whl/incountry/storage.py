...
class Storage:
    ...
    def write(
        ...
        self.http_client.write(country=country, data=data_to_send, request_options=request_options)
    ...
    def batch_write(self, country: str, records: List[TRecord], request_options: dict = {}) -> Dict[str, List[TRecord]]:
        ...
        self.http_client.batch_write(country=country, data=data_to_send, request_options=request_options)
