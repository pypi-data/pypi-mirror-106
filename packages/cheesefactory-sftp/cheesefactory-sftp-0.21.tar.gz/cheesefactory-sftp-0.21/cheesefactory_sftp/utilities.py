...
class CfSftpUtilities(CfSftpConnection):
    ...
    def file_size_match(self, local_path: str, remote_path: str, remote_size: int = None):
        ...
        if local_size != remote_size:
            raise FileSizeMismatchError(local_path=local_path, local_size=str(local_size), remote_path=remote_path,
                                        remote_size=str(remote_size))
    ...
    def list_dir(self, path: str = '.', recursive: bool = False) -> List[str]:
        ...
        Note: Maybe Paramiko will offer recursion one day...
        """
        if recursive is False:
            ...
            def dig(dig_path):
                ...
                for item in dig_list:
                    ...
                    directory_list.append(item)  # Prepend the file/dir name with the dir
