...
class CfSftpTransfer(CfSftpUtilities):
    ...
    def _transfer(self, action: str = None, append_local: str = None, append_remote: str = None,
                  local_path: str = None, log_checksum: bool = False, preserve_mtime: bool = True,
                  remote_path: str = None, remove_source: bool = False) -> str:
    ...
    def _transfer_by_glob(self, action: str = None, append_local: str = None, append_remote: str = None,
        ...
        if len(file_list) > 0:
            ...
            transfer_list = self._transfer_by_list(
                action=action, append_local=append_local, append_remote=append_remote, base_dir=base_dir,
    ...
    def _transfer_by_list(self, action: str = None, append_local: str = None, append_remote: str = None,
                          ...
                          log_checksum: bool = False, preserve_mtime: bool = True,
        ...
        for file in file_list:
            ...
            try:
                file = self._transfer(action=action, append_local=append_local, append_remote=append_remote,
                                      local_path=local_path, log_checksum=log_checksum, preserve_mtime=preserve_mtime,
