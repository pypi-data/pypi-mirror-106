...
class DroneClient(Client):
    ...
    def list_indexer_modules(self):
        return self.perform_request(self.exploit_stub.ListIndexerModules, models_pb2.EmptyRequest())

    def list_remote_shares(self, service_id: int, credential_id: int, module_name: str):
    ...
    def index_share(self, share_id: int, max_depth: int, max_duration_seconds: int):
        request = exploitation_pb2.IndexRequest(
            share_id=share_id,
            max_depth=max_depth,
    ...
    def get_file_contents(self, file_id: int):
        return self.perform_request(
    ...
    def change_share_file_status(self, share_file_id: int, status: int):
        return self.perform_request(
