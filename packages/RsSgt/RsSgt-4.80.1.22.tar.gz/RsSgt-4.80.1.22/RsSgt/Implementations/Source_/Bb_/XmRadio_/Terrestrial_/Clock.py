...
class Clock:
	...
	def get_mode(self) -> enums.ArbClockMode:
		...
		Snippet: value: enums.ArbClockMode = driver.source.bb.xmRadio.terrestrial.clock.get_mode() \n
	...
	def set_mode(self, mode: enums.ArbClockMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:XMRadio:TERRestrial:CLOCk:MODE \n
		Snippet: driver.source.bb.xmRadio.terrestrial.clock.set_mode(mode = enums.ArbClockMode.MSAMple) \n
		No command help available \n
	...
	def get_source(self) -> enums.ClockSourceB:
		...
		Snippet: value: enums.ClockSourceB = driver.source.bb.xmRadio.terrestrial.clock.get_source() \n
		No command help available \n
	...
	def set_source(self, source: enums.ClockSourceB) -> None:
		"""SCPI: [SOURce<HW>]:BB:XMRadio:TERRestrial:CLOCk:SOURce \n
		Snippet: driver.source.bb.xmRadio.terrestrial.clock.set_source(source = enums.ClockSourceB.AINTernal) \n
		No command help available \n
