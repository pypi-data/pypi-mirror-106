...
class Cfr:
	...
	def get_cspacing(self) -> float:
		...
		Sets the channel spacing, if method RsSgt.Source.Bb.Arbitrary.Cfr.filterPy is set to SIMPle. \n
	...
	def get_forder(self) -> int:
		...
		Sets the maximum filter order, if method RsSgt.Source.Bb.Arbitrary.Cfr.filterPy is set to ENHanced. \n
	...
	def get_pfreq(self) -> float:
		...
		Sets the passband frequency, if method RsSgt.Source.Bb.Arbitrary.Cfr.filterPy is set to ENHanced. Frequency components
	...
	def get_sbandwidth(self) -> float:
		...
		Sets the signal bandwidth, if method RsSgt.Source.Bb.Arbitrary.Cfr.filterPy is set to SIMPle. The value of the signal
		bandwidth should not be higher than the channel spacing (method RsSgt.Source.Bb.Arbitrary.Cfr.cspacing) . \n
	...
	def get_sfreq(self) -> float:
		...
		Sets the stopband frequency of the filter, if method RsSgt.Source.Bb.Arbitrary.Cfr.filterPy is set to ENHanced. Frequency
