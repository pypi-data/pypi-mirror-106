...
class Ecount:
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_errorCount_get', 'repcap_errorCount_set', repcap.ErrorCount.Nr1)

	def repcap_errorCount_set(self, enum_value: repcap.ErrorCount) -> None:
	...
	def get(self, errorCount=repcap.ErrorCount.Default) -> int:
		...
		errorCount_cmd_val = self._base.get_repcap_cmd_value(errorCount, repcap.ErrorCount)
