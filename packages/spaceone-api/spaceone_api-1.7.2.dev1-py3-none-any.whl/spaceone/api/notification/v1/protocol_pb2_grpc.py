...
class ProtocolStub(object):
    ...
    def __init__(self, channel):
        ...
        self.create = channel.unary_unary(
                '/spaceone.api.monitoring.v1.Protocol/create',
        ...
        self.update = channel.unary_unary(
                '/spaceone.api.monitoring.v1.Protocol/update',
        ...
        self.update_plugin = channel.unary_unary(
                '/spaceone.api.monitoring.v1.Protocol/update_plugin',
        ...
        self.stat = channel.unary_unary(
                '/spaceone.api.monitoring.v1.Protocol/stat',
...
def add_ProtocolServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.monitoring.v1.Protocol', rpc_method_handlers)
...
class Protocol(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/create',
    ...
    def update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/update',
    ...
    def update_plugin(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/update_plugin',
    ...
    def enable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/enable',
    ...
    def disable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/disable',
            spaceone_dot_api_dot_notification_dot_v1_dot_protocol__pb2.ProtocolRequest.SerializeToString,
            spaceone_dot_api_dot_notification_dot_v1_dot_protocol__pb2.ProtocolInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/delete',
            spaceone_dot_api_dot_notification_dot_v1_dot_protocol__pb2.ProtocolRequest.SerializeToString,
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/get',
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/list',
    ...
    def stat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.Protocol/stat',
