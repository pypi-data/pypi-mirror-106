...
class ProjectChannelStub(object):
    ...
    def __init__(self, channel):
        ...
        self.create = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/create',
        ...
        self.update = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/update',
        ...
        self.enable = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/enable',
        ...
        self.disable = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/disable',
                request_serializer=spaceone_dot_api_dot_notification_dot_v1_dot_project__channel__pb2.ProjectChannelRequest.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_notification_dot_v1_dot_project__channel__pb2.ProjectChannelInfo.FromString,
                )
        self.delete = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/delete',
                request_serializer=spaceone_dot_api_dot_notification_dot_v1_dot_project__channel__pb2.ProjectChannelRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.get = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/get',
        ...
        self.list = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/list',
        ...
        self.stat = channel.unary_unary(
                '/spaceone.api.monitoring.v1.ProjectChannel/stat',
...
def add_ProjectChannelServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.monitoring.v1.ProjectChannel', rpc_method_handlers)
...
class ProjectChannel(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/create',
    ...
    def update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/update',
    ...
    def enable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/enable',
    ...
    def disable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/disable',
            spaceone_dot_api_dot_notification_dot_v1_dot_project__channel__pb2.ProjectChannelRequest.SerializeToString,
            spaceone_dot_api_dot_notification_dot_v1_dot_project__channel__pb2.ProjectChannelInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/delete',
            spaceone_dot_api_dot_notification_dot_v1_dot_project__channel__pb2.ProjectChannelRequest.SerializeToString,
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/get',
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/list',
    ...
    def stat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.ProjectChannel/stat',
