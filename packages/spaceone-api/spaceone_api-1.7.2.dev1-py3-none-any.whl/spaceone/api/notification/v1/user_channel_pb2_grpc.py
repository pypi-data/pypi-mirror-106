...
class UserChannelStub(object):
    ...
    def __init__(self, channel):
        ...
        self.create = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/create',
        ...
        self.update = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/update',
        ...
        self.enable = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/enable',
        ...
        self.disable = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/disable',
                request_serializer=spaceone_dot_api_dot_notification_dot_v1_dot_user__channel__pb2.UserChannelRequest.SerializeToString,
                response_deserializer=spaceone_dot_api_dot_notification_dot_v1_dot_user__channel__pb2.UserChannelInfo.FromString,
                )
        self.delete = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/delete',
                request_serializer=spaceone_dot_api_dot_notification_dot_v1_dot_user__channel__pb2.UserChannelRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.get = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/get',
        ...
        self.list = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/list',
        ...
        self.stat = channel.unary_unary(
                '/spaceone.api.monitoring.v1.UserChannel/stat',
...
def add_UserChannelServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceone.api.monitoring.v1.UserChannel', rpc_method_handlers)
...
class UserChannel(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/create',
    ...
    def update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/update',
    ...
    def enable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/enable',
    ...
    def disable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/disable',
            spaceone_dot_api_dot_notification_dot_v1_dot_user__channel__pb2.UserChannelRequest.SerializeToString,
            spaceone_dot_api_dot_notification_dot_v1_dot_user__channel__pb2.UserChannelInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/delete',
            spaceone_dot_api_dot_notification_dot_v1_dot_user__channel__pb2.UserChannelRequest.SerializeToString,
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/get',
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/list',
    ...
    def stat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.UserChannel/stat',
