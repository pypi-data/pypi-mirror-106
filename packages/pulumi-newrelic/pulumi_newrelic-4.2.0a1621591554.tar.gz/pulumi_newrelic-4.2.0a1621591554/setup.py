...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '4.2.0-alpha.1621591554+8b42bca9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 4.2.0-alpha.1621591554+8b42bca9`
                """)
            else:
                raise
