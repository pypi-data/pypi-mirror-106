...
class CliAtomicUserInteraction(IAtomicUserInteraction):
    ...
    def request_from_objects(self, selectionList: List[T], objectIdentifier: str, prompt=None,
                             cancel_text: str = 'CANCEL SELECTION') -> T:
        item_id = self.request_from_list([str(vars(obj)[objectIdentifier]) for obj in selectionList], prompt=prompt,
    ...
    def request_from_dict(self, selectionDict: Dict[int, str], prompt=None,
    ...
    def request_index_from_df(self, df: pd.DataFrame, prompt: str = None, cancel_text: str = 'CANCEL SELECTION',
                              hide_columns: List[str] = None, return_columns: List[str] = None):
        if prompt is None:
    ...
    def request_open_filepath(self, prompt: str = None, title: str = None, filetypes: Tuple[Tuple[str, str]] = None,
                              **open_file_kwargs):
        root = tkinter.Tk()
