    ...
    """
{
    ...
    "package_data": {
        "cdk_lambda_subminute._jsii": [
            "projen-statemachine-example@0.1.2.jsii.tgz"
        ],
        "cdk_lambda_subminute": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-nodejs>=1.105.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.105.0, <2.0.0",
        "aws-cdk.aws-logs>=1.105.0, <2.0.0",
        "aws-cdk.aws-stepfunctions-tasks>=1.105.0, <2.0.0",
        "aws-cdk.aws-stepfunctions>=1.105.0, <2.0.0",
