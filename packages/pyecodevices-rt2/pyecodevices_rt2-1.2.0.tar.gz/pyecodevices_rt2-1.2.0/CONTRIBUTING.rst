...
pyecodevices-rt2 could always use more documentation, whether as part of the
official pyecodevices-rt2 docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `pyecodevices_rt2` repo on GitHub.
