...
class Device:
	...
	def get_language(self) -> enums.HcopyImgFormat:
		"""SCPI: HCOPy:DEVice:LANGuage \n
		Snippet: value: enums.HcopyImgFormat = driver.hardCopy.device.get_language() \n
	...
	def set_language(self, language: enums.HcopyImgFormat) -> None:
		"""SCPI: HCOPy:DEVice:LANGuage \n
		Snippet: driver.hardCopy.device.set_language(language = enums.HcopyImgFormat.BMP) \n
		Selects the graphic format for the hard copy. You can use both commands alternatively. \n
			:param language: BMP| JPG| XPM| PNG
		"""
		param = Conversions.enum_scalar_to_str(language, enums.HcopyImgFormat)
