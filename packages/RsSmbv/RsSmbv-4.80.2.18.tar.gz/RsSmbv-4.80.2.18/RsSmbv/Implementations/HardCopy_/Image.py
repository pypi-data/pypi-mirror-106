...
class Image:
	...
	def get_format_py(self) -> enums.HcopyImgFormat:
		"""SCPI: HCOPy:IMAGe:FORMat \n
		Snippet: value: enums.HcopyImgFormat = driver.hardCopy.image.get_format_py() \n
		...
		return Conversions.str_to_scalar_enum(response, enums.HcopyImgFormat)

	def set_format_py(self, format_py: enums.HcopyImgFormat) -> None:
		"""SCPI: HCOPy:IMAGe:FORMat \n
		Snippet: driver.hardCopy.image.set_format_py(format_py = enums.HcopyImgFormat.BMP) \n
		Selects the graphic format for the hard copy. You can use both commands alternatively. \n
			:param format_py: BMP| JPG| XPM| PNG
		"""
		param = Conversions.enum_scalar_to_str(format_py, enums.HcopyImgFormat)
