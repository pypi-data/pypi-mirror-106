...
class Mcch:
	...
	def get_noffset(self) -> int:
		...
		Defines, together with the method RsSmbv.Source.Bb.Eutra.Downlink.Mbsfn.Ai.Mcch.nrc, the radio frames in which the MCCH
	...
	def get_npattern(self) -> NpatternStruct:
		...
		Snippet: value: NpatternStruct = driver.source.bb.eutra.downlink.mbsfn.ai.mcch.get_npattern() \n
	...
	def set_npattern(self, value: NpatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:MBSFn:AI:MCCH:NPATtern \n
		Snippet: driver.source.bb.eutra.downlink.mbsfn.ai.mcch.set_npattern(value = NpatternStruct()) \n
		Sets the pattern for the notification bits sent on PDCCH DCI format 1c. \n
	...
	def get_offs(self) -> int:
		...
		Indicates, together with the method RsSmbv.Source.Bb.Eutra.Downlink.Mbsfn.Ai.Mcch.rper, the radio frames in which MCCH is
		scheduled. \n
	...
	def get_pattern(self) -> PatternStruct:
		...
		Snippet: value: PatternStruct = driver.source.bb.eutra.downlink.mbsfn.ai.mcch.get_pattern() \n
	...
	def set_pattern(self, value: PatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:MBSFn:AI:MCCH:PATTern \n
		Snippet: driver.source.bb.eutra.downlink.mbsfn.ai.mcch.set_pattern(value = PatternStruct()) \n
		Sets the pattern used as data source for the MCCH. \n
