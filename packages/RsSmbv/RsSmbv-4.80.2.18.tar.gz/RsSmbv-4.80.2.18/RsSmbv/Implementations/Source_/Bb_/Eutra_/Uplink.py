...
class Uplink:
	"""Uplink commands group definition. 440 total commands, 15 Sub-groups, 13 group commands"""
	...
	def apMap(self):
		...
		if not hasattr(self, '_apMap'):
			from .Uplink_.ApMap import ApMap
	...
	def refsig(self):
		...
		if not hasattr(self, '_refsig'):
			from .Uplink_.Refsig import Refsig
	...
	def rstFrame(self):
		...
		if not hasattr(self, '_rstFrame'):
			from .Uplink_.RstFrame import RstFrame
	...
	def get_bw(self) -> enums.EutraChannelBandwidth:
		...
		Snippet: value: enums.EutraChannelBandwidth = driver.source.bb.eutra.uplink.get_bw() \n
	...
	def set_bw(self, bandwidth: enums.EutraChannelBandwidth) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:BW \n
		Snippet: driver.source.bb.eutra.uplink.set_bw(bandwidth = enums.EutraChannelBandwidth.BW0_20) \n
		Sets the UL channel bandwidth. \n
			:param bandwidth: BW1_40| BW3_00| BW5_00| BW10_00| BW15_00| BW20_00 | BW0_20 | USER
		"""
		param = Conversions.enum_scalar_to_str(bandwidth, enums.EutraChannelBandwidth)
	...
	def get_cpc(self) -> enums.EutraCyclicPrefixGs:
		...
		Snippet: value: enums.EutraCyclicPrefixGs = driver.source.bb.eutra.uplink.get_cpc() \n
	...
	def set_cpc(self, cyclic_prefix: enums.EutraCyclicPrefixGs) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:CPC \n
		Snippet: driver.source.bb.eutra.uplink.set_cpc(cyclic_prefix = enums.EutraCyclicPrefixGs.EXTended) \n
		Sets the cyclic prefix length for all subframes. \n
