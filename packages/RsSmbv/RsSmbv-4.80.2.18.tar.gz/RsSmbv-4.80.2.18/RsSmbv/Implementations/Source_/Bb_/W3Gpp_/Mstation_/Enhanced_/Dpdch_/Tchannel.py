...
class Tchannel:
	"""Tchannel commands group definition. 11 total commands, 9 Sub-groups, 0 group commands
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_transportChannelNull_get', 'repcap_transportChannelNull_set', repcap.TransportChannelNull.Nr0)

	def repcap_transportChannelNull_set(self, enum_value: repcap.TransportChannelNull) -> None:
