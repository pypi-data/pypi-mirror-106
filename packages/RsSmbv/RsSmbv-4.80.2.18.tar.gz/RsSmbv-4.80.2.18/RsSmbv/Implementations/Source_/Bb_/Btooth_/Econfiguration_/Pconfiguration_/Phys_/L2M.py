...
class L2M:
	"""L2M commands group definition. 1 total commands, 1 Sub-groups, 0 group commands
	Repeated Capability: ChannelNull, default value after init: ChannelNull.Nr0"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("l2M", core, parent)
	...
	def clone(self) -> 'L2M':
		...
		new_group = L2M(self._core, self._base.parent)
