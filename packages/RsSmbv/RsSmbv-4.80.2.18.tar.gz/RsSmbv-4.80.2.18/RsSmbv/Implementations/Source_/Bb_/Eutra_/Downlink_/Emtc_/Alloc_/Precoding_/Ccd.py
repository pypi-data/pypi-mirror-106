...
class Ccd:
	...
	def set(self, cyc_del_div: enums.EutraDlpRecCycDelDiv, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.emtc.alloc.precoding.ccd.set(cyc_del_div = enums.EutraDlpRecCycDelDiv.LADelay, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> enums.EutraDlpRecCycDelDiv:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:PRECoding:CCD \n
		Snippet: value: enums.EutraDlpRecCycDelDiv = driver.source.bb.eutra.downlink.emtc.alloc.precoding.ccd.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the cyclic delay diversity for the selected allocation. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
