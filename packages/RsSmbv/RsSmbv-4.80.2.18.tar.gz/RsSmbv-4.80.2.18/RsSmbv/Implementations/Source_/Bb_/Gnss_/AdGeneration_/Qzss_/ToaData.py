...
class ToaData:
	...
	def get_date(self) -> DateStruct:
		...
		Snippet: value: DateStruct = driver.source.bb.gnss.adGeneration.qzss.toaData.get_date() \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:QZSS:TOAData:DATE?', self.__class__.DateStruct())

	def set_date(self, value: DateStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:QZSS:TOAData:DATE \n
		Snippet: driver.source.bb.gnss.adGeneration.qzss.toaData.set_date(value = DateStruct()) \n
		Enabled for UTC or GLONASS timebase (method RsSmbv.Source.Bb.Gnss.AdGeneration.Gps.ToaData.tbasis) . Enters the date for
		the assistance data in DMS format of the Gregorian calendar. \n
			:param value: see the help for DateStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:QZSS:TOAData:DATE', value)
	...
	def get_time(self) -> TimeStruct:
		...
		Snippet: value: TimeStruct = driver.source.bb.gnss.adGeneration.qzss.toaData.get_time() \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:QZSS:TOAData:TIME?', self.__class__.TimeStruct())

	def set_time(self, value: TimeStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:QZSS:TOAData:TIME \n
		Snippet: driver.source.bb.gnss.adGeneration.qzss.toaData.set_time(value = TimeStruct()) \n
		Enabled for UTC or GLONASS timebase (method RsSmbv.Source.Bb.Gnss.AdGeneration.Gps.ToaData.tbasis) . Enters the exact
		start time for the assistance data in UTC time format. \n
			:param value: see the help for TimeStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:QZSS:TOAData:TIME', value)
