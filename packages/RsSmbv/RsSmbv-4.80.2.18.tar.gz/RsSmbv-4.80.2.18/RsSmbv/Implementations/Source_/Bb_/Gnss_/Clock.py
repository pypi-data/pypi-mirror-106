...
class Clock:
	...
	def get_source(self) -> enums.ClockSourceA:
		...
		Snippet: value: enums.ClockSourceA = driver.source.bb.gnss.clock.get_source() \n
	...
	def set_source(self, source: enums.ClockSourceA) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:CLOCk:SOURce \n
		Snippet: driver.source.bb.gnss.clock.set_source(source = enums.ClockSourceA.INTernal) \n
			INTRO_CMD_HELP: Selects the clock source: \n
			- INTernal: Internal clock reference \n
