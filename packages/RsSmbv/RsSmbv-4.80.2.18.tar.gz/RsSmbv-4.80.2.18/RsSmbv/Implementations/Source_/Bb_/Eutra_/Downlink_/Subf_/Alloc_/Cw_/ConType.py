...
class ConType:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default, codeword=repcap.Codeword.Default) -> enums.EutraDlContentType:
		...
		Snippet: value: enums.EutraDlContentType = driver.source.bb.eutra.downlink.subf.alloc.cw.conType.get(subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default, codeword = repcap.Codeword.Default) \n
