...
class ApLayer:
	...
	def set(self, ap_layer_id: int, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> None:
		...
		Sets the DCI Format 2C field antenna port(s) , layer, scrambling Id. Option: R&S SMBVB-K119: Value range <ApLayerId>
			Table Header: method RsSmbv.Source.Bb.Eutra.Downlink.User.Cell.Dmrs.State.set / method RsSmbv.Source.Bb.Eutra.Downlink.User.Cell.Seol.State.set / 1 codeword / 2 codewords \n
			- 0 / 0 / 0 to 6 / 0 to 7
			- 1 / 0 / 0 to 11 / 0 to 14
			- 1 / 1 / 0 to 1 / 0 to 1 \n
