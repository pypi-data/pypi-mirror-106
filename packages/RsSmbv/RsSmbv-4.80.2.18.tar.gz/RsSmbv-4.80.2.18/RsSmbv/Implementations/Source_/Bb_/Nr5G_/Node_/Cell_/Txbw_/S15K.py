...
class S15K:
	"""S15K commands group definition. 4 total commands, 4 Sub-groups, 0 group commands"""
	...
	def offset(self):
		...
		if not hasattr(self, '_offset'):
			from .S15K_.Offset import Offset
