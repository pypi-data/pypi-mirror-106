...
class SymbolRate:
	...
	def set(self, srate: enums.SymbRate, mobileStation=repcap.MobileStation.Default) -> None:
		...
		The command sets the symbol rate of the PRACH. A change of symbol rate leads to an automatic change of slot format method
		RsSmbv.Source.Bb.W3Gpp.Mstation.Prach.Sformat.set. \n
