...
class Connector:
	...
	def set(self, connector: enums.FeedbackConnector, mobileStation=repcap.MobileStation.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.hsupa.dpcch.e.frc.harq.simulation.connector.set(connector = enums.FeedbackConnector.LEVatt, mobileStation = repcap.MobileStation.Default) \n
