...
class View:
	...
	def get_cindex(self) -> enums.EutraCcIndex:
		...
		Snippet: value: enums.EutraCcIndex = driver.source.bb.eutra.uplink.view.get_cindex() \n
		No command help available \n
	...
	def set_cindex(self, dl_tp_cell_idx: enums.EutraCcIndex) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:VIEW:CINDex \n
		Snippet: driver.source.bb.eutra.uplink.view.set_cindex(dl_tp_cell_idx = enums.EutraCcIndex.PC) \n
		No command help available \n
