...
class HpNumber:
	"""HpNumber commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("hpNumber", core, parent)
	...
	def set(self, harq_process_num: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Sets the HARQ processes number, for UEs for that method RsSmbv.Source.Bb.Eutra.Downlink.User.Sthp.State.set 1. \n
