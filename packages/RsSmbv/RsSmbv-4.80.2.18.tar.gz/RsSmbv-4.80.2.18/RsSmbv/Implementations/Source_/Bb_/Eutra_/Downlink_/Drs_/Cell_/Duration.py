...
class Duration:
	...
	def set(self, drs_duration: enums.EutraDrsDuration, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.drs.cell.duration.set(drs_duration = enums.EutraDrsDuration.DUR1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> enums.EutraDrsDuration:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:DRS:CELL<CH0>:DURation \n
		Snippet: value: enums.EutraDrsDuration = driver.source.bb.eutra.downlink.drs.cell.duration.get(cellNull = repcap.CellNull.Default) \n
		Sets the DRS duration. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
