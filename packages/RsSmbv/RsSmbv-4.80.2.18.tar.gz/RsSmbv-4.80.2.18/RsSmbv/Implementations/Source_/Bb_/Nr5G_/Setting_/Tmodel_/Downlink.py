...
class Downlink:
	...
	def get_value(self) -> str:
		...
		Loads a test model file with predefined settings. \n
			:return: tmod_down: 'filename' Filename as queried with one of the following commands: method RsSmbv.Source.Bb.Nr5G.Setting.Tmodel.Uplink.catalog method RsSmbv.Source.Bb.Nr5G.Setting.Tmodel.Downlink.catalog method RsSmbv.Source.Bb.Nr5G.Setting.Tmodel.FilterPy.catalog
		"""
	...
	def set_value(self, tmod_down: str) -> None:
		...
		Loads a test model file with predefined settings. \n
			:param tmod_down: 'filename' Filename as queried with one of the following commands: method RsSmbv.Source.Bb.Nr5G.Setting.Tmodel.Uplink.catalog method RsSmbv.Source.Bb.Nr5G.Setting.Tmodel.Downlink.catalog method RsSmbv.Source.Bb.Nr5G.Setting.Tmodel.FilterPy.catalog
		"""
