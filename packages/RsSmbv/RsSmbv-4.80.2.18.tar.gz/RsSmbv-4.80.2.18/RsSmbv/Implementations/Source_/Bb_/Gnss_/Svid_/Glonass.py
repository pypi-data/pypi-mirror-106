...
class Glonass:
	"""Glonass commands group definition. 122 total commands, 14 Sub-groups, 0 group commands"""
	...
	def fnumber(self):
		...
		if not hasattr(self, '_fnumber'):
			from .Glonass_.Fnumber import Fnumber
	...
	def healthy(self):
		...
		if not hasattr(self, '_healthy'):
			from .Glonass_.Healthy import Healthy
	...
	def listPy(self):
		...
		if not hasattr(self, '_listPy'):
			from .Glonass_.ListPy import ListPy
	...
	def mcontrol(self):
		...
		if not hasattr(self, '_mcontrol'):
			from .Glonass_.Mcontrol import Mcontrol
	...
	def mpath(self):
		...
		if not hasattr(self, '_mpath'):
			from .Glonass_.Mpath import Mpath
	...
	def nmessage(self):
		...
		if not hasattr(self, '_nmessage'):
			from .Glonass_.Nmessage import Nmessage
	...
	def power(self):
		...
		if not hasattr(self, '_power'):
			from .Glonass_.Power import Power
	...
	def prErrors(self):
		...
		if not hasattr(self, '_prErrors'):
			from .Glonass_.PrErrors import PrErrors
	...
	def present(self):
		...
		if not hasattr(self, '_present'):
			from .Glonass_.Present import Present
	...
	def sdynamics(self):
		...
		if not hasattr(self, '_sdynamics'):
			from .Glonass_.Sdynamics import Sdynamics
	...
	def simulated(self):
		...
		if not hasattr(self, '_simulated'):
			from .Glonass_.Simulated import Simulated
	...
	def visibility(self):
		...
		if not hasattr(self, '_visibility'):
			from .Glonass_.Visibility import Visibility
