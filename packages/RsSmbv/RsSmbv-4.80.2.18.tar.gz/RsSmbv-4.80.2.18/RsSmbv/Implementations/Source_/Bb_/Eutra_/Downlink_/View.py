...
class View:
	...
	def get_cindex(self) -> enums.EutraCcIndex:
		...
		Snippet: value: enums.EutraCcIndex = driver.source.bb.eutra.downlink.view.get_cindex() \n
		No command help available \n
	...
	def set_cindex(self, dl_tp_cell_idx: enums.EutraCcIndex) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:VIEW:CINDex \n
		Snippet: driver.source.bb.eutra.downlink.view.set_cindex(dl_tp_cell_idx = enums.EutraCcIndex.PC) \n
		No command help available \n
	...
	def get_mode(self) -> enums.EutraViewMode:
		...
		Snippet: value: enums.EutraViewMode = driver.source.bb.eutra.downlink.view.get_mode() \n
		No command help available \n
	...
	def set_mode(self, mode: enums.EutraViewMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:VIEW:MODE \n
		Snippet: driver.source.bb.eutra.downlink.view.set_mode(mode = enums.EutraViewMode.PRB) \n
		No command help available \n
