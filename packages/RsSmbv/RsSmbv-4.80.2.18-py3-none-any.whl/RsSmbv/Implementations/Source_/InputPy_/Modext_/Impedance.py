...
class Impedance:
	...
	def set(self, impedance: enums.Imp, inputIx=repcap.InputIx.Default) -> None:
		"""SCPI: [SOURce<HW>]:INPut:MODext:IMPedance<CH> \n
		Snippet: driver.source.inputPy.modext.impedance.set(impedance = enums.Imp.G50, inputIx = repcap.InputIx.Default) \n
	...
	# noinspection PyTypeChecker
	def get(self, inputIx=repcap.InputIx.Default) -> enums.Imp:
		"""SCPI: [SOURce<HW>]:INPut:MODext:IMPedance<CH> \n
		Snippet: value: enums.Imp = driver.source.inputPy.modext.impedance.get(inputIx = repcap.InputIx.Default) \n
		Sets the impedance for the externally supplied modulation signal. \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Impedance')
