...
class S30K:
	"""S30K commands group definition. 4 total commands, 4 Sub-groups, 0 group commands"""
	...
	def offset(self):
		...
		if not hasattr(self, '_offset'):
			from .S30K_.Offset import Offset
	...
	def clone(self) -> 'S30K':
		...
		new_group = S30K(self._core, self._base.parent)
