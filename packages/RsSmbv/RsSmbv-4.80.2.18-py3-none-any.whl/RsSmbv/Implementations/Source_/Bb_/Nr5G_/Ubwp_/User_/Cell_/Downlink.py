...
class Downlink:
	"""Downlink commands group definition. 130 total commands, 2 Sub-groups, 0 group commands"""
	...
	def nbwParts(self):
		...
		if not hasattr(self, '_nbwParts'):
			from .Downlink_.NbwParts import NbwParts
