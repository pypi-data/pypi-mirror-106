...
class Svid:
	"""Svid commands group definition. 1 total commands, 1 Sub-groups, 0 group commands
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_satelliteSvid_get', 'repcap_satelliteSvid_set', repcap.SatelliteSvid.Nr1)

	def repcap_satelliteSvid_set(self, enum_value: repcap.SatelliteSvid) -> None:
