...
class SubType:
	...
	def set(self, sub_type: enums.EvdoLayer, terminal=repcap.Terminal.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EVDO:TERMinal<ST>:SUBType \n
		Snippet: driver.source.bb.evdo.terminal.subType.set(sub_type = enums.EvdoLayer.S1, terminal = repcap.Terminal.Default) \n
		...
		param = Conversions.enum_scalar_to_str(sub_type, enums.EvdoLayer)
