...
class Output:
	"""Output commands group definition. 10 total commands, 9 Sub-groups, 0 group commands
	...
	def pindex(self):
		...
		if not hasattr(self, '_pindex'):
			from .Output_.Pindex import Pindex
			self._pindex = Pindex(self._core, self._base)
		return self._pindex
