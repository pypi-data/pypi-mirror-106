...
class Srs:
	...
	def get_dsfc(self) -> str:
		...
		SRS subframe configuration (method RsSmbv.Source.Bb.Eutra.Uplink.Refsig.Srs.csrs) and the dduplexing mode (method RsSmbv.
	...
	def get_tsfc(self) -> str:
		...
		subframe configuration (method RsSmbv.Source.Bb.Eutra.Uplink.Refsig.Srs.csrs) and the duplexing mode (method RsSmbv.
		Source.Bb.Eutra.duplexing) . \n
			:return: tsfc: string
		"""
