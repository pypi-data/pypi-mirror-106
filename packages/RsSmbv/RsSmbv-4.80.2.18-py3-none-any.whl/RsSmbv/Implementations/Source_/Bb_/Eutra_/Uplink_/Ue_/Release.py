...
class Release:
	...
	def set(self, release: enums.EutraUeRelease, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.uplink.ue.release.set(release = enums.EutraUeRelease.EMTC, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraUeRelease:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:RELease \n
		Snippet: value: enums.EutraUeRelease = driver.source.bb.eutra.uplink.ue.release.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets which LTE release version the UE supports. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
