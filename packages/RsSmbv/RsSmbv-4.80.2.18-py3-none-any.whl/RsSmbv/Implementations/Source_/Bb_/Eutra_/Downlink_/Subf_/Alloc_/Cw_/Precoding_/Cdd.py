...
class Cdd:
	...
	def set(self, cyclic_delay_div: enums.EutraDlpRecCycDelDiv, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default, codeword=repcap.Codeword.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.subf.alloc.cw.precoding.cdd.set(cyclic_delay_div = enums.EutraDlpRecCycDelDiv.LADelay, subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default, codeword = repcap.Codeword.Default) \n
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default, codeword=repcap.Codeword.Default) -> enums.EutraDlpRecCycDelDiv:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:[SUBF<ST0>]:ALLoc<CH0>:[CW<USER>]:PRECoding:CDD \n
		Snippet: value: enums.EutraDlpRecCycDelDiv = driver.source.bb.eutra.downlink.subf.alloc.cw.precoding.cdd.get(subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default, codeword = repcap.Codeword.Default) \n
		Sets the CDD for the selected allocation. The combination of cyclic delay diversity and the selected number of layers
		determines the precoding parameters for spatial multiplexing. \n
			:param subframeNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Subf')
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
