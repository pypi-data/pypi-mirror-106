...
class F2Naport:
	"""F2Naport commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("f2Naport", core, parent)
	...
	def set(self, num_aps: enums.EutraPucchNumAp, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.uplink.ue.pucch.f2Naport.set(num_aps = enums.EutraPucchNumAp.AP1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraPucchNumAp:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:PUCCh:F2Naport \n
		Snippet: value: enums.EutraPucchNumAp = driver.source.bb.eutra.uplink.ue.pucch.f2Naport.get(userEquipment = repcap.UserEquipment.Default) \n
		For LTE-A UEs, sets the number of antenna ports used for every PUCCH format transmission. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
