...
class F1Amode:
	...
	def set(self, format_1_a_mode: enums.EutraF1AcontentType, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:[SUBF<ST0>]:ENCC:PDCCh:EXTC:ITEM<CH0>:DCIConf:F1AMode \n
		Snippet: driver.source.bb.eutra.downlink.subf.encc.pdcch.extc.item.dciConf.f1Amode.set(format_1_a_mode = enums.EutraF1AcontentType.PDSCh, subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
		...
		param = Conversions.enum_scalar_to_str(format_1_a_mode, enums.EutraF1AcontentType)
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> enums.EutraF1AcontentType:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:[SUBF<ST0>]:ENCC:PDCCh:EXTC:ITEM<CH0>:DCIConf:F1AMode \n
		Snippet: value: enums.EutraF1AcontentType = driver.source.bb.eutra.downlink.subf.encc.pdcch.extc.item.dciConf.f1Amode.get(subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
		Selects the mode of the DCI format. \n
			:param subframeNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Subf')
			:param itemNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Item')
