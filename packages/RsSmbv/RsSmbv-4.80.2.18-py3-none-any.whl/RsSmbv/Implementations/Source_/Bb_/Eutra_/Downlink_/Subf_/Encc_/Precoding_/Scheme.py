...
class Scheme:
	...
	def set(self, scheme: enums.EutraDlecpRecScheme, subframeNull=repcap.SubframeNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.subf.encc.precoding.scheme.set(scheme = enums.EutraDlecpRecScheme.NONE, subframeNull = repcap.SubframeNull.Default) \n
	...
	def get(self, subframeNull=repcap.SubframeNull.Default) -> enums.EutraDlecpRecScheme:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:[SUBF<ST0>]:ENCC:PRECoding:SCHeme \n
		Snippet: value: enums.EutraDlecpRecScheme = driver.source.bb.eutra.downlink.subf.encc.precoding.scheme.get(subframeNull = repcap.SubframeNull.Default) \n
		Selects the precoding scheme for PDCCH. \n
			:param subframeNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Subf')
