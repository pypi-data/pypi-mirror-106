...
class Mbsfn:
	...
	def get_uec(self) -> enums.EutraMbsfnUeCat:
		...
		Snippet: value: enums.EutraMbsfnUeCat = driver.source.bb.eutra.downlink.mbsfn.get_uec() \n
	...
	def set_uec(self, ue_category: enums.EutraMbsfnUeCat) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:MBSFn:UEC \n
		Snippet: driver.source.bb.eutra.downlink.mbsfn.set_uec(ue_category = enums.EutraMbsfnUeCat.C1) \n
		Defines the UE category as defined in . \n
