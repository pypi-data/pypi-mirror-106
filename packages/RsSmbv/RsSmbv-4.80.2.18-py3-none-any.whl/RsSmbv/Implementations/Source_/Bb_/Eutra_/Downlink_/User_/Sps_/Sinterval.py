...
class Sinterval:
	...
	def set(self, user_sps_int: enums.EutraSpsInt, userIx=repcap.UserIx.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:SPS:SINTerval \n
		Snippet: driver.source.bb.eutra.downlink.user.sps.sinterval.set(user_sps_int = enums.EutraSpsInt.S10, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> enums.EutraSpsInt:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:SPS:SINTerval \n
		Snippet: value: enums.EutraSpsInt = driver.source.bb.eutra.downlink.user.sps.sinterval.get(userIx = repcap.UserIx.Default) \n
		Defines the SPS interval. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
