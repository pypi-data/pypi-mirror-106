...
class TbSize:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> int:
		...
		Queries the transport block size. \n
			...
			:return: nbiot_tb_size: integer Max transport block size depends on the installed options Option: R&S SMBVB-K115: Max = 1000 Option: R&S SMBVB-K143: Max = 2536 Range: 16 to max"""
