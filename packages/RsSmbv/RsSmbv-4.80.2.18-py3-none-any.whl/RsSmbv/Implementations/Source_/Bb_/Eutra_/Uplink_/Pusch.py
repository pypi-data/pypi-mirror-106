...
class Pusch:
	...
	def get_fh_mode(self) -> enums.EutraUlFreqHopMode:
		...
		Snippet: value: enums.EutraUlFreqHopMode = driver.source.bb.eutra.uplink.pusch.get_fh_mode() \n
	...
	def set_fh_mode(self, freq_hopping_mode: enums.EutraUlFreqHopMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:PUSCh:FHMode \n
		Snippet: driver.source.bb.eutra.uplink.pusch.set_fh_mode(freq_hopping_mode = enums.EutraUlFreqHopMode.INTer) \n
		Sets the frequency hopping mode for PUSCH. \n
