...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '2.2.0-alpha.1621591561+f35aca10'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 2.2.0-alpha.1621591561+f35aca10`
                """)
            else:
                raise
