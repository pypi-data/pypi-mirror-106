...
class BaseMl:
    def __init__(self, fname: str, encoding: str = 'utf-8', return_: Union[str, list, dict] = None):
        if fname:
    ...
    def reinit(self, fname: str, encoding: str = 'utf-8', return_: Union[str, list, dict] = None):
        if fname:
            file_dir, file_name = os.path.split(fname)
        else:
            file_dir, file_name = None, None
