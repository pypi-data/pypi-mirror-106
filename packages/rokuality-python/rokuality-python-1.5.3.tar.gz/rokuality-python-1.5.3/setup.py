...
setup(
    ...
    description="Python bindings for the rokuality platform. End to End Test Automation for Roku, XBox, Vizio, Tizen TV, LG webOS, and HDMI devices including Cable SetTop, Playstation, Tivo and more!",
