...
class Annotator(libcellml.logger.Logger):
    ...
    def assignComponentId(self, component):
        r"""Assign an automatically generated, unique identifier to the given component."""
        return _annotator.Annotator_assignComponentId(self, component)

    def assignComponentRefId(self, component):
        r"""Assign an automatically generated, unique identifier to the given component's encapsulation."""
        return _annotator.Annotator_assignComponentRefId(self, component)

    def assignConnectionId(self, variablePair):
        r"""Assign an automatically generated, unique identifier to the connection defined by the VariablePair."""
        return _annotator.Annotator_assignConnectionId(self, variablePair)

    def assignEncapsulationId(self, model):
        r"""Assign an automatically generated, unique identifier to the encapsulation of the given model."""
        return _annotator.Annotator_assignEncapsulationId(self, model)

    def assignImportSourceId(self, importSource):
        r"""Assign an automatically generated, unique identifier to the given import source."""
        return _annotator.Annotator_assignImportSourceId(self, importSource)

    def assignMapVariablesId(self, variablePair):
        r"""Assign an automatically generated, unique identifier to the equivalence defined by the VariablePair."""
        return _annotator.Annotator_assignMapVariablesId(self, variablePair)

    def assignModelId(self, model):
        r"""Assign an automatically generated, unique identifier to the given model."""
        return _annotator.Annotator_assignModelId(self, model)

    def assignResetId(self, reset):
        r"""Assign an automatically generated, unique identifier to the given reset."""
        return _annotator.Annotator_assignResetId(self, reset)

    def assignResetValueId(self, reset):
        r"""Assign an automatically generated, unique identifier to the reset value of the given reset."""
        return _annotator.Annotator_assignResetValueId(self, reset)

    def assignTestValueId(self, reset):
        r"""Assign an automatically generated, unique identifier to the test value of the given reset."""
        return _annotator.Annotator_assignTestValueId(self, reset)

    def assignUnitId(self, unitsItem):
        r"""Assign an automatically generated, unique identifier to the unit given by the units and index supplied."""
        return _annotator.Annotator_assignUnitId(self, unitsItem)

    def assignUnitsId(self, units):
        r"""Assign an automatically generated, unique identifier to the given units."""
        return _annotator.Annotator_assignUnitsId(self, units)

    def assignVariableId(self, variable):
        r"""Assign an automatically generated, unique identifier to the given variable."""
    ...
    def _itemCellmlElement(self, id, index):
        r"""Private: Utility function to retrieve item type integer based on identifier."""
        return _annotator.Annotator__itemCellmlElement(self, id, index)

    def _assignId(self, *args):
        r"""Private: Utility function to assign an automatic identifier."""
