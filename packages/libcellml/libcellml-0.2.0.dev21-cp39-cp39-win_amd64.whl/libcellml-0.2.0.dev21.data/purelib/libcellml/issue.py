...
class Issue(object):
    ...
    def setUnitsItem(self, unitsItem):
        r"""Sets the :class`UnitsItem` relevant to this issue (``None`` to unset)."""
        return _issue.Issue_setUnitsItem(self, unitsItem)

    def unitsItem(self):
        r"""Get the :class:`UnitsItem` relevant to this issue (or ``None``)."""
        return _issue.Issue_unitsItem(self)
