...
class GeneratorProfile(object):
    ...
    def assignmentString(self):
        r"""Returns the string representing the MathML "assigment" operator."""
        return _generatorprofile.GeneratorProfile_assignmentString(self)

    def setAssignmentString(self, assignmentString):
        r"""Sets the string representing the MathML "assigment" operator."""
    ...
    def variableTypeObjectExternalTypeString(self):
        r"""Returns the string for the external type for the data structure for the variable type object."""
        return _generatorprofile.GeneratorProfile_variableTypeObjectExternalTypeString(self)

    def setVariableTypeObjectExternalTypeString(self, variableTypeObjectExternalTypeString):
        r"""Sets the string for the external type for the data structure for the variable type object."""
        return _generatorprofile.GeneratorProfile_setVariableTypeObjectExternalTypeString(self, variableTypeObjectExternalTypeString)
    ...
    def variableInfoWithTypeObjectString(self):
        r"""Returns the string for the data structure for the variable information (incl. its type) object."""
    ...
    def variableInfoWithTypeEntryString(self):
        r"""Returns the string for an entry in an array for some information about a variable (incl. its type)."""
    ...
    def externalVariableMethodTypeDefinitionString(self):
        r"""Returns the string for the type definition of an external variable method."""
        return _generatorprofile.GeneratorProfile_externalVariableMethodTypeDefinitionString(self)

    def setExternalVariableMethodTypeDefinitionString(self, externalVariableMethodTypeDefinitionString):
        r"""Sets the string for the type definition of an external variable method."""
        return _generatorprofile.GeneratorProfile_setExternalVariableMethodTypeDefinitionString(self, externalVariableMethodTypeDefinitionString)

    def externalVariableMethodParameterString(self):
        r"""Returns the string for the external variable method parameter."""
        return _generatorprofile.GeneratorProfile_externalVariableMethodParameterString(self)

    def setExternalVariableMethodParameterString(self, externalVariableMethodParameterString):
        r"""Sets the string for the external variable method parameter."""
        return _generatorprofile.GeneratorProfile_setExternalVariableMethodParameterString(self, externalVariableMethodParameterString)

    def externalVariableMethodCallString(self):
        r"""Returns the string for the call to the external variable method."""
        return _generatorprofile.GeneratorProfile_externalVariableMethodCallString(self)

    def setExternalVariableMethodCallString(self, externalVariableMethodCallString):
        r"""Sets the string for the call to the external variable method."""
        return _generatorprofile.GeneratorProfile_setExternalVariableMethodCallString(self, externalVariableMethodCallString)
    ...
    def interfaceInitialiseStatesAndConstantsMethodString(self):
        r"""Returns the string for the interface to initialise states and constants."""
    ...
    def setInterfaceInitialiseStatesAndConstantsMethodString(self, interfaceInitialiseStatesAndConstantsMethodString):
        r"""Sets the string for the interface to initialise states and constants."""
    ...
    def implementationInitialiseStatesAndConstantsMethodString(self):
        r"""Returns the string for the implementation to initialise states and constants."""
    ...
    def setImplementationInitialiseStatesAndConstantsMethodString(self, implementationInitialiseStatesAndConstantsMethodString):
        r"""Sets the string for the implementation to initialise states and constants."""
