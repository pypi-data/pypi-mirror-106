...
class Los:
	"""Los commands group definition. 12 total commands, 3 Sub-groups, 3 group commands"""
	...
	def arrival(self):
		...
		if not hasattr(self, '_arrival'):
			from .Los_.Arrival import Arrival
	...
	def departure(self):
		...
		if not hasattr(self, '_departure'):
			from .Los_.Departure import Departure
