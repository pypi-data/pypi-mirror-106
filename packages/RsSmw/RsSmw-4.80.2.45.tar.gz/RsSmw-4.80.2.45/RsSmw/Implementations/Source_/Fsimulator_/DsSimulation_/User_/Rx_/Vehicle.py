...
class Vehicle:
	"""Vehicle commands group definition. 5 total commands, 2 Sub-groups, 1 group commands"""
	...
	def predefined(self):
		...
		if not hasattr(self, '_predefined'):
			from .Vehicle_.Predefined import Predefined
	...
	def user(self):
		...
		if not hasattr(self, '_user'):
			from .Vehicle_.User import User
