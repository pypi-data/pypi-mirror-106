...
class Calc:
	"""Calc commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("calc", core, parent)
	...
	def get_mode(self) -> enums.AntModCalcMode:
		...
		Set how the distance between the antenna elements is defined: based on the physical distance or on the relative phase. \n
			:return: ant_mod_calc_rx_mod: SPACing| RELativphase SPACing To set the distance, use the corresponding command, for example method RsSmw.Source.Fsimulator.Mimo.Antenna.Tx.Espacing.horizontal. RELativphase Load an antenna pattern file that contains the relative phase description. See 'Antenna Pattern File Format'
		"""
	...
	def set_mode(self, ant_mod_calc_rx_mod: enums.AntModCalcMode) -> None:
		...
		Set how the distance between the antenna elements is defined: based on the physical distance or on the relative phase. \n
			:param ant_mod_calc_rx_mod: SPACing| RELativphase SPACing To set the distance, use the corresponding command, for example method RsSmw.Source.Fsimulator.Mimo.Antenna.Tx.Espacing.horizontal. RELativphase Load an antenna pattern file that contains the relative phase description. See 'Antenna Pattern File Format'
		"""
