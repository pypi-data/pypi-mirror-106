...
class Rdelay:
	...
	def get(self, fadingGroup=repcap.FadingGroup.Default, path=repcap.Path.Default) -> float:
		...
		Basic Delay (SOURce:FSIM:...:BDELay) and the Additional Delay (SOURce:FSIM:...:ADELay) . \n
			...
			:return: rdelay: float Sum of the values set with the commands FSIMulator:GROupst:PATHch:BDELay and FSIMulator:GROupst:PATHch:ADELay. Range: depends on the installed options* *) See 'Major Differences Between R&S SMW-B14 and R&S SMW-B15'."""
