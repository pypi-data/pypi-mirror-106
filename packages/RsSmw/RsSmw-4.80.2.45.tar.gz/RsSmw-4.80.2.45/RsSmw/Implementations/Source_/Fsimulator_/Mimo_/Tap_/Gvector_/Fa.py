...
class Fa:
	"""Fa commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Fa':
		...
		new_group = Fa(self._core, self._base.parent)
