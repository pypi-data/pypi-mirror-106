...
class Tx:
	"""Tx commands group definition. 8 total commands, 5 Sub-groups, 2 group commands"""
	...
	def columns(self):
		...
		if not hasattr(self, '_columns'):
			from .Tx_.Columns import Columns
			self._columns = Columns(self._core, self._base)
	...
	def get_pattern(self) -> enums.AntMod3DaNtPattern:
		...
		Sets the antenna pattern mode. \n
			:return: pattern: ISOtropic| USER| SEC3| SEC6| DIPole
		"""
	...
	def set_pattern(self, pattern: enums.AntMod3DaNtPattern) -> None:
		...
		Sets the antenna pattern mode. \n
			:param pattern: ISOtropic| USER| SEC3| SEC6| DIPole
		"""
