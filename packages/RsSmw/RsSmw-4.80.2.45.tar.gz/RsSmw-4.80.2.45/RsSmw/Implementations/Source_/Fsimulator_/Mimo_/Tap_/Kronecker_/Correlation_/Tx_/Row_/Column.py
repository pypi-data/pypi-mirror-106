...
class Column:
	"""Column commands group definition. 4 total commands, 4 Sub-groups, 0 group commands
	...
	def imaginary(self):
		...
		if not hasattr(self, '_imaginary'):
			from .Column_.Imaginary import Imaginary
	...
	def magnitude(self):
		...
		if not hasattr(self, '_magnitude'):
			from .Column_.Magnitude import Magnitude
	...
	def phase(self):
		...
		if not hasattr(self, '_phase'):
			from .Column_.Phase import Phase
