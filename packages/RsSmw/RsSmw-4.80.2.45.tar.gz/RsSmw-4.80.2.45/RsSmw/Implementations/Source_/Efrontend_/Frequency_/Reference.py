...
class Reference:
	"""Reference commands group definition. 2 total commands, 0 Sub-groups, 2 group commands"""
	...
	def get_value(self) -> enums.FeRefFreq:
		...
		Sets the reference frequency, that is used for RF frequency conversion at the R&S FE44A. \n
			:return: fe_ref_freq: FCURrent| FG5| FG64| F1G
		"""
	...
	def set_value(self, fe_ref_freq: enums.FeRefFreq) -> None:
		"""SCPI: [SOURce<HW>]:EFRontend:FREQuency:REFerence \n
		Snippet: driver.source.efrontend.frequency.reference.set_value(fe_ref_freq = enums.FeRefFreq.F1G) \n
		Sets the reference frequency, that is used for RF frequency conversion at the R&S FE44A. \n
			:param fe_ref_freq: FCURrent| FG5| FG64| F1G
		"""
