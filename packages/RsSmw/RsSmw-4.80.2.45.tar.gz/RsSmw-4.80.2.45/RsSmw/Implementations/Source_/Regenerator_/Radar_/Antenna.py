...
class Antenna:
	"""Antenna commands group definition. 4 total commands, 2 Sub-groups, 0 group commands"""
	...
	def gain(self):
		...
		if not hasattr(self, '_gain'):
			from .Antenna_.Gain import Gain
	...
	def reg(self):
		...
		if not hasattr(self, '_reg'):
			from .Antenna_.Reg import Reg
			self._reg = Reg(self._core, self._base)
		return self._reg
