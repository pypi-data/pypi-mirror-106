...
class UpInterval:
	"""UpInterval commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("upInterval", core, parent)
	...
	def get(self, objectIx=repcap.ObjectIx.Default) -> float:
		...
		No command help available \n
			...
			:return: rcs_update_interv: No help available"""
