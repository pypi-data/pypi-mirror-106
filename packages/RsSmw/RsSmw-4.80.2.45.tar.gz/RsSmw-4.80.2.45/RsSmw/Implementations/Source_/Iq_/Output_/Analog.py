...
class Analog:
	"""Analog commands group definition. 61 total commands, 5 Sub-groups, 4 group commands"""
	...
	def preset(self) -> None:
		...
		Sets the default settings (*RST values specified for the commands) .
			...
			- The state set with the command method RsSmw.Source.Iq.Output.Analog.state.
