...
class SymbolRate:
	"""SymbolRate commands group definition. 3 total commands, 2 Sub-groups, 1 group commands"""
	...
	def set(self, srate: float, digitalIq=repcap.DigitalIq.Default) -> None:
		...
		digitalIq_cmd_val = self._base.get_repcap_cmd_value(digitalIq, repcap.DigitalIq)
