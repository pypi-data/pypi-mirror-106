...
class Dpd:
	"""Dpd commands group definition. 53 total commands, 10 Sub-groups, 5 group commands"""
	...
	def preset(self) -> None:
		...
		method RsSmw.Source.Iq.Dpd.state. \n
		"""
	...
	def preset_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'SOURce<HwInstance>:IQ:DPD:PRESet')
