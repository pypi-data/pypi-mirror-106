...
class Lora:
	"""Lora commands group definition. 57 total commands, 7 Sub-groups, 6 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Lora.state. \n
		"""
