...
class Rtf:
	...
	def get_bb_selector(self) -> int:
		...
		Defines which baseband selector index is used in the serial messages to address the baseband. \n
	...
	def get_connector(self) -> enums.FeedbackConnector:
		...
		Snippet: value: enums.FeedbackConnector = driver.source.bb.nr5G.tcw.rtf.get_connector() \n
		Sets the connector used for the real-time feedback. \n
	...
	def set_connector(self, connector: enums.FeedbackConnector) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:TCW:RTF:CONNector \n
		Snippet: driver.source.bb.nr5G.tcw.rtf.set_connector(connector = enums.FeedbackConnector.GLOBal) \n
		Sets the connector used for the real-time feedback. \n
