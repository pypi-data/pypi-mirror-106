...
class Trigger:
	"""Trigger commands group definition. 22 total commands, 5 Sub-groups, 5 group commands"""
	...
	def get_sl_unit(self) -> enums.UnitSlB:
		...
		Sets the unit for the entry of the length of the signal sequence (method RsSmw.Source.Bb.Wlad.Trigger.slength) to be
		output in the Single trigger mode (SOUR:BB:WLAD:SEQ SING) . \n
