...
class Data:
	...
	def dpattern(self):
		...
		if not hasattr(self, '_dpattern'):
			from .Data_.Dpattern import Dpattern
			self._dpattern = Dpattern(self._core, self._base)
