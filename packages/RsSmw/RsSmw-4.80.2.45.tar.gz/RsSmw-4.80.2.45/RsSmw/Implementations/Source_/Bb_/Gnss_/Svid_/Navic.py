...
class Navic:
	"""Navic commands group definition. 122 total commands, 13 Sub-groups, 0 group commands"""
	...
	def healthy(self):
		...
		if not hasattr(self, '_healthy'):
			from .Navic_.Healthy import Healthy
	...
	def listPy(self):
		...
		if not hasattr(self, '_listPy'):
			from .Navic_.ListPy import ListPy
	...
	def mcontrol(self):
		...
		if not hasattr(self, '_mcontrol'):
			from .Navic_.Mcontrol import Mcontrol
	...
	def mpath(self):
		...
		if not hasattr(self, '_mpath'):
			from .Navic_.Mpath import Mpath
	...
	def nmessage(self):
		...
		if not hasattr(self, '_nmessage'):
			from .Navic_.Nmessage import Nmessage
	...
	def power(self):
		...
		if not hasattr(self, '_power'):
			from .Navic_.Power import Power
	...
	def prErrors(self):
		...
		if not hasattr(self, '_prErrors'):
			from .Navic_.PrErrors import PrErrors
	...
	def present(self):
		...
		if not hasattr(self, '_present'):
			from .Navic_.Present import Present
	...
	def sdynamics(self):
		...
		if not hasattr(self, '_sdynamics'):
			from .Navic_.Sdynamics import Sdynamics
	...
	def signal(self):
		...
		if not hasattr(self, '_signal'):
			from .Navic_.Signal import Signal
	...
	def simulated(self):
		...
		if not hasattr(self, '_simulated'):
			from .Navic_.Simulated import Simulated
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Navic_.State import State
	...
	def visibility(self):
		...
		if not hasattr(self, '_visibility'):
			from .Navic_.Visibility import Visibility
