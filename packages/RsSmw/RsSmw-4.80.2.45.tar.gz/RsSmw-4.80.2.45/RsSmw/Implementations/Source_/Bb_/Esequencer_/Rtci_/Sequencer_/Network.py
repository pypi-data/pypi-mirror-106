...
class Network:
	"""Network commands group definition. 4 total commands, 4 Sub-groups, 0 group commands"""
	...
	def hostname(self):
		...
		if not hasattr(self, '_hostname'):
			from .Network_.Hostname import Hostname
			self._hostname = Hostname(self._core, self._base)
	...
	def socket(self):
		...
		if not hasattr(self, '_socket'):
			from .Network_.Socket import Socket
	...
	def status(self):
		...
		if not hasattr(self, '_status'):
			from .Network_.Status import Status
