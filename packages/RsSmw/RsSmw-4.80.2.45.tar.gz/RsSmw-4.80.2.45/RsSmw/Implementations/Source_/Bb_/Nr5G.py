...
class Nr5G:
	"""Nr5G commands group definition. 981 total commands, 24 Sub-groups, 6 group commands"""
	...
	@property
	def sanity(self):
		"""sanity commands group. 0 Sub-classes, 1 commands."""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Nr5G.state. \n
		"""
