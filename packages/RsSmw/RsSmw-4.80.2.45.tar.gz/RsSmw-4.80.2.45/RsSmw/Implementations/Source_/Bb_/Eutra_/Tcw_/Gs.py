...
class Gs:
	...
	def get_ant_subset(self) -> enums.EutraTcwaNtSubset:
		...
		Enabled for test setups with four Rx antennas Determines the signal of which antenna couple, Antenna 1 and 2 (AS12) or
		Antenna 3 and 4 (AS34) , is generated by the instrument. \n
			:return: antenna_subset: AS34| AS12| ALL
		"""
	...
	def set_ant_subset(self, antenna_subset: enums.EutraTcwaNtSubset) -> None:
		...
		Enabled for test setups with four Rx antennas Determines the signal of which antenna couple, Antenna 1 and 2 (AS12) or
		Antenna 3 and 4 (AS34) , is generated by the instrument. \n
			:param antenna_subset: AS34| AS12| ALL
		"""
	...
	def get_gen_signals(self) -> enums.EutraTcwGeneratedSig:
		...
		Determines the signal generated by the instrument. \n
			:return: generated_signal: WSIF1AWGN| IF23| ALL WSIF1AWGN Wanted Signal, Interfere 1 and AWGN only; required in test setup with two instruments WSIF1AWGN Interferes 2 and 3 only; required in test setup with two instruments ALL The instrument generates all required signals
		"""
	...
	def set_gen_signals(self, generated_signal: enums.EutraTcwGeneratedSig) -> None:
		...
		Determines the signal generated by the instrument. \n
			:param generated_signal: WSIF1AWGN| IF23| ALL WSIF1AWGN Wanted Signal, Interfere 1 and AWGN only; required in test setup with two instruments WSIF1AWGN Interferes 2 and 3 only; required in test setup with two instruments ALL The instrument generates all required signals
		"""
	...
	def get_release(self) -> enums.EutraTcwRelease:
		...
		Sets the 3GPP test specification used as a guideline for the test cases. \n
			:return: release: REL8| REL9| REL10| REL11 | REL12
		"""
	...
	def set_release(self, release: enums.EutraTcwRelease) -> None:
		...
		Sets the 3GPP test specification used as a guideline for the test cases. \n
			:param release: REL8| REL9| REL10| REL11 | REL12
		"""
