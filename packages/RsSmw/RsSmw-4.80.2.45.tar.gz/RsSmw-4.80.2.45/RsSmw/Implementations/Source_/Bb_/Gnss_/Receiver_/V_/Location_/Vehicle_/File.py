...
class File:
	...
	def set(self, filename: str, vehicle=repcap.Vehicle.Default) -> None:
		...
		Selects a predefined or user-defined vehicle description (*.xvd) file. \n
			:param filename: Filename or complete file path; file extension is optional Query the existing files with: method RsSmw.Source.Bb.Gnss.Vehicle.Catalog.predefined method RsSmw.Source.Bb.Gnss.Vehicle.Catalog.user
	...
	def get(self, vehicle=repcap.Vehicle.Default) -> str:
		...
		Selects a predefined or user-defined vehicle description (*.xvd) file. \n
			:param vehicle: optional repeated capability selector. Default value: Nr1 (settable in the interface 'V')
			:return: filename: Filename or complete file path; file extension is optional Query the existing files with: method RsSmw.Source.Bb.Gnss.Vehicle.Catalog.predefined method RsSmw.Source.Bb.Gnss.Vehicle.Catalog.user"""
		vehicle_cmd_val = self._base.get_repcap_cmd_value(vehicle, repcap.Vehicle)
