...
class Eutra:
	"""Eutra commands group definition. 1268 total commands, 18 Sub-groups, 7 group commands"""
	...
	def downlink(self):
		...
		if not hasattr(self, '_downlink'):
			from .Eutra_.Downlink import Downlink
	...
	def noise(self):
		...
		if not hasattr(self, '_noise'):
			from .Eutra_.Noise import Noise
	...
	def notch(self):
		...
		if not hasattr(self, '_notch'):
			from .Eutra_.Notch import Notch
	...
	def uplink(self):
		...
		if not hasattr(self, '_uplink'):
			from .Eutra_.Uplink import Uplink
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Eutra.state. \n
		"""
