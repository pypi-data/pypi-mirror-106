...
class Uplink:
	"""Uplink commands group definition. 12 total commands, 3 Sub-groups, 9 group commands"""
	...
	def logPoint(self):
		...
		if not hasattr(self, '_logPoint'):
			from .Uplink_.LogPoint import LogPoint
	...
	def set_pucch(self, pucch_log_state: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param pucch_log_state: 0| 1| OFF| ON
		"""
	...
	def set_pucdrs(self, pusch_drs_log: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param pusch_drs_log: 0| 1| OFF| ON
		"""
	...
	def get_pusch(self) -> bool:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:return: pusch_log_state: 0| 1| OFF| ON
		"""
	...
	def set_pusch(self, pusch_log_state: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param pusch_log_state: 0| 1| OFF| ON
		"""
	...
	def set_sld(self, log_sidelink_drs: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param log_sidelink_drs: 0| 1| OFF| ON
		"""
