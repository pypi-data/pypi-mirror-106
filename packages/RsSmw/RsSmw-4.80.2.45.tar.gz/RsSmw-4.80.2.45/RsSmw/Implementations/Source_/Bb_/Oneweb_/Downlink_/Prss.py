...
class Prss:
	...
	def get_mi_pattern(self) -> MiPatternStruct:
		...
		Snippet: value: MiPatternStruct = driver.source.bb.oneweb.downlink.prss.get_mi_pattern() \n
		No command help available \n
			:return: structure: for return value, see the help for MiPatternStruct structure arguments.
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:ONEWeb:DL:PRSS:MIPattern?', self.__class__.MiPatternStruct())

	def set_mi_pattern(self, value: MiPatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:ONEWeb:DL:PRSS:MIPattern \n
		Snippet: driver.source.bb.oneweb.downlink.prss.set_mi_pattern(value = MiPatternStruct()) \n
		No command help available \n
			:param value: see the help for MiPatternStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:ONEWeb:DL:PRSS:MIPattern', value)
