...
class Sequencer:
	"""Sequencer commands group definition. 3 total commands, 3 Sub-groups, 0 group commands
	...
	def comment(self):
		...
		if not hasattr(self, '_comment'):
			from .Sequencer_.Comment import Comment
			self._comment = Comment(self._core, self._base)
	...
	def date(self):
		...
		if not hasattr(self, '_date'):
			from .Sequencer_.Date import Date
	...
	def file(self):
		...
		if not hasattr(self, '_file'):
			from .Sequencer_.File import File
