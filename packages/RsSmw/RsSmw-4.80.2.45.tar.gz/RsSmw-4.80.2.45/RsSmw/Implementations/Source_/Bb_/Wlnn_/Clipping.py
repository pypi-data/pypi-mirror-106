...
class Clipping:
	...
	def get_level(self) -> int:
		...
		if method RsSmw.Source.Bb.Wlnn.Clipping.state is set to ON. \n
	...
	def get_state(self) -> bool:
		...
		Activates level clipping (Clipping) . The value is defined with method RsSmw.Source.Bb.Wlnn.Clipping.level, the mode of
		calculation with method RsSmw.Source.Bb.Wlnn.Clipping.mode. \n
