...
class Nfc:
	"""Nfc commands group definition. 192 total commands, 10 Sub-groups, 12 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Nfc.state. \n
		"""
