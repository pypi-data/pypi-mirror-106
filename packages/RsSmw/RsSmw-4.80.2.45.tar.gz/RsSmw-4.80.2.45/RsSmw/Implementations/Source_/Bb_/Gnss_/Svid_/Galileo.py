...
class Galileo:
	"""Galileo commands group definition. 207 total commands, 13 Sub-groups, 0 group commands"""
	...
	def healthy(self):
		...
		if not hasattr(self, '_healthy'):
			from .Galileo_.Healthy import Healthy
	...
	def listPy(self):
		...
		if not hasattr(self, '_listPy'):
			from .Galileo_.ListPy import ListPy
	...
	def mcontrol(self):
		...
		if not hasattr(self, '_mcontrol'):
			from .Galileo_.Mcontrol import Mcontrol
	...
	def mpath(self):
		...
		if not hasattr(self, '_mpath'):
			from .Galileo_.Mpath import Mpath
	...
	def nmessage(self):
		...
		if not hasattr(self, '_nmessage'):
			from .Galileo_.Nmessage import Nmessage
	...
	def power(self):
		...
		if not hasattr(self, '_power'):
			from .Galileo_.Power import Power
	...
	def prErrors(self):
		...
		if not hasattr(self, '_prErrors'):
			from .Galileo_.PrErrors import PrErrors
	...
	def present(self):
		...
		if not hasattr(self, '_present'):
			from .Galileo_.Present import Present
	...
	def sdynamics(self):
		...
		if not hasattr(self, '_sdynamics'):
			from .Galileo_.Sdynamics import Sdynamics
	...
	def signal(self):
		...
		if not hasattr(self, '_signal'):
			from .Galileo_.Signal import Signal
	...
	def simulated(self):
		...
		if not hasattr(self, '_simulated'):
			from .Galileo_.Simulated import Simulated
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Galileo_.State import State
	...
	def visibility(self):
		...
		if not hasattr(self, '_visibility'):
			from .Galileo_.Visibility import Visibility
