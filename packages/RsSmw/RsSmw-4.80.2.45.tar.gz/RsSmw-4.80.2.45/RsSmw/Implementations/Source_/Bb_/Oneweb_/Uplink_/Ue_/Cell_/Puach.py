...
class Puach:
	"""Puach commands group definition. 9 total commands, 5 Sub-groups, 0 group commands"""
	...
	def ccoding(self):
		...
		if not hasattr(self, '_ccoding'):
			from .Puach_.Ccoding import Ccoding
	...
	def dselect(self):
		...
		if not hasattr(self, '_dselect'):
			from .Puach_.Dselect import Dselect
	...
	def pattern(self):
		...
		if not hasattr(self, '_pattern'):
			from .Puach_.Pattern import Pattern
	...
	def scrambling(self):
		...
		if not hasattr(self, '_scrambling'):
			from .Puach_.Scrambling import Scrambling
