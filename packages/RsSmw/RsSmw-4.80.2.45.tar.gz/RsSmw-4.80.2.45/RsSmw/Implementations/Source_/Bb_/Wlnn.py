...
class Wlnn:
	"""Wlnn commands group definition. 295 total commands, 9 Sub-groups, 8 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Wlnn.state. \n
		"""
