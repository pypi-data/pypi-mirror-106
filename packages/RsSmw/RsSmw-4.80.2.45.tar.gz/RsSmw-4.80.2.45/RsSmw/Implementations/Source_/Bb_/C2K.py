...
class C2K:
	"""C2K commands group definition. 147 total commands, 13 Sub-groups, 5 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.C2K.state. \n
		"""
