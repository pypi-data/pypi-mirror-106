...
class Ws:
	...
	def get_sc_spacing(self) -> enums.Numerology:
		...
		Sets the subcarrier spacing. \n
			:return: ws_subcar_spacing: N15| N30| N60| X60| N120| N240 N15, N30, N60, N120, N240 Normal cyclic prefix, value in kHz E60 Extended cyclic prefix, 60 kHz
		"""
	...
	def set_sc_spacing(self, ws_subcar_spacing: enums.Numerology) -> None:
		...
		Sets the subcarrier spacing. \n
			:param ws_subcar_spacing: N15| N30| N60| X60| N120| N240 N15, N30, N60, N120, N240 Normal cyclic prefix, value in kHz E60 Extended cyclic prefix, 60 kHz
		"""
