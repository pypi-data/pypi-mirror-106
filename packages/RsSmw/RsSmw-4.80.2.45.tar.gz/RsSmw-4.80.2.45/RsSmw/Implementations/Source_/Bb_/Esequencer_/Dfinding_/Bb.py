...
class Bb:
	"""Bb commands group definition. 3 total commands, 3 Sub-groups, 0 group commands
	...
	def comment(self):
		...
		if not hasattr(self, '_comment'):
			from .Bb_.Comment import Comment
