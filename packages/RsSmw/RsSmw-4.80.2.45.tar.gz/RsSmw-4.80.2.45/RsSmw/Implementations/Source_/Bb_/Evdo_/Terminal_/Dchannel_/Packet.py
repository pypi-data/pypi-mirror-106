...
class Packet:
	...
	def ccoding(self):
		...
		if not hasattr(self, '_ccoding'):
			from .Packet_.Ccoding import Ccoding
	...
	def drate(self):
		...
		if not hasattr(self, '_drate'):
			from .Packet_.Drate import Drate
	...
	def modulation(self):
		...
		if not hasattr(self, '_modulation'):
			from .Packet_.Modulation import Modulation
	...
	def psize(self):
		...
		if not hasattr(self, '_psize'):
			from .Packet_.Psize import Psize
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Packet_.State import State
	...
	def subPackets(self):
		...
		if not hasattr(self, '_subPackets'):
			from .Packet_.SubPackets import SubPackets
