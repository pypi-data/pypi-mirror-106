...
class Xpusch:
	"""Xpusch commands group definition. 7 total commands, 6 Sub-groups, 0 group commands"""
	...
	def dselect(self):
		...
		if not hasattr(self, '_dselect'):
			from .Xpusch_.Dselect import Dselect
	...
	def pattern(self):
		...
		if not hasattr(self, '_pattern'):
			from .Xpusch_.Pattern import Pattern
	...
	def scrambling(self):
		...
		if not hasattr(self, '_scrambling'):
			from .Xpusch_.Scrambling import Scrambling
	...
	def txMode(self):
		...
		if not hasattr(self, '_txMode'):
			from .Xpusch_.TxMode import TxMode
