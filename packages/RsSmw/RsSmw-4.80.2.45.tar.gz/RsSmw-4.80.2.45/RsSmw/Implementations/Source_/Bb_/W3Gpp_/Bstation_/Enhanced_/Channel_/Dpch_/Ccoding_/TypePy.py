...
class TypePy:
	...
	def set(self, type_py: enums.ChanCodType, channelNull=repcap.ChannelNull.Default) -> None:
		...
		(method RsSmw.Source.Bb.W3Gpp.Bstation.Enhanced.Channel.Dpch.Ccoding.State.set) the slot format (method RsSmw.Source.Bb.
		W3Gpp.Bstation.Enhanced.Channel.Dpch.Ccoding.Sformat.set) and thus the symbol rate (method RsSmw.Source.Bb.W3Gpp.Bstation.
		Enhanced.Channel.Dpch.Ccoding.SymbolRate.get_) , the bits per frame, (method RsSmw.Source.Bb.W3Gpp.Bstation.Enhanced.
		Channel.Dpch.Ccoding.BpFrame.get_) , the pilot length (method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Dpcch.Plength.set)
		and the TFCI state (method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Dpcch.Tfci.State.set) are set to the associated values. \n
