...
class Setting:
	...
	def load_file(self, filename: str) -> None:
		...
		specific directory. \n
			:param filename: 'filename' Filename or complete file path; file extension can be omitted Query the existing files with the command method RsSmw.Source.Bb.Gnss.Setting.Catalog.value.
		"""
		param = Conversions.value_to_quoted_str(filename)
