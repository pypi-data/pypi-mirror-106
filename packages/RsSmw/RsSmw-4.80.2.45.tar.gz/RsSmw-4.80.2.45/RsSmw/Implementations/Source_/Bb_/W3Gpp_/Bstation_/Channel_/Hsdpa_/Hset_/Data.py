...
class Data:
	...
	def set(self, data: enums.DataSourceA, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Selects the data source for the transport channel. \n
			:param data: ZERO| ONE| PATTern| PN9| PN11| PN15| PN16| PN20| PN21| PN23| DLISt ZERO | ONE Internal 0 and 1 data is used. PATTern Internal data is used. Use the command method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Hsdpa.Hset.Data.Pattern.set to set the pattern. DLISt A data list is used. Use the command method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Hsdpa.Hset.Data.Dselect.set to select the data list file.
