...
class Tdscdma:
	"""Tdscdma commands group definition. 357 total commands, 12 Sub-groups, 6 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Tdscdma.state. \n
		"""
