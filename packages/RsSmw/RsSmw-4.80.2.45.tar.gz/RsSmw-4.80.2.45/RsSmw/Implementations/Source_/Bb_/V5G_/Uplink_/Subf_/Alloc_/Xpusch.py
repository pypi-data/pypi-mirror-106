...
class Xpusch:
	"""Xpusch commands group definition. 6 total commands, 6 Sub-groups, 0 group commands"""
	...
	def rbCount(self):
		...
		if not hasattr(self, '_rbCount'):
			from .Xpusch_.RbCount import RbCount
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Xpusch_.State import State
	...
	def physBits(self):
		...
		if not hasattr(self, '_physBits'):
			from .Xpusch_.PhysBits import PhysBits
	...
	def power(self):
		...
		if not hasattr(self, '_power'):
			from .Xpusch_.Power import Power
	...
	def rbOffset(self):
		...
		if not hasattr(self, '_rbOffset'):
			from .Xpusch_.RbOffset import RbOffset
	...
	def modulation(self):
		...
		if not hasattr(self, '_modulation'):
			from .Xpusch_.Modulation import Modulation
