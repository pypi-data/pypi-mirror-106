...
class Sbas:
	...
	def get_state(self) -> bool:
		...
		Queries if at least one of the SBAS system is enabled. \n
			:return: state: 0| 1| OFF| ON 1 At least one SBAS system is enabled. To enable each of the SBAS systems, use the corresponding command, e.g. method RsSmw.Source.Bb.Gnss.System.Sbas.state. 0 All SBAS systems are disabled.
		"""
