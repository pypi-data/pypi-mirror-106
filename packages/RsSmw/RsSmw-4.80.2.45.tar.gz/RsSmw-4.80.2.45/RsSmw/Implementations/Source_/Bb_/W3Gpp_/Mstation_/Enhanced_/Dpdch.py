...
class Dpdch:
	"""Dpdch commands group definition. 37 total commands, 4 Sub-groups, 4 group commands"""
	...
	def get_interleaver_2(self) -> bool:
		...
		1 can be activated and deactivated for each channel individually (method RsSmw.Source.Bb.W3Gpp.Mstation.Enhanced.Dpdch.
	...
	def get_orate(self) -> enums.SymbRate:
		...
		command method RsSmw.Source.Bb.W3Gpp.Mstation.Dpdch.Orate.set. This setting also defines the number of active channels,
