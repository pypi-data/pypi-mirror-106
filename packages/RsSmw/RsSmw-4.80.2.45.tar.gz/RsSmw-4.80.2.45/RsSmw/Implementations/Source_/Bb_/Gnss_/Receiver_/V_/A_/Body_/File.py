...
class File:
	...
	def set(self, body_mask_file: str, vehicle=repcap.Vehicle.Default, antenna=repcap.Antenna.Default) -> None:
		...
		the default and in a specific directory. \n
			:param body_mask_file: 'filename' Filename or complete file path; file extension can be omitted. Query the existing files with the following commands: method RsSmw.Source.Bb.Gnss.Apattern.Catalog.predefined method RsSmw.Source.Bb.Gnss.Apattern.Catalog.user
