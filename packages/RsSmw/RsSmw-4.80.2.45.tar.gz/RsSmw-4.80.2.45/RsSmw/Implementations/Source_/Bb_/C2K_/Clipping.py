...
class Clipping:
	...
	def get_level(self) -> int:
		...
		clipping is activated with the command method RsSmw.Source.Bb.C2K.Clipping.state \n
	...
	def get_state(self) -> bool:
		...
		The command activates level clipping (Clipping) . The value is defined with the command method RsSmw.Source.Bb.C2K.
		Clipping.level, the mode of calculation with the command method RsSmw.Source.Bb.C2K.Clipping.mode. \n
