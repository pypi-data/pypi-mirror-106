...
class Srs:
	...
	def get_dsfc(self) -> str:
		...
		SRS subframe configuration (method RsSmw.Source.Bb.Eutra.Uplink.Refsig.Srs.csrs) and the dduplexing mode (method RsSmw.
	...
	def get_tsfc(self) -> str:
		...
		subframe configuration (method RsSmw.Source.Bb.Eutra.Uplink.Refsig.Srs.csrs) and the duplexing mode (method RsSmw.Source.
		Bb.Eutra.duplexing) . \n
			:return: tsfc: string
		"""
