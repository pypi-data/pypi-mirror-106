...
class Smodulation:
	"""Smodulation commands group definition. 7 total commands, 4 Sub-groups, 2 group commands"""
	...
	def ddelay(self):
		...
		if not hasattr(self, '_ddelay'):
			from .Smodulation_.Ddelay import Ddelay
			self._ddelay = Ddelay(self._core, self._base)
		return self._ddelay
