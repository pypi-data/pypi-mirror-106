...
class Ofdm:
	"""Ofdm commands group definition. 100 total commands, 14 Sub-groups, 17 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Ofdm.state. \n
		"""
