...
class Srs:
	...
	def get_dsfc(self) -> str:
		...
		SRS subframe configuration (method RsSmw.Source.Bb.Oneweb.Uplink.Refsig.Srs.csrs) and the duplexing mode (method RsSmw.
		Source.Bb.Oneweb.duplexing. \n
	...
	def get_tsfc(self) -> str:
		...
		subframe configuration (method RsSmw.Source.Bb.Oneweb.Uplink.Refsig.Srs.csrs) and the duplexing mode (method RsSmw.Source.
		Bb.Oneweb.duplexing) . \n
			:return: tsfc: string
		"""
