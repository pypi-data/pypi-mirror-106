...
class SdSelection:
	"""SdSelection commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("sdSelection", core, parent)
	...
	def set(self, sd_selection: str, testMode=repcap.TestMode.Default, slot=repcap.Slot.Default, channel=repcap.Channel.Default) -> None:
		...
		the data source with the aid of command method RsSmw.Source.Bb.Tetra.Sconfiguration.Tmode.Slot.Ldirection.Sdata.set. \n
