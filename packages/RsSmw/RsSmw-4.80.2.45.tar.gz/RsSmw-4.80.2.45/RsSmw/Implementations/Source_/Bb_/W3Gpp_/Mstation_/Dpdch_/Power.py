...
class Power:
	...
	def set(self, power: float, mobileStation=repcap.MobileStation.Default) -> None:
		...
		Power to 0 dB' is executed (method RsSmw.Source.Bb.W3Gpp.Power.Adjust.set) , the power is normalized to a total power for
		all channels of 0 dB. The power ratios of the individual channels remains unchanged. Note: The uplink channels are not
