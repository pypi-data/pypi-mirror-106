...
class LogGen:
	"""LogGen commands group definition. 21 total commands, 2 Sub-groups, 4 group commands"""
	...
	def downlink(self):
		...
		if not hasattr(self, '_downlink'):
			from .LogGen_.Downlink import Downlink
	...
	def uplink(self):
		...
		if not hasattr(self, '_uplink'):
			from .LogGen_.Uplink import Uplink
