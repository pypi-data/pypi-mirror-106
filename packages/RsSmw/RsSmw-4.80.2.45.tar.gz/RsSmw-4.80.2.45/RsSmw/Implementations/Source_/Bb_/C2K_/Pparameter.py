...
class Pparameter:
	...
	def get_crest(self) -> enums.CresFactMode:
		...
		after execution of command method RsSmw.Source.Bb.C2K.Pparameter.Execute.set. The setting of command method RsSmw.Source.
		Bb.C2K.Bstation.Cgroup.Coffset.Wcode.set is adjusted according to the selection. \n
