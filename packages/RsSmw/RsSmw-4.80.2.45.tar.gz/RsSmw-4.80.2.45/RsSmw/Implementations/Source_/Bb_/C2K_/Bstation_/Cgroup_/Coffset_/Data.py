...
class Data:
	...
	def set(self, data: enums.DataSourceA, baseStation=repcap.BaseStation.Default, groupNull=repcap.GroupNull.Default, offset=repcap.Offset.Default) -> None:
		...
		selected radio configuration. The data source for the power control bits is selected with the command method RsSmw.Source.
		Bb.C2K.Bstation.Cgroup.Coffset.Tpc.Data.set. \n
