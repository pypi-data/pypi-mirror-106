...
class Powc:
	"""Powc commands group definition. 4 total commands, 0 Sub-groups, 4 group commands"""
	...
	def get_ref_channel(self) -> enums.EutraPowcRefChan:
		...
		If method RsSmw.Source.Bb.Eutra.Powc.levReferenceUEBurst, queries the channel type to that the measured RMS and PEP are
		referring. \n
	...
	def get_ref_subframe(self) -> int:
		...
		If method RsSmw.Source.Bb.Eutra.Powc.levReferenceUEBurst, queries the subframe or slot number used as reference for
	...
	def get_rue(self) -> enums.MobStatType:
		...
		If method RsSmw.Source.Bb.Eutra.Powc.levReferenceUEBurst, queries the UE to that the measured RMS and PEP are referring. \n
