...
class Trigger:
	"""Trigger commands group definition. 25 total commands, 6 Sub-groups, 6 group commands"""
	...
	def get_slength(self) -> int:
		...
		Defines the length of the signal sequence that is output in the SINGle trigger mode. \n
			:return: slength: integer Maximun value dependents on the selected units method RsSmw.Source.Bb.Arbitrary.Trigger.slUnit as follows: SAMPle: Max = 232-1 SEQuence: Max = 1000 Range: 1 to dynamic
		"""
	...
	def set_slength(self, slength: int) -> None:
		...
		Defines the length of the signal sequence that is output in the SINGle trigger mode. \n
			:param slength: integer Maximun value dependents on the selected units method RsSmw.Source.Bb.Arbitrary.Trigger.slUnit as follows: SAMPle: Max = 232-1 SEQuence: Max = 1000 Range: 1 to dynamic
		"""
