...
class Data:
	...
	def set(self, data: enums.TpcDataSour, mobileStation=repcap.MobileStation.Default) -> None:
		...
		The command determines the data source for the TPC field of the PCPCH. \n
			:param data: ZERO| ONE| PATTern| DLISt DLISt A data list is used. The data list is selected with the command method RsSmw.Source.Bb.W3Gpp.Mstation.Pcpch.Tpc.Data.Dselect.set. ZERO | ONE Internal 0 and 1 data is used. PATTern Internal data is used. The bit pattern for the data is defined by the command method RsSmw.Source.Bb.W3Gpp.Mstation.Pcpch.Tpc.Data.Pattern.set. The maximum length is 64 bits.
