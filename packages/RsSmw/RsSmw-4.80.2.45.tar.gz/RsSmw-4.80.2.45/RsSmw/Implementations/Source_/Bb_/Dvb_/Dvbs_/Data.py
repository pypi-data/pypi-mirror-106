...
class Data:
	...
	def get_pattern(self) -> PatternStruct:
		...
		Snippet: value: PatternStruct = driver.source.bb.dvb.dvbs.data.get_pattern() \n
		Sets the the bit pattern. \n
			:return: structure: for return value, see the help for PatternStruct structure arguments.
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:DVB:DVBS:DATA:PATTern?', self.__class__.PatternStruct())

	def set_pattern(self, value: PatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBS:DATA:PATTern \n
		Snippet: driver.source.bb.dvb.dvbs.data.set_pattern(value = PatternStruct()) \n
		Sets the the bit pattern. \n
			:param value: see the help for PatternStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:DVB:DVBS:DATA:PATTern', value)
	...
	def get_value(self) -> enums.DvbDataSource:
		...
		Selects the data source. \n
			:return: data: ZERO| ONE| PATTern| PN9| PN11| PN15| PN16| PN20| PN21| PN23| DLISt| TFILe| GFILe PATTern To set the bit pattern, use the command BB:DVB:DATA:PATTern. DLISt|TFILe|GFILe To select the data list, TS file or the GSE file, use the command BB:DVB:DATA.
		"""
	...
	def set_value(self, data: enums.DvbDataSource) -> None:
		...
		Selects the data source. \n
			:param data: ZERO| ONE| PATTern| PN9| PN11| PN15| PN16| PN20| PN21| PN23| DLISt| TFILe| GFILe PATTern To set the bit pattern, use the command BB:DVB:DATA:PATTern. DLISt|TFILe|GFILe To select the data list, TS file or the GSE file, use the command BB:DVB:DATA.
		"""
