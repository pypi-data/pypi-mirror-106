...
class Pparameter:
	...
	def get_crest(self) -> enums.CresFactMode:
		...
		effect only after execution of command method RsSmw.Source.Bb.W3Gpp.Pparameter.Execute.set.
			INTRO_CMD_HELP: The settings of commands \n
			- method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Ccode.set and
			- method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Toffset.set
	...
	def get_schannels(self) -> bool:
		...
		equipment for synchronization. The setting takes effect only after execution of command method RsSmw.Source.Bb.W3Gpp.
