...
class Dm:
	"""Dm commands group definition. 107 total commands, 18 Sub-groups, 8 group commands"""
	...
	def get_format_py(self) -> enums.BbDmModType:
		...
		Sets the modulation type. When a standard is selected (method RsSmw.Source.Bb.Dm.Standard.value) , the modulation type is
	...
	def preset(self) -> None:
		...
		with the command method RsSmw.Source.Bb.Dm.state \n
		"""
