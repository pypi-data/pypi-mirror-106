...
class Trigger:
	"""Trigger commands group definition. 26 total commands, 5 Sub-groups, 5 group commands"""
	...
	def get_sl_unit(self) -> enums.UnitSlB:
		...
		Defines the unit for the entry of the length of the signal sequence (method RsSmw.Source.Bb.Wlnn.Trigger.slength) to be
