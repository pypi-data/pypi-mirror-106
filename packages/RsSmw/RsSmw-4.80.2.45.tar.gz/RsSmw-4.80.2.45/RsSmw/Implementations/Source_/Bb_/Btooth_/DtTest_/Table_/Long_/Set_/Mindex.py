...
class Mindex:
	...
	def set(self, mindex: float, channel=repcap.Channel.Default) -> None:
		...
		the command method RsSmw.Source.Bb.Btooth.SymbolRate.
		variation <img border='0' src='images/img388349408bdb4b210a00206a01f5817c_1_--_--_PNG96.png' alt='' title=''>= 'frequency
		deviation', set with the command method RsSmw.Source.Bb.Btooth.Msettings.fdeviation According to the Bluetooth standard,
