...
class Step:
	...
	def get_state(self) -> bool:
		...
		Activates the edit mode to set the power step. To determine the power step size, use command method RsSmw.Source.Bb.Pramp.
		Ramp.Stair.Step.level. \n
			:return: enable_power_step: 0| 1| OFF| ON
		"""
	...
	def set_state(self, enable_power_step: bool) -> None:
		...
		Activates the edit mode to set the power step. To determine the power step size, use command method RsSmw.Source.Bb.Pramp.
		Ramp.Stair.Step.level. \n
			:param enable_power_step: 0| 1| OFF| ON
		"""
