...
class Alevel:
	...
	def get_value(self) -> float:
		...
		If method RsSmw.Source.Correction.Fresponse.Rf.User.state1, queries the absolute level correction value. \n
	...
	def get_state(self) -> bool:
		...
		method RsSmw.Source.Correction.Fresponse.Rf.User.Alevel.value. \n
