...
class Bbin:
	"""Bbin commands group definition. 31 total commands, 7 Sub-groups, 9 group commands"""
	...
	def get_mperiod(self) -> int:
		...
		For method RsSmw.Source.Bbin.Digital.source CODER1|CODER2 Sets the recording duration for measuring the baseband input
		signal by executed method RsSmw.Source.Bbin.Alevel.Execute.set. \n
	...
	def get_state(self) -> bool:
		...
		Switches the feeding of an external analog signal into the signal path on/off. \n
