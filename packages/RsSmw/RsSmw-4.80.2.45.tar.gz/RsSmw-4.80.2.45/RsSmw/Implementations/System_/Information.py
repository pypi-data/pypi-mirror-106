...
class Information:
	"""Information commands group definition. 4 total commands, 1 Sub-groups, 2 group commands"""
	...
	def test(self):
		...
		if not hasattr(self, '_test'):
			from .Information_.Test import Test
	...
	def clone(self) -> 'Information':
		...
		new_group = Information(self._core, self._base.parent)
