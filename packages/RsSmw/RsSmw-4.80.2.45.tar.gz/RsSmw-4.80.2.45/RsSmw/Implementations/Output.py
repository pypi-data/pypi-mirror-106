...
class Output:
	"""Output commands group definition. 16 total commands, 7 Sub-groups, 2 group commands"""
	...
	def blank(self):
		...
		if not hasattr(self, '_blank'):
			from .Output_.Blank import Blank
