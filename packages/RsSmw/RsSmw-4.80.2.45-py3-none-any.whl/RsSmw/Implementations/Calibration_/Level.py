...
class Level:
	"""Level commands group definition. 10 total commands, 4 Sub-groups, 4 group commands"""
	...
	def haccuracy(self):
		...
		if not hasattr(self, '_haccuracy'):
			from .Level_.Haccuracy import Haccuracy
			self._haccuracy = Haccuracy(self._core, self._base)
