...
class Restart:
	...
	def get_state(self) -> enums.NumbersI:
		"""SCPI: BERT:SETup:RESTart:[STATe] \n
		Snippet: value: enums.NumbersI = driver.bert.setup.restart.get_state() \n
	...
	def set_state(self, state: enums.NumbersI) -> None:
		"""SCPI: BERT:SETup:RESTart:[STATe] \n
		Snippet: driver.bert.setup.restart.set_state(state = enums.NumbersI._0) \n
		Activates/deactivates an external restart of the BERT measurement. \n
			:param state: 0| OFF| 1| ON
		"""
		param = Conversions.enum_scalar_to_str(state, enums.NumbersI)
