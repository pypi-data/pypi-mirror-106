...
class Path:
	"""Path commands group definition. 3 total commands, 3 Sub-groups, 0 group commands
	...
	def prof(self):
		...
		if not hasattr(self, '_prof'):
			from .Path_.Prof import Prof
			self._prof = Prof(self._core, self._base)
		return self._prof
