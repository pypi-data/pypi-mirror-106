...
class Hopping:
	...
	def get_mode(self) -> enums.FadHoppMode:
		...
		This is a password-protected function. Unlock the protection level 1 to access it. See SYSTem. Activates frequency
		hopping and determines how fading is resumed after a frequency hop. Note: Activate list mode and load the frequency table
		befor activating frequency hopping. \n
