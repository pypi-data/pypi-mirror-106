...
class Clock:
	"""Clock commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""
	...
	def get_rate(self) -> enums.BbClock:
		...
		Queries the clock rate the fading simulator is using for the signal processing. \n
			:return: cloc_rate: CR200| CR100| CR050| CR025 | CR250| CR125| CR062 CR200 = 200 MHz, CR100 = 100 MHz, CR050 = 50 MHz, CR025 = 25 MHz CR250 = 250 MHz, CR125 = 125 MHz, CR062 = 62.5 MHz The value depends on the selected 'System Configuration' and influences the bandwidth of the generated signal. *) CR200M (R&S SMW-B10) /CR250M (R&S SMW-B9)
		"""
