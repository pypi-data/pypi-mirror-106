...
class Gg:
	"""Gg commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Gg':
		...
		new_group = Gg(self._core, self._base.parent)
