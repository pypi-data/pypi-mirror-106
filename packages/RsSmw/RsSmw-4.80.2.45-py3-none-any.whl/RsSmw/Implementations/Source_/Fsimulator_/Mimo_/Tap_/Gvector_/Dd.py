...
class Dd:
	"""Dd commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'Dd':
		...
		new_group = Dd(self._core, self._base.parent)
