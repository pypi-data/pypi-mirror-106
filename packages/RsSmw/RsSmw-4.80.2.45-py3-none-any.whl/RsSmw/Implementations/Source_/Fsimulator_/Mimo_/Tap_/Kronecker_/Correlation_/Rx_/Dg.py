...
class Dg:
	"""Dg commands group definition. 4 total commands, 4 Sub-groups, 0 group commands"""
	...
	def imaginary(self):
		...
		if not hasattr(self, '_imaginary'):
			from .Dg_.Imaginary import Imaginary
	...
	def magnitude(self):
		...
		if not hasattr(self, '_magnitude'):
			from .Dg_.Magnitude import Magnitude
