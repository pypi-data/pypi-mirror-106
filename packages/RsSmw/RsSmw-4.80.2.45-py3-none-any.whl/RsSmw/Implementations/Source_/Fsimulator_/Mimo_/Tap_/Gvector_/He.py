...
class He:
	"""He commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def clone(self) -> 'He':
		...
		new_group = He(self._core, self._base.parent)
