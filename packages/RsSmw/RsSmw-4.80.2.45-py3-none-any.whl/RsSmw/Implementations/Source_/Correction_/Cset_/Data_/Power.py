...
class Power:
	"""Power commands group definition. 3 total commands, 1 Sub-groups, 2 group commands"""
	...
	def sgamma(self):
		...
		if not hasattr(self, '_sgamma'):
			from .Power_.Sgamma import Sgamma
			self._sgamma = Sgamma(self._core, self._base)
		return self._sgamma
