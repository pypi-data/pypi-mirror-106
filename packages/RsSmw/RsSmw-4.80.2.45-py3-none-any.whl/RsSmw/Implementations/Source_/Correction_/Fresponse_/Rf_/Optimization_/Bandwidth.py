...
class Bandwidth:
	...
	def get_mode(self) -> enums.AutoManualMode:
		...
		For method RsSmw.Source.Correction.Fresponse.Rf.Optimization.modeQHIG|QHT, sets how the signal bandwidth is estimated:
	...
	def get_value(self) -> int:
		...
		Sets the signal compensation bandwidth for method RsSmw.Source.Correction.Fresponse.Rf.Optimization.Bandwidth.mode MAN. \n
