...
class Doherty:
	"""Doherty commands group definition. 47 total commands, 11 Sub-groups, 2 group commands"""
	...
	def lrf(self):
		...
		if not hasattr(self, '_lrf'):
			from .Doherty_.Lrf import Lrf
			self._lrf = Lrf(self._core, self._base)
		return self._lrf
	...
	def measurement(self):
		...
		if not hasattr(self, '_measurement'):
			from .Doherty_.Measurement import Measurement
	...
	def phase(self):
		...
		if not hasattr(self, '_phase'):
			from .Doherty_.Phase import Phase
	...
	def power(self):
		...
		if not hasattr(self, '_power'):
			from .Doherty_.Power import Power
	...
	def setting(self):
		...
		if not hasattr(self, '_setting'):
			from .Doherty_.Setting import Setting
