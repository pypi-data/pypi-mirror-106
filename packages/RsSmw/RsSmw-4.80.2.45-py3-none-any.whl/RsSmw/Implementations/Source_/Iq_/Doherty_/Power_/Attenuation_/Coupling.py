...
class Coupling:
	...
	def get_state(self) -> bool:
		...
		If enabled, the digital attenuation values set with the command method RsSmw.Source.Iq.Doherty.Power.Attenuation.
		value for both signals are coupled. The difference between the values is, however, maintained. \n
