...
class Setting:
	"""Setting commands group definition. 5 total commands, 0 Sub-groups, 5 group commands"""
	...
	def preset(self) -> None:
		...
		method RsSmw.Source.Iq.Doherty.state. \n
		"""
	...
	def preset_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'SOURce:IQ:DOHerty:SETTing:PRESet')
