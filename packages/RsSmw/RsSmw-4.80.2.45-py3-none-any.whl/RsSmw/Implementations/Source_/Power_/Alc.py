...
class Alc:
	"""Alc commands group definition. 8 total commands, 1 Sub-groups, 7 group commands"""
	...
	def get_mode(self) -> enums.AlcOnOffAuto:
		...
		Queries the currently set ALC mode. See method RsSmw.Source.Power.Level.Immediate.amplitude. \n
