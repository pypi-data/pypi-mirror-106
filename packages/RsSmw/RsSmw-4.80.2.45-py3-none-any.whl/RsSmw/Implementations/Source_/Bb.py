...
class Bb:
	"""Bb commands group definition. 9514 total commands, 40 Sub-groups, 7 group commands"""
	...
	@property
	def arbitrary(self):
		"""arbitrary commands group. 11 Sub-classes, 2 commands."""
	...
	@property
	def dm(self):
		"""dm commands group. 18 Sub-classes, 8 commands."""
	...
	@property
	def dvb(self):
		"""dvb commands group. 12 Sub-classes, 3 commands."""
		if not hasattr(self, '_dvb'):
			from .Bb_.Dvb import Dvb
			self._dvb = Dvb(self._core, self._base)
		return self._dvb

	@property
	def esequencer(self):
		"""esequencer commands group. 11 Sub-classes, 6 commands."""
		if not hasattr(self, '_esequencer'):
			from .Bb_.Esequencer import Esequencer
			self._esequencer = Esequencer(self._core, self._base)
		return self._esequencer

	@property
	def eutra(self):
		"""eutra commands group. 18 Sub-classes, 7 commands."""
	...
	def measurement(self):
		...
		if not hasattr(self, '_measurement'):
			from .Bb_.Measurement import Measurement
	...
	def oneweb(self):
		...
		if not hasattr(self, '_oneweb'):
			from .Bb_.Oneweb import Oneweb
			self._oneweb = Oneweb(self._core, self._base)
		return self._oneweb
	...
	def v5G(self):
		...
		if not hasattr(self, '_v5G'):
			from .Bb_.V5G import V5G
			self._v5G = V5G(self._core, self._base)
		return self._v5G
	...
	def wlad(self):
		...
		if not hasattr(self, '_wlad'):
			from .Bb_.Wlad import Wlad
			self._wlad = Wlad(self._core, self._base)
		return self._wlad
