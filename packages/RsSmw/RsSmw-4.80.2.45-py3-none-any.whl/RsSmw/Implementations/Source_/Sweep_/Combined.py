...
class Combined:
	...
	def get_count(self) -> int:
		...
		To start the sweep signal generation, use the command method RsSmw.Source.Sweep.Combined.Execute.set. \n
