...
class Dedication:
	"""Dedication commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("dedication", core, parent)
	...
	def set(self, dedication: enums.RegObjPowDedicStartRang, objectIx=repcap.ObjectIx.Default) -> None:
		...
		In method RsSmw.Source.Regenerator.Radar.Power.modeMANual mode and for moving objects, defines how to interpret the value
		PRX set with the command method RsSmw.Source.Regenerator.Object.Power.Rx.set. \n
