...
class Alignment:
	"""Alignment commands group definition. 4 total commands, 1 Sub-groups, 1 group commands"""
	...
	def file(self):
		...
		if not hasattr(self, '_file'):
			from .Alignment_.File import File
	...
	def get_state(self) -> bool:
		...
		Activates correction of the IF signal for different IF signal frequencies. \n
			:return: cable_corr_state: 0| 1| OFF| ON
		"""
	...
	def set_state(self, cable_corr_state: bool) -> None:
		...
		Activates correction of the IF signal for different IF signal frequencies. \n
			:param cable_corr_state: 0| 1| OFF| ON
		"""
	...
	def clone(self) -> 'Alignment':
		...
		new_group = Alignment(self._core, self._base.parent)
