...
class Frequency:
	"""Frequency commands group definition. 5 total commands, 2 Sub-groups, 0 group commands"""
	...
	@property
	def band(self):
		"""band commands group. 2 Sub-classes, 1 commands."""
		if not hasattr(self, '_band'):
			from .Frequency_.Band import Band
