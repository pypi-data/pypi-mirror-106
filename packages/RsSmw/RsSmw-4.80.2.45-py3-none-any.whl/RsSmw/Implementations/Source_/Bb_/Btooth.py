...
class Btooth:
	"""Btooth commands group definition. 253 total commands, 16 Sub-groups, 17 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Btooth.state. \n
		"""
	...
	def get_tmode(self) -> enums.BtoTranMode:
		...
		Selects the transport mode. \n
			:return: tmode: ACL| SCO| ESCO ACL Asynchronous connection-less mode used for a point-to-point multipoint link between a master and all slaves. SCO Synchronous connection-oriented mode used for a point-to-point link between a master and a specific slave. ESCO Enhanced synchronous connection-oriented mode used for a symmetric or asymmetric point-to point link between a master and a specific slave.
		"""
	...
	def set_tmode(self, tmode: enums.BtoTranMode) -> None:
		...
		Selects the transport mode. \n
			:param tmode: ACL| SCO| ESCO ACL Asynchronous connection-less mode used for a point-to-point multipoint link between a master and all slaves. SCO Synchronous connection-oriented mode used for a point-to-point link between a master and a specific slave. ESCO Enhanced synchronous connection-oriented mode used for a symmetric or asymmetric point-to point link between a master and a specific slave.
		"""
