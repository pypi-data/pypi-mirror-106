...
class State:
	...
	def set(self, state: bool, baseband=repcap.Baseband.Default, attenuationList=repcap.AttenuationList.Default) -> None:
		...
		baseband_cmd_val = self._base.get_repcap_cmd_value(baseband, repcap.Baseband)
		attenuationList_cmd_val = self._base.get_repcap_cmd_value(attenuationList, repcap.AttenuationList)
