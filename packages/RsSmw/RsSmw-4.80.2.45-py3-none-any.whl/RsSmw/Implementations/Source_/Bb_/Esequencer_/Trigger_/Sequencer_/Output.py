...
class Output:
	"""Output commands group definition. 5 total commands, 5 Sub-groups, 0 group commands
	...
	def duration(self):
		...
		if not hasattr(self, '_duration'):
			from .Output_.Duration import Duration
	...
	def post(self):
		...
		if not hasattr(self, '_post'):
			from .Output_.Post import Post
			self._post = Post(self._core, self._base)
		return self._post
