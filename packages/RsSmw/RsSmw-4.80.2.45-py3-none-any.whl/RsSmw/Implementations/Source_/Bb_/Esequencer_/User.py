...
class User:
	"""User commands group definition. 8 total commands, 4 Sub-groups, 0 group commands"""
	...
	def aoTime(self):
		...
		if not hasattr(self, '_aoTime'):
			from .User_.AoTime import AoTime
	...
	def hoTime(self):
		...
		if not hasattr(self, '_hoTime'):
			from .User_.HoTime import HoTime
	...
	def sequence(self):
		...
		if not hasattr(self, '_sequence'):
			from .User_.Sequence import Sequence
