...
class Puach:
	"""Puach commands group definition. 6 total commands, 5 Sub-groups, 0 group commands"""
	...
	def modulation(self):
		...
		if not hasattr(self, '_modulation'):
			from .Puach_.Modulation import Modulation
	...
	def physBits(self):
		...
		if not hasattr(self, '_physBits'):
			from .Puach_.PhysBits import PhysBits
	...
	def ulsch(self):
		...
		if not hasattr(self, '_ulsch'):
			from .Puach_.Ulsch import Ulsch
