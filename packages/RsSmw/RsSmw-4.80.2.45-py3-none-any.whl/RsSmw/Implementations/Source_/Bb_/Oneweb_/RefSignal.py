...
class RefSignal:
	"""RefSignal commands group definition. 2 total commands, 0 Sub-groups, 2 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("refSignal", core, parent)
	...
	def get_value(self) -> str:
		...
		Selects and loads a predefined reference signal. \n
			:return: ref_signal: string Filename as returned by the query method RsSmw.Source.Bb.Oneweb.RefSignal.catalog. File extension is omitted.
		"""
	...
	def set_value(self, ref_signal: str) -> None:
		...
		Selects and loads a predefined reference signal. \n
			:param ref_signal: string Filename as returned by the query method RsSmw.Source.Bb.Oneweb.RefSignal.catalog. File extension is omitted.
		"""
