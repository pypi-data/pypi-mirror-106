...
class Fader:
	"""Fader commands group definition. 8 total commands, 7 Sub-groups, 0 group commands
	...
	def delay(self):
		...
		if not hasattr(self, '_delay'):
			from .Fader_.Delay import Delay
	...
	def iqRatio(self):
		...
		if not hasattr(self, '_iqRatio'):
			from .Fader_.IqRatio import IqRatio
	...
	def leakage(self):
		...
		if not hasattr(self, '_leakage'):
			from .Fader_.Leakage import Leakage
	...
	def poffset(self):
		...
		if not hasattr(self, '_poffset'):
			from .Fader_.Poffset import Poffset
	...
	def quadrature(self):
		...
		if not hasattr(self, '_quadrature'):
			from .Fader_.Quadrature import Quadrature
