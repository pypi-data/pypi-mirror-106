...
class Tchannel:
	...
	def get_count(self) -> int:
		...
		method RsSmw.Source.Bb.C2K.Pparameter.Execute.set. \n
	...
	def get_flength(self) -> enums.Cdma2KpredFramLen:
		...
		The setting takes effect only after execution of command method RsSmw.Source.Bb.C2K.Pparameter.Execute.set.
