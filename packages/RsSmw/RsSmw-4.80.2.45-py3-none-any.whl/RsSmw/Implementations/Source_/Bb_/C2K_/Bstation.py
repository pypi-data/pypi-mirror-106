...
class Bstation:
	"""Bstation commands group definition. 57 total commands, 9 Sub-groups, 1 group commands
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_baseStation_get', 'repcap_baseStation_set', repcap.BaseStation.Nr1)

	def repcap_baseStation_set(self, enum_value: repcap.BaseStation) -> None:
	...
	def preset(self) -> None:
		...
		A standardized default for all the base stations (*RST values specified for the commands) . See ' 			Reset All Base
