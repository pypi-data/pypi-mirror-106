...
class Schannel:
	...
	def get_count(self) -> int:
		...
		configuration. The setting takes effect only after execution of command method RsSmw.Source.Bb.C2K.Pparameter.Execute.set.
		It is specific for the selected radio configuration. \n
