...
class W3Gpp:
	"""W3Gpp commands group definition. 561 total commands, 14 Sub-groups, 5 group commands"""
	...
	def ts25141(self):
		...
		if not hasattr(self, '_ts25141'):
			from .W3Gpp_.Ts25141 import Ts25141
			self._ts25141 = Ts25141(self._core, self._base)
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.W3Gpp.state. \n
		"""
