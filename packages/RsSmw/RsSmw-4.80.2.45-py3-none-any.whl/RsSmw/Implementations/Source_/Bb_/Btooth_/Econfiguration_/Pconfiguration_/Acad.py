...
class Acad:
	...
	def get_apattern(self) -> ApatternStruct:
		...
		Specifies user-defined pattern. The settings is relevant for method RsSmw.Source.Bb.Btooth.Econfiguration.Pconfiguration.
		Acad.valuePATTern \n
	...
	def get_aselection(self) -> str:
		...
		Specifies data list file. The settings is relevant for method RsSmw.Source.Bb.Btooth.Econfiguration.Pconfiguration.Acad.
		valueDLISt \n
