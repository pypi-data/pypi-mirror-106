...
class StmPhy:
	"""StmPhy commands group definition. 3 total commands, 3 Sub-groups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("stmPhy", core, parent)

	@property
	def l1M(self):
		"""l1M commands group. 1 Sub-classes, 0 commands."""
		if not hasattr(self, '_l1M'):
			from .StmPhy_.L1M import L1M
	...
	def clone(self) -> 'StmPhy':
		...
		new_group = StmPhy(self._core, self._base.parent)
