...
class Uplink:
	...
	def set_value(self, tmod_up: str) -> None:
		...
		Loads a test model file with predefined settings. \n
			:param tmod_up: 'filename' Filename as queried with one of the following commands: method RsSmw.Source.Bb.Nr5G.Setting.Tmodel.Uplink.catalog method RsSmw.Source.Bb.Nr5G.Setting.Tmodel.Downlink.catalog method RsSmw.Source.Bb.Nr5G.Setting.Tmodel.FilterPy.catalog
		"""
