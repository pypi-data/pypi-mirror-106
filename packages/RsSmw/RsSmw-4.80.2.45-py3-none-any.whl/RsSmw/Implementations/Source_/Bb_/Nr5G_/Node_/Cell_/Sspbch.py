...
class Sspbch:
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_ssPbchNull_get', 'repcap_ssPbchNull_set', repcap.SsPbchNull.Nr0)

	def repcap_ssPbchNull_set(self, enum_value: repcap.SsPbchNull) -> None:
