...
class FilterPy:
	...
	def get_bw(self) -> enums.FilterBandwidth:
		...
		Applies a bandwidth filter to narrow down the files returned by the query method RsSmw.Source.Bb.Nr5G.Setting.Tmodel.
		FilterPy.catalog. \n
	...
	def get_duplexing(self) -> enums.FilterDuplexing:
		...
		Applies a duplexing filter to narrow down the files returned by the query method RsSmw.Source.Bb.Nr5G.Setting.Tmodel.
		FilterPy.catalog. \n
	...
	def get_freq(self) -> enums.FilterFreqRange:
		...
		Applies a frequency range filter to narrow down the files returned by the query method RsSmw.Source.Bb.Nr5G.Setting.
	...
	def get_scs(self) -> enums.FilterSubcarrierSpacing:
		...
		Applies a subcarrier spacing filter to narrow down the files returned by the query method RsSmw.Source.Bb.Nr5G.Setting.
		Tmodel.FilterPy.catalog. \n
	...
	def get_tmodel(self) -> enums.FilterTestModels:
		...
		Applies a test model filter to narrow down the files returned by the query method RsSmw.Source.Bb.Nr5G.Setting.Tmodel.
		FilterPy.catalog. \n
