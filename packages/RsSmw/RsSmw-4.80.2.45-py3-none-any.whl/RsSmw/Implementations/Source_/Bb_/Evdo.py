...
class Evdo:
	"""Evdo commands group definition. 153 total commands, 13 Sub-groups, 8 group commands"""
	...
	def preset(self) -> None:
		...
		Not affected is the state set with the command method RsSmw.Source.Bb.Evdo.state. \n
		"""
