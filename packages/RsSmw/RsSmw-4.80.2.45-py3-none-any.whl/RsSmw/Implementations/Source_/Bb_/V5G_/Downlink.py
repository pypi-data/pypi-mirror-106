...
class Downlink:
	"""Downlink commands group definition. 338 total commands, 22 Sub-groups, 15 group commands"""
	...
	def conf(self):
		...
		if not hasattr(self, '_conf'):
			from .Downlink_.Conf import Conf
	...
	def csettings(self):
		...
		if not hasattr(self, '_csettings'):
			from .Downlink_.Csettings import Csettings
	...
	def csis(self):
		...
		if not hasattr(self, '_csis'):
			from .Downlink_.Csis import Csis
	...
	def dumd(self):
		...
		if not hasattr(self, '_dumd'):
			from .Downlink_.Dumd import Dumd
	...
	def pbch(self):
		...
		if not hasattr(self, '_pbch'):
			from .Downlink_.Pbch import Pbch
	...
	def pdsch(self):
		...
		if not hasattr(self, '_pdsch'):
			from .Downlink_.Pdsch import Pdsch
	...
	def phich(self):
		...
		if not hasattr(self, '_phich'):
			from .Downlink_.Phich import Phich
	...
	def prss(self):
		...
		if not hasattr(self, '_prss'):
			from .Downlink_.Prss import Prss
	...
	def refsig(self):
		...
		if not hasattr(self, '_refsig'):
			from .Downlink_.Refsig import Refsig
	...
	def rstFrame(self):
		...
		if not hasattr(self, '_rstFrame'):
			from .Downlink_.RstFrame import RstFrame
	...
	def signals(self):
		...
		if not hasattr(self, '_signals'):
			from .Downlink_.Signals import Signals
			self._signals = Signals(self._core, self._base)
	...
	def sync(self):
		...
		if not hasattr(self, '_sync'):
			from .Downlink_.Sync import Sync
	...
	def view(self):
		...
		if not hasattr(self, '_view'):
			from .Downlink_.View import View
	...
	def xpdcch(self):
		...
		if not hasattr(self, '_xpdcch'):
			from .Downlink_.Xpdcch import Xpdcch
			self._xpdcch = Xpdcch(self._core, self._base)
		return self._xpdcch
	...
	def cell(self):
		...
		if not hasattr(self, '_cell'):
			from .Downlink_.Cell import Cell
	...
	def plci(self):
		...
		if not hasattr(self, '_plci'):
			from .Downlink_.Plci import Plci
	...
	def subf(self):
		...
		if not hasattr(self, '_subf'):
			from .Downlink_.Subf import Subf
