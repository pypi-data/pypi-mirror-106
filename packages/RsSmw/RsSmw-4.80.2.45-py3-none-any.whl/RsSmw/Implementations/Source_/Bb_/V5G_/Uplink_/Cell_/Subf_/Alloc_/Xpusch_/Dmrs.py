...
class Dmrs:
	"""Dmrs commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def niddmrs(self):
		...
		if not hasattr(self, '_niddmrs'):
			from .Dmrs_.Niddmrs import Niddmrs
			self._niddmrs = Niddmrs(self._core, self._base)
