...
class Uplink:
	"""Uplink commands group definition. 18 total commands, 4 Sub-groups, 0 group commands"""
	...
	def afSeq(self):
		...
		if not hasattr(self, '_afSeq'):
			from .Uplink_.AfSeq import AfSeq
	...
	def nhtrans(self):
		...
		if not hasattr(self, '_nhtrans'):
			from .Uplink_.Nhtrans import Nhtrans
