...
class Dwell:
	...
	def get_time(self) -> float:
		...
		Sets the dwell time for a power step. To activate the dwell time, use command .BB:PRAMp:RAMP:STAir. \n
	...
	def get_state(self) -> bool:
		...
		Activates the edit mode to set the dwell time. To determine the dwell time, use command method RsSmw.Source.Bb.Pramp.Ramp.
		Stair.Dwell.time. \n
			:return: enable_dwell: 0| 1| OFF| ON
		"""
