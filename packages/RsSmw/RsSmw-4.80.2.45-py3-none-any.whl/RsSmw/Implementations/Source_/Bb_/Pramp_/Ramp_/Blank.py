...
class Blank:
	...
	def get_time(self) -> float:
		...
		Sets the RF blanking time. To activate RF blanking, use commandBB:PRAMp:RAMP. \n
	...
	def get_state(self) -> bool:
		...
		Activates the RF blanking. To determine the blanking interval, use command BB:PRAMp:RAMP. \n
			:return: enable_rf_blank: 0| 1| OFF| ON
		"""
	...
	def set_state(self, enable_rf_blank: bool) -> None:
		...
		Activates the RF blanking. To determine the blanking interval, use command BB:PRAMp:RAMP. \n
			:param enable_rf_blank: 0| 1| OFF| ON
		"""
