...
class PreSweep:
	...
	def get_state(self) -> bool:
		...
		Activates the pre-sweep. To determine the pre-sweep power, use command BB:PRAMp:RAMP. \n
			:return: enable_pre_sweep: 0| 1| OFF| ON
		"""
	...
	def set_state(self, enable_pre_sweep: bool) -> None:
		...
		Activates the pre-sweep. To determine the pre-sweep power, use command BB:PRAMp:RAMP. \n
			:param enable_pre_sweep: 0| 1| OFF| ON
		"""
	...
	def get_level(self) -> float:
		...
		Sets the pre-sweep power. To activate pre-sweep, use command method RsSmw.Source.Bb.Pramp.Ramp.PreSweep.state. \n
