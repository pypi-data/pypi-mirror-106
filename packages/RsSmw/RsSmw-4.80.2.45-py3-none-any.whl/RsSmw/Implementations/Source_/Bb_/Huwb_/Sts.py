...
class Sts:
	...
	def get_cpart(self) -> List[str]:
		...
		No command help available \n
			:return: counter_part: No help available
		"""
	...
	def set_cpart(self, counter_part: List[str]) -> None:
		...
		No command help available \n
			:param counter_part: No help available
		"""
	...
	def get_upart(self) -> List[str]:
		...
		No command help available \n
			:return: upper_part: No help available
		"""
	...
	def set_upart(self, upper_part: List[str]) -> None:
		...
		No command help available \n
			:param upper_part: No help available
		"""
