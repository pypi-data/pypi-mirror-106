...
class Findex:
	...
	def set(self, findex: int, output=repcap.Output.Default) -> None:
		...
		Sets the frame index, that is, the frame to be marked in the frame block marked with method RsSmw.Source.Bb.Wlnn.Trigger.
		Output.FbIndex.set. The maximum value depends on the number of frames set with command method RsSmw.Source.Bb.Wlnn.Fblock.
		Fcount.set . The maximum value is 1024. \n
