...
class DpControl:
	"""DpControl commands group definition. 11 total commands, 2 Sub-groups, 7 group commands"""
	...
	def get_assignment(self) -> enums.PowContAssMode:
		...
		Enabled for UL-DTX mode only (method RsSmw.Source.Bb.W3Gpp.Mstation.Udtx.state ON) . The power control recognizes the
