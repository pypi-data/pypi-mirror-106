...
class Mode:
	...
	def set(self, mode: enums.TpcMode, mobileStation=repcap.MobileStation.Default) -> None:
		...
		Selects the TPC (Transmit Power Control) mode. The command sets the slot format (method RsSmw.Source.Bb.W3Gpp.Mstation.
		Dpcch.Sformat.set) in conjunction with the set TFCI status (method RsSmw.Source.Bb.W3Gpp.Mstation.Dpcch.Tfci.State.set)
		and the FBI Mode (method RsSmw.Source.Bb.W3Gpp.Mstation.Dpcch.Fbi.Mode.set) to the associated values. \n
