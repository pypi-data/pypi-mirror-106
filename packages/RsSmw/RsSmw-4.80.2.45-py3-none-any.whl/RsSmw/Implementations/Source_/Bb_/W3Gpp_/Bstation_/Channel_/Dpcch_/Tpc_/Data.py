...
class Data:
	...
	def set(self, data: enums.TpcDataSour, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Determines the data source for the TPC field of the channel. \n
			:param data: ZERO| ONE| PATTern| DLISt DLISt A data list is used. Use the command method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Dpcch.Tpc.Data.Dselect.set to define the data list file. ZERO | ONE Internal 0 and 1 data is used. PATTern Internal data is used. Use the command method RsSmw.Source.Bb.W3Gpp.Bstation.Channel.Dpcch.Tpc.Data.Pattern.set to define the bit pattern.
