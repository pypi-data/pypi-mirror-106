...
class Sformat:
	...
	def set(self, sformat: int, mobileStation=repcap.MobileStation.Default) -> None:
		...
		RsSmw.Source.Bb.W3Gpp.Mstation.Dpcch.Fbi.Mode.set) , the TFCI status (method RsSmw.Source.Bb.W3Gpp.Mstation.Dpcch.Tfci.
		State.set) and the TPC Mode (method RsSmw.Source.Bb.W3Gpp.Mstation.Dpcch.Tpc.Mode.set) to the associated values. \n
