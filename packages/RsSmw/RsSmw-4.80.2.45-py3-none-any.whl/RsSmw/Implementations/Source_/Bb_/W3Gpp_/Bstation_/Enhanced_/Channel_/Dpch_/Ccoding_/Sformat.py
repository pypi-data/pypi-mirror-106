...
class Sformat:
	...
	def set(self, sformat: int, channelNull=repcap.ChannelNull.Default) -> None:
		...
		standard is selected (method RsSmw.Source.Bb.W3Gpp.Bstation.Enhanced.Channel.Dpch.Ccoding.TypePy.set) and channel coding
		is activated, the slot format is (method RsSmw.Source.Bb.W3Gpp.Bstation.Enhanced.Channel.Dpch.Ccoding.State.
