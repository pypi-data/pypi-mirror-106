...
class State:
	...
	def set(self, state: bool, channelNull=repcap.ChannelNull.Default) -> None:
		...
		physical or the transport layer, method RsSmw.Source.Bb.W3Gpp.Bstation.Enhanced.Channel.Dpch.Derror.Bit.Layer.set) . When
		the data source is read out, individual bits are deliberately inverted at random points in the data bit stream at the
