...
class Ccoding:
	...
	def get_state(self) -> bool:
		...
		overall symbol rate (method RsSmw.Source.Bb.W3Gpp.Mstation.Enhanced.Dpdch.orate) is set to the value predetermined by the
		selected channel coding type (method RsSmw.Source.Bb.W3Gpp.Mstation.Enhanced.Dpdch.Ccoding.typePy) . \n
	...
	def get_type_py(self) -> enums.ChanCodType:
		...
		selected predetermines the overall symbol rate. When channel coding is activated (method RsSmw.Source.Bb.W3Gpp.Mstation.
		Enhanced.Dpdch.Ccoding.state) the overall symbol rate (method RsSmw.Source.Bb.W3Gpp.Mstation.Enhanced.Dpdch.orate) is set
		to the value predetermined by the selected channel coding type. \n
