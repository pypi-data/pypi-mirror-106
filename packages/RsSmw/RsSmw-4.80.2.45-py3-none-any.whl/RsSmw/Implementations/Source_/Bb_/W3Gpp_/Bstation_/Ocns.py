...
class Ocns:
	...
	def get_mode(self) -> enums.OcnsMode:
		...
		Selects the scenario for setting the OCNS channels. To activate the selected scenario, send the command method RsSmw.
	...
	def get_state(self) -> bool:
		...
		Activates OCNS channels according to the scenario selected with the command method RsSmw.Source.Bb.W3Gpp.Bstation.Ocns.
		mode. \n
