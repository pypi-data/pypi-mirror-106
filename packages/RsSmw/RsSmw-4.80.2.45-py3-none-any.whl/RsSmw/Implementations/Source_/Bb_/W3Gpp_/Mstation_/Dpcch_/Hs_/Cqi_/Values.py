...
class Values:
	...
	def set(self, values: int, mobileStation=repcap.MobileStation.Default, channelQualId=repcap.ChannelQualId.Default) -> None:
		...
		Sets the values of the CQI sequence. The length of the CQI sequence is defined with command method RsSmw.Source.Bb.W3Gpp.
		...
		channelQualId_cmd_val = self._base.get_repcap_cmd_value(channelQualId, repcap.ChannelQualId)
