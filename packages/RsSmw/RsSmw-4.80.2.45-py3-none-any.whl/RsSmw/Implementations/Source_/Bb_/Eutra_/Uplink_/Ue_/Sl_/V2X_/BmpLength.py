...
class BmpLength:
	...
	def set(self, bmp_length: enums.EutraSlV2xBmpLength, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Sets the bitmap length. To set the subframe bitmap, use the commands method RsSmw.Source.Bb.Eutra.Uplink.Ue.Sl.V2X.BitLow.
		set and method RsSmw.Source.Bb.Eutra.Uplink.Ue.Sl.V2X.BitHigh.set. \n
