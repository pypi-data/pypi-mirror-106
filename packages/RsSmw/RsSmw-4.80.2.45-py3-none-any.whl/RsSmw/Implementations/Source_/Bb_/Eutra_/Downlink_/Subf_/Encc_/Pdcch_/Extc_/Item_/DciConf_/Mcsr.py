...
class Mcsr:
	...
	def set(self, mcsr: int, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> None:
		...
		Sets the DCI formats 1/1B/1D/2/2A/2B/2C/2D field modulation and coding scheme. \n
			:param mcsr: integer Range: 0 to depends on the installed options Option: R&S SMW-K55 max = 31 Option: R&S SMW-K119 max = 63 Values 32 to 63 available if method RsSmw.Source.Bb.Eutra.Downlink.User.Cell.Mcs.set T4.
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> int:
		...
		Sets the DCI formats 1/1B/1D/2/2A/2B/2C/2D field modulation and coding scheme. \n
			:param subframeNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Subf')
			:param itemNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Item')
			:return: mcsr: integer Range: 0 to depends on the installed options Option: R&S SMW-K55 max = 31 Option: R&S SMW-K119 max = 63 Values 32 to 63 available if method RsSmw.Source.Bb.Eutra.Downlink.User.Cell.Mcs.set T4."""
		subframeNull_cmd_val = self._base.get_repcap_cmd_value(subframeNull, repcap.SubframeNull)
		itemNull_cmd_val = self._base.get_repcap_cmd_value(itemNull, repcap.ItemNull)
