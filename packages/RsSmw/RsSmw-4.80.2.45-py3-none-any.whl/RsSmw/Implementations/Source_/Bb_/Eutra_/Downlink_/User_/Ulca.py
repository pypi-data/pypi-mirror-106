...
class Ulca:
	"""Ulca commands group definition. 1 total commands, 1 Sub-groups, 0 group commands
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_ulCarriersNull_get', 'repcap_ulCarriersNull_set', repcap.UlCarriersNull.Nr0)

	def repcap_ulCarriersNull_set(self, enum_value: repcap.UlCarriersNull) -> None:
