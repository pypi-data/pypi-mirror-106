...
class Rbaf:
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		...
		If method RsSmw.Source.Bb.Eutra.Downlink.bwBW20_00 and method RsSmw.Source.Bb.Eutra.Downlink.Emtc.wbcfgBW20 sets the DCI
		format 6-1A field resource block assignment index. \n
