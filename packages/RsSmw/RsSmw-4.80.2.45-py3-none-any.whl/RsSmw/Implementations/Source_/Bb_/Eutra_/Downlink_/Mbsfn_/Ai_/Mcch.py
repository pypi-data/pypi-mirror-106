...
class Mcch:
	...
	def get_noffset(self) -> int:
		...
		Defines, together with the method RsSmw.Source.Bb.Eutra.Downlink.Mbsfn.Ai.Mcch.nrc, the radio frames in which the MCCH
	...
	def get_offs(self) -> int:
		...
		Indicates, together with the method RsSmw.Source.Bb.Eutra.Downlink.Mbsfn.Ai.Mcch.rper, the radio frames in which MCCH is
		scheduled. \n
