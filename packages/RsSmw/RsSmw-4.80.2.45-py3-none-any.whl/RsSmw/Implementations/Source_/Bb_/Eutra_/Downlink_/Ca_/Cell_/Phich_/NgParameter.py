...
class NgParameter:
	...
	def set(self, ng_parameter: enums.PhichNg, cellNull=repcap.CellNull.Default) -> None:
		...
		Sets the parameter N_g according to . \n
			:param ng_parameter: NG1_6| NG1_2| NG1| NG2| NGCustom NG1_6 | NG1_2 | NG1 | NG2 Determines the number of PHICH groups. NGCustom (not if carrier aggregation is used) The number of PHICH groups are set with the command BB:EUTRa:ENCC:NOGRoups.
	...
	def get(self, cellNull=repcap.CellNull.Default) -> enums.PhichNg:
		...
		Sets the parameter N_g according to . \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
			:return: ng_parameter: NG1_6| NG1_2| NG1| NG2| NGCustom NG1_6 | NG1_2 | NG1 | NG2 Determines the number of PHICH groups. NGCustom (not if carrier aggregation is used) The number of PHICH groups are set with the command BB:EUTRa:ENCC:NOGRoups."""
		cellNull_cmd_val = self._base.get_repcap_cmd_value(cellNull, repcap.CellNull)
