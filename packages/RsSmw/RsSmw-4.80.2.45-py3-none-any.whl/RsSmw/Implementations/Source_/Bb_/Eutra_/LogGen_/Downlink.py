...
class Downlink:
	"""Downlink commands group definition. 9 total commands, 3 Sub-groups, 6 group commands"""
	...
	def dall(self):
		...
		if not hasattr(self, '_dall'):
			from .Downlink_.Dall import Dall
	...
	def eall(self):
		...
		if not hasattr(self, '_eall'):
			from .Downlink_.Eall import Eall
	...
	def logPoint(self):
		...
		if not hasattr(self, '_logPoint'):
			from .Downlink_.LogPoint import LogPoint
	...
	def set_encc(self, encc_log_state: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param encc_log_state: 0| 1| OFF| ON
		"""
	...
	def set_pbch(self, pbch_log_state: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param pbch_log_state: 0| 1| OFF| ON
		"""
	...
	def set_pdsch(self, pdsch_log_state: bool) -> None:
		...
		Enables the channel or reference signal for that logfiles are generated. \n
			:param pdsch_log_state: 0| 1| OFF| ON
		"""
