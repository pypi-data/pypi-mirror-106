...
class Nprs:
	...
	def get_mtia(self) -> MtiaStruct:
		...
		Snippet: value: MtiaStruct = driver.source.bb.eutra.downlink.niot.nprs.get_mtia() \n
	...
	def set_mtia(self, value: MtiaStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:NPRS:MTIA \n
		Snippet: driver.source.bb.eutra.downlink.niot.nprs.set_mtia(value = MtiaStruct()) \n
		Sets the nprs-MutingInfoA/nprs-MutingInfoB parameter, required if muting is used for the NPRS part A (and Part B)
		configurations. \n
	...
	def get_mtib(self) -> MtibStruct:
		...
		Snippet: value: MtibStruct = driver.source.bb.eutra.downlink.niot.nprs.get_mtib() \n
		Sets the nprs-MutingInfoA/nprs-MutingInfoB parameter, required if muting is used for the NPRS part A (and Part B)
		configurations. \n
	...
	def set_mtib(self, value: MtibStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:NPRS:MTIB \n
		Snippet: driver.source.bb.eutra.downlink.niot.nprs.set_mtib(value = MtibStruct()) \n
		Sets the nprs-MutingInfoA/nprs-MutingInfoB parameter, required if muting is used for the NPRS part A (and Part B)
		configurations. \n
