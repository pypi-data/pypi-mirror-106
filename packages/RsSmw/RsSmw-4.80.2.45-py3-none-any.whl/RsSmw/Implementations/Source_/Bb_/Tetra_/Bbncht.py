...
class Bbncht:
	"""Bbncht commands group definition. 26 total commands, 0 Sub-groups, 26 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("bbncht", core, parent)
	...
	def get_dnb_broadcast(self) -> bool:
		...
		Enables/disables support of the D-NWRK-BROADCAST PDU. \n
			:return: dnb_broadcast: 0| 1| OFF| ON
		"""
	...
	def set_dnb_broadcast(self, dnb_broadcast: bool) -> None:
		...
		Enables/disables support of the D-NWRK-BROADCAST PDU. \n
			:param dnb_broadcast: 0| 1| OFF| ON
		"""
	...
	def get_fe_extension(self) -> bool:
		...
		to perform this function. \n
			:return: fe_extension: 0| 1| OFF| ON
		"""
	...
	def get_tr_frames(self) -> enums.TetraTsRsrvdFrm:
		...
		selected method RsSmw.Source.Bb.Tetra.Bbncht.smode. If MCCH sharing is indicated, the TS reserved frames field shall
		indicate which frames are reserved in this mode of operation. For the other values of sharing mode, the contents of the
		TS reserved frames field shall be ignored. \n
