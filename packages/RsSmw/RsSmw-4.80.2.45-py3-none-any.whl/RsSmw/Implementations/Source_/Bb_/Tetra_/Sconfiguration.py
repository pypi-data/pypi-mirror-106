...
class Sconfiguration:
	"""Sconfiguration commands group definition. 20 total commands, 2 Sub-groups, 0 group commands"""
	...
	def slot(self):
		...
		if not hasattr(self, '_slot'):
			from .Sconfiguration_.Slot import Slot
	...
	def tmode(self):
		...
		if not hasattr(self, '_tmode'):
			from .Sconfiguration_.Tmode import Tmode
