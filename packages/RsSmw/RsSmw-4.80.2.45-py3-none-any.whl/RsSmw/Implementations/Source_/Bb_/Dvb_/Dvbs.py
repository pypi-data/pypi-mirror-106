...
class Dvbs:
	...
	def adLength(self):
		...
		if not hasattr(self, '_adLength'):
			from .Dvbs_.AdLength import AdLength
	...
	def bhConfig(self):
		...
		if not hasattr(self, '_bhConfig'):
			from .Dvbs_.BhConfig import BhConfig
	...
	def binterleaver(self):
		...
		if not hasattr(self, '_binterleaver'):
			from .Dvbs_.Binterleaver import Binterleaver
	...
	def bscrambler(self):
		...
		if not hasattr(self, '_bscrambler'):
			from .Dvbs_.Bscrambler import Bscrambler
	...
	def icoder(self):
		...
		if not hasattr(self, '_icoder'):
			from .Dvbs_.Icoder import Icoder
	...
	def ocoder(self):
		...
		if not hasattr(self, '_ocoder'):
			from .Dvbs_.Ocoder import Ocoder
	...
	def pscrambler(self):
		...
		if not hasattr(self, '_pscrambler'):
			from .Dvbs_.Pscrambler import Pscrambler
	...
	def pstate(self):
		...
		if not hasattr(self, '_pstate'):
			from .Dvbs_.Pstate import Pstate
	...
	def thConfig(self):
		...
		if not hasattr(self, '_thConfig'):
			from .Dvbs_.ThConfig import ThConfig
	...
	def ucMode(self):
		...
		if not hasattr(self, '_ucMode'):
			from .Dvbs_.UcMode import UcMode
