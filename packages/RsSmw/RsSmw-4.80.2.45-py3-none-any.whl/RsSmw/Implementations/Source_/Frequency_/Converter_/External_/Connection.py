...
class Connection:
	"""Connection commands group definition. 3 total commands, 2 Sub-groups, 1 group commands"""
	...
	def remote(self):
		...
		if not hasattr(self, '_remote'):
			from .Connection_.Remote import Remote
	...
	def usb(self):
		...
		if not hasattr(self, '_usb'):
			from .Connection_.Usb import Usb
