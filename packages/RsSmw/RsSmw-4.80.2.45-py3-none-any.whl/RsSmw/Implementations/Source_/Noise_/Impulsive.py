...
class Impulsive:
	"""Impulsive commands group definition. 7 total commands, 1 Sub-groups, 6 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("impulsive", core, parent)

	@property
	def burst(self):
		"""burst commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_burst'):
			from .Impulsive_.Burst import Burst
	...
	def get_max_space(self) -> float:
		...
		If more than 1 pulse per burst are enabled (method RsSmw.Source.Noise.Impulsive.pulsee.g. 2) , sets the minimum/maximum
		spacing between 2 pulses within a burst. \n
	...
	def get_state(self) -> bool:
		...
		Enables or disables the impulsive noise generator. \n
			:return: impulsive_state: 0| 1| OFF| ON
		"""
	...
	def set_state(self, impulsive_state: bool) -> None:
		...
		Enables or disables the impulsive noise generator. \n
			:param impulsive_state: 0| 1| OFF| ON
		"""
	...
	def clone(self) -> 'Impulsive':
		...
		new_group = Impulsive(self._core, self._base.parent)
