...
class Flexible:
	...
	def get_external(self) -> ExternalStruct:
		"""SCPI: ROUTe:WCDMa:SIGNaling<instance>:SCENario:DCFDiversity:FLEXible[:EXTernal] \n
		Snippet: value: ExternalStruct = driver.route.scenario.dcfDiversity.flexible.get_external() \n
		...
		"""
		return self._core.io.query_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:DCFDiversity:FLEXible:EXTernal?', self.__class__.ExternalStruct())

	def set_external(self, value: ExternalStruct) -> None:
		"""SCPI: ROUTe:WCDMa:SIGNaling<instance>:SCENario:DCFDiversity:FLEXible[:EXTernal] \n
		Snippet: driver.route.scenario.dcfDiversity.flexible.set_external(value = ExternalStruct()) \n
		Activates the 'Dual Carrier RX Diversity Fading: External' scenario and selects the signal paths. For possible connector
		and converter values, see 'Values for Signal Path Selection'. \n
			:param value: see the help for ExternalStruct structure arguments.
		"""
		self._core.io.write_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:DCFDiversity:FLEXible:EXTernal', value)
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.dcfDiversity.flexible.get_internal() \n
		...
		"""
		return self._core.io.query_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:DCFDiversity:FLEXible:INTernal?', self.__class__.InternalStruct())

	def set_internal(self, value: InternalStruct) -> None:
		"""SCPI: ROUTe:WCDMa:SIGNaling<instance>:SCENario:DCFDiversity:FLEXible:INTernal \n
		Snippet: driver.route.scenario.dcfDiversity.flexible.set_internal(value = InternalStruct()) \n
		Activates the 'Dual Carrier RX Diversity Fading: Internal' scenario and selects the signal paths. For possible parameter
		values, see 'Values for Signal Path Selection'. \n
			:param value: see the help for InternalStruct structure arguments.
		"""
		self._core.io.write_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:DCFDiversity:FLEXible:INTernal', value)
