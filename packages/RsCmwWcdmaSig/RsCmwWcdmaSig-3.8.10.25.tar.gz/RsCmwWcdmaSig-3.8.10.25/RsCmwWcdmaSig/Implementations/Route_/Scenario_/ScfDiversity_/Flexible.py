...
class Flexible:
	...
	def get_external(self) -> ExternalStruct:
		...
		Snippet: value: ExternalStruct = driver.route.scenario.scfDiversity.flexible.get_external() \n
		Activates the 'Standard Cell RX Diversity Fading: External' scenario and selects the signal paths. For possible connector
		...
		"""
		return self._core.io.query_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:SCFDiversity:FLEXible:EXTernal?', self.__class__.ExternalStruct())

	def set_external(self, value: ExternalStruct) -> None:
		"""SCPI: ROUTe:WCDMa:SIGNaling<instance>:SCENario:SCFDiversity:FLEXible[:EXTernal] \n
		Snippet: driver.route.scenario.scfDiversity.flexible.set_external(value = ExternalStruct()) \n
		Activates the 'Standard Cell RX Diversity Fading: External' scenario and selects the signal paths. For possible connector
		and converter values, see 'Values for Signal Path Selection'. \n
			:param value: see the help for ExternalStruct structure arguments.
		"""
		self._core.io.write_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:SCFDiversity:FLEXible:EXTernal', value)
	...
	def get_internal(self) -> InternalStruct:
		...
		Snippet: value: InternalStruct = driver.route.scenario.scfDiversity.flexible.get_internal() \n
		Activates the 'Standard Cell RX Diversity Fading: Internal' scenario and selects the signal paths. For possible parameter
		...
		"""
		return self._core.io.query_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:SCFDiversity:FLEXible:INTernal?', self.__class__.InternalStruct())

	def set_internal(self, value: InternalStruct) -> None:
		"""SCPI: ROUTe:WCDMa:SIGNaling<instance>:SCENario:SCFDiversity:FLEXible:INTernal \n
		Snippet: driver.route.scenario.scfDiversity.flexible.set_internal(value = InternalStruct()) \n
		Activates the 'Standard Cell RX Diversity Fading: Internal' scenario and selects the signal paths. For possible parameter
		values, see 'Values for Signal Path Selection'. \n
			:param value: see the help for InternalStruct structure arguments.
		"""
		self._core.io.write_struct('ROUTe:WCDMa:SIGNaling<Instance>:SCENario:SCFDiversity:FLEXible:INTernal', value)
