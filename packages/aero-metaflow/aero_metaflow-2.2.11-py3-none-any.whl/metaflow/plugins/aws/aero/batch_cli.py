...
@aero.command(help="List unfinished Aero tasks of this flow")
...
@aero.command(help="Terminate unfinished Aero tasks of this flow.")
@click.option("--my-runs", default=False, is_flag=True,
...
def step(
    ...
    **kwargs
    ...
    def echo(msg, stream=sys.stdout):
        ctx.obj.echo_always("%s" % (msg))
