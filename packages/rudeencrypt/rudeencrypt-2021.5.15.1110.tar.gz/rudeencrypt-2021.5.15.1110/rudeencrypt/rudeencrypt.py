...
#
#        [fun] getDecryptedData_Dict()
#              similar to SaveDecryptedDataToFile, directly get a python-dict
#
#        [sub] setByDecryptedData(Dict)
#              similar to ReadDecryptedDataFile, directly input a python-dict
#══════════════════════════════════════════════════════════════════════════════════════════════════════════════════
...
class Encryption():
   ...
   #           initiate a data file with a key
    ...
    @__IsconnectCheck
    def getDecryptedData_Dict(self):
        return dict( self.__Dict )

    def setByDecryptedData(self,Dict):
