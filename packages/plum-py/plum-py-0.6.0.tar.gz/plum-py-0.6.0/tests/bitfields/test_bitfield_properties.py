...
register = EnumX("register", Register)


class Fields(BitFields):

    defaulted_bitfield = bitfield("doc", size=3)

    annotated_bitfield: bool = bitfield("doc", size=3)
...
class TestDefault:
    ...
    def test_type_hint(self):
        assert Fields.annotated_bitfield.type_hint is bool
        assert Fields.defaulted_bitfield.type_hint is int

    def test_typ(self):
        assert Fields.annotated_bitfield.typ is bool
