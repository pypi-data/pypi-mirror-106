    ...
    data = CaseData(
        ...
        implementation=Baseline(
            ...
            def __repr__(self) -> str:
                try:
                    return f"{type(self).__name__}(data_len={self.data_len!s}, data={self.data!r}, bookend={self.bookend!s})"
                except Exception:
...
class TestTypeFactorySingleDim(Case):
    ...
    data = CaseData(
        ...
        implementation=Baseline(
            ...
            def __repr__(self) -> str:
                try:
                    return f"{type(self).__name__}(data_type={self.data_type!s}, data_len={self.data_len!s}, data={self.data!r}, bookend={self.bookend!s})"
                except Exception:
                    return f"{type(self).__name__}()"
...
class TestTypeFactoryMultiDim(Case):
    ...
    data = CaseData(
        ...
        implementation=Baseline(
            ...
            def __repr__(self) -> str:
                try:
                    return f"{type(self).__name__}(data_type={self.data_type!s}, data_dims={self.data_dims!r}, data={self.data!r}, bookend={self.bookend!s})"
                except Exception:
                    return f"{type(self).__name__}()"
