...
class TestFirst(Case):
    ...
    data = CaseData(
        ...
        implementation=Baseline(
            """
            def __init__(self, *, m1: int, m2: int = 1, m3: int = 2, m4: int = 255) -> None:
                if not 0 <= m1 <= 15:
            ...
            def __pack__(cls, value, pieces: List[bytes], dump: Optional[Record] = None) -> None:
                ...
                if dump is None:
                    ...
                    bitfields_0 |= (bitfields_0 & -16) | ((m_m1 & 0xf) << 0)
            ...
            def __repr__(self) -> str:
                try:
                    return f"{type(self).__name__}(m1={self.m1!s}, m2={self.m2!s}, m3={self.m3!s}, m4={self.m4!s})"
                except Exception:
...
class TestLast(Case):
    ...
    data = CaseData(
        ...
        implementation=Baseline(
            ...
            def __repr__(self) -> str:
                try:
                    return f"{type(self).__name__}(m0={self.m0!s}, m1={self.m1!s}, m2={self.m2!s}, m3={self.m3!s})"
                except Exception:
                    return f"{type(self).__name__}()"
        ...
        implementation=Baseline(
            ...
            def __pack__(cls, value, pieces: List[bytes], dump: Optional[Record] = None) -> None:
                ...
                if dump is None:
                    ...
                    bitfields_0 |= (bitfields_0 & -16) | ((m_m0 & 0xf) << 0)
                    ...
                    bitfields_1 |= (bitfields_1 & -16) | ((m_m3 & 0xf) << 0)
                    ...
                    bitfields_2 |= (bitfields_2 & -16) | ((m_m6 & 0xf) << 0)
            ...
            def __repr__(self) -> str:
                try:
                    return f"{type(self).__name__}(m0={self.m0!s}, m1={self.m1!s}, m2={self.m2!s}, m3={self.m3!s}, m4={self.m4!s}, m5={self.m5!s}, m6={self.m6!s}, m7={self.m7!s})"
                except Exception:
                    return f"{type(self).__name__}()"
...
class TestTypDefault:
    ...
    def test_annotation(self):
        """Test defaults to annotation."""

        class WithAnnotation(Structure):

            """Sample Structure."""

            m1: bool = bitfield_member(size=4)

        assert WithAnnotation.m1.typ is bool

    def test_no_annotation(self):
        """Test defaults to int when no annotation."""

        class NoAnnotation(Structure):

            """Sample Structure."""

            m1 = bitfield_member(size=4)

        assert NoAnnotation.m1.typ is int
