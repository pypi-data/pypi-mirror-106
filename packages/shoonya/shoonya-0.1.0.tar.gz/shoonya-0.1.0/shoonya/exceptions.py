...
class ShoonyaException(Exception):
    """
    ...
    def __init__(self, message, code=500):
        ...
        super(ShoonyaException, self).__init__(message)
        self.code = code


class GeneralException(ShoonyaException):
...
class TokenException(ShoonyaException):
...
class PermissionException(ShoonyaException):
...
class OrderException(ShoonyaException):
...
class InputException(ShoonyaException):
...
class DataException(ShoonyaException):
...
class NetworkException(ShoonyaException):
