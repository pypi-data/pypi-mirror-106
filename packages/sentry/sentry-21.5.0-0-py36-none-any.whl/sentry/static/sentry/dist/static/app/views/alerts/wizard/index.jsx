...
var AlertWizard = /** @class */ (function (_super) {
    ...
    AlertWizard.prototype.renderCreateAlertButton = function () {
        ...
        {function (_a) {
            ...
            <CreateAlertButton organization={organization} projectSlug={project.slug} disabled={!hasFeature} priority="primary" to={to} hideIcon>
              {t('Set Conditions')}
            </CreateAlertButton>
        ...
        <Feature features={['organizations:alert-wizard']}>
          <Layout.Header>
            <Layout.HeaderContent>
              <BuilderBreadCrumbs hasMetricAlerts={hasMetricAlerts} orgSlug={organization.slug} projectSlug={projectId} title={t('Select Alert')}/>
...
var WizardFooter = styled('div')(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  border-top: 1px solid ", ";\n  padding: ", " ", " ", " ", ";\n"], ["\n  border-top: 1px solid ", ";\n  padding: ", " ", " ", " ", ";\n"])), function (p) { return p.theme.border; }, space(1.5), space(1.5), space(1.5), space(1.5));
var WizardButtonContainer = styled('div')(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  display: flex;\n  justify-content: flex-end;\n"], ["\n  display: flex;\n  justify-content: flex-end;\n"])));
