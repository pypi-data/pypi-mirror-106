...
var SettingsNavItem = function (_a) {
    ...
    var renderedBadge = badge === 'new' ? (<FeatureBadge type="new"/>) : badge === 'warning' ? (<Tooltip title={t('This settings needs review')} position="right">
        <SyledBadge text={badge} type="warning"/>
      </Tooltip>) : (<SyledBadge text={badge}/>);
...
var SyledBadge = styled(Badge)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  font-weight: 400;\n  height: auto;\n  line-height: 1;\n  font-size: ", ";\n  padding: 3px ", ";\n"], ["\n  font-weight: 400;\n  height: auto;\n  line-height: 1;\n  font-size: ", ";\n  padding: 3px ", ";\n"])), function (p) { return p.theme.fontSizeExtraSmall; }, space(0.75));
