...
var Provider = withApi(withProject(function (_a) {
    ...
    function getAppStoreConnectSymbolSourceId() {
        var _a;
        return (_a = (project.symbolSources ? JSON.parse(project.symbolSources) : []).find(function (symbolSouce) { return symbolSouce.type === 'appStoreConnect'; })) === null || _a === void 0 ? void 0 : _a.id;
    }
