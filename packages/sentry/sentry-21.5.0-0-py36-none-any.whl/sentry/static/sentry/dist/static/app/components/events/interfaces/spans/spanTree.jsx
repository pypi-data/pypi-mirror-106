...
import { boundsGenerator, generateRootSpan, getSpanID, getSpanOperation, getSpanTraceID, isEventFromBrowserJavaScriptSDK, isGapSpan, isOrphanSpan, } from './utils';
var SpanTree = /** @class */ (function (_super) {
    ...
    function SpanTree() {
        ...
        _this.renderSpan = function (_a) {
            ...
            var _c = _this.props, event = _c.event, organization = _c.organization;
            var spanBarColour = pickBarColour(getSpanOperation(span));
            ...
            var spanGapComponent = isValidGap && isSpanDisplayed ? (<SpanGroup organization={organization} event={event} spanNumber={spanNumber} isLast={false} continuingTreeDepths={continuingTreeDepths} isRoot={isRoot} span={spanGap} trace={_this.props.trace} generateBounds={generateBounds} treeDepth={treeDepth} numOfSpanChildren={0} renderedSpanChildren={[]} isCurrentSpanFilteredOut={isCurrentSpanFilteredOut} spanBarHatch/>) : null;
            return {
          ...
          {infoMessage}
          {spanGapComponent}
          <SpanGroup organization={organization} event={event} spanNumber={spanGroupNumber} isLast={isLast} continuingTreeDepths={continuingTreeDepths} isRoot={isRoot} span={span} trace={_this.props.trace} generateBounds={generateBounds} treeDepth={treeDepth} numOfSpanChildren={spanChildren.length} renderedSpanChildren={reduced.renderedSpanChildren} spanBarColour={spanBarColour} isCurrentSpanFilteredOut={isCurrentSpanFilteredOut} spanBarHatch={false}/>
        </React.Fragment>),
            };
        };
...
var GuideAnchorWrapper = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  height: 0;\n  width: 0;\n  margin-left: 50%;\n"], ["\n  height: 0;\n  width: 0;\n  margin-left: 50%;\n"])));
/**
