...
var COLOR_ERRORS = Color(ChartPalette[4][3]).lighten(0.25).string();
var COLOR_TRANSACTIONS = Color(ChartPalette[4][2]).lighten(0.35).string();
var COLOR_ATTACHMENTS = Color(ChartPalette[4][1]).lighten(0.65).string();
