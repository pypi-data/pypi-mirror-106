...
var QueryField = /** @class */ (function (_super) {
    ...
    QueryField.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, takeFocus = _a.takeFocus, filterPrimaryOptions = _a.filterPrimaryOptions, inFieldLabels = _a.inFieldLabels, disabled = _a.disabled, hidePrimarySelector = _a.hidePrimarySelector, gridColumns = _a.gridColumns;
        ...
        return (<Container className={className} gridColumns={gridColumns ? gridColumns : parameters.length + 1}>
        {!hidePrimarySelector && (<SelectControl {...selectProps} styles={!inFieldLabels ? styles : undefined} components={{
                    Option: function (_a) {
