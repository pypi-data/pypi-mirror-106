...
var RuleListRow = /** @class */ (function (_super) {
    ...
    RuleListRow.prototype.render = function () {
        ...
        var alertLink = (<TitleLink to={hasRedesign ? detailsLink : editLink}>{rule.name}</TitleLink>);
            ...
            <AlertNameWrapper isIncident={isIssueAlert(rule)}>
              <FlexCenter>
                <Tooltip title={isIssueAlert(rule)
                    ? t('Issue Alert')
                    : IssueStatusText[(_d = (_c = rule === null || rule === void 0 ? void 0 : rule.latestIncident) === null || _c === void 0 ? void 0 : _c.status) !== null && _d !== void 0 ? _d : IncidentStatus.CLOSED]}>
...
var TitleLink = styled(Link)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n\n  @media (max-width: ", ") {\n    max-width: 300px;\n  }\n  @media (max-width: ", ") {\n    max-width: 165px;\n  }\n  @media (max-width: ", ") {\n    max-width: 100px;\n  }\n"], ["\n  ", "\n\n  @media (max-width: ", ") {\n    max-width: 300px;\n  }\n  @media (max-width: ", ") {\n    max-width: 165px;\n  }\n  @media (max-width: ", ") {\n    max-width: 100px;\n  }\n"])), overflowEllipsis, function (p) { return p.theme.breakpoints[3]; }, function (p) { return p.theme.breakpoints[2]; }, function (p) { return p.theme.breakpoints[1]; });
