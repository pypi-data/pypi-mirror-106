    ...
    function renderMiniDashboards() {
        return dashboards === null || dashboards === void 0 ? void 0 : dashboards.map(function (dashboard, index) {
            return (<DashboardCard key={index + "-" + dashboard.id} title={dashboard.id === 'default-overview' ? 'Default Dashboard' : dashboard.title} to={{
                ...
                }} detail={tn('%s widget', '%s widgets', dashboard.widgetDisplay.length)} dateStatus={dashboard.dateCreated ? <TimeSince date={dashboard.dateCreated}/> : undefined} onEventClick={function () { return handleClick(dashboard); }} createdBy={dashboard.createdBy} renderWidgets={function () { return (<WidgetGrid>
              {dashboard.widgetDisplay.map(function (displayType, i) {
                        return displayType === DisplayType.BIG_NUMBER ? (<BigNumberWidgetWrapper key={i + "-" + displayType} src={miniWidget(displayType)}/>) : (<MiniWidgetWrapper key={i + "-" + displayType} src={miniWidget(displayType)}/>);
                    })}
...
var BigNumberWidgetWrapper = styled('img')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  /* 2 cols */\n  grid-area: span 1 / span 2;\n\n  @media (min-width: ", ") {\n    /* 4 cols */\n    grid-area: span 1 / span 1;\n  }\n\n  @media (min-width: ", ") {\n    /* 6 and 8 cols */\n    grid-area: span 1 / span 2;\n  }\n"], ["\n  width: 100%;\n  height: 100%;\n  /* 2 cols */\n  grid-area: span 1 / span 2;\n\n  @media (min-width: ", ") {\n    /* 4 cols */\n    grid-area: span 1 / span 1;\n  }\n\n  @media (min-width: ", ") {\n    /* 6 and 8 cols */\n    grid-area: span 1 / span 2;\n  }\n"])), function (p) { return p.theme.breakpoints[0]; }, function (p) { return p.theme.breakpoints[3]; });
var MiniWidgetWrapper = styled('img')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  grid-area: span 2 / span 2;\n"], ["\n  width: 100%;\n  height: 100%;\n  grid-area: span 2 / span 2;\n"])));
var PaginationRow = styled(Pagination)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  margin-bottom: ", ";\n"], ["\n  margin-bottom: ", ";\n"])), space(3));
