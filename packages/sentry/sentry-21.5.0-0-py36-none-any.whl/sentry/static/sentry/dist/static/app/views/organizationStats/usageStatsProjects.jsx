...
var UsageStatsProjects = /** @class */ (function (_super) {
    ...
    Object.defineProperty(UsageStatsProjects.prototype, "endpointQuery", {
        get: function () {
            ...
            return __assign(__assign({}, queryDatetime), { interval: '1d', groupBy: ['outcome', 'project'], field: ['sum(quantity)'], category: dataCategory.slice(0, -1) });
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(UsageStatsProjects.prototype, "filteredProjects", {
        ...
        get: function () {
            ...
            return tableQuery ? projects.filter(function (p) { return p.slug.includes(tableQuery); }) : projects;
        },
        enumerable: false,
        configurable: true
    });
