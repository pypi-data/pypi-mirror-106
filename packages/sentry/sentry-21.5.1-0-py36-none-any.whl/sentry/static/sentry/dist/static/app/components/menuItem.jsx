...
var MenuItem = /** @class */ (function (_super) {
    ...
    function MenuItem() {
        ...
        _this.handleClick = function (e) {
            var _a = _this.props, onSelect = _a.onSelect, disabled = _a.disabled, eventKey = _a.eventKey, allowDefaultEvent = _a.allowDefaultEvent;
            if (disabled) {
                return;
            }
            if (onSelect) {
    ...
    MenuItem.prototype.render = function () {
        ...
        return (<MenuListItem className={className} role="presentation" isActive={isActive} divider={divider} noAnchor={noAnchor} header={header} {...omit(props, ['href', 'title', 'onSelect', 'eventKey', 'to', 'as'])}>
        {renderChildren}
      </MenuListItem>);
    };
    return MenuItem;
...
var MenuAnchor = styled('a', {
    shouldForwardProp: function (p) {
        return typeof p === 'string' && ['isActive', 'disabled'].includes(p) === false;
    },
