...
import { getDurationDisplay, getHumanDuration, pickBarColour, toPercent, } from 'app/components/performance/waterfall/utils';
...
import { AGGREGATIONS, getAggregateAlias, getSpanOperationName, isRelativeSpanOperationBreakdownField, isSpanOperationBreakdownField, SPAN_OP_BREAKDOWN_FIELDS, SPAN_OP_RELATIVE_BREAKDOWN_FIELD, } from 'app/utils/discover/fields';
...
var spanOperationBreakdownRenderer = function (field) { return function (data) {
    var _a;
    ...
    var transactionDuration = data['transaction.duration'];
    var spanOpDuration = data[field];
    var widthPercentage = spanOpDuration / transactionDuration;
    var operationName = (_a = getSpanOperationName(field)) !== null && _a !== void 0 ? _a : 'op';
    return (<div style={{ position: 'relative' }}>
      <RowRectangle spanBarHatch={false} style={{
...
var spanOperationRelativeBreakdownRenderer = function (data, _a) {
    var location = _a.location, organization = _a.organization;
    var cumulativeSpanOpBreakdown = data['spans.total.time'];
    ...
    return (<RelativeOpsBreakdown>
      {SPAN_OP_BREAKDOWN_FIELDS.map(function (field) {
            var _a;
