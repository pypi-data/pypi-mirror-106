 ...
 */
export function isCurrentEvent(event, currentEvent) {
...
export function parseQuickTrace(quickTrace, event, organization) {
    var _a, _b, _c;
...
export function getTraceRequestPayload(_a) {
...
export function isTraceFull(transaction) {
