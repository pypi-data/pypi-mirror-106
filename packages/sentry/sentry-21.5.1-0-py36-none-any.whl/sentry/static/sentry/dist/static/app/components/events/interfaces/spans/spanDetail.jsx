...
var SpanDetail = /** @class */ (function (_super) {
    ...
    SpanDetail.prototype.renderSpanErrorMessage = function () {
        ...
        {errorsOpened && (<ErrorMessageContent>
            {relatedErrors.map(function (error) { return (<React.Fragment key={error.event_id}>
...
var Toggle = styled(Button)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  font-weight: bold;\n  color: ", ";\n  :hover {\n    color: ", ";\n  }\n"], ["\n  font-weight: bold;\n  color: ", ";\n  :hover {\n    color: ", ";\n  }\n"])), function (p) { return p.theme.subText; }, function (p) { return p.theme.textColor; });
