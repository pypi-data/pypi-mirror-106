...
var SmartSearchBar = /** @class */ (function (_super) {
    ...
    function SmartSearchBar() {
        ...
        _this.onTogglePinnedSearch = function (evt) { return __awaiter(_this, void 0, void 0, function () {
            var _a, api, location, organization, savedSearchType, hasPinnedSearch, pinnedSearch, sort, _b, _cursor, _page, currentQuery, resp;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.props, api = _a.api, location = _a.location, organization = _a.organization, savedSearchType = _a.savedSearchType, hasPinnedSearch = _a.hasPinnedSearch, pinnedSearch = _a.pinnedSearch, sort = _a.sort;
                        evt.preventDefault();
                        evt.stopPropagation();
                        if (savedSearchType === undefined || !hasPinnedSearch) {
                            return [2 /*return*/];
                        }
                        _b = location.query, _cursor = _b.cursor, _page = _b.page, currentQuery = __rest(_b, ["cursor", "page"]);
                        trackAnalyticsEvent({
                            eventKey: 'search.pin',
                        ...
                        return [4 /*yield*/, pinSearch(api, organization.slug, savedSearchType, removeSpace(this.state.query), sort)];
                    case 1:
                        resp = _d.sent();
                        if (!resp || !resp.id) {
                            return [2 /*return*/];
    ...
    SmartSearchBar.prototype.render = function () {
        ...
        var pinIcon = <IconPin isSolid={!!pinnedSearch} size="xs"/>;
