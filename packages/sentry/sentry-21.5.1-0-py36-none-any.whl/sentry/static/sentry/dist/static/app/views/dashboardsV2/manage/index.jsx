...
var ManageDashboards = /** @class */ (function (_super) {
    ...
    ManageDashboards.prototype.renderActions = function () {
        ...
        <StyledSearchBar defaultQuery="" query={this.getQuery()} placeholder={t('Search Dashboards')} onSearch={function (query) { return _this.handleSearch(query); }}/>
        <StyledDropdownControl buttonProps={{ prefix: t('Sort By') }} label={activeSort.label}>
    ...
    ManageDashboards.prototype.renderBody = function () {
        ...
        return (<Feature organization={organization} features={['dashboards-manage']} renderDisabled={this.renderNoAccess}>
...
var StyledPageHeader = styled('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  align-items: flex-end;\n  font-size: ", ";\n  color: ", ";\n  justify-content: space-between;\n  margin-bottom: ", ";\n"], ["\n  display: flex;\n  align-items: flex-end;\n  font-size: ", ";\n  color: ", ";\n  justify-content: space-between;\n  margin-bottom: ", ";\n"])), function (p) { return p.theme.headerFontSize; }, function (p) { return p.theme.textColor; }, space(2));
var StyledDropdownControl = styled(DropdownControl)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  margin-bottom: ", ";\n"], ["\n  margin-bottom: ", ";\n"])), space(2));
var StyledActions = styled('div')(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: auto max-content min-content;\n  width: 100%;\n\n  @media (max-width: ", ") {\n    grid-template-columns: auto;\n  }\n\n  margin-bottom: ", ";\n  align-items: center;\n"], ["\n  display: grid;\n  grid-template-columns: auto max-content min-content;\n  width: 100%;\n\n  @media (max-width: ", ") {\n    grid-template-columns: auto;\n  }\n\n  margin-bottom: ", ";\n  align-items: center;\n"])), function (p) { return p.theme.breakpoints[0]; }, space(1));
