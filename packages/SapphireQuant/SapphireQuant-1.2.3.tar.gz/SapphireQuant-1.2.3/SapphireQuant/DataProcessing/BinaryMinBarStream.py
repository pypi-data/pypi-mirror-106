...
class BinaryMinBarStream(object):
    ...
    def _write_bar(writer, file_header, bar):
        ...
        if file_header.begin_trading_day == datetime.datetime.max or trading_date < file_header.begin_trading_day:
            file_header.begin_trading_day = trading_date
            file_header.mark_as_dirty(True)
        if file_header.end_trading_day == datetime.datetime.max or trading_date > file_header.end_trading_day:
