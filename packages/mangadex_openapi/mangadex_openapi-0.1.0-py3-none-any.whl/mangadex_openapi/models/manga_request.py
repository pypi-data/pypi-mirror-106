...
class MangaRequest(object):
    ...
    def __init__(self, title=None, alt_titles=None, description=None, authors=None, artists=None, links=None, original_language=None, last_volume=None, last_chapter=None, publication_demographic=None, status=None, year=None, content_rating=None, mod_notes=None, version=None):  # noqa: E501
    ...
    def publication_demographic(self, publication_demographic):
        ...
        if publication_demographic not in allowed_values:
            raise ValueError(
                "Invalid value for `publication_demographic` ({0}), must be one of {1}"  # noqa: E501
                .format(publication_demographic, allowed_values)
            )
    ...
    def content_rating(self, content_rating):
        ...
        if content_rating not in allowed_values:
            raise ValueError(
                "Invalid value for `content_rating` ({0}), must be one of {1}"  # noqa: E501
