...
class InlineResponse2003(object):
    ...
    @property
    def statuses(self):
        """Gets the statuses of this InlineResponse2003.  # noqa: E501


        :return: The statuses of this InlineResponse2003.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def statuses(self, statuses):
        """Sets the statuses of this InlineResponse2003.


        :param statuses: The statuses of this InlineResponse2003.  # noqa: E501
        :type: dict(str, str)
        """
        allowed_values = ["reading", "on_hold", "plan_to_read", "dropped", "re_reading", "completed"]  # noqa: E501
        if not set(statuses.keys()).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid keys in `statuses` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(statuses.keys()) - set(allowed_values))),  # noqa: E501
