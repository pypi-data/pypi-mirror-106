...
class MangaAttributes(object):
    ...
    def __init__(self, title=None, alt_titles=None, description=None, is_locked=None, links=None, original_language=None, last_volume=None, last_chapter=None, publication_demographic=None, status=None, year=None, content_rating=None, tags=None, version=None, created_at=None, updated_at=None):  # noqa: E501
