...
class Order4(object):
    ...
    @property
    def name(self):
        """Gets the name of this Order4.  # noqa: E501


        :return: The name of this Order4.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Order4.


        :param name: The name of this Order4.  # noqa: E501
        :type: str
        """
