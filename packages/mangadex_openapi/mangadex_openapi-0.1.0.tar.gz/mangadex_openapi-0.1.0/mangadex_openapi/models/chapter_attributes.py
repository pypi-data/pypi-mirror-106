...
class ChapterAttributes(object):
    ...
    def __init__(self, title=None, volume=None, chapter=None, translated_language=None, hash=None, data=None, data_saver=None, uploader=None, version=None, created_at=None, updated_at=None, publish_at=None):  # noqa: E501
