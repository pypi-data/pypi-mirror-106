...
class Order1(object):
    ...
    def __init__(self, created_at=None, updated_at=None, publish_at=None, volume=None, chapter=None):  # noqa: E501
    ...
    def created_at(self, created_at):
        ...
        if created_at not in allowed_values:
            raise ValueError(
                "Invalid value for `created_at` ({0}), must be one of {1}"  # noqa: E501
                .format(created_at, allowed_values)
            )
    ...
    def updated_at(self, updated_at):
        ...
        if updated_at not in allowed_values:
            raise ValueError(
                "Invalid value for `updated_at` ({0}), must be one of {1}"  # noqa: E501
                .format(updated_at, allowed_values)
            )
    ...
    def publish_at(self, publish_at):
        ...
        if publish_at not in allowed_values:
            raise ValueError(
                "Invalid value for `publish_at` ({0}), must be one of {1}"  # noqa: E501
                .format(publish_at, allowed_values)
            )
    ...
    def chapter(self, chapter):
        ...
        if chapter not in allowed_values:
            raise ValueError(
                "Invalid value for `chapter` ({0}), must be one of {1}"  # noqa: E501
                .format(chapter, allowed_values)
            )
