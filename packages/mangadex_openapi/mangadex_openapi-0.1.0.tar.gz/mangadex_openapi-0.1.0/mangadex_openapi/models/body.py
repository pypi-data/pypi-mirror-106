...
class Body(object):
    ...
    def __init__(self, captcha_challenge=None):  # noqa: E501
        """Body - a model defined in Swagger"""  # noqa: E501
        self._captcha_challenge = None
        self.discriminator = None
        self.captcha_challenge = captcha_challenge

    @property
    def captcha_challenge(self):
        """Gets the captcha_challenge of this Body.  # noqa: E501


        :return: The captcha_challenge of this Body.  # noqa: E501
        :rtype: str
        """
    ...
    def captcha_challenge(self, captcha_challenge):
        """Sets the captcha_challenge of this Body.


        :param captcha_challenge: The captcha_challenge of this Body.  # noqa: E501
        :type: str
        """
        if captcha_challenge is None:
            raise ValueError("Invalid value for `captcha_challenge`, must not be `None`")  # noqa: E501
