...
class SearchApi(object):
    ...
    def get_chapter_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'ids', 'title', 'groups', 'uploader', 'manga', 'volume', 'chapter', 'translated_language', 'created_at_since', 'updated_at_since', 'publish_at_since', 'order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'translated_language' in params:
            query_params.append(('translatedLanguage', params['translated_language']))  # noqa: E501
