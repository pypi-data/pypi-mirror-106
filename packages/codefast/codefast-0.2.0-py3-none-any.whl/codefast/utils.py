...
class Network:
    ...
    def get(cls, url: str, **kwargs) -> requests.models.Response:
        return requests.get(url, headers=cls._headers, **kwargs)
...
class FileIO:
    ...
    @staticmethod
    def write(cons: Union[str, List], file_name: str) -> None:
        with open(file_name, 'w') as f:
            text = '\n'.join(map(str, cons)) if isinstance(cons, list) else cons
            f.write(text)
