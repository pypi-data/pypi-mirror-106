...
def create():
    ...
    echo(f'Please create an account from our website, {site_base}/register.')
...
def _provision(account):
    ...
    while status != ComputeStatus.CREATED:
        ...
        if status == ComputeStatus.CREATED:
            ...
            echo(f"You are now ready to run Flows with Aero. For more, read here: {site_base}/tutorials")
            break  
