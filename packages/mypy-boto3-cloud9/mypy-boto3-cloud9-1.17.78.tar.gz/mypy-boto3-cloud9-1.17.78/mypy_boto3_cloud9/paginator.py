...
class DescribeEnvironmentMembershipsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.78/reference/services/cloud9.html#Cloud9.Paginator.DescribeEnvironmentMemberships.paginate)
...
class ListEnvironmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.78/reference/services/cloud9.html#Cloud9.Paginator.ListEnvironments.paginate)
