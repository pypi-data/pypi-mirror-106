...
without quitting the program. Note: currently, this will only work with
Click < 8, because Click-shell (required for this feature) does not
[support Click 8](https://github.com/clarkperkins/click-shell/issues/30)
yet.
