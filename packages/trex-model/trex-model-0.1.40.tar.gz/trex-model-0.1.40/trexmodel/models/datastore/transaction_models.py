...
class CustomerTransaction(BaseNModel, DictModel):
    ...
    def revert(self, customer_acct, reverted_by):
        ...
        logger.debug('revert: entitled_point_details_list=%s', entitled_point_details_list)
        logger.debug('revert: entitled_stamp_details_list=%s', entitled_stamp_details_list)
        logger.debug('revert: entiteld_vouchers_list=%s', entiteld_vouchers_list)
