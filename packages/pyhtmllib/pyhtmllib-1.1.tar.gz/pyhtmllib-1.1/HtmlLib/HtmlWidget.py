...
class HtmlWidget():
    def __init__(self, content='', **args):
        if args.get('class_'):
            self.args = {**args, 'class': args['class_']}
            del self.args['class_']
        else:
            self.args = args

        if args.get('style') and not isinstance(args.get('style'), str):
            self.args['style'] = args['style'].content
...
class UnorderedList(HtmlWidget):
    ...
    def addListItem(self, content='', **args):
        normal_list_item = NormalListItem(content='', **args)
        self.addItem(normal_list_item)
...
class DefinedList(HtmlWidget):
    ...
    def addListItem(self, content='', **args):
        defined_list_item = DefinedListItem(content='', **args)
        self.addItem(defined_list_item)

    def addListInformation(self, content='', **args):
        defined_list_information = DefinedListInformation(content='', **args)
        self.addItem(defined_list_information)
...
class Menu(HtmlWidget):
    ...
    def addMenuItem(self, content='', **args):
        menu_item = MenuItem(content='', **args)
...
class Table(HtmlWidget):
    ...
    def addCaption(self, content='', **args):
        table_caption = TableCaption(content='', **args)
        self.addItem(table_caption)

    def addRow(self, content='', **args):
        table_row = TableRow(content='', **args)
        self.addItem(table_row)

    def addCell(self, content='', **args):
        table_cell = TableCell(content='', **args)
        self.addItem(table_cell)
    
    def addHeadCell(self, content='', **args):
        table_head_cell = TableHeadCell(content='', **args)
        self.addItem(table_head_cell)

    def addHead(self, content='', **args):
        table_head = TableHead(content='', **args)
        self.addItem(table_head)

    def addBody(self, content='', **args):
        table_body = TableBody(content='', **args)
        self.addItem(table_body)

    def addFoot(self, content='', **args):
        table_foot = TableFoot(content='', **args)
        self.addItem(table_foot)
    
    def addColumnAttribute(self, content='', **args):
        table_column_attribute = TableColumnAttribute(content='', **args)
        self.addItem(table_table_column_attribute)

    def addColumnAttributegGroup(self, content='', **args):
        table_column_attribute_group = TableColumnAttributeGroup(content='', **args)
        self.addItem(table_table_column_attribute_group)
...
class FormInput(HtmlWidget):
    ...
    def addTextBox(self, content='', **args):
        form_text_box = FormTextBox(content='', **args)
        self.addItem(form_text_box)

    def addButton(self, content='', **args):
        form_button = FormButton(content='', **args)
        self.addItem(form_button)

    def addSelect(self, content='', **args):
        form_select = FormSelect(content='', **args)
        self.addItem(form_select)

    def addSelectOption(self, content='', **args):
        form_select_option = FormSelectOption(content='', **args)
        self.addItem(form_select_option)

    def addSelectOptionGroup(self, content='', **args):
        form_select_option_group = FormSelectOptionGroup(content='', **args)
        self.addItem(form_select_option_group)
