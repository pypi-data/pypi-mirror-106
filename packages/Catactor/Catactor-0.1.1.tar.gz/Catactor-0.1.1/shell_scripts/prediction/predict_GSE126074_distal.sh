...
Catactor --simulate --verbose --scmobj output/scobj/${GSE}_${dist}_${clabel}__all_scanpy_obj_with_feat.pyn \
         ...
         --mdir $mdir --markers $marker_file --data-markers rank_gene_list_celltype.csv --cluster cluster,cluster_leiden,cluster_louvain,Ident,celltype \
...
#for GSE_train in GSE111586 GSE123576 GSE126074 GSE127257 BICCN2 GSE1303990 BICCN2_rna
