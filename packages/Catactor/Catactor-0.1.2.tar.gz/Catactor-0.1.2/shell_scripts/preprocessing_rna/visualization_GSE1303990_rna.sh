...
#cATACter --rna --pca 50 --tsne-params nn=30,perplexity=50,learning_rate=1000  --gene-name Name --cfilter genome_flag --clabel $clabel --cindex global_index --rindex local_index --rlabel '' --verbose \
#	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
#  --row ${GSE}_cell_ng_Actxr_meta.csv --skip 2 \
#	--column ${GSE}_bin_ng_Actxr_csv \
...
#	--output ${GSE}_rna_${dist} visualization ${GSE}_sparse_mat_Actxr.mtx
if false; then
Catactor --rna --marker-genes --top-genes 5000 --na_filtering --test-vis --gene-name Name  --clabel $clabel --cindex global_index --rindex local_index --rlabel '' --verbose \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
        --row ${GSE}_cell_ng_Actxr_meta.csv --skip 2 \
	--column ${GSE}_bin_ng_Actxr.csv \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --mdir $mdir --markers $marker_file --cluster cluster,cluster_leiden,cluster_louvain,Ident,celltype \
	--output ${GSE}_rna_${dist}m visualization ${GSE}_sparse_mat_Actxr.mtx
break
else
Catactor --rna --pca 8 --tsne-params nn=15,perplexity=50,learning_rate=100 --top-genes 2000 \
         --na_filtering --gene-name Name  --clabel $clabel --cindex global_index --rindex local_index --rlabel '' --verbose \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
        --row ${GSE}_cell_ng_Actxr_meta.csv --skip 2 \
	--column ${GSE}_bin_ng_Actxr.csv \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --mdir $mdir --markers $marker_file --cluster cluster,cluster_leiden,cluster_louvain,Ident,celltype \
