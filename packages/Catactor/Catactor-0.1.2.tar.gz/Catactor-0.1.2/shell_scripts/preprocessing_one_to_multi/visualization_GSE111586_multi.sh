...
if false; then
Catactor --update --test-vis --na_filtering --pca 8 --tsne-params nn=15,perplexity=50,learning_rate=1000 --gene-name '' --cfilter genome_flag  --clabel global_index_5000  --cindex global_index_5000 --rindex local_index --rlabel '' --verbose \
...
Catactor  --test-vis --na_filtering --pca 8 --tsne-params nn=15,perplexity=50,learning_rate=1000 --cfilter genome_flag  \
	--clabel_mat _${dist}_col_mat.mtx --clabel_ann _${dist}_gene.csv  \
	--cindex global_index_5000 --gene-name gene_name --rindex local_index --rlabel '' --verbose \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
	--row ${GSE}_cell_ng_Wholebrain1_meta.csv,${GSE}_cell_ng_Wholebrain2_meta.csv,${GSE}_cell_ng_Prefrontal_meta.csv	\
	--column ${GSE}_bin_ng_Wholebrain1_with_bins_annot.csv,${GSE}_bin_ng_Wholebrain2_with_bins_annot.csv,${GSE}_bin_ng_Prefrontal_with_bins_annot.csv \
	--mdir $mdir --markers $marker_file --cluster Ident,cluster_leiden,cluster_louvain,id,cell_label,celltype \
...
Catactor --update --na_filtering --pca 40 --tsne-params nn=15,perplexity=30,learning_rate=1000 --cfilter genome_flag --verbose \
	--clabel_mat _${dist}_col_mat.mtx --clabel_ann _${dist}_gene.csv  \
	--cindex global_index_5000 --gene-name gene_name --rindex local_index --rlabel '' --verbose \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
	--row ${GSE}_cell_ng_Wholebrain1_meta.csv,${GSE}_cell_ng_Wholebrain2_meta.csv,${GSE}_cell_ng_Prefrontal_meta.csv	\
