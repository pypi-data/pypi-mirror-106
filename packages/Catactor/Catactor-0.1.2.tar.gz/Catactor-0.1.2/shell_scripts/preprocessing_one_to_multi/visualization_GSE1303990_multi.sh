...
if false; then
Catactor  --tfidf --goutlier 6000 --na_filtering --norm --top-genes 2000 --test-vis --cfilter genome_flag --gene-name '' --clabel global_index_5000  --cindex global_index --rindex local_index --rlabel '' --verbose \
...
Catactor  --update --goutlier 6000 --na_filtering --norm --top-genes 5000 --test-vis --cfilter genome_flag --cindex global_index --rindex local_index --rlabel '' --verbose \
...
Catactor --update --pca 50 --na_filtering --norm --tsne-params nn=30,perplexity=100,learning_rate=100  --top-genes 5000 --cfilter genome_flag --cindex global_index --rindex local_index --rlabel '' --verbose \
	--clabel_mat _${dist}_col_mat.mtx --clabel_ann _${dist}_gene.csv --gene-name gene_name \
	--dir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} --adir /data/rkawaguc/data/190813_meta_scATAC/processed/${GSE} \
	--row ${GSE}_cell_ng_Actx_meta.csv --skip 2 \
	--column ${GSE}_bin_ng_Actx_with_bins_annot.csv \
