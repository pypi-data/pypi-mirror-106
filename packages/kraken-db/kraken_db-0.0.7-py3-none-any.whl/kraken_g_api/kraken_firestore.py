...
class Kraken_firestore:
    """ Library to access google firestore. 
    ...
    def __init__(self, key_location, project_id='kraken-v1'):
    ...
    def init_db(self):
        ...
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = self.key_location
    ...
    def get_docs2(self, doc_path, order_by = 'createdDate', direction = "DESCENDING", offset = 0, limit = 100):
        """ Get list of document in order ot creation (or reverse order)
        """
    ...
    def add_to_search(self, doc_path, key, ops, value):
        ...
        doc_path:
        key: variable to be searched
        ops: the operation to be performed (eq, lt, gt, le, ge)
        value: the value to be cmpared against
        ex: age lt 10
        """
        record = {
            'doc_path': doc_path,
    ...
    def get_docs(self, doc_path = None, order_by = None, direction = None, offset = 0, limit = 100):
        """ Get lis tof documents based on search criteria
            Search criteria needs to be set with add_to_search
        """
    ...
    def post(self, doc_path = None, record = None):
        ...
        for item in self.post_list:
            ...
            record['createdDate'] = datetime.datetime.now()
