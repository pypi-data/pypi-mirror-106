...
class Dtime:
	...
	def set(self, index: int, dwell_time: float) -> None:
		...
		in the other list modes (see method RsCmwGprfGen.Source.ListPy.Increment.value) . \n
			...
			:param dwell_time: Dwell time for the frequency/level step Range: 200E-6 s to 20 s, Unit: s
		"""
	...
	def get(self, index: int) -> float:
		...
		in the other list modes (see method RsCmwGprfGen.Source.ListPy.Increment.value) . \n
			:param index: Number of the frequency/level step in the table Range: 0 to 1999
			:return: dwell_time: Dwell time for the frequency/level step Range: 200E-6 s to 20 s, Unit: s"""
