...
class CacheClusterAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/elasticache.html#ElastiCache.Waiter.CacheClusterAvailableWaiter)
...
class CacheClusterDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/elasticache.html#ElastiCache.Waiter.CacheClusterDeletedWaiter)
...
class ReplicationGroupAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/elasticache.html#ElastiCache.Waiter.ReplicationGroupAvailableWaiter)
...
class ReplicationGroupDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/elasticache.html#ElastiCache.Waiter.ReplicationGroupDeletedWaiter)
