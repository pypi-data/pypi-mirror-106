...
class fz_layout_char(object):
    ...
    w = property(_mupdf.fz_layout_char_w_get, _mupdf.fz_layout_char_w_set)
...
class fz_layout_line(object):
    ...
    h = property(_mupdf.fz_layout_line_h_get, _mupdf.fz_layout_line_h_set)
...
class pdf_document(object):
    ...
    dirty = property(_mupdf.pdf_document_dirty_get, _mupdf.pdf_document_dirty_set)
...
class pdf_annot(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    refs = property(_mupdf.pdf_annot_refs_get, _mupdf.pdf_annot_refs_set)
    page = property(_mupdf.pdf_annot_page_get, _mupdf.pdf_annot_page_set)
    obj = property(_mupdf.pdf_annot_obj_get, _mupdf.pdf_annot_obj_set)
    is_hot = property(_mupdf.pdf_annot_is_hot_get, _mupdf.pdf_annot_is_hot_set)
    is_active = property(_mupdf.pdf_annot_is_active_get, _mupdf.pdf_annot_is_active_set)
    needs_new_ap = property(_mupdf.pdf_annot_needs_new_ap_get, _mupdf.pdf_annot_needs_new_ap_set)
    has_new_ap = property(_mupdf.pdf_annot_has_new_ap_get, _mupdf.pdf_annot_has_new_ap_set)
    ignore_trigger_events = property(_mupdf.pdf_annot_ignore_trigger_events_get, _mupdf.pdf_annot_ignore_trigger_events_set)
    next = property(_mupdf.pdf_annot_next_get, _mupdf.pdf_annot_next_set)

    def __init__(self):
        _mupdf.pdf_annot_swiginit(self, _mupdf.new_pdf_annot())
    __swig_destroy__ = _mupdf.delete_pdf_annot

# Register pdf_annot in _mupdf:
_mupdf.pdf_annot_swigregister(pdf_annot)
...
def new_docx_writer(format, path, options):
    return _mupdf.new_docx_writer(format, path, options)
...
def new_odt_writer(format, path, options):
    return _mupdf.new_odt_writer(format, path, options)
...
def new_pdf_writer(path, options):
    r"""	Document writers for various possible output formats."""
...
def new_pdfocr_band_writer(out, options):
    r"""	Create a new band writer, outputing pdfocr"""
...
def new_zip_writer_with_output(out):
    r"""	Create a new zip writer that writes to a given output stream."""
...
def paint_shade(shade, override_cs, ctm, dest, color_params, bbox, eop):
    ...
    """
    return _mupdf.paint_shade(shade, override_cs, ctm, dest, color_params, bbox, eop)
...
def ppdf_access_alert_event(event):
    return _mupdf.ppdf_access_alert_event(event)

def ppdf_access_exec_menu_item_event(event):
    return _mupdf.ppdf_access_exec_menu_item_event(event)

def ppdf_access_launch_url_event(event):
    return _mupdf.ppdf_access_launch_url_event(event)

def ppdf_access_mail_doc_event(event):
    return _mupdf.ppdf_access_mail_doc_event(event)
...
def ppdf_annot_default_appearance(annot, font, size, color):
    return _mupdf.ppdf_annot_default_appearance(annot, font, size, color)
...
def ppdf_annot_set_active(annot, active):
    return _mupdf.ppdf_annot_set_active(annot, active)

def ppdf_annot_set_hot(annot, hot):
    return _mupdf.ppdf_annot_set_hot(annot, hot)
...
def ppdf_drop_annots(annot_list):
    return _mupdf.ppdf_drop_annots(annot_list)
...
def ppdf_drop_widgets(widget_list):
    return _mupdf.ppdf_drop_widgets(widget_list)
...
def ppdf_event_issue_alert(doc, event):
    return _mupdf.ppdf_event_issue_alert(doc, event)
...
def ppdf_event_issue_mail_doc(doc, event):
    return _mupdf.ppdf_event_issue_mail_doc(doc, event)
...
def ppdf_load_annots(page, annots):
    return _mupdf.ppdf_load_annots(page, annots)
...
def ppdf_parse_default_appearance(da, font, size, color):
    return _mupdf.ppdf_parse_default_appearance(da, font, size, color)

def ppdf_parse_dict(doc, f, buf):
    return _mupdf.ppdf_parse_dict(doc, f, buf)

def ppdf_parse_ind_obj(doc, f, buf, num, gen, stm_ofs, try_repair):
    return _mupdf.ppdf_parse_ind_obj(doc, f, buf, num, gen, stm_ofs, try_repair)
...
def ppdf_print_default_appearance(buf, nbuf, font, size, color):
    return _mupdf.ppdf_print_default_appearance(buf, nbuf, font, size, color)
...
def ppdf_process_annot(proc, doc, page, annot, cookie):
    return _mupdf.ppdf_process_annot(proc, doc, page, annot, cookie)
...
def ppdf_run_page_with_usage(doc, page, dev, ctm, usage, cookie):
    return _mupdf.ppdf_run_page_with_usage(doc, page, dev, ctm, usage, cookie)
...
def ppdf_set_annot_default_appearance(annot, font, size, color):
    return _mupdf.ppdf_set_annot_default_appearance(annot, font, size, color)
...
def ppdf_set_doc_event_callback(doc, event_cb, data):
    return _mupdf.ppdf_set_doc_event_callback(doc, event_cb, data)
...
def ppdf_update_appearance(annot):
    return _mupdf.ppdf_update_appearance(annot)

def ppdf_update_appearance_from_display_list(annot, disp_list):
    return _mupdf.ppdf_update_appearance_from_display_list(annot, disp_list)
...
class DocumentWriter(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Type_CBZ = _mupdf.DocumentWriter_Type_CBZ
    Type_PAM_PIXMAP = _mupdf.DocumentWriter_Type_PAM_PIXMAP
    Type_PBM_PIXMAP = _mupdf.DocumentWriter_Type_PBM_PIXMAP
    Type_PCL = _mupdf.DocumentWriter_Type_PCL
    Type_PCLM = _mupdf.DocumentWriter_Type_PCLM
    Type_PGM_PIXMAP = _mupdf.DocumentWriter_Type_PGM_PIXMAP
    Type_PKM_PIXMAP = _mupdf.DocumentWriter_Type_PKM_PIXMAP
    Type_PNG_PIXMAP = _mupdf.DocumentWriter_Type_PNG_PIXMAP
    Type_PNM_PIXMAP = _mupdf.DocumentWriter_Type_PNM_PIXMAP
    Type_PPM_PIXMAP = _mupdf.DocumentWriter_Type_PPM_PIXMAP
    Type_PS = _mupdf.DocumentWriter_Type_PS
    Type_PWG = _mupdf.DocumentWriter_Type_PWG
    Type_SVG = _mupdf.DocumentWriter_Type_SVG
...
class PdfAnnot(object):
    ...
    def annot_default_appearance(self, font, size, color):
        return _mupdf.PdfAnnot_annot_default_appearance(self, font, size, color)
    ...
    def annot_set_active(self, active):
        return _mupdf.PdfAnnot_annot_set_active(self, active)

    def annot_set_hot(self, hot):
        return _mupdf.PdfAnnot_annot_set_hot(self, hot)
    ...
    def set_annot_default_appearance(self, font, size, color):
        return _mupdf.PdfAnnot_set_annot_default_appearance(self, font, size, color)
    ...
    def update_appearance(self):
        return _mupdf.PdfAnnot_update_appearance(self)

    def update_appearance_from_display_list(self, disp_list):
        return _mupdf.PdfAnnot_update_appearance_from_display_list(self, disp_list)
...
class PdfDocument(object):
    ...
    def event_issue_alert(self, event):
        return _mupdf.PdfDocument_event_issue_alert(self, event)
    ...
    def event_issue_mail_doc(self, event):
        return _mupdf.PdfDocument_event_issue_mail_doc(self, event)
    ...
    def parse_ind_obj(self, f, buf, num, gen, stm_ofs, try_repair):
        return _mupdf.PdfDocument_parse_ind_obj(self, f, buf, num, gen, stm_ofs, try_repair)
    ...
    def run_page_with_usage(self, page, dev, ctm, usage, cookie):
        return _mupdf.PdfDocument_run_page_with_usage(self, page, dev, ctm, usage, cookie)
    ...
    def set_doc_event_callback(self, event_cb, data):
        return _mupdf.PdfDocument_set_doc_event_callback(self, event_cb, data)
...
class PdfPage(object):
    ...
    def load_annots(self, annots):
        return _mupdf.PdfPage_load_annots(self, annots)
...
class PdfProcessor(object):
    ...
    def process_annot(self, doc, page, annot, cookie):
        return _mupdf.PdfProcessor_process_annot(self, doc, page, annot, cookie)
...
class Shade(object):
    ...
    def paint_shade(self, override_cs, ctm, dest, color_params, bbox, eop):
        r"""
        Render a shade to a given pixmap.
        ...
        op: NULL, or pointer to overprint bitmap.
        """
        return _mupdf.Shade_paint_shade(self, override_cs, ctm, dest, color_params, bbox, eop)
...
def ppdf_parse_ind_obj_outparams_fn(doc, f, buf, outparams):
    return _mupdf.ppdf_parse_ind_obj_outparams_fn(doc, f, buf, outparams)
...
def ppdf_parse_ind_obj(doc, f, buf):
    ...
    ret = ppdf_parse_ind_obj_outparams_fn(doc, f, buf, outparams)
...
def PdfAnnot_ppdf_annot_default_appearance_outparams_fn( self, color):
    ...
    """
    font, size = ppdf_annot_default_appearance( self.m_internal, color)
    return font, size
...
def PdfDocument_ppdf_parse_ind_obj_outparams_fn( self, f, buf):
    """
    Helper for out-params of pdf_document::ppdf_parse_ind_obj() [pdf_parse_ind_obj()].
    """
    ret, num, gen, stm_ofs, try_repair = ppdf_parse_ind_obj( self.m_internal, f, buf)
