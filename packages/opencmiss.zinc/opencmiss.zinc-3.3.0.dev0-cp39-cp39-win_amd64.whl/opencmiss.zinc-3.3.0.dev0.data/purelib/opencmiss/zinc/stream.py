...
class Streamresource(object):
    ...
    def getId(self) -> "cmzn_streamresource_id":
        return _stream.Streamresource_getId(self)

    def castFile(self) -> "OpenCMISS::Zinc::StreamresourceFile":
        return _stream.Streamresource_castFile(self)

    def castMemory(self) -> "OpenCMISS::Zinc::StreamresourceMemory":
...
class Streaminformation(object):
    ...
    def getId(self) -> "cmzn_streaminformation_id":
        return _stream.Streaminformation_getId(self)

    def createStreamresourceFile(self, file_name: "char const *") -> "OpenCMISS::Zinc::StreamresourceFile":
        return _stream.Streaminformation_createStreamresourceFile(self, file_name)

    def createStreamresourceMemory(self) -> "OpenCMISS::Zinc::StreamresourceMemory":
        return _stream.Streaminformation_createStreamresourceMemory(self)

    def createStreamresourceMemoryBufferCopy(self, buffer: "void const *") -> "OpenCMISS::Zinc::StreamresourceMemory":
        return _stream.Streaminformation_createStreamresourceMemoryBufferCopy(self, buffer)

    def getResourceDataCompressionType(self, resource: "Streamresource") -> "enum OpenCMISS::Zinc::Streaminformation::DataCompressionType":
        return _stream.Streaminformation_getResourceDataCompressionType(self, resource)

    def setResourceDataCompressionType(self, resource: "Streamresource", dataCompressionType: "OpenCMISS::Zinc::Streaminformation::DataCompressionType") -> "int":
        return _stream.Streaminformation_setResourceDataCompressionType(self, resource, dataCompressionType)

    def getDataCompressionType(self) -> "enum OpenCMISS::Zinc::Streaminformation::DataCompressionType":
        return _stream.Streaminformation_getDataCompressionType(self)

    def setDataCompressionType(self, dataCompressionType: "OpenCMISS::Zinc::Streaminformation::DataCompressionType") -> "int":
        return _stream.Streaminformation_setDataCompressionType(self, dataCompressionType)

    def castImage(self) -> "OpenCMISS::Zinc::StreaminformationImage":
        return _stream.Streaminformation_castImage(self)

    def castRegion(self) -> "OpenCMISS::Zinc::StreaminformationRegion":
        return _stream.Streaminformation_castRegion(self)

    def castScene(self) -> "OpenCMISS::Zinc::StreaminformationScene":
        return _stream.Streaminformation_castScene(self)

    def createStreamresourceMemoryBuffer(self, buffer: "void const *") -> "OpenCMISS::Zinc::StreamresourceMemory":
