...
class Elementbasis(object):
    ...
    def getFunctionType(self, chartComponent: "int") -> "enum OpenCMISS::Zinc::Elementbasis::FunctionType":
...
class Elementtemplate(object):
    ...
    def getElementShapeType(self) -> "enum OpenCMISS::Zinc::Element::ShapeType":
        return _element.Elementtemplate_getElementShapeType(self)

    def setElementShapeType(self, shapeType: "enum OpenCMISS::Zinc::Element::ShapeType") -> "int":
