...
class Timekeeper(object):
    ...
    def getId(self) -> "cmzn_timekeeper_id":
        return _timekeeper.Timekeeper_getId(self)

    def createTimenotifierRegular(self, updateFrequency: "double", timeOffset: "double") -> "OpenCMISS::Zinc::TimenotifierRegular":
        return _timekeeper.Timekeeper_createTimenotifierRegular(self, updateFrequency, timeOffset)

    def getMaximumTime(self) -> "double":
        return _timekeeper.Timekeeper_getMaximumTime(self)

    def setMaximumTime(self, maximumTime: "double") -> "int":
        return _timekeeper.Timekeeper_setMaximumTime(self, maximumTime)

    def getMinimumTime(self) -> "double":
        return _timekeeper.Timekeeper_getMinimumTime(self)

    def setMinimumTime(self, minimumTime: "double") -> "int":
    ...
    def getNextCallbackTime(self, playDirection: "enum OpenCMISS::Zinc::Timekeeper::PlayDirection") -> "double":
...
class Timekeepermodule(object):
    ...
    def getId(self) -> "cmzn_timekeepermodule_id":
        return _timekeeper.Timekeepermodule_getId(self)

    def getDefaultTimekeeper(self) -> "OpenCMISS::Zinc::Timekeeper":
