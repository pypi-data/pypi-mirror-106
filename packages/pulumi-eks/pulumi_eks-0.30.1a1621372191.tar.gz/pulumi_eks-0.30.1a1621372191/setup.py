...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.30.1-alpha.1621372191+42f6e333'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.30.1-alpha.1621372191+42f6e333`
                """)
            else:
                raise
