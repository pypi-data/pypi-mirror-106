...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.30.1-alpha.1621360070+c0d357bd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.30.1-alpha.1621360070+c0d357bd`
                """)
            else:
                raise
