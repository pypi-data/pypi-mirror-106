    ...
    def test_package_files_assets(self, cass):
        ...
        with patch('gitlabracadabra.packages.github.logger', autospec=True) as logger:
            self.assertEqual(
                source.package_files, [
                    PackageFile(
                        'https://api.github.com/repos/operator-framework/operator-lifecycle-manager/releases/assets/36465174',
                        'raw',
                    ...
                    PackageFile(
                        'https://api.github.com/repos/operator-framework/operator-lifecycle-manager/releases/assets/36465173',
                        'raw',
                        'operator-lifecycle-manager',
                        'v0.18.1',
                        'crds.yaml',
                    ...
                    PackageFile(
                        'https://api.github.com/repos/operator-framework/operator-lifecycle-manager/releases/assets/36465175',
                        'raw',
                        'operator-lifecycle-manager',
                        'v0.18.1',
                        'olm.yaml',
                    ...
                    PackageFile(
                        'https://api.github.com/repos/operator-framework/operator-lifecycle-manager/releases/assets/35912092',
                        'raw',
                        'operator-lifecycle-manager',
                        'v0.18.0',
                        'install.sh',
                    ...
                    PackageFile(
                        'https://api.github.com/repos/operator-framework/operator-lifecycle-manager/releases/assets/35912089',
                        'raw',
                        'operator-lifecycle-manager',
                        'v0.18.0',
                        'crds.yaml',
                    ...
                    PackageFile(
                        'https://api.github.com/repos/operator-framework/operator-lifecycle-manager/releases/assets/35912093',
                        'raw',
                        'operator-lifecycle-manager',
                        'v0.18.0',
                        'olm.yaml',
