...
class LocalDb():
    ...
    def insertVal(self, data = []):
        ...
        for file in data:
            ...
            sql = f"INSERT INTO TDADATA (filepath, osspath, objectPath, filename, md5, frame_id, sensor, referid, filesize, metadata, labeldata) VALUES ('{file.filepath}', '{file.osspath}', '{file.objectPath}', '{file.filename}', '{file.md5}', '{file.frameId}', '{file.sensor}', '{file.referId}', '{file.filesize}', '{file.metadata.ToString()}', '{file.labeldata.ToString()}')"
