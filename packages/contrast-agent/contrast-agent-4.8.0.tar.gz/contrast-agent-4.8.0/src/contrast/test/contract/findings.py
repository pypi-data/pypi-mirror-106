...
def validate_provider_finding(mock_send_finding):
    hardcoded_key = mock_send_finding.call_args_list[0][0][0]
    ...
    hardcoded_pwd = mock_send_finding.call_args_list[1][0][0]
