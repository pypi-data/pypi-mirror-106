...
class SeekArea(Area):
    ...
    #
    # def findNearest(self, x: float, y: float, minDistance: float, maxDistance: float):
    #     return (findRefNearest(int1, x, y, minDistance, maxDistance) == 1) ?self.context.getPoint(int1[0]) : null
    #
    # def findNearest(self, find: Point, minDistance: float, maxDistance: float):
    #     return (findRefNearest(int1, find.getX(), find.getY(), minDistance, maxDistance) == 1) ?self.context.getPoint(int1[0]) : null
    #
    # def findNearest(self, k: int, x: float, y: float, minDistance: float, maxDistance: float):
    #     return findNearest(k, new PointDirect(x, y), minDistance, maxDistance)
    #
    # def findNearest(self, k: int, find: Point, minDistance: float, maxDistance: float):
    #     points = [None] * k
    #     findNearest(points, find, minDistance, maxDistance)
    #     return points
    #
    # def findNearest(self, finds: list[Point], x: float, y: float, minDistance: float, maxDistance: float):
    #     findNearest(finds, new PointDirect(x, y), minDistance, maxDistance)
