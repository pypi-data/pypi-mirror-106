    ...
    def ems_compare(self, project_name1, project_name2):
        ...
        if project1 is None:
            ...
            raise EmsCliException(
                "The first project '{}' does not exist in this instance".format(project_name1)
            )
        ...
        if project2 is None:
            ...
            raise EmsCliException(
                "The second project '{}' does not exist in this instance".format(project_name2)
            )
                        ...
                        if objectclass.has_variant:
                            ...
                            for layer in objectclass.layers:
                                ...
                                if layer_data1.length != layer_data2.length:
                                    error_message = \
                                        "Feature list count of {}/{}/{}/{} is NOT equal ({} != {})!".format(
                                            project1,
                                            variant1["NAME"],
                                            objectclass.name,
                                            layer.name,
