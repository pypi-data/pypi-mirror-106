    ...
    operations = [
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('device_role', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE,
                        related_name = '+', to = 'dcim.DeviceRole')),
                ('platform', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE,
                        related_name = '+', to = 'dcim.Platform')),
                ('site', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE,
                        related_name = '+', to = 'dcim.Site')),
            ],
            options = {
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('device', models.ForeignKey(blank = True, null = True,
                        ...
                        related_name = '+', to = 'dcim.Device')),
                ('discovery_request',
                        models.ForeignKey(on_delete = django.db.models.deletion.CASCADE,
                        related_name = 'results', to = 'np_autodisc.DiscoveryRequest')),
            ],
        ),
    ]
