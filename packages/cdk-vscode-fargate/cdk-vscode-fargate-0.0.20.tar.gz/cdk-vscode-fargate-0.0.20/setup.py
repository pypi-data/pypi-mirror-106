    ...
    """
{
    ...
    "package_data": {
        "cdk_vscode_fargate._jsii": [
            "cdk-vscode-fargate@0.0.20.jsii.tgz"
        ],
        "cdk_vscode_fargate": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-ecs-patterns>=1.105.0, <2.0.0",
        "aws-cdk.aws-ecs>=1.105.0, <2.0.0",
        "aws-cdk.aws-efs>=1.105.0, <2.0.0",
        "aws-cdk.aws-kms>=1.105.0, <2.0.0",
        "aws-cdk.aws-logs>=1.105.0, <2.0.0",
        "aws-cdk.aws-route53>=1.105.0, <2.0.0",
        "aws-cdk.aws-secretsmanager>=1.105.0, <2.0.0",
