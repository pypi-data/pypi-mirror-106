def dumpread(ftoread="dump.main"):
    """
        ...
        for j in range(1,n):
            if j%ratio == 1:
                ...
                if distance > 2.5:
                    ...
                    bound_arr[index_btf] = 0


        
        boundN[i] = np.sum(bound_arr,dtype="int")
        ts[i] = i + 1
        #print (last)
