...
from hestia_earth.models.ipcc2013.gwp100IncludingFeedbacks import TERM_ID, run

class_path = f"hestia_earth.models.ipcc2013.{TERM_ID}"
fixtures_folder = f"{fixtures_path}/ipcc2013/{TERM_ID}"
