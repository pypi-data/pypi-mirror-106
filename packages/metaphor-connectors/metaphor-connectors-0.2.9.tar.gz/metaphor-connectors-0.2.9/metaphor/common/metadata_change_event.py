...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, dashboard_info, deleted_at, entity_type, id, last_modified_at, logical_id, upstream)
...
class Person:
    ...
    def from_dict(obj: Any) -> 'Person':
        ...
        return Person(avatar_url, created_at, deleted_at, editable_info, entity_type, first_name, id, last_modified_at, last_name, logical_id, organization, password, properties)
