...
from ._libimagequant2 import lib, ffi
import sys
...
class Attr:
    ...
    def min_posterization(self, value):
    ...
    @max_quality.setter
    def max_quality(self, value):
        _check_ret(lib.liq_set_quality(self._c, self.min_quality, value))

    def last_index_transparent(self, value):
    ...
    def set_log_callback(self, log_callback_function, user_info):
    ...
    def set_progress_callback(self, progress_callback_function, user_info):
    ...
    def create_rgba(self, bitmap, width, height, gamma):
...
class Image:
    ...
    def importance_map(self, buffer):
    ...
    def add_fixed_color(self, color):
...
class Result:
    ...
    def dithering_level(self, value):
    ...
    def remap_image(self, input_image):
