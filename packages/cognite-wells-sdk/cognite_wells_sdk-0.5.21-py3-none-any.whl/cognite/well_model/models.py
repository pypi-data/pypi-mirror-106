...
class NDS(WellsBaseModel):
    ...
    source: str = Field(..., description="The source of this event.", example="EDM-NPT")
    description: str = Field(..., description="Textual description of the event.", example="REAM OUT TIGHT HOLE")
    start_time: int = Field(
        ...,
        alias="startTime",
        description="epoch time stamp in milliseconds for when the NPT event started.",
    ...
    end_time: int = Field(
        ...,
        alias="endTime",
        description="epoch time stamp in milliseconds for when the NPT event ended.",
        example=1256167426,
    )
    severity: int = Field(..., description="severity of NPT event", example=1)
...
class EventIngestion(WellsBaseModel):
    ...
    nds_ingestion: Optional[List[NDS]] = Field(None, alias="ndsIngestion")
