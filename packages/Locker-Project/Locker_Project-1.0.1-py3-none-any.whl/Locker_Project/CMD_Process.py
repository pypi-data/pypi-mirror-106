                    ...
                    if (dta[1] == 'Cused') and dta[2] != "OK\n":
                        ...
                        if len(self.lstThread) == 0:
                            t2 = MyTask_Tag.MyTask_Tag(
                                mes=dta, lstInput=self.lstinput, lstLock=self.lstLock,
                                TypeReader=dta[1], host=self.host, Port=self.Port, input1=self._input1,
                                input2=self._input2,
                    ...
                    if dta[1] == 'Copen\n':
                        ...
                        if len(self.lstThread) == 0:
                            t21 = MyTask_Tag.MyTask_Tag(
                                mes=dta, lstInput=self.lstinput, lstLock=self.lstLock, TypeReader=dta[1],
