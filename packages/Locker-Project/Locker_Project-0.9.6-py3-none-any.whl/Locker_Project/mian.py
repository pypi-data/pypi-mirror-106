...
def Run():
        ...
        for i in lstip:
            ...
            try:
                with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
                    ...
                    chuoi1 = '<id>12121</id><type>message</type><data>0.9.6</data>'
    ...
    while not Connect_Device():
        chuoi12 = '<id>12121</id><type>message</type><data>Chưa kết nối được các thiết bị ngoại vi</data>'
        chuoi12 = chuoi12.encode('utf-8')
        size2 = len(chuoi12)
        sock.sendall(size2.to_bytes(4, byteorder='big'))
        sock.sendall(chuoi12)
