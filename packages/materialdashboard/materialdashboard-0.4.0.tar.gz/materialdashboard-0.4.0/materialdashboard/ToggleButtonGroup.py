...
- color (a value equal to: "standard", "primary", "secondary"; optional): The color of a button when it is selected.
- exclusive (boolean; optional): If `true`, only allow one of the child ToggleButton values to be selected.
- fullWidth (boolean; optional): If `true`, the button group will take up the full width of its container.
...
- value (boolean | number | string | dict | list; optional): The currently selected value within the group or an array of selected
