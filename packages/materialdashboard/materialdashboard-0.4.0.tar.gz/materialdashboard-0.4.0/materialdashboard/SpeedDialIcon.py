...
- openIcon (boolean | number | string | dict | list; optional): The icon to display in the SpeedDial Floating Action Button when the SpeedDial is open.
