...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Two or more `<Step />` components.
- activeStep (number; optional): Set the active step (zero based index).
Set to -1 to disable all the steps.
- alternativeLabel (boolean; optional): If set to 'true' and orientation is horizontal,
then the step label will be positioned under the icon.
- nonLinear (boolean; optional): If set the `Stepper` will not assist in controlling steps for linear flow.
