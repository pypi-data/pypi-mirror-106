...
- value (number; optional): The value of the progress indicator for the determinate and buffer variants.
Value between 0 and 100.
- valueBuffer (number; optional): The value for the buffer variant.
Value between 0 and 100.
- variant (a value equal to: "determinate", "indeterminate", "buffer", "query"; optional): The variant to use.
