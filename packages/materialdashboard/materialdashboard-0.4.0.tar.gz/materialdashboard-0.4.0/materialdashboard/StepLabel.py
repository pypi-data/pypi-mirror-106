...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): In most cases will simply be a string containing a title for the label.
- error (boolean; optional): If `true`, the step is marked as failed.
- icon (boolean | number | string | dict | list; optional): Override the default label of the step icon.
