...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Alias for the `primary` prop.
- disableTypography (boolean; optional): If `true`, the children won't be wrapped by a Typography component.
This can be useful to render an alternative Typography variant by wrapping
the `children` (or `primary`) text, and optional `secondary` text
with the Typography component.
- inset (boolean; optional): If `true`, the children are indented.
This should be used if there is no left avatar or left icon.
- primary (boolean | number | string | dict | list; optional): The main content element.
- secondary (boolean | number | string | dict | list; optional): The secondary content element.
