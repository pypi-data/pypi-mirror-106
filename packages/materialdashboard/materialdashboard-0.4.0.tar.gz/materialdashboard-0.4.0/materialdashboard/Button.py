...
- endIcon (boolean | number | string | dict | list; optional): Element placed after the children.
...
- startIcon (boolean | number | string | dict | list; optional): Element placed before the children.
