...
Keyword arguments:
- label (boolean | number | string | dict | list; optional): The label of the `input`. It is only used for layout. The actual labelling
is handled by `InputLabel`.
- notched (boolean; optional): If `true`, the outline is notched to accommodate the label.
