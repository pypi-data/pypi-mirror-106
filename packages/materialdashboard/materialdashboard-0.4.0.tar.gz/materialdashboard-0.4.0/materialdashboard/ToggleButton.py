...
- color (a value equal to: "standard", "primary", "secondary"; optional): The color of the button when it is in an active state.
...
- selected (boolean; optional): If `true`, the button is rendered in an active state.
- size (a value equal to: "small", "medium", "large"; optional): The size of the component.
The prop defaults to the value inherited from the parent ToggleButtonGroup component.
- value (boolean | number | string | dict | list; optional): The value to associate with the button when selected in a
ToggleButtonGroup.
