...
- defaultExpanded (boolean; optional): If `true`, expands the accordion by default.
- disabled (boolean; optional): If `true`, the component is disabled.
- disableGutters (boolean; optional): If `true`, it removes the margin between two expanded accordion items and the increase of height.
- expanded (boolean; optional): If `true`, expands the accordion, otherwise collapse it.
