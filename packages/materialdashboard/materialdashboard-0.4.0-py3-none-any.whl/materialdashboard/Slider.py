...
- disableSwap (boolean; optional): If `true`, the active thumb doesn't swap when moving pointer over a thumb while dragging another thumb.
...
- tabIndex (number; optional): Tab index attribute of the hidden `input` element.
...
- classes (dict; optional): Override or extend the styles applied to the component."""
    ...
    def __init__(self, color=Component.UNDEFINED, disabled=Component.UNDEFINED, disableSwap=Component.UNDEFINED, isRtl=Component.UNDEFINED, max=Component.UNDEFINED, min=Component.UNDEFINED, name=Component.UNDEFINED, orientation=Component.UNDEFINED, step=Component.UNDEFINED, tabIndex=Component.UNDEFINED, track=Component.UNDEFINED, valueLabelDisplay=Component.UNDEFINED, id=Component.UNDEFINED, classes=Component.UNDEFINED, **kwargs):
        self._prop_names = ['color', 'disabled', 'disableSwap', 'isRtl', 'max', 'min', 'name', 'orientation', 'step', 'tabIndex', 'track', 'valueLabelDisplay', 'id', 'classes']
        self._type = 'Slider'
        self._namespace = 'materialdashboard'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['color', 'disabled', 'disableSwap', 'isRtl', 'max', 'min', 'name', 'orientation', 'step', 'tabIndex', 'track', 'valueLabelDisplay', 'id', 'classes']
