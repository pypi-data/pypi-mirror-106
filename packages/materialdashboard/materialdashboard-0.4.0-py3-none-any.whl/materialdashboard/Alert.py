...
- action (boolean | number | string | dict | list; optional): The action to display. It renders after the message, at the end of the alert.
- closeText (string; optional): Override the default label for the *close popup* icon button.

For localization purposes, you can use the provided [translations](/guides/localization/).
- color (a value equal to: "success", "info", "warning", "error"; optional): The main color for the alert. Unless provided, the value is taken from the `severity` prop.
- severity (a value equal to: "success", "info", "warning", "error"; optional): The severity of the alert. This defines the color and icon used.
- icon (boolean | number | string | dict | list; optional): Override the icon displayed before the children.
