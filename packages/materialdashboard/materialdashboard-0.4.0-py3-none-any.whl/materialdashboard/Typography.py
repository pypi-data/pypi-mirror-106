...
- style (dict; optional)"""
    @_explicitize_args
    def __init__(self, children=None, typography=Component.UNDEFINED, align=Component.UNDEFINED, gutterBottom=Component.UNDEFINED, noWrap=Component.UNDEFINED, paragraph=Component.UNDEFINED, variant=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, classes=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'typography', 'align', 'gutterBottom', 'noWrap', 'paragraph', 'variant', 'className', 'id', 'classes', 'style']
        self._type = 'Typography'
        self._namespace = 'materialdashboard'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'typography', 'align', 'gutterBottom', 'noWrap', 'paragraph', 'variant', 'className', 'id', 'classes', 'style']
