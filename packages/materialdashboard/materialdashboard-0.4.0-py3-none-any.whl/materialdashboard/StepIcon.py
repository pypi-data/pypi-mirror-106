...
Keyword arguments:
- active (boolean; optional): Whether this step is active.
- completed (boolean; optional): Mark the step as completed. Is passed to child components.
- error (boolean; optional): If `true`, the step is marked as failed.
- icon (boolean | number | string | dict | list; optional): The label displayed in the step icon.
