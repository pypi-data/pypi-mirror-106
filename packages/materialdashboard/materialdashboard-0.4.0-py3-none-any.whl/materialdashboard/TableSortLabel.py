...
Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): Label contents, the arrow will be appended automatically.


The content of the component.
- href (string; optional)
- active (boolean; optional): If `true`, the label will have the active styling (should be true for the sorted column).
- direction (a value equal to: "desc", "asc"; optional): The current sort direction.
- hideSortIcon (boolean; optional): Hide sort icon when active is false.
