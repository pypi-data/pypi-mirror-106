...
{Fore.RED}
          ...
          /^\\
          |-|
          |{Fore.WHITE}s{Fore.RED}|
          |{Fore.WHITE}n{Fore.RED}|
          |{Fore.WHITE}i{Fore.RED}|
          |{Fore.WHITE}p{Fore.RED}|
          |{Fore.WHITE}e{Fore.RED}|
         /|{Fore.WHITE}r{Fore.RED}|\\
        / | | \\
       |  | |  |
       `-\\"\\"\\"-`
""")
...
try:  
    ...
    print(f"{Fore.GREEN}{bold}be sure to join the {Fore.BLUE}discord{Fore.GREEN}: ")
