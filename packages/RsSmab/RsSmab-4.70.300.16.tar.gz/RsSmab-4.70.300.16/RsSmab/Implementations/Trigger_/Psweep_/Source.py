...
class Source:
	"""Source commands group definition. 2 total commands, 1 Sub-groups, 1 group commands"""
	...
	def advanced(self):
		...
		if not hasattr(self, '_advanced'):
			from .Source_.Advanced import Advanced
