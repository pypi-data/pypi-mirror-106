...
class Source:
	...
	def set(self, source: enums.LfSource, lfOutput=repcap.LfOutput.Default) -> None:
		...
		Determines the LF signal to be synchronized, when monitoring is enabled. \n
			:param source: LF1| LF2| NOISe| AM| FMPM| EXT1 | | EXT2 LF1|LF2 Selects an internally generated LF signal. NOISe Selects an internally generated noise signal. EXT1|EXT2 Selects an externally supplied LF signal AM Selects the AM signal. FMPM Selects the signal also used by the frequency or phase modulations.
	...
	def get(self, lfOutput=repcap.LfOutput.Default) -> enums.LfSource:
		...
		Determines the LF signal to be synchronized, when monitoring is enabled. \n
			:param lfOutput: optional repeated capability selector. Default value: Nr1 (settable in the interface 'LfOutput')
			:return: source: LF1| LF2| NOISe| AM| FMPM| EXT1 | | EXT2 LF1|LF2 Selects an internally generated LF signal. NOISe Selects an internally generated noise signal. EXT1|EXT2 Selects an externally supplied LF signal AM Selects the AM signal. FMPM Selects the signal also used by the frequency or phase modulations."""
		lfOutput_cmd_val = self._base.get_repcap_cmd_value(lfOutput, repcap.LfOutput)
