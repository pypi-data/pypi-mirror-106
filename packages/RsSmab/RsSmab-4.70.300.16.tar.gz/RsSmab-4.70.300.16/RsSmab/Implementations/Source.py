...
class Source:
	"""Source commands group definition. 499 total commands, 29 Sub-groups, 1 group commands"""
	...
	def chirp(self):
		...
		if not hasattr(self, '_chirp'):
			from .Source_.Chirp import Chirp
			self._chirp = Chirp(self._core, self._base)
		return self._chirp
