...
class Dwell:
	...
	def get_mode(self) -> enums.ParameterSetMode:
		...
		Selects the dwell time mode. \n
			:return: dwell_mode: LIST| GLOBal LIST Uses the dwell time, specified in the data table for each value pair individually. GLOBal Uses a constant dwell time, set with command method RsSmab.Source.ListPy.Dwell.value.
		"""
	...
	def set_mode(self, dwell_mode: enums.ParameterSetMode) -> None:
		...
		Selects the dwell time mode. \n
			:param dwell_mode: LIST| GLOBal LIST Uses the dwell time, specified in the data table for each value pair individually. GLOBal Uses a constant dwell time, set with command method RsSmab.Source.ListPy.Dwell.value.
		"""
