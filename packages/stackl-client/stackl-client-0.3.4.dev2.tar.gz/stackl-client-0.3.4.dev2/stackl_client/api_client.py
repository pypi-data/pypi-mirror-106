...
from stackl_client.exceptions import ApiTypeError, ApiValueError, ApiException
from stackl_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v0.3.4dev/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_hostname  # this is an instance of the class Endpoint
        api_instance.get_hostname()  # this invokes api_instance.get_hostname.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_hostname.callable or self.callable in this class
