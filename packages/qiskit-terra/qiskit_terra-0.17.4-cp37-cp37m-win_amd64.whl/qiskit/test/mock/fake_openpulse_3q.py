                ...
                Command.from_dict({
                    ...
                    'sequence': [
                        PulseQobjInstruction(name='fc',
                                             ...
                                             t0=0,
                                             phase='-P1').to_dict(),
                        PulseQobjInstruction(name='y90p_d2',
                                             ch='d2',
                                             t0=0).to_dict(),
                        PulseQobjInstruction(name='fc',
                                             ch='d2',
                ...
                Command.from_dict({
                    ...
                    'sequence': [
                        PulseQobjInstruction(name='fc',
                                             ...
                                             t0=0,
                                             phase='-P2').to_dict(),
                        PulseQobjInstruction(name='x90p_d2',
                                             ch='d2',
                                             t0=0).to_dict(),
                        PulseQobjInstruction(name='fc',
                                             ch='d2',
                                             t0=2,
                                             phase='-P0').to_dict(),
                        PulseQobjInstruction(name='x90m_d2',
                                             ch='d2',
                                             t0=2).to_dict(),
                        PulseQobjInstruction(name='fc',
                                             ch='d2',
                ...
                Command.from_dict({
                    ...
                    'sequence': [
                        PulseQobjInstruction(name='fc',
                                             ...
                                             t0=0,
                                             phase=1.57).to_dict(),
                        PulseQobjInstruction(name='ym_d1',
                                             ch='d1',
                                             t0=0).to_dict(),
                        PulseQobjInstruction(name='xp_d1',
                                             ch='d1',
                                             t0=11).to_dict(),
                        PulseQobjInstruction(name='x90p_d2',
                                             ch='d2',
                                             t0=0).to_dict(),
                        PulseQobjInstruction(name='cr90p_u1',
                                             ch='u1',
                                             t0=2).to_dict(),
                        PulseQobjInstruction(name='cr90m_u1',
                                             ch='u1',
                                             t0=13).to_dict()]}).to_dict(),
                Command.from_dict({
                    'name': 'measure',
                    ...
                    'sequence': [
                        ...
                        PulseQobjInstruction(name='measure_m1',
                                             ch='m1',
                                             t0=0).to_dict(),
                        PulseQobjInstruction(name='measure_m2',
                                             ch='m2',
                                             t0=0).to_dict(),
