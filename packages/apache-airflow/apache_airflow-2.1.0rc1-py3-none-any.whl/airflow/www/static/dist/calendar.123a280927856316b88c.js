...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function draw() {
    ...
    const svg = d3.select('#calendar-svg').attr('width', fullWidth).attr('height', fullHeight).call(dayTip); // Add the title

    svg.append('g').append('text').attr('x', fullWidth / 2).attr('y', 20).attr('text-anchor', 'middle').attr('class', 'title').text('DAG states'); // Add the legend
