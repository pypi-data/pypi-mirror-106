...
setup(
	...
	packages=setuptools.find_packages(include="*"),  # Chose the same as "name"
	...
	download_url='https://github.com/JSoftwareLabs/jsl_django_sitemap/archive/refs/tags/V1_0_1.tar.gz',
	# I explain this later on
	keywords=['Django sitemap', 'JSoftwareLabs', 'sitemap.xml'],
