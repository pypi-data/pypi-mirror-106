...
RDCodeDir=os.path.join(r'/tmp/pip-req-build-5lvg3g83/build/temp.linux-x86_64-3.7/rdkit_install/lib/python3.7/site-packages','rdkit')
# not really hard-coded alternative RDCodeDir=os.path.dirname(__file__)
_share = os.path.join(r'/tmp/pip-req-build-5lvg3g83/build/temp.linux-x86_64-3.7/rdkit_install', r'share/RDKit')
