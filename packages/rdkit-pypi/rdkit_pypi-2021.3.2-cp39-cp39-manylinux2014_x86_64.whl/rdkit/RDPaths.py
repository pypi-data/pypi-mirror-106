...
RDCodeDir=os.path.join(r'/tmp/pip-req-build-5c4y6o05/build/temp.linux-x86_64-3.9/rdkit_install/lib/python3.9/site-packages','rdkit')
# not really hard-coded alternative RDCodeDir=os.path.dirname(__file__)
_share = os.path.join(r'/tmp/pip-req-build-5c4y6o05/build/temp.linux-x86_64-3.9/rdkit_install', r'share/RDKit')
