...
RDCodeDir=os.path.join(r'/tmp/pip-req-build-44v4mkjg/build/temp.linux-x86_64-3.6/rdkit_install/lib/python3.6/site-packages','rdkit')
# not really hard-coded alternative RDCodeDir=os.path.dirname(__file__)
_share = os.path.join(r'/tmp/pip-req-build-44v4mkjg/build/temp.linux-x86_64-3.6/rdkit_install', r'share/RDKit')
