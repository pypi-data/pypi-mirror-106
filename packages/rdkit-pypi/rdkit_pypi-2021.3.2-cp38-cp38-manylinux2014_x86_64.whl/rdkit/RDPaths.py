...
RDCodeDir=os.path.join(r'/tmp/pip-req-build-vnsiyh88/build/temp.linux-x86_64-3.8/rdkit_install/lib/python3.8/site-packages','rdkit')
# not really hard-coded alternative RDCodeDir=os.path.dirname(__file__)
_share = os.path.join(r'/tmp/pip-req-build-vnsiyh88/build/temp.linux-x86_64-3.8/rdkit_install', r'share/RDKit')
