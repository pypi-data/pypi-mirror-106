...
class DescribeVoicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/polly.html#Polly.Paginator.DescribeVoices.paginate)
...
class ListLexiconsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/polly.html#Polly.Paginator.ListLexicons.paginate)
...
class ListSpeechSynthesisTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/polly.html#Polly.Paginator.ListSpeechSynthesisTasks.paginate)
