...
s2s = DLStudio.Seq2SeqWithPretrainedEmbeddings(
                                 dl_studio = dls,
                                 dataroot = dataroot,
...
encoder = DLStudio.Seq2SeqWithPretrainedEmbeddings.EncoderRNN(
                        dls,
                        s2s,
                        embedding_size = embedding_size,
...
decoder = DLStudio.Seq2SeqWithPretrainedEmbeddings.DecoderRNN(
                        dls,
                        s2s,
                        embedding_size = embedding_size,
                        hidden_size = hidden_size,
