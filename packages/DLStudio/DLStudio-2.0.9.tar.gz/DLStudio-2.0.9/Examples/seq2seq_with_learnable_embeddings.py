...
s2s = DLStudio.Seq2SeqWithLearnableEmbeddings( 
                                 dl_studio = dls,
                                 dataroot = dataroot,
...
encoder = DLStudio.Seq2SeqWithLearnableEmbeddings.EncoderRNN(
                        dls,
                        s2s,
                        embedding_size = embedding_size,
...
decoder = DLStudio.Seq2SeqWithLearnableEmbeddings.DecoderRNN(
                        dls,
                        s2s, 
                        embedding_size = embedding_size,
                        hidden_size = hidden_size,
