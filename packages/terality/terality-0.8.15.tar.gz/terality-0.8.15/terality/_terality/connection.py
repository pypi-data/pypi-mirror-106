...
from common_client_scheduler import (
    ...
    headers, AwsCredentials, DataTransferResponse
)
    ...
    def send_request(cls, action: str, payload: Any, without_session: bool = False) -> Any:
        ...
        try:
            ...
            try:
                ...
                add_info = f' (request ID: {e.response.headers[headers.TERALITY_REQUEST_ID]})' if headers.TERALITY_REQUEST_ID in e.response.headers else ''
