...
from seven_dyapp.handlers.base.douyin_base import *
from seven_dyapp.handlers.base.seven_helper import *


class DouYinError(Exception):
    def __init__(self, msg):
        super(DouYinError, self).__init__(msg)
    ...
    def query_order(self, out_order_no="", thirdparty_id=""):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return DouYinError("查询订单出现异常，请重试")
