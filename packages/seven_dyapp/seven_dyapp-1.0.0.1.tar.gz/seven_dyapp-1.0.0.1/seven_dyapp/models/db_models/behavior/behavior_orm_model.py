...
class BehaviorOrmModel(BaseModel):
    def __init__(self, db_connect_key='db_dyapp', sub_table=None, db_transaction=None, context=None):
...
class BehaviorOrm:
    ...
    def __init__(self):
        ...
        self.id = 0  # id
        self.act_id = 0  # 活动id
        self.object_id = 0  # 对象id（机台id或者系列id等）
    ...
    def get_field_list(self):
        return ['id', 'act_id', 'object_id', 'orm_type', 'group_name', 'key_name', 'key_value', 'value_type', 'is_repeat', 'repeat_type', 'is_common', 'sort_index', 'create_date']
