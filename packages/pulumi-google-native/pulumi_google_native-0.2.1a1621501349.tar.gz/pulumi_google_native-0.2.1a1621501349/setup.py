...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'google-native', '0.2.1a1621501349'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource google-native 0.2.1a1621501349`
                """)
            else:
                raise
