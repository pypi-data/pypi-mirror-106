...
class TradeModule():
    ...
    def redeem_delta_amount(self, pair_name="BINANCE.LUNAUSDT", offset="CLOSE"):
        ...
        if delta_value > 200: # 机动修改!!!  平常设置为1000
...
# gateway_setting_lst = [LSH_BINANCE_SETTING, LZC_BINANCE_SETTING]

am = AccountManager(main_account_name="C")
gateway_setting_lst = [C_BINANCE_SETTING]
# gateway_setting_lst = [XB_BINANCE_SETTING, Y_BINANCE_SETTING, X_BINANCE_SETTING]
