...
class Issuer(object):
    ...
    attribute_map = {
        ...
        'name_slug': 'name_slug',
        'saml_state_encryption_key': 'saml_state_encryption_key'
    }

    def __init__(self, id=None, issuer=None, enabled=True, org_id=None, theme_file_id=None, upstream_redirect_uri=None, managed_upstreams=None, oidc_upstreams=None, local_auth_upstreams=None, clients=None, upstream_group_mappings=None, name_slug=None, saml_state_encryption_key=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._saml_state_encryption_key = None
        ...
        if saml_state_encryption_key is not None:
            self.saml_state_encryption_key = saml_state_encryption_key
    ...
    def saml_state_encryption_key(self):
        """Gets the saml_state_encryption_key of this Issuer.  # noqa: E501

        The encryption key used to secure the saml state. This is used to encrypt the saml cookie that is used to identify the user.   # noqa: E501

        :return: The saml_state_encryption_key of this Issuer.  # noqa: E501
        :rtype: str
        """
        return self._saml_state_encryption_key

    @saml_state_encryption_key.setter
    def saml_state_encryption_key(self, saml_state_encryption_key):
        """Sets the saml_state_encryption_key of this Issuer.

        The encryption key used to secure the saml state. This is used to encrypt the saml cookie that is used to identify the user.   # noqa: E501

        :param saml_state_encryption_key: The saml_state_encryption_key of this Issuer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                saml_state_encryption_key is not None and len(saml_state_encryption_key) > 100):
            raise ValueError("Invalid value for `saml_state_encryption_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                saml_state_encryption_key is not None and len(saml_state_encryption_key) < 10):
            raise ValueError("Invalid value for `saml_state_encryption_key`, length must be greater than or equal to `10`")  # noqa: E501

        self._saml_state_encryption_key = saml_state_encryption_key
