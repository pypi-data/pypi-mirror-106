...
class ApplicationsApi(object):
    ...
    def get_application_with_http_info(self, app_id, **kwargs):  # noqa: E501
        ...
        all_params = ['app_id', 'org_id', 'assigned_org_id', 'include_migrated_environments']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'include_migrated_environments' in local_var_params and local_var_params['include_migrated_environments'] is not None:  # noqa: E501
            query_params.append(('include_migrated_environments', local_var_params['include_migrated_environments']))  # noqa: E501
    ...
    def list_applications_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['org_id', 'assigned_org_id', 'maintained', 'assigned', 'owned', 'updated_since', 'show_status', 'application_type', 'include_migrated_environments']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_patch_application(self, app_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str app_id: Application unique identifier (required)
        :param OrgScopePatchDocument org_scope_patch_document:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_patch_application_with_http_info(app_id, **kwargs)  # noqa: E501

    def update_patch_application_with_http_info(self, app_id, **kwargs):  # noqa: E501
        """patch application  # noqa: E501

        patch application  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_patch_application_with_http_info(app_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['app_id', 'org_scope_patch_document']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_patch_application" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'app_id' is set
        if self.api_client.client_side_validation and ('app_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['app_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `app_id` when calling `update_patch_application`")  # noqa: E501

        if self.api_client.client_side_validation and 'app_id' in local_var_params and not re.search(r'^[a-zA-Z0-9-]+$', local_var_params['app_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `app_id` when calling `update_patch_application`, must conform to the pattern `/^[a-zA-Z0-9-]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'org_scope_patch_document' in local_var_params:
            body_params = local_var_params['org_scope_patch_document']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
