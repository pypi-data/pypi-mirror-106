...
"""
    ...
    The version of the OpenAPI document: 2021.05.19
...
class IpsecConnectionSpec(object):
    ...
    openapi_types = {
        ...
        'use_cert_hash': 'bool',
        'local_certificate_uribase': 'str',
        'remote_certificate_uribase': 'str'
    }
    ...
    def __init__(self, ike_version=None, remote_ipv4_address=None, remote_dns_ipv4_address=None, remote_healthcheck_ipv4_address=None, ike_cipher_encryption_algorithm=None, ike_cipher_integrity_algorithm=None, ike_cipher_diffie_hellman_group=None, esp_cipher_encryption_algorithm=None, esp_cipher_integrity_algorithm=None, esp_cipher_diffie_hellman_group=None, esp_lifetime=None, ike_lifetime=None, ike_rekey=None, ike_reauth=None, ike_authentication_type=None, ike_preshared_key=None, ike_chain_of_trust_certificates=None, ike_certificate_dn=None, ike_remote_identity=None, local_ipv4_block=None, remote_ipv4_ranges=None, use_cert_hash=None, local_certificate_uribase=None, remote_certificate_uribase=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._ike_remote_identity = None
        self._local_ipv4_block = None
        self._remote_ipv4_ranges = None
        self._use_cert_hash = None
        self._local_certificate_uribase = None
        self._remote_certificate_uribase = None
        ...
        if ike_remote_identity is not None:
            self.ike_remote_identity = ike_remote_identity
        ...
        if use_cert_hash is not None:
            self.use_cert_hash = use_cert_hash
        if local_certificate_uribase is not None:
            self.local_certificate_uribase = local_certificate_uribase
        if remote_certificate_uribase is not None:
            self.remote_certificate_uribase = remote_certificate_uribase
    ...
    def ike_certificate_dn(self):
        ...
        certificate distinguished name (DN) Deprecated in favour of the generic ike_remote_identity field.   # noqa: E501
    ...
    def ike_remote_identity(self):
        """Gets the ike_remote_identity of this IpsecConnectionSpec.  # noqa: E501

        The identity of the remote peer. The remote peer will send credentials including this identity as part of the IKE authentication exchange.  The meaning of the identity depends on the authentication type.   - `ike_preshared_key`: This is an arbitrary value provisioned on the remote     peer, often a FQDN or email address. E.g. \"vpn.my-org.example.com\".   - `certificate`: This is the distinguished name (DN) of the entity certificate     presented by the remote peer. E.g. \"C=CA; O=Agilicus; CN=vpn-1.ca-1.agilicus.ca\".   # noqa: E501

        :return: The ike_remote_identity of this IpsecConnectionSpec.  # noqa: E501
        :rtype: str
        """
        return self._ike_remote_identity

    @ike_remote_identity.setter
    def ike_remote_identity(self, ike_remote_identity):
        """Sets the ike_remote_identity of this IpsecConnectionSpec.

        The identity of the remote peer. The remote peer will send credentials including this identity as part of the IKE authentication exchange.  The meaning of the identity depends on the authentication type.   - `ike_preshared_key`: This is an arbitrary value provisioned on the remote     peer, often a FQDN or email address. E.g. \"vpn.my-org.example.com\".   - `certificate`: This is the distinguished name (DN) of the entity certificate     presented by the remote peer. E.g. \"C=CA; O=Agilicus; CN=vpn-1.ca-1.agilicus.ca\".   # noqa: E501

        :param ike_remote_identity: The ike_remote_identity of this IpsecConnectionSpec.  # noqa: E501
        :type: str
        """

        self._ike_remote_identity = ike_remote_identity
    ...
    def use_cert_hash(self):
        """Gets the use_cert_hash of this IpsecConnectionSpec.  # noqa: E501

        Controls if certificate exchange using hash is enabled.   # noqa: E501

        :return: The use_cert_hash of this IpsecConnectionSpec.  # noqa: E501
        :rtype: bool
        """
        return self._use_cert_hash

    @use_cert_hash.setter
    def use_cert_hash(self, use_cert_hash):
        """Sets the use_cert_hash of this IpsecConnectionSpec.

        Controls if certificate exchange using hash is enabled.   # noqa: E501

        :param use_cert_hash: The use_cert_hash of this IpsecConnectionSpec.  # noqa: E501
        :type: bool
        """

        self._use_cert_hash = use_cert_hash

    @property
    def local_certificate_uribase(self):
        """Gets the local_certificate_uribase of this IpsecConnectionSpec.  # noqa: E501

        Provides the local endpoint uri base for certificate hash lookup. See https://tools.ietf.org/html/rfc7296#section-3.6 (Hash and URL encoding). Note that since the ultimate URL is constructed through concatenation, the final `/` is important.   # noqa: E501

        :return: The local_certificate_uribase of this IpsecConnectionSpec.  # noqa: E501
        :rtype: str
        """
        return self._local_certificate_uribase

    @local_certificate_uribase.setter
    def local_certificate_uribase(self, local_certificate_uribase):
        """Sets the local_certificate_uribase of this IpsecConnectionSpec.

        Provides the local endpoint uri base for certificate hash lookup. See https://tools.ietf.org/html/rfc7296#section-3.6 (Hash and URL encoding). Note that since the ultimate URL is constructed through concatenation, the final `/` is important.   # noqa: E501

        :param local_certificate_uribase: The local_certificate_uribase of this IpsecConnectionSpec.  # noqa: E501
        :type: str
        """

        self._local_certificate_uribase = local_certificate_uribase

    @property
    def remote_certificate_uribase(self):
        """Gets the remote_certificate_uribase of this IpsecConnectionSpec.  # noqa: E501

        Provides the remote endpoint uri base for certificate hash lookup. See https://tools.ietf.org/html/rfc7296#section-3.6 (Hash and URL encoding). Note that since the ultimate URL is constructed through concatenation, the final `/` is important.   # noqa: E501

        :return: The remote_certificate_uribase of this IpsecConnectionSpec.  # noqa: E501
        :rtype: str
        """
        return self._remote_certificate_uribase

    @remote_certificate_uribase.setter
    def remote_certificate_uribase(self, remote_certificate_uribase):
        """Sets the remote_certificate_uribase of this IpsecConnectionSpec.

        Provides the remote endpoint uri base for certificate hash lookup. See https://tools.ietf.org/html/rfc7296#section-3.6 (Hash and URL encoding). Note that since the ultimate URL is constructed through concatenation, the final `/` is important.   # noqa: E501

        :param remote_certificate_uribase: The remote_certificate_uribase of this IpsecConnectionSpec.  # noqa: E501
        :type: str
        """

        self._remote_certificate_uribase = remote_certificate_uribase
