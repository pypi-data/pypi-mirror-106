...
class PolicySpec(object):
    ...
    def __init__(self, name=None, issuer_id=None, org_id=None, supported_mfa_methods=None, default_action=None, rules=None, policy_groups=None, source=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def source(self):
        """Gets the source of this PolicySpec.  # noqa: E501

        An identifier for the policy this policy was based on.  # noqa: E501

        :return: The source of this PolicySpec.  # noqa: E501
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this PolicySpec.

        An identifier for the policy this policy was based on.  # noqa: E501

        :param source: The source of this PolicySpec.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
