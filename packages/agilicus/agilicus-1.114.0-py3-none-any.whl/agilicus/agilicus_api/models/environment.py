...
class Environment(object):
    ...
    def __init__(self, created=None, name=None, maintenance_org_id=None, domain_aliases=None, version_tag=None, config_mount_path=None, config_as_mount=None, config_as_env=None, secrets_mount_path=None, secrets_as_mount=None, secrets_as_env=None, application_services=None, serverless_image=None, status=None, updated=None, application_configs=None, name_slug=None, migrated_app_id=None, proxy_location=None, local_vars_configuration=None):  # noqa: E501
        ...
        if migrated_app_id is not None:
            self.migrated_app_id = migrated_app_id
    ...
    def migrated_app_id(self):
        """Gets the migrated_app_id of this Environment.  # noqa: E501

        Environments are in transition to be deprecated. When an environment is migrated, an application is created specific for the environment. This property provides the id of the application that this environment has been migrated to.   # noqa: E501

        :return: The migrated_app_id of this Environment.  # noqa: E501
        :rtype: str
        """
        return self._migrated_app_id

    @migrated_app_id.setter
    def migrated_app_id(self, migrated_app_id):
        """Sets the migrated_app_id of this Environment.

        Environments are in transition to be deprecated. When an environment is migrated, an application is created specific for the environment. This property provides the id of the application that this environment has been migrated to.   # noqa: E501

        :param migrated_app_id: The migrated_app_id of this Environment.  # noqa: E501
        :type: str
        """

        self._migrated_app_id = migrated_app_id
