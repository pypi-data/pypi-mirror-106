...
class IssuerClient(object):
    ...
    def __init__(self, id=None, issuer_id=None, name=None, secret=None, application=None, org_id=None, restricted_organisations=None, saml_metadata_file=None, id_mapping=None, saml_scopes=None, organisation_scope='here_only', redirects=None, mfa_challenge='user_preference', single_sign_on='never', attributes=None, local_vars_configuration=None):  # noqa: E501
        ...
        if saml_scopes is not None:
            self.saml_scopes = saml_scopes
    ...
    @property
    def id_mapping(self):
        """Gets the id_mapping of this IssuerClient.  # noqa: E501

        The properties from the agilicus id token to map to the user id.  This can be changed if your application relies on an upstream  user_id to map the user, for example SID or email. You can see what is available by logging into the admin portal and finding the token in local storage. When changing this ensure that you are requesting an appropriate saml_scope. For example in order to use federated_claims you need the federated:id scope.   # noqa: E501

        :return: The id_mapping of this IssuerClient.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def id_mapping(self, id_mapping):
        """Sets the id_mapping of this IssuerClient.

        The properties from the agilicus id token to map to the user id.  This can be changed if your application relies on an upstream  user_id to map the user, for example SID or email. You can see what is available by logging into the admin portal and finding the token in local storage. When changing this ensure that you are requesting an appropriate saml_scope. For example in order to use federated_claims you need the federated:id scope.   # noqa: E501

        :param id_mapping: The id_mapping of this IssuerClient.  # noqa: E501
        :type: list[str]
        """
    ...
    def saml_scopes(self):
        """Gets the saml_scopes of this IssuerClient.  # noqa: E501

        The set of scopes to request for the agilicus oidc token when mapping to saml.   # noqa: E501

        :return: The saml_scopes of this IssuerClient.  # noqa: E501
        :rtype: list[str]
        """
        return self._saml_scopes

    @saml_scopes.setter
    def saml_scopes(self, saml_scopes):
        """Sets the saml_scopes of this IssuerClient.

        The set of scopes to request for the agilicus oidc token when mapping to saml.   # noqa: E501

        :param saml_scopes: The saml_scopes of this IssuerClient.  # noqa: E501
        :type: list[str]
        """

        self._saml_scopes = saml_scopes
