...
class IssuersApi(object):
    ...
    def set_policy(self, issuer_id, policy_spec, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str issuer_id: issuer_id path (required)
        :param PolicySpec policy_spec: Policy (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_policy_with_http_info(issuer_id, policy_spec, **kwargs)  # noqa: E501

    def set_policy_with_http_info(self, issuer_id, policy_spec, **kwargs):  # noqa: E501
        """Set the current policy to the policy sent  # noqa: E501

        Set the current policy to the given policy. This will replace the given issuer's policy with the content from the sent policy. Any ids will be used to link rules together, but be replaced, and any org_ids will be replaced with the org_id of the policy sent.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_policy_with_http_info(issuer_id, policy_spec, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['issuer_id', 'policy_spec']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('issuer_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['issuer_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `issuer_id` when calling `set_policy`")  # noqa: E501
        # verify the required parameter 'policy_spec' is set
        if self.api_client.client_side_validation and ('policy_spec' not in local_var_params or  # noqa: E501
                                                        local_var_params['policy_spec'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `policy_spec` when calling `set_policy`")  # noqa: E501
        ...
        body_params = None
        if 'policy_spec' in local_var_params:
            body_params = local_var_params['policy_spec']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/issuers/issuer_extensions/{issuer_id}/set_auth_policy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
