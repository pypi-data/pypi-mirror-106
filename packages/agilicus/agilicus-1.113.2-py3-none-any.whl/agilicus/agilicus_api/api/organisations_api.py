...
class OrganisationsApi(object):
    ...
    def get_usage_metrics(self, org_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_usage_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_usage_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get all usage metrics for an organisation  # noqa: E501

        Get all usage metrics for an organisation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_usage_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_usage_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'org_id' is set
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_usage_metrics`")  # noqa: E501
    ...
    def list_orgs(self, **kwargs):  # noqa: E501
        ...
        :param bool enabled: query any orgs which are enabled
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_orgs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'org_id', 'organisation', 'issuer', 'list_children', 'updated_since', 'suborg_updated', 'enabled']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
