...
class MessageProcessor:
    ...
    async def _parse_message(self, message, tracker: DialogueStateTracker = None):
        ...
        if message_type == "SPOKEN" and len(partials) > 0 and (
                ...
                re.match('action_\w{0,50}_followup', intent_name) or
                (intent_name == "action_handle_error" and message.text) or not intent_name
                or parse_data["intent"]["confidence"] < confidence_threshold):
