...
from ... import KLING_GUPTA,NASH_SUTCLIFFE,RMSE,TargetSpecificationVector,TargetSpecificationPts,TsTransform
from ....time_series import (UtcPeriod, TimeSeries, IntVector, TsFactory)
from ...repository.interfaces import TsStoreItem
from ...repository.interfaces import TimeseriesStore
...
class ConfigCalibrator(simulator.DefaultSimulator):
    ...
    def __init__(self, config):
        ...
        self.obj_funcs = {'NSE': NASH_SUTCLIFFE, 'KGE': KLING_GUPTA, 'RMSE': RMSE}
