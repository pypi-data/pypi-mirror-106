CONFIG = {
    ...
    "MMS": {
        ...
        "MLS_GRAPH_API_URL": {
            ...
            "stg": "http://mls-graph-nlb-5887b6bfea9d1d4e.elb.ap-northeast-2.amazonaws.com:8080",
            "prd": "http://mls-graph-nlb-5887b6bfea9d1d4e.elb.ap-northeast-2.amazonaws.com:8080",
        },
    },
    "LOCAL": {
        "MLS_AB_API_URL": {
