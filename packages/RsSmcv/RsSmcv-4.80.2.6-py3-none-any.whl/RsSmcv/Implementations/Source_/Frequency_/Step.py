...
class Step:
	...
	def get_mode(self) -> enums.FreqStepMode:
		...
		Defines the type of step size to vary the RF frequency at discrete steps with the commands FREQ UP or FREQ DOWN. \n
			:return: mode: DECimal| USER DECimal Increases or decreases the level in steps of ten. USER Increases or decreases the level in increments, set with the command method RsSmcv.Source.Frequency.Step.increment.
		"""
	...
	def set_mode(self, mode: enums.FreqStepMode) -> None:
		...
		Defines the type of step size to vary the RF frequency at discrete steps with the commands FREQ UP or FREQ DOWN. \n
			:param mode: DECimal| USER DECimal Increases or decreases the level in steps of ten. USER Increases or decreases the level in increments, set with the command method RsSmcv.Source.Frequency.Step.increment.
		"""
