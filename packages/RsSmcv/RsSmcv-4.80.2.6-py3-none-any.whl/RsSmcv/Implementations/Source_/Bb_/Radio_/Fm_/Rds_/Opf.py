...
class Opf:
	"""Opf commands group definition. 71 total commands, 24 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("opf", core, parent)

	@property
	def apply(self):
		"""apply commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_apply'):
			from .Opf_.Apply import Apply
	...
	def g10B(self):
		...
		if not hasattr(self, '_g10B'):
			from .Opf_.G10B import G10B
			self._g10B = G10B(self._core, self._base)
		return self._g10B
	...
	def g11A(self):
		...
		if not hasattr(self, '_g11A'):
			from .Opf_.G11A import G11A
			self._g11A = G11A(self._core, self._base)
		return self._g11A
	...
	def g11B(self):
		...
		if not hasattr(self, '_g11B'):
			from .Opf_.G11B import G11B
			self._g11B = G11B(self._core, self._base)
		return self._g11B
	...
	def g12A(self):
		...
		if not hasattr(self, '_g12A'):
			from .Opf_.G12A import G12A
			self._g12A = G12A(self._core, self._base)
		return self._g12A
	...
	def g12B(self):
		...
		if not hasattr(self, '_g12B'):
			from .Opf_.G12B import G12B
			self._g12B = G12B(self._core, self._base)
		return self._g12B
	...
	def g13A(self):
		...
		if not hasattr(self, '_g13A'):
			from .Opf_.G13A import G13A
			self._g13A = G13A(self._core, self._base)
		return self._g13A
	...
	def g13B(self):
		...
		if not hasattr(self, '_g13B'):
			from .Opf_.G13B import G13B
			self._g13B = G13B(self._core, self._base)
		return self._g13B
	...
	def g15A(self):
		...
		if not hasattr(self, '_g15A'):
			from .Opf_.G15A import G15A
			self._g15A = G15A(self._core, self._base)
		return self._g15A
	...
	def g1A(self):
		...
		if not hasattr(self, '_g1A'):
			from .Opf_.G1A import G1A
			self._g1A = G1A(self._core, self._base)
		return self._g1A
	...
	def g1B(self):
		...
		if not hasattr(self, '_g1B'):
			from .Opf_.G1B import G1B
			self._g1B = G1B(self._core, self._base)
		return self._g1B
	...
	def g3A(self):
		...
		if not hasattr(self, '_g3A'):
			from .Opf_.G3A import G3A
			self._g3A = G3A(self._core, self._base)
		return self._g3A
	...
	def g3B(self):
		...
		if not hasattr(self, '_g3B'):
			from .Opf_.G3B import G3B
			self._g3B = G3B(self._core, self._base)
		return self._g3B
	...
	def g4B(self):
		...
		if not hasattr(self, '_g4B'):
			from .Opf_.G4B import G4B
			self._g4B = G4B(self._core, self._base)
		return self._g4B
	...
	def g5A(self):
		...
		if not hasattr(self, '_g5A'):
			from .Opf_.G5A import G5A
			self._g5A = G5A(self._core, self._base)
		return self._g5A
	...
	def g5B(self):
		...
		if not hasattr(self, '_g5B'):
			from .Opf_.G5B import G5B
			self._g5B = G5B(self._core, self._base)
		return self._g5B
	...
	def g6A(self):
		...
		if not hasattr(self, '_g6A'):
			from .Opf_.G6A import G6A
			self._g6A = G6A(self._core, self._base)
		return self._g6A
	...
	def g6B(self):
		...
		if not hasattr(self, '_g6B'):
			from .Opf_.G6B import G6B
			self._g6B = G6B(self._core, self._base)
		return self._g6B
	...
	def g7A(self):
		...
		if not hasattr(self, '_g7A'):
			from .Opf_.G7A import G7A
			self._g7A = G7A(self._core, self._base)
		return self._g7A
	...
	def g7B(self):
		...
		if not hasattr(self, '_g7B'):
			from .Opf_.G7B import G7B
			self._g7B = G7B(self._core, self._base)
		return self._g7B
	...
	def g8A(self):
		...
		if not hasattr(self, '_g8A'):
			from .Opf_.G8A import G8A
			self._g8A = G8A(self._core, self._base)
		return self._g8A
	...
	def g8B(self):
		...
		if not hasattr(self, '_g8B'):
			from .Opf_.G8B import G8B
			self._g8B = G8B(self._core, self._base)
		return self._g8B
	...
	def g9A(self):
		...
		if not hasattr(self, '_g9A'):
			from .Opf_.G9A import G9A
			self._g9A = G9A(self._core, self._base)
		return self._g9A
	...
	def g9B(self):
		...
		if not hasattr(self, '_g9B'):
			from .Opf_.G9B import G9B
			self._g9B = G9B(self._core, self._base)
		return self._g9B
	...
	def get_state(self) -> bool:
		...
		Enables the open format. \n
			:return: open_format_state: 0| 1| OFF| ON
		"""
	...
	def set_state(self, open_format_state: bool) -> None:
		...
		Enables the open format. \n
			:param open_format_state: 0| 1| OFF| ON
		"""
	...
	def clone(self) -> 'Opf':
		...
		new_group = Opf(self._core, self._base.parent)
