...
class G8A:
	"""G8A commands group definition. 4 total commands, 0 Sub-groups, 4 group commands"""
	...
	def get_block_2(self) -> int:
		...
		No command help available \n
			:return: g_8_ab_lk_2: integer Range: 0 to 31
		"""
	...
	def set_block_2(self, g_8_ab_lk_2: int) -> None:
		...
		No command help available \n
			:param g_8_ab_lk_2: integer Range: 0 to 31
		"""
	...
	def get_block_3_a(self) -> int:
		...
		No command help available \n
			:return: ga_8_blk_3: integer Range: 0 to 65535
		"""
