...
class Setting:
	...
	def get_catalog(self) -> List[str]:
		...
		specific directory. \n
			:return: tx_audio_bc_am_cat_name: No help available
		"""
	...
	def get_load(self) -> str:
		...
		a specific directory. \n
			:return: am_rcl: 'AmRcl' Filename or complete file path; file extension can be omitted
		"""
	...
	def set_load(self, am_rcl: str) -> None:
		...
		to 'Accessing Files in the Default or Specified Directory' for general information on file handling in the default and in
		a specific directory. \n
			:param am_rcl: 'AmRcl' Filename or complete file path; file extension can be omitted
		"""
