...
class Graphics:
	"""Graphics commands group definition. 11 total commands, 3 Sub-groups, 7 group commands"""
	...
	def smart(self):
		...
		if not hasattr(self, '_smart'):
			from .Graphics_.Smart import Smart
			self._smart = Smart(self._core, self._base)
		return self._smart
