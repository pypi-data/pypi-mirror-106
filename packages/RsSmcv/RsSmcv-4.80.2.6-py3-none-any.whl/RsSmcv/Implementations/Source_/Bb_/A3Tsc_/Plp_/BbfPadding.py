...
class BbfPadding:
	"""BbfPadding commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("bbfPadding", core, parent)
	...
	def get(self, physicalLayerPipe=repcap.PhysicalLayerPipe.Default) -> bool:
		...
		Queries, if baseband frame padding is enabled/disabled for the current . \n
			...
			:return: bb_frame_padding: 0| 1| OFF| ON"""
