...
class InputPy:
	"""InputPy commands group definition. 17 total commands, 1 Sub-groups, 4 group commands"""
	...
	def t2Mi(self):
		...
		if not hasattr(self, '_t2Mi'):
			from .InputPy_.T2Mi import T2Mi
			self._t2Mi = T2Mi(self._core, self._base)
		return self._t2Mi
