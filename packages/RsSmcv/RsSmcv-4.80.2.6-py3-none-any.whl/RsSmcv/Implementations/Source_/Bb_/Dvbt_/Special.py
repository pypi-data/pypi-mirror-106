...
class Special:
	"""Special commands group definition. 3 total commands, 2 Sub-groups, 0 group commands"""
	...
	def reedSolomon(self):
		...
		if not hasattr(self, '_reedSolomon'):
			from .Special_.ReedSolomon import ReedSolomon
			self._reedSolomon = ReedSolomon(self._core, self._base)
