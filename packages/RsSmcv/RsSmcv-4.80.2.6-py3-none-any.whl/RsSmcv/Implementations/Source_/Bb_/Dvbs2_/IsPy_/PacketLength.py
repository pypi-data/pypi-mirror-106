...
class PacketLength:
	...
	def get(self, inputStream=repcap.InputStream.Default) -> enums.InputSignalPacketLength:
		...
		Queries the packet length of the external transport stream in bytes. \n
			...
			:return: packet_length: INValid| P208| P204| P188 P188|P204|P208 188/204/208 byte packets specified for serial input and parallel input. INValid Packet length does not match the specified length."""
