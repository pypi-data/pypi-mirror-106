...
class RsSmcv:
	"""1878 total commands, 24 Sub-groups, 0 group commands"""
	_driver_options = "SupportedInstrModels = SMCV/SMW/SMBV/SMA, SupportedIdnPatterns = SMCV/SMBV/SMW/SMA, SimulationIdnString = 'Rohde&Schwarz,SMCV100B,100001,4.80.2.0006'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '4.80.2.0006'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '4.80.2.0006'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsSmcv version failed. Current version: '4.80.2.0006', minimum required version: '{min_version}'")
	...
	@property
	def display(self):
		"""display commands group. 4 Sub-classes, 3 commands."""
	...
	def sconfiguration(self):
		"""sconfiguration commands group. 4 Sub-classes, 1 commands."""
	...
	@property
	def system(self):
		"""system commands group. 31 Sub-classes, 28 commands."""
	...
	def tsGen(self):
		...
		if not hasattr(self, '_tsGen'):
			...
			self._tsGen = TsGen(self._core, self._base)
		return self._tsGen
