...
# noinspection SpellCheckingInspection
class AlternaiveFreqList(Enum):
	"""Repeated capability AlternaiveFreqList"""
	Empty = VALUE_EMPTY
	Default = VALUE_DEFAULT
	Nr1 = 1
	Nr2 = 2
...
# noinspection SpellCheckingInspection
class BlockIdCode(Enum):
	"""Repeated capability BlockIdCode"""
	Empty = VALUE_EMPTY
	Default = VALUE_DEFAULT
	Nr1 = 1
	Nr2 = 2
...
# noinspection SpellCheckingInspection
class GroupTypeVariant(Enum):
	"""Repeated capability GroupTypeVariant"""
	Empty = VALUE_EMPTY
	Default = VALUE_DEFAULT
	Nr1 = 1
	Nr2 = 2
...
class InputStream(Enum):
	"""Repeated capability InputStream"""
	Empty = VALUE_EMPTY
	Default = VALUE_DEFAULT
	Nr1 = 1
	Nr2 = 2
...
# noinspection SpellCheckingInspection
class PhysicalLayerPipe(Enum):
	"""Repeated capability PhysicalLayerPipe"""
	Empty = VALUE_EMPTY
	Default = VALUE_DEFAULT
	Nr1 = 1
	Nr2 = 2
