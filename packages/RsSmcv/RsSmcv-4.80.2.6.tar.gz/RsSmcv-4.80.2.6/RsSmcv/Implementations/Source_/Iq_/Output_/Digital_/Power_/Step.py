...
class Step:
	...
	def get_mode(self) -> enums.FreqStepMode:
		...
		Defines the type of step size to vary the digital output power step-by-step. \n
			:return: mode: DECimal| USER DECimal increases or decreases the level in steps of ten. USER increases or decreases the level in increments, determined with the command [:SOURcehw]:IQ:OUTPut:DIGital:POWer:STEP[:INCRement].
		"""
	...
	def set_mode(self, mode: enums.FreqStepMode) -> None:
		...
		Defines the type of step size to vary the digital output power step-by-step. \n
			:param mode: DECimal| USER DECimal increases or decreases the level in steps of ten. USER increases or decreases the level in increments, determined with the command [:SOURcehw]:IQ:OUTPut:DIGital:POWer:STEP[:INCRement].
		"""
