...
class Library:
	"""Library commands group definition. 2 total commands, 0 Sub-groups, 2 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("library", core, parent)
	...
	def get_catalog(self) -> List[str]:
		...
		a specific directory. \n
			:return: tx_audio_bc_fm_wav_cat_nam: filename1,filename2,... Returns a string of filenames separated by commas.
		"""
