...
class InputPy:
	"""InputPy commands group definition. 9 total commands, 2 Sub-groups, 5 group commands"""
	...
	def destination(self):
		...
		if not hasattr(self, '_destination'):
			from .InputPy_.Destination import Destination
