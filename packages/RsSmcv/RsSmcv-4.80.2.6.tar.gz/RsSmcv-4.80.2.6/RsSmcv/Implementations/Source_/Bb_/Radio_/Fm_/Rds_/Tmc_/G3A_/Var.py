...
class Var:
	"""Var commands group definition. 1 total commands, 0 Sub-groups, 1 group commands
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_groupTypeVariant_get', 'repcap_groupTypeVariant_set', repcap.GroupTypeVariant.Nr1)

	def repcap_groupTypeVariant_set(self, enum_value: repcap.GroupTypeVariant) -> None:
	...
	def set(self, g_3_avar: int, groupTypeVariant=repcap.GroupTypeVariant.Default) -> None:
		...
		groupTypeVariant_cmd_val = self._base.get_repcap_cmd_value(groupTypeVariant, repcap.GroupTypeVariant)
	...
	def clone(self) -> 'Var':
		...
		new_group = Var(self._core, self._base.parent)
