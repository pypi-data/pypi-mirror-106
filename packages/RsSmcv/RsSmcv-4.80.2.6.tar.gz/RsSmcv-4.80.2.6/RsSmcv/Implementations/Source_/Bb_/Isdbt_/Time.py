...
class Time:
	"""Time commands group definition. 3 total commands, 1 Sub-groups, 0 group commands"""
	...
	def interleaving(self):
		...
		if not hasattr(self, '_interleaving'):
			from .Time_.Interleaving import Interleaving
			self._interleaving = Interleaving(self._core, self._base)
