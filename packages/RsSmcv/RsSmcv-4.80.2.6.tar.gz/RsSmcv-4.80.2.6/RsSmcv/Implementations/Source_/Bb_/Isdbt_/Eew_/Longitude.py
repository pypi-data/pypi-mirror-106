...
class Longitude:
	"""Longitude commands group definition. 1 total commands, 0 Sub-groups, 1 group commands
	Repeated Capability: Index, default value after init: Index.Nr1"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("longitude", core, parent)
	...
	def clone(self) -> 'Longitude':
		...
		new_group = Longitude(self._core, self._base.parent)
