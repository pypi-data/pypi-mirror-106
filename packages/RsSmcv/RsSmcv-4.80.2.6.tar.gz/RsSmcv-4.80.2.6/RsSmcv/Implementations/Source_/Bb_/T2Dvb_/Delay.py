...
class Delay:
	"""Delay commands group definition. 12 total commands, 1 Sub-groups, 6 group commands"""
	...
	def tsp(self):
		...
		if not hasattr(self, '_tsp'):
			from .Delay_.Tsp import Tsp
			self._tsp = Tsp(self._core, self._base)
		return self._tsp
