...
class ModCod:
	"""ModCod commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("modCod", core, parent)
	...
	def set(self, mod_cod: enums.Dvbs2CodingModCod, timeSlice=repcap.TimeSlice.Default, inputStream=repcap.InputStream.Default) -> None:
		...
		timeSlice_cmd_val = self._base.get_repcap_cmd_value(timeSlice, repcap.TimeSlice)
