...
class Tsp:
	"""Tsp commands group definition. 6 total commands, 1 Sub-groups, 5 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("tsp", core, parent)

	@property
	def update(self):
		"""update commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_update'):
			from .Tsp_.Update import Update
	...
	def clone(self) -> 'Tsp':
		...
		new_group = Tsp(self._core, self._base.parent)
