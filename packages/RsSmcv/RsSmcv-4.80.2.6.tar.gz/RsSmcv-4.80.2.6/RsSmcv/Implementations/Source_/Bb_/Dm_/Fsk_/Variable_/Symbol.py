...
class Symbol:
	"""Symbol commands group definition. 1 total commands, 1 Sub-groups, 0 group commands
	...
	def deviation(self):
		...
		if not hasattr(self, '_deviation'):
			from .Symbol_.Deviation import Deviation
	...
	def clone(self) -> 'Symbol':
		...
		new_group = Symbol(self._core, self._base.parent)
