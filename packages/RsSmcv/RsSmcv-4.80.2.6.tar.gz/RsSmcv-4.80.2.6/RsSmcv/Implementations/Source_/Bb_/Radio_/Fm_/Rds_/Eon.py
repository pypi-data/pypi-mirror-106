...
class Eon:
	"""Eon commands group definition. 16 total commands, 1 Sub-groups, 10 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("eon", core, parent)

	@property
	def af(self):
		"""af commands group. 2 Sub-classes, 1 commands."""
		if not hasattr(self, '_af'):
			from .Eon_.Af import Af
	...
	def clone(self) -> 'Eon':
		...
		new_group = Eon(self._core, self._base.parent)
