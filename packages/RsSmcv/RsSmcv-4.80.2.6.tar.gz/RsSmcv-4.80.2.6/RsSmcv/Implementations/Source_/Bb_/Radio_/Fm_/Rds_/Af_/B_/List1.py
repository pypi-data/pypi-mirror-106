...
class List1:
	"""List1 commands group definition. 4 total commands, 2 Sub-groups, 2 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("list1", core, parent)

	@property
	def desc(self):
		"""desc commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_desc'):
			from .List1_.Desc import Desc
	...
	def frequency(self):
		...
		if not hasattr(self, '_frequency'):
			from .List1_.Frequency import Frequency
	...
	def clone(self) -> 'List1':
		...
		new_group = List1(self._core, self._base.parent)
