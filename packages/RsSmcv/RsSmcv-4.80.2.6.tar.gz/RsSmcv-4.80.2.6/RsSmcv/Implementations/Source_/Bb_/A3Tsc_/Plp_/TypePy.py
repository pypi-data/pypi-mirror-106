...
class TypePy:
	...
	def nsubSlices(self):
		...
		if not hasattr(self, '_nsubSlices'):
			from .TypePy_.NsubSlices import NsubSlices
			self._nsubSlices = NsubSlices(self._core, self._base)
	...
	def subslice(self):
		...
		if not hasattr(self, '_subslice'):
			from .TypePy_.Subslice import Subslice
			self._subslice = Subslice(self._core, self._base)
	...
	def typePy(self):
		...
		if not hasattr(self, '_typePy'):
			from .TypePy_.TypePy import TypePy
