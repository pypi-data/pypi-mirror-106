...
class Catalog:
    ...
    def update_data_source_resource(self, path: str) -> Tuple[DataSource, str]:
        ...
        for resource_item in data_source_to_update[0].resources:
            del resource_item.full_path_slug
            del resource_item.full_path

        updated_contents = data_source_to_update[0].to_json()
        self.update_data_source(
            data_source_to_update[0].name, updated_contents, data_source_to_update[1]
        )
    ...
    def get_all_data_sources(self) -> List[Tuple[DataSource, str]]:
        ...
        while catalog_contents:
            ...
            if file_content.type == "dir":
                ...
                data_sources.append(
                    self.get_data_source(file_content.path, HelixEnvironment.PRODUCTION)
                )
        return data_sources
