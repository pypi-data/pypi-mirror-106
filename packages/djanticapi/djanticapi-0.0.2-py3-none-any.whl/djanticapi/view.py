import decimal
import logging
from typing import Any, Callable, Dict, Iterable, List, Optional, Tuple, Type, Union, TypeVar
...
class JsonResponse(HttpResponse):
    def __init__(self, data, encoder: Callable[[Any], Any] = default, **kwargs):
        kwargs.setdefault('content_type', 'application/json')
        data = orjson.dumps(data, default=encoder)
