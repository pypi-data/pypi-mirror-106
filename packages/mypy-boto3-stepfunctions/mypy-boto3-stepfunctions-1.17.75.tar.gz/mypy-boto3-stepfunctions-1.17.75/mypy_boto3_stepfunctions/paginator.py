...
class GetExecutionHistoryPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/stepfunctions.html#SFN.Paginator.GetExecutionHistory.paginate)
...
class ListActivitiesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/stepfunctions.html#SFN.Paginator.ListActivities.paginate)
...
class ListExecutionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/stepfunctions.html#SFN.Paginator.ListExecutions.paginate)
...
class ListStateMachinesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.75/reference/services/stepfunctions.html#SFN.Paginator.ListStateMachines.paginate)
