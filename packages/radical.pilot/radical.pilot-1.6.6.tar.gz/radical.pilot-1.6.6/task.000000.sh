...
export RADICAL_BASE="<Mock id='139709647530832'>"
export RP_SESSION_ID="sid0"
export RP_PILOT_ID="pid0"
export RP_AGENT_ID="aid0"
export RP_SPAWNER_ID="<Mock id='139709647530736'>"
export RP_TASK_ID="task.000000"
export RP_TASK_NAME="task.0000"
export RP_GTOD="<Mock id='139709647530784'>"
export RP_TMP="<Mock id='139709647530928'>"
export RP_PILOT_SANDBOX="<Mock id='139709647530832'>"
export RP_PILOT_STAGING="<Mock id='139709647530832'>"
