...
class ListContainersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.74/reference/services/mediastore.html#MediaStore.Paginator.ListContainers.paginate)
