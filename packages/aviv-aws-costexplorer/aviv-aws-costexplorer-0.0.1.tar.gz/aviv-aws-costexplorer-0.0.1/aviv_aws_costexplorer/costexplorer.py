...
class CostExplorer(base.AWSClient):
    ...
    def __init__(self, granularity: types.CAUGranularity='MONTHLY', period:relativedelta=None, date: datetime.datetime=None):
        """
    ...
    def get_cost_and_usage(self, **props) -> dict:
        ...
        response = self.client.get_cost_and_usage(**props)
        ...
        while 'NextPageToken' in response:
            ...
            nextresp = self.client.get_cost_and_usage(**props)
