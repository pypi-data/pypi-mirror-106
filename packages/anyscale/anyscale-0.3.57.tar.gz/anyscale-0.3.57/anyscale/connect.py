...
from anyscale.util import get_endpoint, slugify, wait_for_session_start
...
REQUIRED_RAY_COMMIT = "1d834bcbe33c7714913fa06c7a7392c29eb7d71d"
...
PINNED_IMAGES = {
    "anyscale/ray-ml:nightly-py36-cpu": "anyscale/ray-ml@sha256:2b995f899ebfb068e92e615940246f9890e982ef04746e55214897cc10f479a2",
    "anyscale/ray-ml:nightly-py36-gpu": "anyscale/ray-ml@sha256:a4e3bfb9c966a20963f928b6fab1e7040d06461a6597f1c94d5837f31bae9921",
    "anyscale/ray-ml:nightly-py37-cpu": "anyscale/ray-ml@sha256:b361236dab6e4c1459bc45d5f15ce0f6b351513fe2ce0a3e20d23a6cf0b5aad6",
    "anyscale/ray-ml:nightly-py37-gpu": "anyscale/ray-ml@sha256:f5dc4b45fbd20b37ea43db98f6be23c71252f7c3af02cc13d1c52c8d3979e47b",
    "anyscale/ray-ml:nightly-py38-cpu": "anyscale/ray-ml@sha256:adfb2c567ecb59ee2d96c78ad619c6cde1df249e3e98f140890c1b7e1de1af5e",
    "anyscale/ray-ml:nightly-py38-gpu": "anyscale/ray-ml@sha256:6f7b65d02f587c1e5e9bf4a33c1bcb290a36d6ff15056c3624695a2333fb46a8",
    "anyscale/ray:nightly-py36-cpu": "anyscale/ray@sha256:b505f89d5a89ee9ce7a9abda29d39bcb290d1f4c2cef54b412623a52a01f1d21",
    "anyscale/ray:nightly-py36-gpu": "anyscale/ray@sha256:69b2e93774fa56432939884f9bcca238edff26efc57cefb92d0a16f96f14b51d",
    "anyscale/ray:nightly-py37-cpu": "anyscale/ray@sha256:1bc7573c34c6d6cf91f72ad3907a16c5de72e7f13795bb81bfb9fd6f16b6b274",
    "anyscale/ray:nightly-py37-gpu": "anyscale/ray@sha256:52fea67f3e872f584843e29d4cb5681639dc454bd20cd17d9965203b63fcbbd8",
    "anyscale/ray:nightly-py38-cpu": "anyscale/ray@sha256:68da216228d2cfbf0098ea57a0e8a2e15cccd2ec0f10f80fbf358bacf4140c44",
    "anyscale/ray:nightly-py38-gpu": "anyscale/ray@sha256:9482686d0ec5b1fbf8bd3554a8a3857f2e7ec6a5ae00e9b2817ce30524e86bde",
}
...
class ClientBuilder:
    ...
    def namespace(self, namespace: str) -> "ClientBuilder":
        """Sets the namespaces in the job config."""
        raise NotImplementedError

        self._job_config.set_namespace(namespace)
        return self

    def job_name(self, job_name: str) -> "ClientBuilder":
    ...
    def app_config(self, app_config_identifier: str) -> "ClientBuilder":
    ...
    def _start_session(
        ...
        if self._use_compute_config:
            ...
            if not build_id:
                ...
                raise RuntimeError(
                    "Build id must be provided if ANYSCALE_COMPUTE_CONFIG=1."
                )
