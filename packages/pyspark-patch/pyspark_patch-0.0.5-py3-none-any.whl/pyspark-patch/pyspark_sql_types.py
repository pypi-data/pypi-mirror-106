# It's a patched version of pyspark/sql/types.py (CurrencyType and
# PercentType were added).
# It should be copied to python/site-packages/pyspark/sql/types.py
...
# try workaround to save type after creating table from jdf
# reserver 38, 17 for currency and 38, 16 for percent
class CurrencyType(DecimalType):
    def __init__(self, precision=38, scale=17):
...
class PercentType(DecimalType):
    def __init__(self, precision=38, scale=16):
        super().__init__(precision, scale)
