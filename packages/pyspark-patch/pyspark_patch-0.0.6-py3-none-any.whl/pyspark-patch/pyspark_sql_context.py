# It's a patched version of pyspark/sql/context.py that adds **kwargs arg to
# SparkContext.sql() method.
# It should be copied to python/site-packages/pyspark/sql/context.py
# It is based on context.py file of version 3.0.1
#
#
#
...
class SQLContext(object):
    ...
    def sql(self, sqlQuery, **kwargs):
        ...
        """
        return self.sparkSession.sql(sqlQuery, **kwargs)
