...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.1.0-alpha.1621595270+1703535e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.1.0-alpha.1621595270+1703535e`
                """)
            else:
                raise
