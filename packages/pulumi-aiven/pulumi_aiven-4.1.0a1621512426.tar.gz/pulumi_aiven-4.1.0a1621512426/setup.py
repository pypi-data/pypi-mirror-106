...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.1.0-alpha.1621512426+3aa2ce36'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.1.0-alpha.1621512426+3aa2ce36`
                """)
            else:
                raise
