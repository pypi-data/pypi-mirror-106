...
from scarlet.utils.assets import ImageSerializer, get_image_urls
from . import (
    settings,
    get_page_model,
    get_hero_model,
...
class GalleryImageSchema(serializers.Serializer):
    gallery_desktop = serializers.URLField()
    gallery_mobile = serializers.URLField()


class GalleryImageSerializer(serializers.ModelSerializer):
    image = serializers.SerializerMethodField()

    @extend_schema_field(GalleryImageSchema)
...
class CarouselImageSchema(serializers.Serializer):
    carousel_desktop = serializers.URLField()
    carousel_mobile = serializers.URLField()


class CarouselItemSerializer(serializers.ModelSerializer):
    image = serializers.SerializerMethodField()

    @extend_schema_field(CarouselImageSchema)
    def get_image(self, obj):
