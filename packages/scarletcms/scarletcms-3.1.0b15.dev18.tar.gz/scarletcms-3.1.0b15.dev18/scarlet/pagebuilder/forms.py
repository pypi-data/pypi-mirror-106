...
class FieldOrderMixin(object):
    def __init__(self, *args, **kwargs):
        if hasattr(self.Meta.model, "field_order"):
            self.field_order = self.Meta.model.field_order
        super().__init__(*args, **kwargs)


class HeroModuleForm(FieldOrderMixin, forms.ModelForm):
...
class TwoColumnModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = TwoColumnModule
        fields = "__all__"


class HeaderModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = HeaderModule
        fields = "__all__"


class IconListModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = IconListModule
        fields = "__all__"


class IconListItemForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = IconListItem
        fields = "__all__"


class FAQModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = FAQModule
        fields = "__all__"


class FAQItemForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = FAQItem
        fields = "__all__"


class LocationModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = LocationModule
        fields = "__all__"


class LocationItemForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = LocationItem
        fields = "__all__"


class ImageGalleryModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = ImageGalleryModule
        fields = "__all__"


class GalleryImageForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = GalleryImage
        fields = "__all__"


class CarouselModuleForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = CarouselModule
        fields = "__all__"


class CarouselItemForm(FieldOrderMixin, forms.ModelForm):
    class Meta:
        model = CarouselItem
        fields = "__all__"
