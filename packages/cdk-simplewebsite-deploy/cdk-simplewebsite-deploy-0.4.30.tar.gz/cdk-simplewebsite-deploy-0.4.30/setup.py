    ...
    """
{
    ...
    "package_data": {
        "cdk_simplewebsite_deploy._jsii": [
            "cdk-simplewebsite-deploy@0.4.30.jsii.tgz"
        ],
        "cdk_simplewebsite_deploy": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cloudfront-origins>=1.104.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.104.0, <2.0.0",
        "aws-cdk.aws-route53-targets>=1.104.0, <2.0.0",
        "aws-cdk.aws-route53>=1.104.0, <2.0.0",
        "aws-cdk.aws-s3-deployment>=1.104.0, <2.0.0",
        "aws-cdk.aws-s3>=1.104.0, <2.0.0",
