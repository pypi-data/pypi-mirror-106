import requests
import pandas as pd
from arpeggioportal.utils import single_spaced
...
class PortalSession():
    ...
    def login(self, api_key = None, email = None, password = None):
    ...
    def samples(self):
        ...
        return(out.join(pd.DataFrame(out.pop('tags').values.tolist())))
