...
class DataLoad(object):
    ...
    def delete_destination(self, dsId,tblId, bqClt):
        ...
        print('Table {}:{} deleted.'.format(dsId, tblId))
    ...
    def get_record_type_schema(self, record_type, filter=None):
        ...
        if not dst.exists:
            print("Can't find schema for: "+record_type)
            return None
    ...
    def load_bq_data(self, records,record_type):
        try:
            ...
            print("Trouble processing records: {}".format(record_type))
            raise e
    ...
    def convert_to_val(self,inVal, outType, raiseException=True, defaultVal=0):
        try:
            ...
            if raiseException:
                print("Trying to convert ({}) to ({})".format(inVal,str(outType)))
                raise e
            return defaultVal
    ...
    def _process_plant_inventory_growweek(self,growWeekDoc, plant_rec_inv):
        try:
            ...
            print("Problem processing: "+growWeekDoc.id)
            raise e
